...
procedure {:entrypoint} mainloop();
  modifies $exn, $M.2, $M.4, $CurrAddr, $Alloc;



implementation {:entrypoint} mainloop()
{
  var $p0: ref;
  var $i1: i32;
  var $i2: i1;
  ...
  corral_source_split_5:
    assume {:verifier.code 0} true;
    call {:si_unique_call 3} $i3 := printf.ref(.str.14);
  ...
  corral_source_split_14:
    assume {:verifier.code 0} true;
    call {:si_unique_call 8} $i9 := printf.ref.i32(.str.15, $i4);
  ...
  corral_source_split_38:
    assume {:verifier.code 0} true;
    $p28 := $add.ref($add.ref($p0, $mul.ref(0, 1432)), $mul.ref(16, 1));
  ...
  corral_source_split_40:
    assume {:verifier.code 0} true;
    $p33 := $add.ref($add.ref(prevState, $mul.ref(0, 45824)), $mul.ref($i21, 1432));
    $p34 := $add.ref($add.ref($add.ref(prevState, $mul.ref(0, 45824)), $mul.ref($i21, 1432)), $mul.ref(16, 1));
  ...
  corral_source_split_47:
    assume {:verifier.code 0} true;
    $p40 := $add.ref($add.ref($p0, $mul.ref(0, 1432)), $mul.ref(16, 1));
  ...
  corral_source_split_49:
    assume {:verifier.code 0} true;
    call {:si_unique_call 19} $i45 := printf.ref.i32.i32.float(.str.16, $i21, $i22, $f44);
  ...
  corral_source_split_59:
    assume {:verifier.code 0} true;
    $p53 := $add.ref($add.ref($p0, $mul.ref(0, 1432)), $mul.ref(528, 1));
  ...
  corral_source_split_61:
    assume {:verifier.code 0} true;
    $p58 := $add.ref($add.ref(prevState, $mul.ref(0, 45824)), $mul.ref($i21, 1432));
    $p59 := $add.ref($add.ref($add.ref(prevState, $mul.ref(0, 45824)), $mul.ref($i21, 1432)), $mul.ref(528, 1));
  ...
  corral_source_split_69:
    assume {:verifier.code 0} true;
    call {:si_unique_call 26} $M.4 := $memcpy.i8($M.4, $M.3, $p90, $p91, 1432, false);
  ...
  $bb27:
    assume {:verifier.code 0} true;
    $p77 := $add.ref($add.ref($p0, $mul.ref(0, 1432)), $mul.ref(1040, 1));
  ...
  corral_source_split_73:
    assume {:verifier.code 0} true;
    $p82 := $add.ref($add.ref($p0, $mul.ref(0, 1432)), $mul.ref(528, 1));
  ...
  corral_source_split_75:
    assume {:verifier.code 0} true;
    call {:si_unique_call 29} $i87 := printf.ref.i32.i32.i32.float(.str.17, $i21, $i47, $i81, $f86);
  ...
  corral_source_split_78:
    assume {:verifier.code 0} true;
    $p65 := $add.ref($add.ref($p0, $mul.ref(0, 1432)), $mul.ref(1040, 1));
  ...
  corral_source_split_80:
    assume {:verifier.code 0} true;
    $p70 := $add.ref($add.ref(prevState, $mul.ref(0, 45824)), $mul.ref($i21, 1432));
    $p71 := $add.ref($add.ref($add.ref(prevState, $mul.ref(0, 45824)), $mul.ref($i21, 1432)), $mul.ref(1040, 1));
