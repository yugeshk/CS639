...
implementation report_result($i0: i32)
{
  ...
  corral_source_split_4:
    assume {:verifier.code 0} true;
    call {:si_unique_call 1} $i2 := printf.ref(.str);
  ...
  corral_source_split_7:
    assume {:verifier.code 0} true;
    call {:si_unique_call 2} $i3 := printf.ref(.str.1);
    assume {:verifier.code 0} true;
    goto $bb3;
...
implementation emscripten_result_to_string($i0: i32) returns ($r: ref)
{
  ...
  $bb0:
    assume {:verifier.code 0} true;
    call {:si_unique_call 3} {:cexpr "emscripten_result_to_string:arg:result"} boogie_si_record_i32($i0);
...
procedure {:entrypoint} click_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  modifies $exn, $M.8;



implementation {:entrypoint} click_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  var $p3: ref;
  var $p4: ref;
  var $p5: ref;
  ...
  $bb0:
    assume {:verifier.code 0} true;
    call {:si_unique_call 4} {:cexpr "click_callback:arg:eventType"} boogie_si_record_i32($i0);
  ...
  corral_source_split_58:
    ...
    call {:si_unique_call 5} __SMACK_check_memory_safety($p4, $p5);
  ...
  corral_source_split_63:
    ...
    call {:si_unique_call 6} __SMACK_check_memory_safety($p9, $p10);
  ...
  corral_source_split_68:
    ...
    call {:si_unique_call 7} __SMACK_check_memory_safety($p14, $p15);
  ...
  corral_source_split_73:
    ...
    call {:si_unique_call 8} __SMACK_check_memory_safety($p19, $p20);
  ...
  corral_source_split_78:
    ...
    call {:si_unique_call 9} __SMACK_check_memory_safety($p24, $p25);
  ...
  corral_source_split_83:
    ...
    call {:si_unique_call 10} __SMACK_check_memory_safety($p29, $p30);
  ...
  corral_source_split_88:
    ...
    call {:si_unique_call 11} __SMACK_check_memory_safety($p34, $p35);
  ...
  corral_source_split_93:
    ...
    call {:si_unique_call 12} __SMACK_check_memory_safety($p39, $p40);
  ...
  $bb18:
    ...
    call {:si_unique_call 13} __SMACK_check_memory_safety($p44, $p45);
  ...
  $bb22:
    ...
    call {:si_unique_call 14} __SMACK_check_memory_safety($p48, $p49);
    goto corral_source_split_105;

  corral_source_split_105:
    assume {:verifier.code 0} true;
    $M.8 := 1;
    call {:si_unique_call 15} {:cexpr "gotClick"} boogie_si_record_i32(1);
    goto corral_source_split_106;

  corral_source_split_106:
    assume {:verifier.code 0} true;
    call {:si_unique_call 16} $i50 := printf.ref(.str.12);
    goto corral_source_split_107;

  corral_source_split_107:
    assume {:verifier.code 0} true;
    call {:si_unique_call 17} $i51 := emscripten_request_pointerlock($0.ref, 0);
    call {:si_unique_call 18} {:cexpr "ret"} boogie_si_record_i32($i51);
  ...
  corral_source_split_111:
    assume {:verifier.code 0} true;
    call {:si_unique_call 19} $p53 := emscripten_result_to_string($i51);
    goto corral_source_split_112;

  corral_source_split_112:
    assume {:verifier.code 0} true;
    call {:si_unique_call 20} $i54 := printf.ref.ref.ref(.str.13, .str.14, $p53);
  ...
  corral_source_split_117:
    assume {:verifier.code 0} true;
    call {:si_unique_call 21} $i56 := printf.ref(.str.15);
    goto corral_source_split_118;

  corral_source_split_118:
    assume {:verifier.code 0} true;
    call {:si_unique_call 22} report_result(1);
