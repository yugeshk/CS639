...
implementation click_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  corral_source_split_106:
    assume {:verifier.code 0} true;
    call {:si_unique_call 16} vslice_dummy_var_2 := printf.ref(.str.12);
  ...
  corral_source_split_112:
    assume {:verifier.code 0} true;
    call {:si_unique_call 20} vslice_dummy_var_3 := printf.ref.ref.ref(.str.13, .str.14, $p53);
  ...
  corral_source_split_117:
    assume {:verifier.code 0} true;
    call {:si_unique_call 21} vslice_dummy_var_4 := printf.ref(.str.15);
...
procedure {:entrypoint} click_callback_SeqInstr($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.8;



implementation {:entrypoint} click_callback_SeqInstr($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{

  start:
    assertsPassed := true;
    call $r := click_callback($i0, $p1, $p2);
