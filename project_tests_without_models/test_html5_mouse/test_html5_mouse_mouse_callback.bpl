...
procedure  printf.ref.ref.ref($p0: ref, p.1: ref, p.2: ref)
  returns ($r: i32);
procedure  printf.ref.ref.i32.i32.i32.i32.ref.ref.ref.ref.i32.i32.i32.i32.float.float.float.i32($p0: ref, p.1: ref, p.2: i32, p.3: i32, p.4: i32, p.5: i32, p.6: ref, p.7: ref, p.8: ref, p.9: ref, p.10: i32, p.11: i32, p.12: i32, p.13: i32, p.14: float, p.15: float, p.16: float, p.17: i32)
  returns ($r: i32);
...
procedure  {:entrypoint} mouse_callback($i0: i32, $p1: ref, $p2: ref)
  returns ($r: i32)
{
  var $p3: ref;
  var $p4: ref;
...
procedure  wheel_callback($i0: i32, $p1: ref, $p2: ref)
  returns ($r: i32)
{
  var $p3: ref;
  var $p4: ref;
...
$bb0:
  ...
  call __SMACK_check_memory_safety($p66, $p67);
  ...
  call __SMACK_check_memory_safety($p75, $p76);
  assume {:sourceloc "test_html5_mouse.c", 103, 15} true;
  assume {:verifier.code 0} true;
  ...
  call __SMACK_check_memory_safety($p98, $p99);
  assume {:sourceloc "test_html5_mouse.c", 105, 10} true;
  assume {:verifier.code 0} true;
...
procedure {:inline} __SMACK_check_memory_safety($p0: ref, $p1: ref);
