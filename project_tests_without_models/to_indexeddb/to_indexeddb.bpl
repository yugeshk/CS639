...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 143057));
...
procedure  $global_allocations()
{
  ...
  call $galloc(.str.18.49, 35);
  call $galloc(.str.33, 49);
  call $galloc(.str.19.50, 30);
  call $galloc(.str.20.51, 33);
  call $galloc(.str.21.52, 30);
  call $galloc(.str.22.53, 30);
  call $galloc(.str.23.54, 30);
  call $galloc(.str.24.55, 32);
  ...
  call $galloc(.str.31, 24);
  call $galloc(.str.46, 56);
  call $galloc(.str.47, 59);
  call $galloc(.str.59, 29);
  call $galloc(.str.1.60, 29);
  call $galloc(.str.2.61, 29);
  call $galloc(.str.3.62, 29);
  call $galloc(.str.1.32, 37);
  call $galloc(.str.4.63, 15);
  call $galloc(.str.5.64, 15);
  call $galloc(.str.6.65, 15);
  call $galloc(.str.7.66, 15);
  call $galloc(_ZTISt9bad_alloc, 4);
  call $galloc(_ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv, 4);
  call $galloc(.str.16.33, 49);
  call $galloc(.str.2.34, 31);
  call $galloc(.str.3.35, 34);
  call $galloc(.str.4.36, 31);
  call $galloc(.str.5.37, 31);
  call $galloc(.str.6.38, 31);
  call $galloc(.str.7.39, 33);
  call $galloc(.str.8.40, 29);
  call $galloc(.str.9.41, 28);
  call $galloc(.str.10.42, 28);
  call $galloc(.str.11.43, 37);
  call $galloc(.str.14.44, 50);
  call $galloc(.str.15.45, 54);
  call $galloc(.str.12.46, 52);
  call $galloc(.str.13.47, 55);
  call $galloc(.str.17.48, 23);
  call $galloc(__SMACK_check_overflow, 4);
  call $galloc(__SMACK_nondet_char, 4);
  call $galloc(.str.25.56, 27);
  call $galloc(.str.26, 26);
  call $galloc(.str.27, 26);
  call $galloc(.str.28, 35);
  call $galloc(.str.31.57, 50);
  call $galloc(.str.32, 54);
  call $galloc(.str.29.58, 52);
  ...
  call $galloc(.str.43, 30);
  call $galloc(.str.44, 30);
  call $galloc(.str.45, 39);
...
axiom (.str.31 == $sub.ref(0, 25037));
const {:count 37} .str.1.32: ref;
axiom (.str.1.32 == $sub.ref(0, 26098));
const {:count 49} .str.16.33: ref;
axiom (.str.16.33 == $sub.ref(0, 27171));
const {:count 31} .str.2.34: ref;
axiom (.str.2.34 == $sub.ref(0, 28226));
const {:count 34} .str.3.35: ref;
axiom (.str.3.35 == $sub.ref(0, 29284));
const {:count 31} .str.4.36: ref;
axiom (.str.4.36 == $sub.ref(0, 30339));
const {:count 31} .str.5.37: ref;
axiom (.str.5.37 == $sub.ref(0, 31394));
const {:count 31} .str.6.38: ref;
axiom (.str.6.38 == $sub.ref(0, 32449));
const {:count 33} .str.7.39: ref;
axiom (.str.7.39 == $sub.ref(0, 33506));
const {:count 29} .str.8.40: ref;
axiom (.str.8.40 == $sub.ref(0, 34559));
const {:count 28} .str.9.41: ref;
axiom (.str.9.41 == $sub.ref(0, 35611));
const {:count 28} .str.10.42: ref;
axiom (.str.10.42 == $sub.ref(0, 36663));
const {:count 37} .str.11.43: ref;
axiom (.str.11.43 == $sub.ref(0, 37724));
const {:count 50} .str.14.44: ref;
axiom (.str.14.44 == $sub.ref(0, 38798));
const {:count 54} .str.15.45: ref;
axiom (.str.15.45 == $sub.ref(0, 39876));
const {:count 52} .str.12.46: ref;
axiom (.str.12.46 == $sub.ref(0, 40952));
const {:count 55} .str.13.47: ref;
axiom (.str.13.47 == $sub.ref(0, 42031));
const {:count 23} .str.17.48: ref;
axiom (.str.17.48 == $sub.ref(0, 43078));
const {:count 35} .str.18.49: ref;
axiom (.str.18.49 == $sub.ref(0, 44137));
const {:count 49} .str.33: ref;
axiom (.str.33 == $sub.ref(0, 45210));
const {:count 30} .str.19.50: ref;
axiom (.str.19.50 == $sub.ref(0, 46264));
const {:count 33} .str.20.51: ref;
axiom (.str.20.51 == $sub.ref(0, 47321));
const {:count 30} .str.21.52: ref;
axiom (.str.21.52 == $sub.ref(0, 48375));
const {:count 30} .str.22.53: ref;
axiom (.str.22.53 == $sub.ref(0, 49429));
const {:count 30} .str.23.54: ref;
axiom (.str.23.54 == $sub.ref(0, 50483));
const {:count 32} .str.24.55: ref;
axiom (.str.24.55 == $sub.ref(0, 51539));
const {:count 27} .str.25.56: ref;
axiom (.str.25.56 == $sub.ref(0, 52590));
const {:count 26} .str.26: ref;
axiom (.str.26 == $sub.ref(0, 53640));
const {:count 26} .str.27: ref;
axiom (.str.27 == $sub.ref(0, 54690));
const {:count 35} .str.28: ref;
axiom (.str.28 == $sub.ref(0, 55749));
const {:count 50} .str.31.57: ref;
axiom (.str.31.57 == $sub.ref(0, 56823));
const {:count 54} .str.32: ref;
axiom (.str.32 == $sub.ref(0, 57901));
const {:count 52} .str.29.58: ref;
axiom (.str.29.58 == $sub.ref(0, 58977));
const {:count 55} .str.30: ref;
axiom (.str.30 == $sub.ref(0, 60056));
const {:count 27} .str.34: ref;
axiom (.str.34 == $sub.ref(0, 61107));
const {:count 39} .str.35: ref;
axiom (.str.35 == $sub.ref(0, 62170));
const {:count 53} .str.50: ref;
axiom (.str.50 == $sub.ref(0, 63247));
const {:count 34} .str.36: ref;
axiom (.str.36 == $sub.ref(0, 64305));
const {:count 37} .str.37: ref;
axiom (.str.37 == $sub.ref(0, 65366));
const {:count 34} .str.38: ref;
axiom (.str.38 == $sub.ref(0, 66424));
const {:count 34} .str.39: ref;
axiom (.str.39 == $sub.ref(0, 67482));
const {:count 34} .str.40: ref;
axiom (.str.40 == $sub.ref(0, 68540));
const {:count 36} .str.41: ref;
axiom (.str.41 == $sub.ref(0, 69600));
const {:count 31} .str.42: ref;
axiom (.str.42 == $sub.ref(0, 70655));
const {:count 30} .str.43: ref;
axiom (.str.43 == $sub.ref(0, 71709));
const {:count 30} .str.44: ref;
axiom (.str.44 == $sub.ref(0, 72763));
const {:count 39} .str.45: ref;
axiom (.str.45 == $sub.ref(0, 73826));
const {:count 54} .str.48: ref;
axiom (.str.48 == $sub.ref(0, 74904));
const {:count 58} .str.49: ref;
axiom (.str.49 == $sub.ref(0, 75986));
const {:count 56} .str.46: ref;
axiom (.str.46 == $sub.ref(0, 77066));
const {:count 59} .str.47: ref;
axiom (.str.47 == $sub.ref(0, 78149));
const {:count 29} .str.59: ref;
axiom (.str.59 == $sub.ref(0, 79202));
const {:count 29} .str.1.60: ref;
axiom (.str.1.60 == $sub.ref(0, 80255));
const {:count 29} .str.2.61: ref;
axiom (.str.2.61 == $sub.ref(0, 81308));
const {:count 29} .str.3.62: ref;
axiom (.str.3.62 == $sub.ref(0, 82361));
const {:count 15} .str.4.63: ref;
axiom (.str.4.63 == $sub.ref(0, 83400));
const {:count 15} .str.5.64: ref;
axiom (.str.5.64 == $sub.ref(0, 84439));
const {:count 15} .str.6.65: ref;
axiom (.str.6.65 == $sub.ref(0, 85478));
const {:count 15} .str.7.66: ref;
axiom (.str.7.66 == $sub.ref(0, 86517));
const _ZTISt9bad_alloc: ref;
axiom (_ZTISt9bad_alloc == $add.ref($GLOBALS_BOTTOM, $sub.ref(0, 32772)));
const main: ref;
axiom (main == $sub.ref(0, 87545));
...
axiom (_ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv == $sub.ref(0, 92685));
...
axiom (_ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv == $sub.ref(0, 93713));
...
axiom (_ZZ4mainENK3$_2clEP18emscripten_fetch_t == $sub.ref(0, 98853));
...
axiom (_ZZ4mainEN3$_18__invokeEP18emscripten_fetch_t == $sub.ref(0, 100909));
...
axiom (_ZZ4mainENK3$_1clEP18emscripten_fetch_t == $sub.ref(0, 101937));
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p1, $mul.ref(0, 208)), $mul.ref(32, 1));
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  $f29 := $ui2fp.i64.bvdouble($rmode, $i28);
  assume {:sourceloc "to_indexeddb.cpp", 40, 96} true;
  assume {:verifier.code 0} true;
  $f30 := $fdiv.bvdouble($rmode, $f24, $f29);
  assume {:sourceloc "to_indexeddb.cpp", 40, 7} true;
  assume {:verifier.code 0} true;
  call $i31 := printf.ref.bvdouble(.str.11, $f30);
...
$bb9:
  ...
  assume {:verifier.code 0} true;
  call $i41 := printf.ref.i64(.str.12, $i40);
  assume {:verifier.code 0} true;
  goto $bb7;
}
const _ZZ4mainEN3$_08__invokeEP18emscripten_fetch_t: ref;
axiom (_ZZ4mainEN3$_08__invokeEP18emscripten_fetch_t == $sub.ref(0, 102965));
...
axiom (_ZZ4mainENK3$_0clEP18emscripten_fetch_t == $sub.ref(0, 103993));
...
$bb22:
  ...
  assume {:verifier.code 0} true;
  call $i35 := emscripten_fetch_close($p1);
...
axiom (_Z6strcmpPKcS0_ == $sub.ref(0, 105021));
procedure  _Z6strcmpPKcS0_($p0: ref, $p1: ref)
  returns ($r: i32);
const emscripten_fetch_close: ref;
axiom (emscripten_fetch_close == $sub.ref(0, 106049));
procedure  emscripten_fetch_close($p0: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 107077));
...
axiom (__SMACK_code == $sub.ref(0, 108105));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 109133));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 110161));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 111189));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 112217));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 113245));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 114273));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 115301));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 116329));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 117357));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 118385));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 119413));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 120441));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 121469));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 122497));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 123525));
procedure  __SMACK_nondet_long()
  returns ($r: i32);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 124553));
procedure  __SMACK_nondet_long_int()
  returns ($r: i32);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 125581));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i32);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 126609));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 127637));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 128665));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i32);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 129693));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 130721));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 131749));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 132777));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 133805));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 134833));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 135861));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 136889));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_check_memory_safety: ref;
axiom (__SMACK_check_memory_safety == $sub.ref(0, 137917));
procedure  __SMACK_check_memory_safety($p0: ref, $p1: ref);
const __SMACK_check_memory_leak: ref;
axiom (__SMACK_check_memory_leak == $sub.ref(0, 138945));
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 139973));
...
axiom (__gxx_personality_v0 == $sub.ref(0, 141001));
procedure  __gxx_personality_v0()
  returns ($r: i32);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 142029));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 143057));
