...
procedure  compile_shader($i0: i32, $p1: ref)
  returns ($r: i32)
{
  var $p2: ref;
  var $p3: ref;
...
$bb0:
  ...
  call {:cexpr "compile_shader:arg:shaderType"} boogie_si_record_i32($i0);
  ...
  assume {:sourceloc "html5_webgl.c", 11, 19} true;
  assume {:verifier.code 0} true;
  call $i5 := glCreateShader($i0);
  call {:cexpr "shader"} boogie_si_record_i32($i5);
  assume {:sourceloc "html5_webgl.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call glShaderSource($i5, 1, $p2, $0.ref);
  assume {:sourceloc "html5_webgl.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call glCompileShader($i5);
...
procedure  create_program($i0: i32, $i1: i32)
  returns ($r: i32)
{
  var $i2: i32;
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "create_program:arg:vertexShader"} boogie_si_record_i32($i0);
  call {:cexpr "create_program:arg:fragmentShader"} boogie_si_record_i32($i1);
  assume {:sourceloc "html5_webgl.c", 19, 21} true;
  assume {:verifier.code 0} true;
  call $i2 := glCreateProgram();
  call {:cexpr "program"} boogie_si_record_i32($i2);
  assume {:sourceloc "html5_webgl.c", 20, 4} true;
  assume {:verifier.code 0} true;
  call glAttachShader($i2, $i0);
  assume {:sourceloc "html5_webgl.c", 21, 4} true;
  assume {:verifier.code 0} true;
  call glAttachShader($i2, $i1);
  assume {:sourceloc "html5_webgl.c", 22, 4} true;
  assume {:verifier.code 0} true;
  call glBindAttribLocation($i2, 0, .str);
  assume {:sourceloc "html5_webgl.c", 23, 4} true;
  assume {:verifier.code 0} true;
  call glBindAttribLocation($i2, 1, .str.1);
  assume {:sourceloc "html5_webgl.c", 24, 4} true;
  assume {:verifier.code 0} true;
  call glLinkProgram($i2);
