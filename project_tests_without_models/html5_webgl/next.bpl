...
procedure compile_shader($i0: i32, $p1: ref) returns ($r: i32);
  free requires assertsPassed;
  modifies $M.0, assertsPassed, $CurrAddr, $Alloc;



implementation compile_shader($i0: i32, $p1: ref) returns ($r: i32)
{
  var $p2: ref;
  var $p3: ref;
  var $p4: ref;
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 146} $p2 := $alloc($mul.ref(4, 1));
    call {:si_unique_call 147} {:cexpr "compile_shader:arg:shaderType"} boogie_si_record_i32($i0);
    $p3 := $bitcast.ref.ref($p2);
    $p4 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 148} __SMACK_check_memory_safety($p3, $p4);
  ...
  corral_source_split_1:
    assume {:verifier.code 0} true;
    call {:si_unique_call 149} $i5 := glCreateShader($i0);
    call {:si_unique_call 150} {:cexpr "shader"} boogie_si_record_i32($i5);
    goto corral_source_split_2;

  corral_source_split_2:
    assume {:verifier.code 0} true;
    call {:si_unique_call 151} glShaderSource($i5, 1, $p2, $0.ref);
    goto corral_source_split_3;

  corral_source_split_3:
    assume {:verifier.code 0} true;
    call {:si_unique_call 152} glCompileShader($i5);
...
procedure create_program($i0: i32, $i1: i32) returns ($r: i32);
  free requires assertsPassed;



implementation create_program($i0: i32, $i1: i32) returns ($r: i32)
{
  var $i2: i32;

  $bb0:
    assume {:verifier.code 0} true;
    call {:si_unique_call 153} {:cexpr "create_program:arg:vertexShader"} boogie_si_record_i32($i0);
    call {:si_unique_call 154} {:cexpr "create_program:arg:fragmentShader"} boogie_si_record_i32($i1);
    goto corral_source_split_6;

  corral_source_split_6:
    assume {:verifier.code 0} true;
    call {:si_unique_call 155} $i2 := glCreateProgram();
    call {:si_unique_call 156} {:cexpr "program"} boogie_si_record_i32($i2);
    goto corral_source_split_7;

  corral_source_split_7:
    assume {:verifier.code 0} true;
    call {:si_unique_call 157} glAttachShader($i2, $i0);
    goto corral_source_split_8;

  corral_source_split_8:
    assume {:verifier.code 0} true;
    call {:si_unique_call 158} glAttachShader($i2, $i1);
    goto corral_source_split_9;

  corral_source_split_9:
    assume {:verifier.code 0} true;
    call {:si_unique_call 159} glBindAttribLocation($i2, 0, .str);
    goto corral_source_split_10;

  corral_source_split_10:
    assume {:verifier.code 0} true;
    call {:si_unique_call 160} glBindAttribLocation($i2, 1, .str.1);
    goto corral_source_split_11;

  corral_source_split_11:
    assume {:verifier.code 0} true;
    call {:si_unique_call 161} glLinkProgram($i2);
...
implementation main() returns ($r: i32)
{
  ...
  corral_source_split_87:
    ...
    call {:si_unique_call 204} cmdloc_dummy_var_1 := $memset.i8(cmdloc_dummy_var_0, $p47, 0, 16, false);
  ...
  corral_source_split_169:
    ...
    call {:si_unique_call 233} cmdloc_dummy_var_3 := $memset.i8(cmdloc_dummy_var_2, $p100, 0, 16, false);
  ...
  corral_source_split_366:
    ...
    call {:si_unique_call 315} cmdloc_dummy_var_5 := $memset.i8(cmdloc_dummy_var_4, $p198, 0, 16, false);
...
implementation {:ForceInline} __SMACK_check_memory_safety(p: ref, size: ref)
{
  ...
  assert_rewrite_dummy_block_0:
    assume {:corral_assert_pt} !$Alloc[$base(p)];
    assertsPassed := false;
  ...
  assert_rewrite_dummy_block_3:
    assume {:corral_assert_pt} !$sle.ref.bool($base(p), p);
    assertsPassed := false;
  ...
  assert_rewrite_dummy_block_6:
    assume {:corral_assert_pt} !$sle.ref.bool($add.ref(p, size), $add.ref($base(p), $Size($base(p))));
    assertsPassed := false;
...
implementation {:ForceInline} $free(p: ref)
{
  ...
  anon3_Then:
    ...
    goto assert_rewrite_dummy_block_9, assert_rewrite_dummy_block_10;

  assert_rewrite_dummy_block_9:
  ...
  SeqInstr_156:
    goto assert_rewrite_dummy_block_11;

  assert_rewrite_dummy_block_10:
    assume $eq.ref.bool($base(p), p);
    goto assert_rewrite_dummy_block_11;

  assert_rewrite_dummy_block_11:
    goto assert_rewrite_dummy_block_12, assert_rewrite_dummy_block_13;

  assert_rewrite_dummy_block_12:
    assume {:corral_assert_pt} false;
    assume true;
  ...
  SeqInstr_159:
    goto assert_rewrite_dummy_block_14;

  assert_rewrite_dummy_block_13:
    assume $Alloc[p];
    goto assert_rewrite_dummy_block_14;

  assert_rewrite_dummy_block_14:
    goto assert_rewrite_dummy_block_15, assert_rewrite_dummy_block_16;

  assert_rewrite_dummy_block_15:
    assume {:corral_assert_pt} false;
    assume true;
  ...
  SeqInstr_162:
    goto assert_rewrite_dummy_block_17;

  assert_rewrite_dummy_block_16:
    assume $slt.ref.bool($0.ref, p);
    goto assert_rewrite_dummy_block_17;

  assert_rewrite_dummy_block_17:
    $Alloc[p] := false;
...
implementation __SMACK_check_memory_leak()
{
  ...
  corral_source_split_447:
    assume {:verifier.code 1} true;
    goto assert_rewrite_dummy_block_18, assert_rewrite_dummy_block_19;

  assert_rewrite_dummy_block_18:
    assume {:corral_assert_pt} $allocatedCounter != 0;
    assertsPassed := false;
  ...
  SeqInstr_165:
    goto assert_rewrite_dummy_block_20;

  assert_rewrite_dummy_block_19:
    assume $allocatedCounter == 0;
    goto assert_rewrite_dummy_block_20;

  assert_rewrite_dummy_block_20:
...
procedure $initialize();
  free requires assertsPassed;
  modifies $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.18, $M.19, $M.20, $M.21, $M.22, $M.23, $M.24, $M.25, $M.26, $M.27, $M.28, $M.29, $M.30, $M.31, $M.32, $M.33, $M.34, $M.35, $M.36, $M.37, $M.38, $M.39, $M.40, $M.41, $M.42, $M.43, $M.44, $M.45, $M.46, $M.47, $M.48, $M.49, $M.50, $M.51, $M.52, $M.53, $M.54, $M.55, $M.56, $M.57, $M.58, $M.59, $M.60, $M.61, $M.62, $M.63, $M.64, $M.65, $M.66, $M.67, $M.68, $M.69, $M.70, $M.71, $M.72, $M.73, $M.74, $M.75, $M.76, $M.77, $M.78, $M.79, $M.80, $M.81, $M.82, $M.83, $M.84, $M.85, $M.86, $M.87, $M.88, $M.89, $M.90, $M.91, $M.92, $M.93, $M.94, $M.95, $M.96, $M.97, $M.98, $M.99, $M.100, $M.101, $M.102, $M.103, $M.104, $M.105, $M.106, $M.107, $M.108, $M.109, $M.110, $M.111, $M.112, $M.113, $M.114, $M.115, $M.116, $M.117, $M.118, $M.119, $M.120, $M.121, $M.122, $M.123, $M.124, $M.125, $M.126, $M.127, $M.128, $M.129, $M.130, $M.131, $M.132, $M.133, $M.134, $M.135, $M.136, $M.137, $M.138, $M.139, $M.140, $M.141, $M.142, $M.143, $M.144, $M.145, $M.146, $M.147, $M.148, $M.149, $M.150, $M.151, $M.152, $M.153, $M.154, $M.155, $M.156, $M.157, $M.158, $M.159, $M.160, $M.161, $M.162, $M.163, $M.164, $M.165, $M.166, $M.167, $M.168, $M.169, $M.170, $M.171, $M.172, $M.173, $M.174, $M.175, $M.176, $M.177, $M.178, $CurrAddr, $allocatedCounter, $Alloc;
...
procedure {:entrypoint} main_SeqInstr() returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.1, $M.2, $M.3, $M.6, $M.7, $M.8, $M.0, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.18, $M.19, $M.20, $M.21, $M.22, $M.23, $M.24, $M.25, $M.26, $M.27, $M.28, $M.29, $M.30, $M.31, $M.32, $M.33, $M.34, $M.35, $M.36, $M.37, $M.38, $M.39, $M.40, $M.41, $M.42, $M.43, $M.44, $M.45, $M.46, $M.47, $M.48, $M.49, $M.50, $M.51, $M.52, $M.53, $M.54, $M.55, $M.56, $M.57, $M.58, $M.59, $M.60, $M.61, $M.62, $M.63, $M.64, $M.65, $M.66, $M.67, $M.68, $M.69, $M.70, $M.71, $M.72, $M.73, $M.74, $M.75, $M.76, $M.77, $M.78, $M.79, $M.80, $M.81, $M.82, $M.83, $M.84, $M.85, $M.86, $M.87, $M.88, $M.89, $M.90, $M.91, $M.92, $M.93, $M.94, $M.95, $M.96, $M.97, $M.98, $M.99, $M.100, $M.101, $M.102, $M.103, $M.104, $M.105, $M.106, $M.107, $M.108, $M.109, $M.110, $M.111, $M.112, $M.113, $M.114, $M.115, $M.116, $M.117, $M.118, $M.119, $M.120, $M.121, $M.122, $M.123, $M.124, $M.125, $M.126, $M.127, $M.128, $M.129, $M.130, $M.131, $M.132, $M.133, $M.134, $M.135, $M.136, $M.137, $M.138, $M.139, $M.140, $M.141, $M.142, $M.143, $M.144, $M.145, $M.146, $M.147, $M.148, $M.149, $M.150, $M.151, $M.152, $M.153, $M.154, $M.155, $M.156, $M.157, $M.158, $M.159, $M.160, $M.161, $M.162, $M.163, $M.164, $M.165, $M.166, $M.167, $M.168, $M.169, $M.170, $M.171, $M.172, $M.173, $M.174, $M.175, $M.176, $M.177, $M.178, $CurrAddr, $allocatedCounter, $Alloc;
