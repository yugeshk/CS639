...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 76744));
...
procedure  $global_allocations()
{
  ...
  call $galloc(.str.7, 31);
  call $galloc(.str.2, 86);
  call $galloc(.str.1, 11);
  call $galloc(.str, 13);
  call $galloc(__func__.main, 5);
  call $galloc(.str.3, 14);
  call $galloc(.str.4, 4);
  call $galloc(.str.5, 85);
  call $galloc(.str.6, 29);
  call $galloc(.str.8, 17);
  call $galloc(.str.9, 28);
  call $galloc(.str.10, 46);
  call $galloc(.str.11, 14);
  call $galloc(.str.12, 81);
  call $galloc(.str.13, 21);
  call $galloc(.str.14, 17);
  call $galloc(.str.15, 125);
  call $galloc(.str.16, 17);
  call $galloc(__SMACK_dummy, 4);
  call $galloc(.str.24, 28);
  call $galloc(.str.25, 26);
  call $galloc(env_value_str, 4);
  call $galloc(.str.2.34, 3);
  call $galloc(.str.35, 49);
  call $galloc(.str.1.36, 14);
...
axiom (.str.1 == $sub.ref(0, 2072));
const {:count 86} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 3182));
const {:count 14} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 4220));
const {:count 5} __func__.main: ref;
axiom (__func__.main == $sub.ref(0, 5249));
const {:count 4} .str.4: ref;
axiom (.str.4 == $sub.ref(0, 6277));
const {:count 85} .str.5: ref;
axiom (.str.5 == $sub.ref(0, 7386));
const {:count 29} .str.6: ref;
axiom (.str.6 == $sub.ref(0, 8439));
const {:count 31} .str.7: ref;
axiom (.str.7 == $sub.ref(0, 9494));
const {:count 17} .str.8: ref;
axiom (.str.8 == $sub.ref(0, 10535));
const {:count 28} .str.9: ref;
axiom (.str.9 == $sub.ref(0, 11587));
const {:count 46} .str.10: ref;
axiom (.str.10 == $sub.ref(0, 12657));
const {:count 14} .str.11: ref;
axiom (.str.11 == $sub.ref(0, 13695));
const {:count 81} .str.12: ref;
axiom (.str.12 == $sub.ref(0, 14800));
const {:count 21} .str.13: ref;
axiom (.str.13 == $sub.ref(0, 15845));
const {:count 17} .str.14: ref;
axiom (.str.14 == $sub.ref(0, 16886));
const {:count 125} .str.15: ref;
axiom (.str.15 == $sub.ref(0, 18035));
const {:count 17} .str.16: ref;
axiom (.str.16 == $sub.ref(0, 19076));
const {:count 28} .str.24: ref;
axiom (.str.24 == $sub.ref(0, 20128));
const {:count 26} .str.25: ref;
axiom (.str.25 == $sub.ref(0, 21178));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 22206));
const {:count 3} .str.2.34: ref;
axiom (.str.2.34 == $sub.ref(0, 23233));
const {:count 49} .str.35: ref;
axiom (.str.35 == $sub.ref(0, 24306));
const {:count 14} .str.1.36: ref;
axiom (.str.1.36 == $sub.ref(0, 25344));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 26372));
const _ZTISt9bad_alloc: ref;
axiom (_ZTISt9bad_alloc == $add.ref($GLOBALS_BOTTOM, $sub.ref(0, 32772)));
const main: ref;
axiom (main == $sub.ref(0, 27400));
...
$bb0:
  call $initialize();
  assume {:sourceloc "idb_store.cpp", 20, 3} true;
  ...
  assume {:sourceloc "idb_store.cpp", 22, 19} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, 84);
  assume {:sourceloc "idb_store.cpp", 23, 29} true;
  assume {:verifier.code 0} true;
  call $p7 := malloc(512000);
  assume {:sourceloc "idb_store.cpp", 24, 9} true;
  assume {:verifier.code 0} true;
  call $i8 := time($0.ref);
  assume {:sourceloc "idb_store.cpp", 24, 3} true;
  assume {:verifier.code 0} true;
  call srand($i8);
  assume {:sourceloc "idb_store.cpp", 25, 7} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "idb_store.cpp", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "idb_store.cpp", 25, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $slt.i32($i9, 512000);
  assume {:sourceloc "idb_store.cpp", 25, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "idb_store.cpp", 26, 24} true;
  assume {:verifier.code 0} true;
  call $i11 := rand();
  assume {:sourceloc "idb_store.cpp", 26, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i32.i8($i11);
  assume {:sourceloc "idb_store.cpp", 26, 15} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i8.i32($i12);
  assume {:sourceloc "idb_store.cpp", 26, 31} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: idb_store.cpp:26:31: warning: over-approximating bitwise operation or;
  $i14 := $or.i32($i13, 64);
  assume {:sourceloc "idb_store.cpp", 26, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i32.i8($i14);
  assume {:sourceloc "idb_store.cpp", 26, 5} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p7, $mul.ref($i9, 1));
  $p17 := $bitcast.ref.ref($p16);
  $p18 := $bitcast.ref.ref($i2p.i64.ref(1));
  call __SMACK_check_memory_safety($p17, $p18);
  assume {:sourceloc "idb_store.cpp", 26, 13} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i10 == 1));
  assume {:sourceloc "idb_store.cpp", 27, 8} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(84, 1));
  $p21 := $bitcast.ref.ref($p20);
  $p22 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p21, $p22);
  assume {:sourceloc "idb_store.cpp", 27, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p20, $p7);
  assume {:sourceloc "idb_store.cpp", 28, 8} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(88, 1));
  $p24 := $bitcast.ref.ref($p23);
  $p25 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p24, $p25);
  assume {:sourceloc "idb_store.cpp", 28, 24} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.i32($M.4, $p23, 512000);
  assume {:sourceloc "idb_store.cpp", 29, 31} true;
  assume {:verifier.code 0} true;
  call $p26 := emscripten_fetch($p0, .str.1);
  assume $isExternal($p26);
  assume {:sourceloc "idb_store.cpp", 30, 3} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p26, $mul.ref(0, 208)), $mul.ref(42, 1));
  $p28 := $bitcast.ref.ref($p27);
  $p29 := $bitcast.ref.ref($i2p.i64.ref(2));
  call __SMACK_check_memory_safety($p28, $p29);
  assume {:sourceloc "idb_store.cpp", 30, 3} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i16($M.0, $p27);
  assume {:sourceloc "idb_store.cpp", 30, 3} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb5, $bb7;
$bb4:
  assume {:sourceloc "idb_store.cpp", 25, 33} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i9, 1);
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "idb_store.cpp", 31, 3} true;
  assume {:verifier.code 0} true;
  call $i33 := emscripten_fetch_close($p26);
  assume {:sourceloc "idb_store.cpp", 34, 3} true;
  assume {:verifier.code 0} true;
  call emscripten_fetch_attr_init($p0);
  assume {:sourceloc "idb_store.cpp", 35, 15} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1));
  $p35 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1)), $mul.ref(0, 1));
  assume {:sourceloc "idb_store.cpp", 35, 3} true;
  assume {:verifier.code 0} true;
  call $p36 := _Z6strcpyPcPKc($p35, .str.4);
  assume $isExternal($p36);
  assume {:sourceloc "idb_store.cpp", 36, 8} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(52, 1));
  $p38 := $bitcast.ref.ref($p37);
  $p39 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p38, $p39);
  assume {:sourceloc "idb_store.cpp", 36, 19} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p37, 97);
  assume {:sourceloc "idb_store.cpp", 37, 11} true;
  assume {:verifier.code 0} true;
  call $p40 := emscripten_fetch($p0, .str.1);
  assume $isExternal($p40);
  assume {:sourceloc "idb_store.cpp", 38, 3} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($add.ref($p40, $mul.ref(0, 208)), $mul.ref(42, 1));
  $p42 := $bitcast.ref.ref($p41);
  $p43 := $bitcast.ref.ref($i2p.i64.ref(2));
  call __SMACK_check_memory_safety($p42, $p43);
  assume {:sourceloc "idb_store.cpp", 38, 3} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i16($M.0, $p41);
  assume {:sourceloc "idb_store.cpp", 38, 3} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  assume {:sourceloc "idb_store.cpp", 30, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.2, .str.3, 30, __func__.main);
  assume {:sourceloc "idb_store.cpp", 30, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb8:
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "idb_store.cpp", 39, 3} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p40, $mul.ref(0, 208)), $mul.ref(16, 1));
  $p48 := $bitcast.ref.ref($p47);
  $p49 := $bitcast.ref.ref($i2p.i64.ref(8));
  call __SMACK_check_memory_safety($p48, $p49);
  assume {:sourceloc "idb_store.cpp", 39, 3} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i64($M.0, $p47);
  assume {:sourceloc "idb_store.cpp", 39, 3} true;
  assume {:verifier.code 0} true;
  $i51 := $eq.i64($i50, 512000);
  assume {:sourceloc "idb_store.cpp", 39, 3} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  assume {:sourceloc "idb_store.cpp", 38, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.5, .str.3, 38, __func__.main);
  assume {:sourceloc "idb_store.cpp", 38, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb12:
...
$bb13:
  ...
  goto $bb14;
$bb14:
  assume {:sourceloc "idb_store.cpp", 40, 3} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref($p40, $mul.ref(0, 208)), $mul.ref(32, 1));
...
$bb15:
  ...
  assume {:sourceloc "idb_store.cpp", 39, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.6, .str.3, 39, __func__.main);
  assume {:sourceloc "idb_store.cpp", 39, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb16:
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "idb_store.cpp", 41, 3} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($add.ref($p40, $mul.ref(0, 208)), $mul.ref(12, 1));
...
$bb19:
  ...
  assume {:sourceloc "idb_store.cpp", 40, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.7, .str.3, 40, __func__.main);
  assume {:sourceloc "idb_store.cpp", 40, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb20:
...
$bb21:
  ...
  goto $bb22;
$bb22:
  assume {:sourceloc "idb_store.cpp", 42, 3} true;
  assume {:verifier.code 0} true;
  $p62 := $add.ref($add.ref($p40, $mul.ref(0, 208)), $mul.ref(12, 1));
  $p63 := $bitcast.ref.ref($p62);
  $p64 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p63, $p64);
  assume {:sourceloc "idb_store.cpp", 42, 3} true;
  assume {:verifier.code 0} true;
  $p65 := $load.ref($M.0, $p62);
  assume {:sourceloc "idb_store.cpp", 42, 3} true;
  assume {:verifier.code 0} true;
  $i66 := $ne.ref($p65, $p7);
  assume {:sourceloc "idb_store.cpp", 42, 3} true;
...
$bb23:
  ...
  assume {:sourceloc "idb_store.cpp", 41, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.8, .str.3, 41, __func__.main);
  assume {:sourceloc "idb_store.cpp", 41, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb24:
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "idb_store.cpp", 43, 3} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($add.ref($p40, $mul.ref(0, 208)), $mul.ref(12, 1));
  $p68 := $bitcast.ref.ref($p67);
  $p69 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p68, $p69);
  assume {:sourceloc "idb_store.cpp", 43, 3} true;
  assume {:verifier.code 0} true;
  $p70 := $load.ref($M.0, $p67);
  assume {:sourceloc "idb_store.cpp", 43, 3} true;
  assume {:verifier.code 0} true;
  call $p71 := _Z6memcpyPvPKvm($p7, $p70, 512000);
...
$bb27:
  ...
  assume {:sourceloc "idb_store.cpp", 42, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.9, .str.3, 42, __func__.main);
  assume {:sourceloc "idb_store.cpp", 42, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb28:
...
$bb29:
  ...
  assume {:sourceloc "idb_store.cpp", 43, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.10, .str.3, 43, __func__.main);
  assume {:sourceloc "idb_store.cpp", 43, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb30:
  ...
  goto $bb31;
$bb31:
  assume {:sourceloc "idb_store.cpp", 44, 3} true;
  assume {:verifier.code 0} true;
  call $i73 := emscripten_fetch_close($p40);
  assume {:sourceloc "idb_store.cpp", 47, 3} true;
  assume {:verifier.code 0} true;
  call emscripten_fetch_attr_init($p0);
  assume {:sourceloc "idb_store.cpp", 48, 15} true;
  assume {:verifier.code 0} true;
  $p74 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1));
  $p75 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1)), $mul.ref(0, 1));
  assume {:sourceloc "idb_store.cpp", 48, 3} true;
  assume {:verifier.code 0} true;
  call $p76 := _Z6strcpyPcPKc($p75, .str.11);
  assume $isExternal($p76);
  assume {:sourceloc "idb_store.cpp", 49, 8} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(52, 1));
  $p78 := $bitcast.ref.ref($p77);
  $p79 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p78, $p79);
  assume {:sourceloc "idb_store.cpp", 49, 19} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p77, 64);
  assume {:sourceloc "idb_store.cpp", 50, 11} true;
  assume {:verifier.code 0} true;
  call $p80 := emscripten_fetch($p0, .str.1);
  assume $isExternal($p80);
  assume {:sourceloc "idb_store.cpp", 51, 3} true;
  assume {:verifier.code 0} true;
  $p81 := $add.ref($add.ref($p80, $mul.ref(0, 208)), $mul.ref(42, 1));
  $p82 := $bitcast.ref.ref($p81);
  $p83 := $bitcast.ref.ref($i2p.i64.ref(2));
  call __SMACK_check_memory_safety($p82, $p83);
  assume {:sourceloc "idb_store.cpp", 51, 3} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i16($M.0, $p81);
  assume {:sourceloc "idb_store.cpp", 51, 3} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  goto $bb34;
$bb34:
  assume {:sourceloc "idb_store.cpp", 52, 3} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($add.ref($p80, $mul.ref(0, 208)), $mul.ref(16, 1));
  $p88 := $bitcast.ref.ref($p87);
  $p89 := $bitcast.ref.ref($i2p.i64.ref(8));
  call __SMACK_check_memory_safety($p88, $p89);
  assume {:sourceloc "idb_store.cpp", 52, 3} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i64($M.0, $p87);
  assume {:sourceloc "idb_store.cpp", 52, 3} true;
  assume {:verifier.code 0} true;
  $i91 := $eq.i64($i90, 0);
  assume {:sourceloc "idb_store.cpp", 52, 3} true;
...
$bb35:
  ...
  assume {:sourceloc "idb_store.cpp", 51, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.12, .str.3, 51, __func__.main);
  assume {:sourceloc "idb_store.cpp", 51, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb36:
...
$bb37:
  ...
  goto $bb38;
$bb38:
  assume {:sourceloc "idb_store.cpp", 53, 3} true;
  assume {:verifier.code 0} true;
  $p92 := $add.ref($add.ref($p80, $mul.ref(0, 208)), $mul.ref(12, 1));
  $p93 := $bitcast.ref.ref($p92);
  $p94 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p93, $p94);
  assume {:sourceloc "idb_store.cpp", 53, 3} true;
  assume {:verifier.code 0} true;
  $p95 := $load.ref($M.0, $p92);
  assume {:sourceloc "idb_store.cpp", 53, 3} true;
  assume {:verifier.code 0} true;
  $i96 := $eq.ref($p95, $0.ref);
  assume {:sourceloc "idb_store.cpp", 53, 3} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:sourceloc "idb_store.cpp", 52, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.13, .str.3, 52, __func__.main);
  assume {:sourceloc "idb_store.cpp", 52, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb40:
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "idb_store.cpp", 54, 3} true;
  assume {:verifier.code 0} true;
  call $i97 := emscripten_fetch_close($p80);
  assume {:sourceloc "idb_store.cpp", 57, 3} true;
  assume {:verifier.code 0} true;
  call emscripten_fetch_attr_init($p0);
  assume {:sourceloc "idb_store.cpp", 58, 15} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1));
  $p99 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1)), $mul.ref(0, 1));
  assume {:sourceloc "idb_store.cpp", 58, 3} true;
  assume {:verifier.code 0} true;
  call $p100 := _Z6strcpyPcPKc($p99, .str.4);
  assume $isExternal($p100);
  assume {:sourceloc "idb_store.cpp", 59, 8} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(52, 1));
  $p102 := $bitcast.ref.ref($p101);
  $p103 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p102, $p103);
  assume {:sourceloc "idb_store.cpp", 59, 19} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p101, 97);
  assume {:sourceloc "idb_store.cpp", 60, 11} true;
  assume {:verifier.code 0} true;
  call $p104 := emscripten_fetch($p0, .str.1);
  assume $isExternal($p104);
  assume {:sourceloc "idb_store.cpp", 61, 3} true;
  assume {:verifier.code 0} true;
  $p105 := $add.ref($add.ref($p104, $mul.ref(0, 208)), $mul.ref(42, 1));
  $p106 := $bitcast.ref.ref($p105);
  $p107 := $bitcast.ref.ref($i2p.i64.ref(2));
  call __SMACK_check_memory_safety($p106, $p107);
  assume {:sourceloc "idb_store.cpp", 61, 3} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i16($M.0, $p105);
  assume {:sourceloc "idb_store.cpp", 61, 3} true;
  assume {:verifier.code 0} true;
  $i109 := $zext.i16.i32($i108);
  assume {:sourceloc "idb_store.cpp", 61, 3} true;
  assume {:verifier.code 0} true;
  $i110 := $eq.i32($i109, 404);
  assume {:sourceloc "idb_store.cpp", 61, 3} true;
  assume {:verifier.code 0} true;
...
$bb43:
  ...
  assume {:sourceloc "idb_store.cpp", 53, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.14, .str.3, 53, __func__.main);
  assume {:sourceloc "idb_store.cpp", 53, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb44:
...
$bb45:
  ...
  goto $bb46;
$bb46:
  assume {:sourceloc "idb_store.cpp", 62, 3} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($add.ref($p104, $mul.ref(0, 208)), $mul.ref(16, 1));
  $p112 := $bitcast.ref.ref($p111);
  $p113 := $bitcast.ref.ref($i2p.i64.ref(8));
  call __SMACK_check_memory_safety($p112, $p113);
  assume {:sourceloc "idb_store.cpp", 62, 3} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i64($M.0, $p111);
  assume {:sourceloc "idb_store.cpp", 62, 3} true;
  assume {:verifier.code 0} true;
  $i115 := $eq.i64($i114, 0);
  assume {:sourceloc "idb_store.cpp", 62, 3} true;
...
$bb47:
  ...
  assume {:sourceloc "idb_store.cpp", 61, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.15, .str.3, 61, __func__.main);
  assume {:sourceloc "idb_store.cpp", 61, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb48:
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "idb_store.cpp", 63, 3} true;
  assume {:verifier.code 0} true;
  $p116 := $add.ref($add.ref($p104, $mul.ref(0, 208)), $mul.ref(12, 1));
  $p117 := $bitcast.ref.ref($p116);
  $p118 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p117, $p118);
  assume {:sourceloc "idb_store.cpp", 63, 3} true;
  assume {:verifier.code 0} true;
  $p119 := $load.ref($M.0, $p116);
  assume {:sourceloc "idb_store.cpp", 63, 3} true;
  assume {:verifier.code 0} true;
  $i120 := $eq.ref($p119, $0.ref);
  assume {:sourceloc "idb_store.cpp", 63, 3} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:sourceloc "idb_store.cpp", 62, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.13, .str.3, 62, __func__.main);
  assume {:sourceloc "idb_store.cpp", 62, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb52:
...
$bb53:
  ...
  goto $bb54;
$bb54:
  assume {:sourceloc "idb_store.cpp", 64, 3} true;
  assume {:verifier.code 0} true;
  call $i121 := emscripten_fetch_close($p104);
  assume {:sourceloc "idb_store.cpp", 66, 3} true;
  assume {:verifier.code 0} true;
  call $i122 := printf.ref(.str.16);
  call __SMACK_check_memory_leak();
  assume {:sourceloc "idb_store.cpp", 71, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb55:
  ...
  assume {:sourceloc "idb_store.cpp", 63, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.14, .str.3, 63, __func__.main);
  assume {:sourceloc "idb_store.cpp", 63, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb56:
...
axiom (llvm.dbg.declare == $sub.ref(0, 28428));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const emscripten_fetch_attr_init: ref;
axiom (emscripten_fetch_attr_init == $sub.ref(0, 29456));
procedure  emscripten_fetch_attr_init($p0: ref);
const _Z6strcpyPcPKc: ref;
axiom (_Z6strcpyPcPKc == $sub.ref(0, 30484));
procedure  _Z6strcpyPcPKc($p0: ref, $p1: ref)
  returns ($r: ref);
const malloc: ref;
axiom (malloc == $sub.ref(0, 31512));
...
const time: ref;
axiom (time == $sub.ref(0, 32540));
procedure  time($p0: ref)
  returns ($r: i32);
const srand: ref;
axiom (srand == $sub.ref(0, 33568));
procedure  srand($i0: i32);
const rand: ref;
axiom (rand == $sub.ref(0, 34596));
procedure  rand()
  returns ($r: i32);
const emscripten_fetch: ref;
axiom (emscripten_fetch == $sub.ref(0, 35624));
procedure  emscripten_fetch($p0: ref, $p1: ref)
  returns ($r: ref);
const __assert_fail: ref;
axiom (__assert_fail == $sub.ref(0, 36652));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const emscripten_fetch_close: ref;
axiom (emscripten_fetch_close == $sub.ref(0, 37680));
procedure  emscripten_fetch_close($p0: ref)
  returns ($r: i32);
const _Z6memcpyPvPKvm: ref;
axiom (_Z6memcpyPvPKvm == $sub.ref(0, 38708));
procedure  _Z6memcpyPvPKvm($p0: ref, $p1: ref, $i2: i32)
  returns ($r: ref);
const printf: ref;
axiom (printf == $sub.ref(0, 39736));
procedure  printf.ref($p0: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 40764));
...
axiom (__SMACK_code == $sub.ref(0, 41792));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 42820));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 43848));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 44876));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 45904));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 46932));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 47960));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 48988));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 50016));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 51044));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 52072));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 53100));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 54128));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 55156));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 56184));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 57212));
procedure  __SMACK_nondet_long()
  returns ($r: i32);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 58240));
procedure  __SMACK_nondet_long_int()
  returns ($r: i32);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 59268));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i32);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 60296));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 61324));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 62352));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i32);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 63380));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 64408));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 65436));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 66464));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 67492));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 68520));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 69548));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 70576));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_check_memory_safety: ref;
axiom (__SMACK_check_memory_safety == $sub.ref(0, 71604));
procedure  __SMACK_check_memory_safety($p0: ref, $p1: ref);
const __SMACK_check_memory_leak: ref;
axiom (__SMACK_check_memory_leak == $sub.ref(0, 72632));
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 73660));
...
axiom (__gxx_personality_v0 == $sub.ref(0, 74688));
procedure  __gxx_personality_v0()
  returns ($r: i32);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 75716));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 76744));
