...
$bb0:
  ...
  assume {:sourceloc "harness.c", 27, 1} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "harness.c", 27, 1} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "harness.c", 28, 47} true;
  assume {:verifier.code 0} true;
  $i9 := $mul.i32($u0, 1);
  assume {:sourceloc "harness.c", 28, 32} true;
  assume {:verifier.code 0} true;
  call $p10 := malloc($i9);
  assume {:sourceloc "harness.c", 28, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "harness.c", 28, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p11, $p10);
  assume {:sourceloc "harness.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p7, $mul.ref(0, 16)), $mul.ref(8, 1));
  $p15 := $bitcast.ref.ref($p14);
  $p16 := $bitcast.ref.ref($i2p.i64.ref(4));
  call __SMACK_check_memory_safety($p15, $p16);
  assume {:sourceloc "harness.c", 29, 24} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p14, $u0);
  assume {:sourceloc "harness.c", 30, 1} true;
  assume {:verifier.code 0} true;
  call $i17 := WebSocketOpen($u0, $p1, $u1);
  assume {:sourceloc "harness.c", 31, 1} true;
  assume {:verifier.code 0} true;
  call $i18 := WebSocketClose($u0, $p3, $u1);
  assume {:sourceloc "harness.c", 32, 1} true;
  assume {:verifier.code 0} true;
  call $i19 := WebSocketError($u0, $p5, $u1);
  assume {:sourceloc "harness.c", 33, 1} true;
  assume {:verifier.code 0} true;
  call $i20 := WebSocketMessage($u0, $p7, $u1);
  assume {:sourceloc "harness.c", 35, 20} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p7, $mul.ref(0, 16)), $mul.ref(4, 1));
  ...
  assume {:verifier.code 0} true;
  call free_($p27);
  assume {:sourceloc "harness.c", 39, 6} true;
  assume {:verifier.code 0} true;
  $p28 := $bitcast.ref.ref($p7);
  assume {:sourceloc "harness.c", 39, 1} true;
  assume {:verifier.code 0} true;
  call free_($p28);
  call __SMACK_check_memory_leak();
  assume {:sourceloc "harness.c", 41, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "test_websocket_send.c", 12, 7} true;
  assume {:verifier.code 0} true;
  call $M.4 := $memcpy.i8($M.4, $M.3, $p11, __const.WebSocketOpen.data, 11, false);
...
$bb0:
  ...
  $M.3 := $store.i8($M.3, __const.WebSocketOpen.data, 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(1, 1)), 1);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(2, 1)), 2);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(3, 1)), 3);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(4, 1)), 4);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(5, 1)), 5);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(6, 1)), 6);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(7, 1)), 7);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(8, 1)), 8);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(9, 1)), 9);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.WebSocketOpen.data, $mul.ref(0, 11)), $mul.ref(10, 1)), 10);
  $M.11 := .str.2.18;
  $M.12 := 0;
