...
implementation WebSocketOpen($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 83} $i5 := printf.ref.i32.i32(.str, $i0, $i4);
  ...
  $bb0$1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 84} $i10 := emscripten_websocket_send_utf8_text($i9, .str.1);
    assume true;
  ...
  $bb0$3:
    assume {:sourceloc "test_websocket_send.c", 12, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 85} $M.2 := $memcpy.i8($M.2, $M.1, $p11, __const.WebSocketOpen.data, 11, false);
  ...
  $bb0$4:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 86} $i21 := emscripten_websocket_send_binary($i19, $p20, 11);
...
implementation WebSocketClose($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0$2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 88} $i15 := printf.ref.i32.i32.i32.ref.i32(.str.2, $i0, $i6, $i11, $p13, $i14);
...
implementation WebSocketMessage($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0$3:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 90} $i16 := printf.ref.i32.i32.ref.i32.i32(.str.4, $i0, $i3, $p7, $i11, $i15);
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 91} $i27 := printf.ref(.str.6);
  ...
  $bb6:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 92} $i45 := printf.ref(.str.8);
  ...
  $bb6$3:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 94} $i56 := emscripten_websocket_close($i55, 0, $0.ref);
  ...
  $bb6$4:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} $i61 := emscripten_websocket_delete($i60);
    assume {:verifier.code 0} true;
    goto $bb3;
  ...
  $bb5$2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 96} $i43 := printf.ref.i32(.str.7, $i42);
  ...
  $bb1$1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 98} $i26 := printf.ref.ref(.str.5, $p25);
...
implementation main() returns ($r: i32)
{
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 104} $i4 := printf.ref(.str.9);
  ...
  $bb3$1:
    assume {:sourceloc "test_websocket_send.c", 75, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 106} $M.11 := $memset.i8($M.11, $p5, 0, 12, false);
    assume {:sourceloc "test_websocket_send.c", 75, 2} true;
    assume {:verifier.code 0} true;
    goto $bb4;
  ...
  $bb12:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 114} $i23 := emscripten_websocket_set_onopen_callback_on_thread($i11, $i2p.i32.ref(42), WebSocketOpen, $i2p.i32.ref(2));
    assume {:sourceloc "test_websocket_send.c", 93, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 115} $i24 := emscripten_websocket_set_onclose_callback_on_thread($i11, $i2p.i32.ref(43), WebSocketClose, $i2p.i32.ref(2));
    assume {:sourceloc "test_websocket_send.c", 94, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 116} $i25 := emscripten_websocket_set_onerror_callback_on_thread($i11, $i2p.i32.ref(44), WebSocketError, $i2p.i32.ref(2));
    assume {:sourceloc "test_websocket_send.c", 95, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 117} $i26 := emscripten_websocket_set_onmessage_callback_on_thread($i11, $i2p.i32.ref(45), WebSocketMessage, $i2p.i32.ref(2));
  ...
  $bb5:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 119} $i13 := printf.ref.i32(.str.11, $i11);
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 125} $CurrAddr := havocNonDetAvh.ref();
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeCallId 0} {:si_unique_call 134} {:ConcretizeConstantName "$M.13"} $M.13 := unknown_ref();
    assume unknownTrigger_0($M.13);
    call {:ConcretizeCallId 1} {:si_unique_call 135} {:ConcretizeConstantName "$exnv"} $exnv := unknown_int();
    assume unknownTrigger_1($exnv);
    call {:ConcretizeCallId 2} {:si_unique_call 136} {:ConcretizeConstantName "$allocatedCounter"} $allocatedCounter := unknown_int();
    assume unknownTrigger_2($allocatedCounter);
    call {:ConcretizeCallId 3} {:si_unique_call 137} {:ConcretizeConstantName "$CurrAddr"} $CurrAddr := unknown_ref();
  ...
  L_BAF_3:
    ...
    call {:si_unique_call 138} {:AvhEntryPoint} $r_main := main();
    return;
  ...
  L_BAF_2:
    ...
    assume MustReach(true);
    call {:si_unique_call 141} {:AvhEntryPoint} $r_WebSocketMessage := WebSocketMessage($i0_WebSocketMessage, $p1_WebSocketMessage, $p2_WebSocketMessage);
    return;
  ...
  L_BAF_1:
    ...
    assume MustReach(true);
    call {:si_unique_call 144} {:AvhEntryPoint} $r_WebSocketClose := WebSocketClose($i0_WebSocketClose, $p1_WebSocketClose, $p2_WebSocketClose);
    return;
  ...
  L_BAF_0:
    ...
    assume MustReach(true);
    call {:si_unique_call 147} {:AvhEntryPoint} $r_WebSocketOpen := WebSocketOpen($i0_WebSocketOpen, $p1_WebSocketOpen, $p2_WebSocketOpen);
    return;
}
