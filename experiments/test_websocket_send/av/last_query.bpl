...
procedure CorralMain_trace_1();
  ...
  free requires {:BlockingConstraint 1} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1)))));
  free requires {:BlockingConstraint 2} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1))), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1))))))));
  free requires {:BlockingConstraint 3} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(12, 1))))]);
  free requires {:BlockingConstraint 4} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1))))]);
  free requires {:BlockingConstraint 5} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1)))));
  free requires {:BlockingConstraint 6} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(12, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(12, 1)))));
  ...
  free requires {:BlockingConstraint 10} (forall x_5: ref :: unknownTrigger_6(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(4, 1))))]);
  modifies $M.13, $exnv, $allocatedCounter, $CurrAddr, assertsPassed, $M.11, $M.12, $M.9, $M.2, $M.1, $Alloc;



procedure WebSocketOpen_trace_1($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.2, $CurrAddr, $Alloc;
...
implementation {:origRTname "$alloc"} $alloc_trace_1(n: ref) returns (p: ref)
{
  ...
  anon0__unique__1:
    ...
    inline$$$alloc$0$n := n;
    call corral_fix_context_0();
    call {:si_unique_call 123} inline$$$alloc$0$p := havocNonDetAvh.ref_trace_1();
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
  ...
  inline$$$alloc$0$anon3_Then__unique__2:
    ...
    call corral_fix_context_0();
    call {:si_unique_call 125} cmdloc_dummy_var_5 := havocNonDetAvh.ref_trace_2();
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
...
implementation {:origRTname "WebSocketOpen"} WebSocketOpen_trace_1($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  var $p3: ref;
  var $i4: i32;
  var $p6: ref;
  ...
  $bb0__unique__1:
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i4 := init_locals_nondet_tmp_i32();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i19 := init_locals_nondet_tmp_i32();
    ...
    assume {:verifier.code 0} true;
    call corral_fix_context_0();
    call {:si_unique_call 81} $p3 := $alloc_trace_1($mul.ref(11, 1));
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_1__unique__2;

  AvnSeqInstr_1__unique__2:
    call corral_fix_context_0();
...
implementation {:origRTname "CorralMain"} CorralMain_trace_1()
{
  ...
  L_BAF_0__unique__2:
    ...
    call corral_fix_context_0();
    call {:si_unique_call 147} {:AvhEntryPoint} vslice_dummy_var_20 := WebSocketOpen_trace_1($i0_WebSocketOpen, $p1_WebSocketOpen, $p2_WebSocketOpen);
    goto AvnSeqInstr_223__unique__3;

  AvnSeqInstr_223__unique__3:
    call corral_fix_context_0();
