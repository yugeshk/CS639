...
implementation $global_allocations()
{
  ...
  anon0:
    ...
    call $galloc(emscripten_websocket_get_url_length, 4);
...
implementation WebSocketOpen($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call $p3 := $alloc($mul.ref(11, 1));
    call {:cexpr "WebSocketOpen:arg:eventType"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_websocket_send.c", 8, 57} true;
    assume {:verifier.code 0} true;
    $i4 := $p2i.ref.i32($p2);
    assume {:sourceloc "test_websocket_send.c", 8, 2} true;
    assume {:verifier.code 0} true;
    call $i5 := printf.ref.i32.i32(.str, $i0, $i4);
  ...
  $bb0$1:
    ...
    assume {:verifier.code 0} true;
    call $i10 := emscripten_websocket_send_utf8_text($i9, .str.1);
    assume true;
  ...
  $bb0$3:
    assume {:sourceloc "test_websocket_send.c", 12, 7} true;
    assume {:verifier.code 0} true;
    call $M.2 := $memcpy.i8($M.2, $M.1, $p11, __const.WebSocketOpen.data, 11, false);
  ...
  $bb0$4:
    ...
    assume {:verifier.code 0} true;
    call $i21 := emscripten_websocket_send_binary($i19, $p20, 11);
...
implementation WebSocketClose($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:cexpr "WebSocketClose:arg:eventType"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_websocket_send.c", 20, 94} true;
    assume {:verifier.code 0} true;
  ...
  $bb0$2:
    ...
    assume {:verifier.code 0} true;
    call $i15 := printf.ref.i32.i32.i32.ref.i32(.str.2, $i0, $i6, $i11, $p13, $i14);
...
implementation WebSocketError($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0:
    assume {:sourceloc "test_websocket_send.c", 26, 58} true;
    assume {:verifier.code 0} true;
    call {:cexpr "WebSocketError:arg:eventType"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_websocket_send.c", 26, 58} true;
    assume {:verifier.code 0} true;
    $i3 := $p2i.ref.i32($p2);
    assume {:sourceloc "test_websocket_send.c", 26, 2} true;
    assume {:verifier.code 0} true;
    call $i4 := printf.ref.i32.i32(.str.3, $i0, $i3);
    assume {:sourceloc "test_websocket_send.c", 27, 2} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
...
implementation WebSocketMessage($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:cexpr "WebSocketMessage:arg:eventType"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_websocket_send.c", 34, 93} true;
    assume {:verifier.code 0} true;
    $i3 := $p2i.ref.i32($p2);
  ...
  $bb0$3:
    ...
    assume {:verifier.code 0} true;
    call $i16 := printf.ref.i32.i32.ref.i32.i32(.str.4, $i0, $i3, $p7, $i11, $i15);
  ...
  $bb4:
    call $i28, $p29, $p30, $p31, $i32, $i33, $p34, $p35, $p36, $p37, $p38, $p39, $p40, $i41, $i42, $i43, $i44, inline$__SMACK_check_memory_safety$5$p, inline$__SMACK_check_memory_safety$5$size, inline$__SMACK_check_memory_safety$6$p, inline$__SMACK_check_memory_safety$6$size, inline$__SMACK_check_memory_safety$7$p, inline$__SMACK_check_memory_safety$7$size := WebSocketMessage_loop_$bb4($p1, $i28, $p29, $p30, $p31, $i32, $i33, $p34, $p35, $p36, $p37, $p38, $p39, $p40, $i41, $i42, $i43, $i44, inline$__SMACK_check_memory_safety$5$p, inline$__SMACK_check_memory_safety$5$size, inline$__SMACK_check_memory_safety$6$p, inline$__SMACK_check_memory_safety$6$size, inline$__SMACK_check_memory_safety$7$p, inline$__SMACK_check_memory_safety$7$size);
    goto $bb4_last;
  ...
  $bb6$2:
    ...
    assume {:verifier.code 0} true;
    $M.9 := $i49;
    call {:cexpr "passed"} boogie_si_record_i32($i49);
  ...
  $bb6$3:
    ...
    assume {:verifier.code 0} true;
    call $i56 := emscripten_websocket_close($i55, 0, $0.ref);
  ...
  $bb6$4:
    ...
    assume {:verifier.code 0} true;
    call $i61 := emscripten_websocket_delete($i60);
    assume {:verifier.code 0} true;
    goto $bb3;
  ...
  $bb5$2:
    ...
    assume {:verifier.code 0} true;
    call $i43 := printf.ref.i32(.str.7, $i42);
  ...
  $bb1$1:
    ...
    assume {:verifier.code 0} true;
    call $i26 := printf.ref.ref(.str.5, $p25);
...
procedure main() returns ($r: i32);
  modifies $M.11, $M.12, $exn, $M.1, $M.9, $M.13, $M.14, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "test_websocket_send.c", 68, 7} true;
    assume {:verifier.code 0} true;
    call $i2 := emscripten_websocket_is_supported();
    assume {:sourceloc "test_websocket_send.c", 68, 7} true;
    assume {:verifier.code 0} true;
    $i3 := $ne.i32($i2, 0);
  ...
  $bb3$1:
    assume {:sourceloc "test_websocket_send.c", 75, 2} true;
    assume {:verifier.code 0} true;
    call $M.11 := $memset.i8($M.11, $p5, 0, 12, false);
    assume {:sourceloc "test_websocket_send.c", 75, 2} true;
    assume {:verifier.code 0} true;
    goto $bb4;
  ...
  $bb4$1:
    ...
    assume {:verifier.code 0} true;
    call $i11 := emscripten_websocket_new($p0);
    call {:cexpr "socket"} boogie_si_record_i32($i11);
  ...
  $bb6$1:
    ...
    assume {:verifier.code 0} true;
    call $i16 := emscripten_websocket_get_url_length($i11, $p1);
    call {:cexpr "res"} boogie_si_record_i32($i16);
  ...
  $bb9:
    ...
    assume {:sourceloc "test_websocket_send.c", 89, 2} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.12, .str.13, 89, __func__.main);
    assume {:sourceloc "test_websocket_send.c", 89, 2} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb13:
    ...
    assume {:sourceloc "test_websocket_send.c", 90, 2} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.14, .str.13, 90, __func__.main);
    assume {:sourceloc "test_websocket_send.c", 90, 2} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb12:
    ...
    assume {:verifier.code 0} true;
    call $i23 := emscripten_websocket_set_onopen_callback_on_thread($i11, $i2p.i32.ref(42), WebSocketOpen, $i2p.i32.ref(2));
    assume {:sourceloc "test_websocket_send.c", 93, 2} true;
    assume {:verifier.code 0} true;
    call $i24 := emscripten_websocket_set_onclose_callback_on_thread($i11, $i2p.i32.ref(43), WebSocketClose, $i2p.i32.ref(2));
    assume {:sourceloc "test_websocket_send.c", 94, 2} true;
    assume {:verifier.code 0} true;
    call $i25 := emscripten_websocket_set_onerror_callback_on_thread($i11, $i2p.i32.ref(44), WebSocketError, $i2p.i32.ref(2));
    assume {:sourceloc "test_websocket_send.c", 95, 2} true;
    assume {:verifier.code 0} true;
    call $i26 := emscripten_websocket_set_onmessage_callback_on_thread($i11, $i2p.i32.ref(45), WebSocketMessage, $i2p.i32.ref(2));
  ...
  $bb5:
    ...
    assume {:verifier.code 0} true;
    call $i13 := printf.ref.i32(.str.11, $i11);
...
procedure __SMACK_static_init();
  modifies $M.1, $M.9, $M.13, $M.14, $exn;
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    ...
    $M.9 := 0;
    call {:cexpr "passed"} boogie_si_record_i32(0);
    $M.13 := .str.2.30;
    $M.14 := 0;
...
procedure $initialize();
  modifies $M.1, $M.9, $M.13, $M.14, $exn, $CurrAddr, $allocatedCounter, $Alloc;
...
procedure {:entrypoint} CorralMain();
  modifies $M.13, $exnv, $allocatedCounter, $CurrAddr, $M.2, $exn, $M.9, $M.11, $M.12, $Alloc, $M.1, $M.14;
...
implementation CorralMain()
{
  ...
  var $i0_WebSocketError: i32;
  var $p1_WebSocketError: ref;
  var $p2_WebSocketError: ref;
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeConstantName "$M.13"} $M.13 := unknown_ref();
  ...
  L_BAF_15:
    ...
    assume MustReach(true);
    call {:AvhEntryPoint} exit($i0_exit);
    return;
  ...
  L_BAF_4:
    ...
    call {:ConcretizeConstantName "$p1_WebSocketMessage"} $p1_WebSocketMessage := unknown_ref();
    call {:ConcretizeConstantName "$p2_WebSocketMessage"} $p2_WebSocketMessage := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_WebSocketMessage := WebSocketMessage($i0_WebSocketMessage, $p1_WebSocketMessage, $p2_WebSocketMessage);
    return;

  L_BAF_3:
    assume __block_call_WebSocketError;
    call {:ConcretizeConstantName "$p1_WebSocketError"} $p1_WebSocketError := unknown_ref();
    call {:ConcretizeConstantName "$p2_WebSocketError"} $p2_WebSocketError := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_WebSocketError := WebSocketError($i0_WebSocketError, $p1_WebSocketError, $p2_WebSocketError);
    return;

  L_BAF_2:
    assume __block_call_WebSocketClose;
    call {:ConcretizeConstantName "$p1_WebSocketClose"} $p1_WebSocketClose := unknown_ref();
    call {:ConcretizeConstantName "$p2_WebSocketClose"} $p2_WebSocketClose := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_WebSocketClose := WebSocketClose($i0_WebSocketClose, $p1_WebSocketClose, $p2_WebSocketClose);
    return;

  L_BAF_1:
    assume __block_call_WebSocketOpen;
    call {:ConcretizeConstantName "$p1_WebSocketOpen"} $p1_WebSocketOpen := unknown_ref();
    call {:ConcretizeConstantName "$p2_WebSocketOpen"} $p2_WebSocketOpen := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_WebSocketOpen := WebSocketOpen($i0_WebSocketOpen, $p1_WebSocketOpen, $p2_WebSocketOpen);
    return;
...
implementation WebSocketMessage_loop_$bb4(in_$p1: ref, in_$i28: i32, in_$p29: ref, in_$p30: ref, in_$p31: ref, in_$i32: i32, in_$i33: i1, in_$p34: ref, in_$p35: ref, in_$p36: ref, in_$p37: ref, in_$p38: ref, in_$p39: ref, in_$p40: ref, in_$i41: i8, in_$i42: i32, in_$i43: i32, in_$i44: i32, in_inline$__SMACK_check_memory_safety$5$p: ref, in_inline$__SMACK_check_memory_safety$5$size: ref, in_inline$__SMACK_check_memory_safety$6$p: ref, in_inline$__SMACK_check_memory_safety$6$size: ref, in_inline$__SMACK_check_memory_safety$7$p: ref, in_inline$__SMACK_check_memory_safety$7$size: ref) returns (out_$i28: i32, out_$p29: ref, out_$p30: ref, out_$p31: ref, out_$i32: i32, out_$i33: i1, out_$p34: ref, out_$p35: ref, out_$p36: ref, out_$p37: ref, out_$p38: ref, out_$p39: ref, out_$p40: ref, out_$i41: i8, out_$i42: i32, out_$i43: i32, out_$i44: i32, out_inline$__SMACK_check_memory_safety$5$p: ref, out_inline$__SMACK_check_memory_safety$5$size: ref, out_inline$__SMACK_check_memory_safety$6$p: ref, out_inline$__SMACK_check_memory_safety$6$size: ref, out_inline$__SMACK_check_memory_safety$7$p: ref, out_inline$__SMACK_check_memory_safety$7$size: ref)
{

  entry:
    out_$i28, out_$p29, out_$p30, out_$p31, out_$i32, out_$i33, out_$p34, out_$p35, out_$p36, out_$p37, out_$p38, out_$p39, out_$p40, out_$i41, out_$i42, out_$i43, out_$i44, out_inline$__SMACK_check_memory_safety$5$p, out_inline$__SMACK_check_memory_safety$5$size, out_inline$__SMACK_check_memory_safety$6$p, out_inline$__SMACK_check_memory_safety$6$size, out_inline$__SMACK_check_memory_safety$7$p, out_inline$__SMACK_check_memory_safety$7$size := in_$i28, in_$p29, in_$p30, in_$p31, in_$i32, in_$i33, in_$p34, in_$p35, in_$p36, in_$p37, in_$p38, in_$p39, in_$p40, in_$i41, in_$i42, in_$i43, in_$i44, in_inline$__SMACK_check_memory_safety$5$p, in_inline$__SMACK_check_memory_safety$5$size, in_inline$__SMACK_check_memory_safety$6$p, in_inline$__SMACK_check_memory_safety$6$size, in_inline$__SMACK_check_memory_safety$7$p, in_inline$__SMACK_check_memory_safety$7$size;
    goto $bb4, exit;
  ...
  $bb4:
    ...
    assume {:sourceloc "test_websocket_send.c", 46, 25} true;
    assume {:verifier.code 0} true;
    out_$p29 := $add.ref($add.ref(in_$p1, $mul.ref(0, 16)), $mul.ref(8, 1));
    out_$p30 := $bitcast.ref.ref(out_$p29);
    out_$p31 := $bitcast.ref.ref($i2p.i64.ref(4));
    goto inline$__SMACK_check_memory_safety$5$Entry;

  $bb7:
    assume {:sourceloc "test_websocket_send.c", 46, 35} true;
    assume {:verifier.code 0} true;
    out_$i44 := $add.i32(out_$i28, 1);
    call {:cexpr "i"} boogie_si_record_i32(out_$i44);
    assume {:sourceloc "test_websocket_send.c", 46, 3} true;
    assume {:verifier.code 0} true;
    out_$i28 := out_$i44;
    goto $bb7_dummy;
  ...
  $bb5$2:
    assume {:sourceloc "test_websocket_send.c", 48, 20} true;
    assume {:verifier.code 0} true;
    out_$i41 := $load.i8($M.8, out_$p38);
    assume {:sourceloc "test_websocket_send.c", 48, 20} true;
    assume {:verifier.code 0} true;
    out_$i42 := $zext.i8.i32(out_$i41);
    assume {:sourceloc "test_websocket_send.c", 48, 4} true;
    assume {:verifier.code 0} true;
    call out_$i43 := printf.ref.i32(.str.7, out_$i42);
    assume {:sourceloc "test_websocket_send.c", 52, 3} true;
    assume {:verifier.code 0} true;
    goto $bb7;
  ...
  inline$__SMACK_check_memory_safety$7$Entry:
    out_inline$__SMACK_check_memory_safety$7$p := out_$p39;
    out_inline$__SMACK_check_memory_safety$7$size := out_$p40;
    goto inline$__SMACK_check_memory_safety$7$anon0;

  $bb5$1:
    assume {:sourceloc "test_websocket_send.c", 48, 23} true;
    assume {:verifier.code 0} true;
    out_$p37 := $load.ref($M.5, out_$p34);
    assume {:sourceloc "test_websocket_send.c", 48, 20} true;
    assume {:verifier.code 0} true;
    out_$p38 := $add.ref(out_$p37, $mul.ref(out_$i28, 1));
    out_$p39 := $bitcast.ref.ref(out_$p38);
    out_$p40 := $bitcast.ref.ref($i2p.i64.ref(1));
    goto inline$__SMACK_check_memory_safety$7$Entry;
  ...
  inline$__SMACK_check_memory_safety$6$Entry:
    out_inline$__SMACK_check_memory_safety$6$p := out_$p35;
    out_inline$__SMACK_check_memory_safety$6$size := out_$p36;
    goto inline$__SMACK_check_memory_safety$6$anon0;
  ...
  $bb5:
    ...
    assume {:sourceloc "test_websocket_send.c", 48, 23} true;
    assume {:verifier.code 0} true;
    out_$p34 := $add.ref($add.ref(in_$p1, $mul.ref(0, 16)), $mul.ref(4, 1));
    out_$p35 := $bitcast.ref.ref(out_$p34);
    out_$p36 := $bitcast.ref.ref($i2p.i64.ref(4));
    goto inline$__SMACK_check_memory_safety$6$Entry;

  $bb4$1:
    assume {:sourceloc "test_websocket_send.c", 46, 25} true;
    assume {:verifier.code 0} true;
    out_$i32 := $load.i32($M.6, out_$p29);
    assume {:sourceloc "test_websocket_send.c", 46, 20} true;
    assume {:verifier.code 0} true;
    out_$i33 := $ult.i32(out_$i28, out_$i32);
    assume {:sourceloc "test_websocket_send.c", 46, 3} true;
    assume {:verifier.code 0} true;
    assume true;
    goto $bb5;
  ...
  inline$__SMACK_check_memory_safety$5$Entry:
    out_inline$__SMACK_check_memory_safety$5$p := out_$p30;
    out_inline$__SMACK_check_memory_safety$5$size := out_$p31;
    goto inline$__SMACK_check_memory_safety$5$anon0;

  $bb7_dummy:
    call {:si_unique_call 1} out_$i28, out_$p29, out_$p30, out_$p31, out_$i32, out_$i33, out_$p34, out_$p35, out_$p36, out_$p37, out_$p38, out_$p39, out_$p40, out_$i41, out_$i42, out_$i43, out_$i44, out_inline$__SMACK_check_memory_safety$5$p, out_inline$__SMACK_check_memory_safety$5$size, out_inline$__SMACK_check_memory_safety$6$p, out_inline$__SMACK_check_memory_safety$6$size, out_inline$__SMACK_check_memory_safety$7$p, out_inline$__SMACK_check_memory_safety$7$size := WebSocketMessage_loop_$bb4(in_$p1, out_$i28, out_$p29, out_$p30, out_$p31, out_$i32, out_$i33, out_$p34, out_$p35, out_$p36, out_$p37, out_$p38, out_$p39, out_$p40, out_$i41, out_$i42, out_$i43, out_$i44, out_inline$__SMACK_check_memory_safety$5$p, out_inline$__SMACK_check_memory_safety$5$size, out_inline$__SMACK_check_memory_safety$6$p, out_inline$__SMACK_check_memory_safety$6$size, out_inline$__SMACK_check_memory_safety$7$p, out_inline$__SMACK_check_memory_safety$7$size);
    return;
...
procedure WebSocketMessage_loop_$bb4(in_$p1: ref, in_$i28: i32, in_$p29: ref, in_$p30: ref, in_$p31: ref, in_$i32: i32, in_$i33: i1, in_$p34: ref, in_$p35: ref, in_$p36: ref, in_$p37: ref, in_$p38: ref, in_$p39: ref, in_$p40: ref, in_$i41: i8, in_$i42: i32, in_$i43: i32, in_$i44: i32, in_inline$__SMACK_check_memory_safety$5$p: ref, in_inline$__SMACK_check_memory_safety$5$size: ref, in_inline$__SMACK_check_memory_safety$6$p: ref, in_inline$__SMACK_check_memory_safety$6$size: ref, in_inline$__SMACK_check_memory_safety$7$p: ref, in_inline$__SMACK_check_memory_safety$7$size: ref) returns (out_$i28: i32, out_$p29: ref, out_$p30: ref, out_$p31: ref, out_$i32: i32, out_$i33: i1, out_$p34: ref, out_$p35: ref, out_$p36: ref, out_$p37: ref, out_$p38: ref, out_$p39: ref, out_$p40: ref, out_$i41: i8, out_$i42: i32, out_$i43: i32, out_$i44: i32, out_inline$__SMACK_check_memory_safety$5$p: ref, out_inline$__SMACK_check_memory_safety$5$size: ref, out_inline$__SMACK_check_memory_safety$6$p: ref, out_inline$__SMACK_check_memory_safety$6$size: ref, out_inline$__SMACK_check_memory_safety$7$p: ref, out_inline$__SMACK_check_memory_safety$7$size: ref);
