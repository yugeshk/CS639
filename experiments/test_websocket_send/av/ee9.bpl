...
const alloc_InitLocalVar__1122: i32;
...
const alloc_InitLocalVar__1126: int;
...
const alloc_InitLocalVar__1133: i32;
...
const alloc_InitLocalVar__1139: i32;
...
const alloc_InitLocalVar__1143: int;

const alloc_InitLocalVar__1144: int;
...
const alloc_InitLocalVar__1148: i32;

const alloc_InitLocalVar__1149: i32;

const alloc_$M.13__1150: ref;

const alloc_$exnv__1151: int;

const alloc_$allocatedCounter__1152: int;

const alloc_$CurrAddr__1153: ref;

const alloc_$p1_WebSocketClose__1154: ref;

const alloc_$p2_WebSocketClose__1155: ref;
...
const alloc_InitLocalVar__1163: i16;

const alloc_InitLocalVar__1164: i32;

const alloc_InitLocalVar__1165: ref;

const alloc_InitLocalVar__1166: i32;
...
const alloc_InitLocalVar__1172: i32;
...
implementation {:origRTname "CorralMain_SeqInstr"} {:entrypoint} CorralMain_SeqInstr_trace_1_trace_1()
{
  ...
  start__unique__1__unique__1:
    ...
    inline$CorralMain_trace_1_trace_1$0$$i0_WebSocketClose := alloc_InitLocalVar__1136;
    ...
    inline$CorralMain_trace_1_trace_1$0$$p1_WebSocketClose := alloc_InitLocalVar__1137;
    ...
    inline$CorralMain_trace_1_trace_1$0$$p2_WebSocketClose := alloc_InitLocalVar__1138;
    ...
    inline$CorralMain_trace_1_trace_1$0$$i0_WebSocketMessage := alloc_InitLocalVar__1139;
    ...
    inline$CorralMain_trace_1_trace_1$0$$p1_WebSocketMessage := alloc_InitLocalVar__1140;
    ...
    inline$CorralMain_trace_1_trace_1$0$$p2_WebSocketMessage := alloc_InitLocalVar__1141;
    ...
    inline$CorralMain_trace_1_trace_1$0$cmdloc_dummy_var_6 := alloc_InitLocalVar__1142;
    ...
    inline$CorralMain_trace_1_trace_1$0$cmdloc_dummy_var_7 := alloc_InitLocalVar__1143;
    ...
    inline$CorralMain_trace_1_trace_1$0$cmdloc_dummy_var_8 := alloc_InitLocalVar__1144;
    ...
    inline$CorralMain_trace_1_trace_1$0$cmdloc_dummy_var_9 := alloc_InitLocalVar__1145;
    ...
    inline$CorralMain_trace_1_trace_1$0$vslice_dummy_var_17 := alloc_InitLocalVar__1146;
    ...
    inline$CorralMain_trace_1_trace_1$0$vslice_dummy_var_18 := alloc_InitLocalVar__1147;
    ...
    inline$CorralMain_trace_1_trace_1$0$vslice_dummy_var_19 := alloc_InitLocalVar__1148;
    ...
    inline$CorralMain_trace_1_trace_1$0$vslice_dummy_var_20 := alloc_InitLocalVar__1149;
    assume true;
    ...
    inline$CorralMain_trace_1_trace_1$0$cmdloc_dummy_var_6 := alloc_$M.13__1150;
    assume true;
    assume true;
    assume true;
    ...
    inline$CorralMain_trace_1_trace_1$0$cmdloc_dummy_var_7 := alloc_$exnv__1151;
    assume true;
    assume true;
    assume true;
    ...
    inline$CorralMain_trace_1_trace_1$0$cmdloc_dummy_var_8 := alloc_$allocatedCounter__1152;
    assume true;
    assume true;
    assume true;
    ...
    inline$CorralMain_trace_1_trace_1$0$cmdloc_dummy_var_9 := alloc_$CurrAddr__1153;
    assume true;
    assume true;
    assume true;
    ...
    inline$CorralMain_trace_1_trace_1$0$$p1_WebSocketClose := alloc_$p1_WebSocketClose__1154;
    assume true;
    assume true;
    assume true;
    ...
    inline$CorralMain_trace_1_trace_1$0$$p2_WebSocketClose := alloc_$p2_WebSocketClose__1155;
    assume true;
    assume true;
    assume true;
    ...
    inline$WebSocketClose_trace_1_trace_1$0$inline$__SMACK_check_memory_safety$0$p := alloc_InitLocalVar__1167;
    ...
    inline$WebSocketClose_trace_1_trace_1$0$inline$__SMACK_check_memory_safety$0$size := alloc_InitLocalVar__1168;
    ...
    inline$WebSocketClose_trace_1_trace_1$0$inline$__SMACK_check_memory_safety$1$p := alloc_InitLocalVar__1169;
    ...
    inline$WebSocketClose_trace_1_trace_1$0$inline$__SMACK_check_memory_safety$1$size := alloc_InitLocalVar__1170;
    ...
    inline$WebSocketClose_trace_1_trace_1$0$vslice_dummy_var_3 := alloc_InitLocalVar__1171;
    call {:ConcretizeConstantName "InitLocalVar"} inline$WebSocketClose_trace_1_trace_1$0$$r := init_locals_nondet_tmp_i32();
    inline$WebSocketClose_trace_1_trace_1$0$$r := alloc_InitLocalVar__1172;
    assume true;
