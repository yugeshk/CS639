...
implementation WebSocketMessage($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  corral_source_split_8:
    assume {:verifier.code 0} true;
    call {:si_unique_call 4} vslice_dummy_var_0 := printf.ref.i32.i32.ref.i32.i32(.str.4, $i0, $i3, $p7, $i11, $i15);
  ...
  corral_source_split_16:
    assume {:verifier.code 0} true;
    call {:si_unique_call 7} vslice_dummy_var_1 := printf.ref.ref(.str.5, $p25);
  ...
  corral_source_split_19:
    assume {:verifier.code 0} true;
    call {:si_unique_call 8} vslice_dummy_var_2 := printf.ref(.str.6);
  ...
  corral_source_split_32:
    assume {:verifier.code 0} true;
    call {:si_unique_call 12} vslice_dummy_var_3 := printf.ref.i32(.str.7, $i42);
  ...
  corral_source_split_35:
    assume {:verifier.code 0} true;
    call {:si_unique_call 13} vslice_dummy_var_4 := printf.ref(.str.8);
    $p46 := $bitcast.ref.ref(passed);
    $p47 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 14} __SMACK_check_memory_safety($p46, $p47);
  ...
  corral_source_split_37:
    ...
    call {:si_unique_call 15} __SMACK_check_memory_safety($p50, $p51);
  ...
  corral_source_split_38:
    assume {:verifier.code 0} true;
    $M.9 := $i49;
    call {:si_unique_call 16} {:cexpr "passed"} boogie_si_record_i32($i49);
  ...
  corral_source_split_39:
    ...
    call {:si_unique_call 17} __SMACK_check_memory_safety($p53, $p54);
  ...
  corral_source_split_41:
    assume {:verifier.code 0} true;
    call {:si_unique_call 18} vslice_dummy_var_5 := emscripten_websocket_close($i55, 0, $0.ref);
  ...
  corral_source_split_42:
    ...
    call {:si_unique_call 19} __SMACK_check_memory_safety($p58, $p59);
  ...
  corral_source_split_44:
    assume {:verifier.code 0} true;
    call {:si_unique_call 20} vslice_dummy_var_6 := emscripten_websocket_delete($i60);
    assume {:verifier.code 0} true;
    goto $bb3;
  ...
  $bb7:
    assume {:verifier.code 0} true;
    $i44 := $add.i32($i28, 1);
    call {:si_unique_call 21} {:cexpr "i"} boogie_si_record_i32($i44);
...
procedure {:entrypoint} WebSocketMessage_SeqInstr($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.9;



implementation {:entrypoint} WebSocketMessage_SeqInstr($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{

  start:
    assertsPassed := true;
    call $r := WebSocketMessage($i0, $p1, $p2);
