...
axiom $GLOBALS_BOTTOM == $sub.ref(0, 119841);
...
implementation $global_allocations()
{
  ...
  anon0:
    call {:si_unique_call 0} $galloc(__em_js__noarg_int, 4);
    call {:si_unique_call 1} $galloc(__em_js__noarg, 4);
    call {:si_unique_call 2} $galloc(.str.12, 121);
    call {:si_unique_call 3} $galloc(.str.10, 79);
    call {:si_unique_call 4} $galloc(.str.9, 66);
    call {:si_unique_call 5} $galloc(.str.8, 62);
    call {:si_unique_call 6} $galloc(.str.7, 126);
    call {:si_unique_call 7} $galloc(.str.11, 71);
    call {:si_unique_call 8} $galloc(.str.14, 24);
    call {:si_unique_call 9} $galloc(llvm.used, 60);
    call {:si_unique_call 10} $galloc(.str.13, 220);
    call {:si_unique_call 11} $galloc(.str.6, 79);
    call {:si_unique_call 12} $galloc(.str.5, 84);
    call {:si_unique_call 13} $galloc(.str.4, 47);
    call {:si_unique_call 14} $galloc(.str.3, 41);
    call {:si_unique_call 15} $galloc(.str.2, 61);
    call {:si_unique_call 16} $galloc(.str.1, 55);
    call {:si_unique_call 17} $galloc(.str, 36);
    call {:si_unique_call 18} $galloc(__const._Z10return_strv.jsString, 15);
    call {:si_unique_call 19} $galloc(.str.15, 7);
    call {:si_unique_call 20} $galloc(.str.16, 28);
    call {:si_unique_call 21} $galloc(.str.17, 31);
    call {:si_unique_call 22} $galloc(.str.19, 11);
    call {:si_unique_call 23} $galloc(.str.18, 28);
    call {:si_unique_call 24} $galloc(.str.20, 31);
    call {:si_unique_call 25} $galloc(.str.22, 6);
    call {:si_unique_call 26} $galloc(.str.21, 33);
    call {:si_unique_call 27} $galloc(.str.23, 30);
    call {:si_unique_call 28} $galloc(.str.24, 28);
    call {:si_unique_call 29} $galloc(.str.25, 28);
    call {:si_unique_call 30} $galloc(.str.26, 33);
    call {:si_unique_call 31} $galloc(.str.27, 29);
    call {:si_unique_call 32} $galloc(.str.28, 29);
    call {:si_unique_call 33} $galloc(.str.29, 34);
    call {:si_unique_call 34} $galloc(.str.30, 19);
    call {:si_unique_call 35} $galloc(_ZTISt9bad_alloc, 4);
    call {:si_unique_call 36} $galloc(__em_js__noarg_double, 4);
    call {:si_unique_call 37} $galloc(__em_js__intarg, 4);
    call {:si_unique_call 38} $galloc(__em_js__doublearg, 4);
    call {:si_unique_call 39} $galloc(__em_js__stringarg, 4);
    call {:si_unique_call 40} $galloc(.str.31, 5);
    call {:si_unique_call 41} $galloc(multi_mixedarg, 4);
    call {:si_unique_call 42} $galloc(unused_args, 4);
    call {:si_unique_call 43} $galloc(skip_args, 4);
    call {:si_unique_call 44} $galloc(add_outer, 4);
    call {:si_unique_call 45} $galloc(user_separator, 4);
    call {:si_unique_call 46} $galloc(user_comma, 4);
    call {:si_unique_call 47} $galloc(return_utf8_str, 4);
    call {:si_unique_call 48} $galloc(_prefixed, 4);
    call {:si_unique_call 49} $galloc(__VERIFIER_assume, 4);
    call {:si_unique_call 50} $galloc(__SMACK_code, 4);
    call {:si_unique_call 51} $galloc(.str.24.55, 28);
    call {:si_unique_call 52} $galloc(.str.25.56, 26);
    call {:si_unique_call 53} $galloc(env_value_str, 4);
    call {:si_unique_call 54} $galloc(.str.2.57, 3);
    call {:si_unique_call 55} $galloc(.str.58, 49);
    call {:si_unique_call 56} $galloc(.str.1.59, 14);
    call {:si_unique_call 57} $galloc(errno_global, 4);
    call {:si_unique_call 58} $galloc(__SMACK_nondet_unsigned, 4);
    call {:si_unique_call 59} $galloc(__SMACK_nondet_unsigned_int, 4);
    call {:si_unique_call 60} $galloc(__em_js__multi_intarg, 4);
    call {:si_unique_call 61} $galloc(__em_js__multi_mixedarg, 4);
    call {:si_unique_call 62} $galloc(__em_js__unused_args, 4);
    call {:si_unique_call 63} $galloc(printf, 4);
    call {:si_unique_call 64} $galloc(__em_js__skip_args, 4);
    call {:si_unique_call 65} $galloc(__em_js__add_outer, 4);
    call {:si_unique_call 66} $galloc(__em_js__user_separator, 4);
    call {:si_unique_call 67} $galloc(__em_js__user_comma, 4);
    call {:si_unique_call 68} $galloc(__em_js__return_utf8_str, 4);
    call {:si_unique_call 69} $galloc(__em_js___prefixed, 4);
    call {:si_unique_call 70} $galloc(_Z10return_strv, 4);
    call {:si_unique_call 71} $galloc(llvm.dbg.declare, 4);
    call {:si_unique_call 72} $galloc(llvm.memcpy.p0i8.p0i8.i32, 4);
    call {:si_unique_call 73} $galloc(_Z6strlenPKc, 4);
    call {:si_unique_call 74} $galloc(malloc, 4);
    call {:si_unique_call 75} $galloc(_Z7strncpyPcPKcm, 4);
    call {:si_unique_call 76} $galloc(main, 4);
    call {:si_unique_call 77} $galloc(noarg, 4);
    call {:si_unique_call 78} $galloc(noarg_int, 4);
    call {:si_unique_call 79} $galloc(noarg_double, 4);
    call {:si_unique_call 80} $galloc(intarg, 4);
    call {:si_unique_call 81} $galloc(doublearg, 4);
    call {:si_unique_call 82} $galloc(stringarg, 4);
    call {:si_unique_call 83} $galloc(multi_intarg, 4);
    call {:si_unique_call 84} $galloc(__SMACK_dummy, 4);
    call {:si_unique_call 85} $galloc(__SMACK_check_overflow, 4);
    call {:si_unique_call 86} $galloc(__SMACK_nondet_char, 4);
    call {:si_unique_call 87} $galloc(__SMACK_nondet_signed_char, 4);
    call {:si_unique_call 88} $galloc(__SMACK_decls, 4);
    call {:si_unique_call 89} $galloc(__SMACK_top_decl, 4);
    call {:si_unique_call 90} $galloc(__SMACK_check_memory_safety, 4);
    call {:si_unique_call 91} $galloc(__SMACK_check_memory_leak, 4);
    call {:si_unique_call 92} $galloc(__SMACK_init_func_memory_model, 4);
    call {:si_unique_call 93} $galloc(__SMACK_nondet_unsigned_char, 4);
    call {:si_unique_call 94} $galloc(__SMACK_nondet_short, 4);
    call {:si_unique_call 95} $galloc(__SMACK_nondet_signed_short, 4);
    call {:si_unique_call 96} $galloc(__SMACK_nondet_signed_short_int, 4);
    call {:si_unique_call 97} $galloc(__SMACK_nondet_unsigned_short, 4);
    call {:si_unique_call 98} $galloc(__SMACK_nondet_unsigned_short_int, 4);
    call {:si_unique_call 99} $galloc(__SMACK_nondet_int, 4);
    call {:si_unique_call 100} $galloc(__SMACK_nondet_signed_int, 4);
    call {:si_unique_call 101} $galloc(__SMACK_nondet_long, 4);
    call {:si_unique_call 102} $galloc(__SMACK_nondet_long_int, 4);
    call {:si_unique_call 103} $galloc(__SMACK_nondet_signed_long, 4);
    call {:si_unique_call 104} $galloc(__SMACK_nondet_signed_long_int, 4);
    call {:si_unique_call 105} $galloc(__SMACK_nondet_unsigned_long, 4);
    call {:si_unique_call 106} $galloc(__SMACK_nondet_unsigned_long_int, 4);
    call {:si_unique_call 107} $galloc(__SMACK_nondet_long_long, 4);
    call {:si_unique_call 108} $galloc(__SMACK_nondet_long_long_int, 4);
    call {:si_unique_call 109} $galloc(__SMACK_nondet_signed_long_long, 4);
    call {:si_unique_call 110} $galloc(__SMACK_nondet_signed_long_long_int, 4);
    call {:si_unique_call 111} $galloc(__SMACK_nondet_unsigned_long_long, 4);
    call {:si_unique_call 112} $galloc(__SMACK_nondet_unsigned_long_long_int, 4);
    call {:si_unique_call 113} $galloc(__gxx_personality_v0, 4);
    call {:si_unique_call 114} $galloc(llvm.dbg.value, 4);
    call {:si_unique_call 115} $galloc(__SMACK_static_init, 4);
    return;
}
...
const {:count 15} llvm.used: ref;

axiom llvm.used == $sub.ref(0, 1084);

const {:count 24} .str.14: ref;

axiom .str.14 == $sub.ref(0, 2132);

const {:count 220} .str.13: ref;

axiom .str.13 == $sub.ref(0, 3376);

const {:count 121} .str.12: ref;

axiom .str.12 == $sub.ref(0, 4521);

const {:count 71} .str.11: ref;

axiom .str.11 == $sub.ref(0, 5616);

const {:count 79} .str.10: ref;

axiom .str.10 == $sub.ref(0, 6719);

const {:count 66} .str.9: ref;

axiom .str.9 == $sub.ref(0, 7809);

const {:count 62} .str.8: ref;

axiom .str.8 == $sub.ref(0, 8895);

const {:count 126} .str.7: ref;

axiom .str.7 == $sub.ref(0, 10045);

const {:count 79} .str.6: ref;

axiom .str.6 == $sub.ref(0, 11148);

const {:count 84} .str.5: ref;

axiom .str.5 == $sub.ref(0, 12256);

const {:count 47} .str.4: ref;

axiom .str.4 == $sub.ref(0, 13327);

const {:count 41} .str.3: ref;

axiom .str.3 == $sub.ref(0, 14392);

const {:count 61} .str.2: ref;

axiom .str.2 == $sub.ref(0, 15477);

const {:count 55} .str.1: ref;

axiom .str.1 == $sub.ref(0, 16556);

const .str: ref;

axiom .str == $sub.ref(0, 17616);

const {:count 15} __const._Z10return_strv.jsString: ref;

axiom __const._Z10return_strv.jsString == $sub.ref(0, 18655);

const {:count 7} .str.15: ref;

axiom .str.15 == $sub.ref(0, 19686);

const {:count 28} .str.16: ref;

axiom .str.16 == $sub.ref(0, 20738);

const {:count 31} .str.17: ref;

axiom .str.17 == $sub.ref(0, 21793);

const {:count 11} .str.19: ref;

axiom .str.19 == $sub.ref(0, 22828);

const {:count 28} .str.18: ref;

axiom .str.18 == $sub.ref(0, 23880);

const {:count 31} .str.20: ref;

axiom .str.20 == $sub.ref(0, 24935);

const {:count 6} .str.22: ref;

axiom .str.22 == $sub.ref(0, 25965);

const {:count 33} .str.21: ref;

axiom .str.21 == $sub.ref(0, 27022);

const {:count 30} .str.23: ref;

axiom .str.23 == $sub.ref(0, 28076);

const {:count 28} .str.24: ref;

axiom .str.24 == $sub.ref(0, 29128);

const {:count 28} .str.25: ref;

axiom .str.25 == $sub.ref(0, 30180);

const {:count 33} .str.26: ref;

axiom .str.26 == $sub.ref(0, 31237);

const {:count 29} .str.27: ref;

axiom .str.27 == $sub.ref(0, 32290);

const {:count 29} .str.28: ref;

axiom .str.28 == $sub.ref(0, 33343);

const {:count 34} .str.29: ref;

axiom .str.29 == $sub.ref(0, 34401);

const {:count 19} .str.30: ref;

axiom .str.30 == $sub.ref(0, 35444);

const {:count 5} .str.31: ref;

axiom .str.31 == $sub.ref(0, 36473);

const {:count 28} .str.24.55: ref;

axiom .str.24.55 == $sub.ref(0, 37525);

const {:count 26} .str.25.56: ref;

axiom .str.25.56 == $sub.ref(0, 38575);

const env_value_str: ref;

axiom env_value_str == $sub.ref(0, 39603);

const {:count 3} .str.2.57: ref;

axiom .str.2.57 == $sub.ref(0, 40630);

const {:count 49} .str.58: ref;

axiom .str.58 == $sub.ref(0, 41703);

const {:count 14} .str.1.59: ref;

axiom .str.1.59 == $sub.ref(0, 42741);

const errno_global: ref;

axiom errno_global == $sub.ref(0, 43769);
...
axiom __em_js__noarg == $sub.ref(0, 44797);

procedure __em_js__noarg() returns ($r: ref);



const __em_js__noarg_int: ref;

axiom __em_js__noarg_int == $sub.ref(0, 45825);

procedure __em_js__noarg_int() returns ($r: ref);



const __em_js__noarg_double: ref;

axiom __em_js__noarg_double == $sub.ref(0, 46853);

procedure __em_js__noarg_double() returns ($r: ref);



const __em_js__intarg: ref;

axiom __em_js__intarg == $sub.ref(0, 47881);

procedure __em_js__intarg() returns ($r: ref);



const __em_js__doublearg: ref;

axiom __em_js__doublearg == $sub.ref(0, 48909);

procedure __em_js__doublearg() returns ($r: ref);



const __em_js__stringarg: ref;

axiom __em_js__stringarg == $sub.ref(0, 49937);

procedure __em_js__stringarg() returns ($r: ref);



const __em_js__multi_intarg: ref;

axiom __em_js__multi_intarg == $sub.ref(0, 50965);

procedure __em_js__multi_intarg() returns ($r: ref);



const __em_js__multi_mixedarg: ref;

axiom __em_js__multi_mixedarg == $sub.ref(0, 51993);

procedure __em_js__multi_mixedarg() returns ($r: ref);



const __em_js__unused_args: ref;

axiom __em_js__unused_args == $sub.ref(0, 53021);

procedure __em_js__unused_args() returns ($r: ref);



const __em_js__skip_args: ref;

axiom __em_js__skip_args == $sub.ref(0, 54049);

procedure __em_js__skip_args() returns ($r: ref);



const __em_js__add_outer: ref;

axiom __em_js__add_outer == $sub.ref(0, 55077);

procedure __em_js__add_outer() returns ($r: ref);



const __em_js__user_separator: ref;

axiom __em_js__user_separator == $sub.ref(0, 56105);

procedure __em_js__user_separator() returns ($r: ref);



const __em_js__user_comma: ref;

axiom __em_js__user_comma == $sub.ref(0, 57133);

procedure __em_js__user_comma() returns ($r: ref);



const __em_js__return_utf8_str: ref;

axiom __em_js__return_utf8_str == $sub.ref(0, 58161);

procedure __em_js__return_utf8_str() returns ($r: ref);



const __em_js___prefixed: ref;

axiom __em_js___prefixed == $sub.ref(0, 59189);

procedure __em_js___prefixed() returns ($r: ref);



const _Z10return_strv: ref;

axiom _Z10return_strv == $sub.ref(0, 60217);

procedure _Z10return_strv() returns ($r: ref);
  modifies $M.1, $exn, $CurrAddr, $Alloc, $allocatedCounter;



implementation _Z10return_strv() returns ($r: ref)
{
  var $p0: ref;
  var $p1: ref;
  var $p2: ref;
  ...
  $bb0:
    assume {:sourceloc "test_em_js.cpp", 76, 6} true;
    assume {:verifier.code 0} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 116} $p0 := $alloc($mul.ref(15, 1));
    assume true;
    assume {:sourceloc "test_em_js.cpp", 76, 6} true;
    assume {:verifier.code 0} true;
    ...
    $p3 := $i2p.i32.ref(15);
    call {:si_unique_call 117} __SMACK_check_memory_safety($p2, $p3);
    $p4 := $bitcast.ref.ref(__const._Z10return_strv.jsString);
    $p5 := $i2p.i32.ref(15);
    call {:si_unique_call 118} __SMACK_check_memory_safety($p4, $p5);
    assume {:sourceloc "test_em_js.cpp", 76, 6} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 119} $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const._Z10return_strv.jsString, 15, false);
    assume {:sourceloc "test_em_js.cpp", 77, 27} true;
    assume {:verifier.code 0} true;
    $p6 := $add.ref($add.ref($p0, $mul.ref(0, 15)), $mul.ref(0, 1));
    assume {:sourceloc "test_em_js.cpp", 77, 20} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 120} $i7 := _Z6strlenPKc($p6);
    assume {:sourceloc "test_em_js.cpp", 77, 36} true;
    assume {:verifier.code 0} true;
    $i8 := $add.i32($i7, 1);
    call {:si_unique_call 121} {:cexpr "lengthyBytes"} boogie_si_record_i32($i8);
    assume {:sourceloc "test_em_js.cpp", 78, 52} true;
    assume {:verifier.code 0} true;
    $i9 := $mul.i32(1, $i8);
    assume {:sourceloc "test_em_js.cpp", 78, 33} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 122} $p10 := malloc($i9);
    assume {:sourceloc "test_em_js.cpp", 79, 9} true;
    assume {:verifier.code 0} true;
    $p11 := $add.ref($add.ref($p0, $mul.ref(0, 15)), $mul.ref(0, 1));
    assume {:sourceloc "test_em_js.cpp", 79, 1} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 123} $p12 := _Z7strncpyPcPKcm($p11, $p10, $i8);
    assume $isExternal($p12);
    assume {:sourceloc "test_em_js.cpp", 80, 1} true;
    assume {:verifier.code 0} true;
    $r := $p10;
    $exn := false;
    return;
...
axiom llvm.dbg.declare == $sub.ref(0, 61245);
...
axiom llvm.memcpy.p0i8.p0i8.i32 == $sub.ref(0, 62273);

procedure llvm.memcpy.p0i8.p0i8.i32($p0: ref, $p1: ref, $i2: i32, $i3: i1);



const _Z6strlenPKc: ref;

axiom _Z6strlenPKc == $sub.ref(0, 63301);

procedure _Z6strlenPKc($p0: ref) returns ($r: i32);



const malloc: ref;

axiom malloc == $sub.ref(0, 64329);

procedure malloc($i0: i32) returns ($r: ref);
  modifies $allocatedCounter, $CurrAddr, $Alloc;



implementation malloc($i0: i32) returns ($r: ref)
{
...
const _Z7strncpyPcPKcm: ref;

axiom _Z7strncpyPcPKcm == $sub.ref(0, 65357);

procedure _Z7strncpyPcPKcm($p0: ref, $p1: ref, $i2: i32) returns ($r: ref);



const main: ref;

axiom main == $sub.ref(0, 66385);

procedure {:entrypoint} main() returns ($r: i32);
  modifies $M.1, $exn, $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.0, $M.18, $M.19, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation {:entrypoint} main() returns ($r: i32)
{
  ...
  $bb0:
    call {:si_unique_call 125} $initialize();
    assume {:sourceloc "test_em_js.cpp", 88, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 126} {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
    assume {:sourceloc "test_em_js.cpp", 88, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 127} $i0 := printf.ref(.str.15);
    assume {:sourceloc "test_em_js.cpp", 89, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 128} noarg();
    assume {:sourceloc "test_em_js.cpp", 90, 42} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 129} $i1 := noarg_int();
    assume {:sourceloc "test_em_js.cpp", 90, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 130} $i2 := printf.ref.i32(.str.16, $i1);
    assume {:sourceloc "test_em_js.cpp", 91, 45} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 131} $f3 := noarg_double();
    assume {:sourceloc "test_em_js.cpp", 91, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 132} $i4 := printf.ref.float(.str.17, $f3);
    assume {:sourceloc "test_em_js.cpp", 93, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 133} intarg(5);
    assume {:sourceloc "test_em_js.cpp", 94, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 134} doublearg($fp(5, 67500, 0));
    assume {:sourceloc "test_em_js.cpp", 95, 42} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 135} $f5 := stringarg(.str.19);
    assume {:sourceloc "test_em_js.cpp", 95, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 136} $i6 := printf.ref.float(.str.18, $f5);
    assume {:sourceloc "test_em_js.cpp", 96, 45} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 137} $i7 := multi_intarg(5, 7);
    assume {:sourceloc "test_em_js.cpp", 96, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 138} $i8 := printf.ref.i32(.str.20, $i7);
    assume {:sourceloc "test_em_js.cpp", 97, 47} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 139} $f9 := multi_mixedarg(3, .str.22, $fp(4, 750000, 0));
    assume {:sourceloc "test_em_js.cpp", 97, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 140} $i10 := printf.ref.float(.str.21, $f9);
    assume {:sourceloc "test_em_js.cpp", 98, 44} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 141} $i11 := unused_args(0);
    assume {:sourceloc "test_em_js.cpp", 98, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 142} $i12 := printf.ref.i32(.str.23, $i11);
    assume {:sourceloc "test_em_js.cpp", 99, 42} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 143} $f13 := skip_args(5, 7);
    assume {:sourceloc "test_em_js.cpp", 99, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 144} $i14 := printf.ref.float(.str.24, $f13);
    assume {:sourceloc "test_em_js.cpp", 100, 42} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 145} $f15 := add_outer($fp(5, 500000, 0), $fp(7, 0, 0), $fp(1, 437500, 1));
    assume {:sourceloc "test_em_js.cpp", 100, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 146} $i16 := printf.ref.float(.str.25, $f15);
    assume {:sourceloc "test_em_js.cpp", 101, 47} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 147} $i17 := user_separator();
    assume {:sourceloc "test_em_js.cpp", 101, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 148} $i18 := printf.ref.i32(.str.26, $i17);
    assume {:sourceloc "test_em_js.cpp", 102, 43} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 149} $i19 := user_comma();
    assume {:sourceloc "test_em_js.cpp", 102, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 150} $i20 := printf.ref.i32(.str.27, $i19);
    assume {:sourceloc "test_em_js.cpp", 104, 43} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 151} $p21 := _Z10return_strv();
    assume {:sourceloc "test_em_js.cpp", 104, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 152} $i22 := printf.ref.ref(.str.28, $p21);
    assume {:sourceloc "test_em_js.cpp", 105, 48} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 153} $p23 := return_utf8_str();
    assume $isExternal($p23);
    assume {:sourceloc "test_em_js.cpp", 105, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 154} $i24 := printf.ref.ref(.str.29, $p23);
    assume {:sourceloc "test_em_js.cpp", 107, 33} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 155} $i25 := _prefixed();
    assume {:sourceloc "test_em_js.cpp", 107, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 156} $i26 := printf.ref.i32(.str.30, $i25);
    assume {:sourceloc "test_em_js.cpp", 109, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 157} $i27 := printf.ref(.str.31);
    call {:si_unique_call 158} __SMACK_check_memory_leak();
    assume {:sourceloc "test_em_js.cpp", 110, 3} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
...
axiom noarg_int == $sub.ref(0, 69469);

procedure noarg_int() returns ($r: i32);



const noarg_double: ref;

axiom noarg_double == $sub.ref(0, 70497);

procedure noarg_double() returns ($r: float);



const intarg: ref;

axiom intarg == $sub.ref(0, 71525);
...
axiom doublearg == $sub.ref(0, 72553);
...
axiom stringarg == $sub.ref(0, 73581);

procedure stringarg($p0: ref) returns ($r: float);



const multi_intarg: ref;

axiom multi_intarg == $sub.ref(0, 74609);

procedure multi_intarg($i0: i32, $i1: i32) returns ($r: i32);



const multi_mixedarg: ref;

axiom multi_mixedarg == $sub.ref(0, 75637);

procedure multi_mixedarg($i0: i32, $p1: ref, $f2: float) returns ($r: float);



const unused_args: ref;

axiom unused_args == $sub.ref(0, 76665);

procedure unused_args($i0: i32) returns ($r: i32);



const skip_args: ref;

axiom skip_args == $sub.ref(0, 77693);

procedure skip_args($i0: i32, $i1: i32) returns ($r: float);



const add_outer: ref;

axiom add_outer == $sub.ref(0, 78721);

procedure add_outer($f0: float, $f1: float, $f2: float) returns ($r: float);



const user_separator: ref;

axiom user_separator == $sub.ref(0, 79749);

procedure user_separator() returns ($r: i32);



const user_comma: ref;

axiom user_comma == $sub.ref(0, 80777);

procedure user_comma() returns ($r: i32);



const return_utf8_str: ref;

axiom return_utf8_str == $sub.ref(0, 81805);

procedure return_utf8_str() returns ($r: ref);



const _prefixed: ref;

axiom _prefixed == $sub.ref(0, 82833);

procedure _prefixed() returns ($r: i32);



const __VERIFIER_assume: ref;

axiom __VERIFIER_assume == $sub.ref(0, 83861);
...
axiom __SMACK_code == $sub.ref(0, 84889);
...
axiom __SMACK_dummy == $sub.ref(0, 85917);
...
axiom __SMACK_check_overflow == $sub.ref(0, 86945);
...
axiom __SMACK_nondet_char == $sub.ref(0, 87973);
...
axiom __SMACK_nondet_signed_char == $sub.ref(0, 89001);
...
axiom __SMACK_nondet_unsigned_char == $sub.ref(0, 90029);
...
axiom __SMACK_nondet_short == $sub.ref(0, 91057);
...
axiom __SMACK_nondet_signed_short == $sub.ref(0, 92085);
...
axiom __SMACK_nondet_signed_short_int == $sub.ref(0, 93113);
...
axiom __SMACK_nondet_unsigned_short == $sub.ref(0, 94141);
...
axiom __SMACK_nondet_unsigned_short_int == $sub.ref(0, 95169);
...
axiom __SMACK_nondet_int == $sub.ref(0, 96197);
...
axiom __SMACK_nondet_signed_int == $sub.ref(0, 97225);
...
axiom __SMACK_nondet_unsigned == $sub.ref(0, 98253);
...
axiom __SMACK_nondet_unsigned_int == $sub.ref(0, 99281);
...
axiom __SMACK_nondet_long == $sub.ref(0, 100309);
...
axiom __SMACK_nondet_long_int == $sub.ref(0, 101337);
...
axiom __SMACK_nondet_signed_long == $sub.ref(0, 102365);
...
axiom __SMACK_nondet_signed_long_int == $sub.ref(0, 103393);
...
axiom __SMACK_nondet_unsigned_long == $sub.ref(0, 104421);
...
axiom __SMACK_nondet_unsigned_long_int == $sub.ref(0, 105449);
...
axiom __SMACK_nondet_long_long == $sub.ref(0, 106477);
...
axiom __SMACK_nondet_long_long_int == $sub.ref(0, 107505);
...
axiom __SMACK_nondet_signed_long_long == $sub.ref(0, 108533);
...
axiom __SMACK_nondet_signed_long_long_int == $sub.ref(0, 109561);
...
axiom __SMACK_nondet_unsigned_long_long == $sub.ref(0, 110589);
...
axiom __SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 111617);
...
axiom __SMACK_decls == $sub.ref(0, 112645);
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 159} corral_atomic_begin();
    call {:si_unique_call 160} p := $$alloc(n);
    call {:si_unique_call 161} corral_atomic_end();
    return;
}
...
implementation $malloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 162} corral_atomic_begin();
  ...
  anon2:
    call {:si_unique_call 163} p := $$alloc(n);
    call {:si_unique_call 164} corral_atomic_end();
    return;
}
...
axiom __SMACK_top_decl == $sub.ref(0, 113673);
...
axiom __SMACK_check_memory_safety == $sub.ref(0, 114701);
...
axiom __SMACK_check_memory_leak == $sub.ref(0, 115729);
...
axiom __SMACK_init_func_memory_model == $sub.ref(0, 116757);
...
axiom __gxx_personality_v0 == $sub.ref(0, 117785);
...
axiom llvm.dbg.value == $sub.ref(0, 118813);
...
axiom __SMACK_static_init == $sub.ref(0, 119841);

procedure __SMACK_static_init();
  modifies $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.0, $M.18, $M.19, $exn;
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    $M.3 := __em_js__noarg;
    $M.4 := __em_js__noarg_int;
    $M.5 := __em_js__noarg_double;
    $M.6 := __em_js__intarg;
    $M.7 := __em_js__doublearg;
    $M.8 := __em_js__stringarg;
    $M.9 := __em_js__multi_intarg;
    $M.10 := __em_js__multi_mixedarg;
    $M.11 := __em_js__unused_args;
    $M.12 := __em_js__skip_args;
    $M.13 := __em_js__add_outer;
    $M.14 := __em_js__user_separator;
    $M.15 := __em_js__user_comma;
    $M.16 := __em_js__return_utf8_str;
    $M.17 := __em_js___prefixed;
    $M.0 := $store.i8($M.0, __const._Z10return_strv.jsString, 104);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(1, 1)), 101);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(2, 1)), 108);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(3, 1)), 108);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(4, 1)), 111);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(5, 1)), 32);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(6, 1)), 102);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(7, 1)), 114);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(8, 1)), 111);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(9, 1)), 109);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(10, 1)), 32);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(11, 1)), 106);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(12, 1)), 115);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(13, 1)), 0);
    $M.0 := $store.i8($M.0, $add.ref($add.ref(__const._Z10return_strv.jsString, $mul.ref(0, 15)), $mul.ref(14, 1)), 0);
    $M.18 := .str.2.57;
    $M.19 := 0;
    call {:si_unique_call 165} {:cexpr "errno_global"} boogie_si_record_i32(0);
    $exn := false;
    return;
}
...
procedure $initialize();
  modifies $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.0, $M.18, $M.19, $exn, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation $initialize()
{
  ...
  anon0:
    call {:si_unique_call 166} $global_allocations();
    call {:si_unique_call 167} __SMACK_static_init();
    call {:si_unique_call 168} __SMACK_init_func_memory_model();
    return;
}
