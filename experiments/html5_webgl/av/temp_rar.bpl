...
implementation $global_allocations()
{
  ...
  anon0:
    ...
    call $galloc(compile_shader, 4);
    call $galloc(glCreateShader, 4);
    call $galloc(glShaderSource, 4);
    call $galloc(glCompileShader, 4);
    call $galloc(__func__.main, 5);
    call $galloc(.str.5, 23);
    call $galloc(.str.1, 7);
    call $galloc(.str.9, 9);
    call $galloc(.str.4, 14);
    call $galloc(.str.6, 6);
    call $galloc(.str.7, 33);
    call $galloc(.str.8, 52);
    call $galloc(.str, 5);
    call $galloc(.str.2, 8);
    call $galloc(.str.3, 11);
    call $galloc(.str.10, 65);
    call $galloc(.str.11, 8);
    call $galloc(.str.12, 6);
    call $galloc(.str.13, 30);
    call $galloc(.str.14, 15);
    call $galloc(.str.15, 17);
    call $galloc(.str.16, 17);
    call $galloc(.str.17, 17);
    call $galloc(.str.18, 17);
    call $galloc(.str.19, 17);
    call $galloc(.str.20, 17);
    call $galloc(.str.21, 15);
    call $galloc(.str.22, 16);
    call $galloc(.str.23, 16);
    call $galloc(.str.24, 16);
    call $galloc(.str.25, 16);
    call $galloc(.str.26, 16);
    call $galloc(.str.27, 16);
    call $galloc(.str.28, 86);
    call $galloc(main.vertex_shader, 169);
    call $galloc(.str.29, 67);
    call $galloc(.str.30, 68);
    call $galloc(.str.31, 80);
    call $galloc(.str.32, 4);
    call $galloc(.str.33, 10);
    call $galloc(.str.34, 30);
    call $galloc(main.failing_shader, 130);
    call $galloc(.str.35, 17);
    call $galloc(.str.36, 37);
    call $galloc(main.fragment_shader, 130);
    call $galloc(.str.37, 67);
    call $galloc(.str.38, 68);
    call $galloc(.str.39, 82);
    call $galloc(.str.40, 8);
    call $galloc(.str.41, 28);
    call $galloc(.str.42, 77);
    call $galloc(.str.43, 11);
    call $galloc(glAttachShader, 4);
    call $galloc(glBindAttribLocation, 4);
    call $galloc(glLinkProgram, 4);
    call $galloc(main, 4);
    call $galloc(.str.44, 7);
    call $galloc(emscripten_webgl_init_context_attributes, 4);
    call $galloc(emscripten_webgl_create_context, 4);
    call $galloc(emscripten_webgl_make_context_current, 4);
    call $galloc(emscripten_webgl_get_supported_extensions, 4);
    call $galloc(__assert_fail, 4);
    call $galloc(strlen, 4);
    call $galloc(strstr, 4);
    call $galloc(.str.45, 34);
    call $galloc(.str.46, 15);
    call $galloc(.str.47, 13);
    call $galloc(.str.48, 22);
    call $galloc(.str.49, 24);
    call $galloc(.str.50, 24);
    call $galloc(.str.51, 24);
    call $galloc(.str.52, 24);
    call $galloc(.str.53, 24);
    call $galloc(glUseProgram, 4);
    call $galloc(glGetUniformLocation, 4);
    call $galloc(glUniform1f, 4);
    call $galloc(glUniform4f, 4);
    call $galloc(.str.24.77, 28);
    call $galloc(.str.25.78, 26);
    call $galloc(env_value_str, 4);
    call $galloc(.str.2.79, 3);
    call $galloc(.str.80, 49);
    call $galloc(.str.1.81, 14);
    call $galloc(errno_global, 4);
    call $galloc(create_program, 4);
    call $galloc(glCreateProgram, 4);
    ...
    call $galloc(free_, 4);
    call $galloc(emscripten_webgl_get_parameter_d, 4);
    call $galloc(glGenBuffers, 4);
    call $galloc(glBindBuffer, 4);
    call $galloc(emscripten_webgl_get_parameter_o, 4);
    call $galloc(emscripten_webgl_get_parameter_utf8, 4);
    call $galloc(emscripten_webgl_get_parameter_i64v, 4);
    call $galloc(glViewport, 4);
    call $galloc(llvm.memset.p0i8.i32, 4);
    call $galloc(emscripten_webgl_get_parameter_v, 4);
    call $galloc(glEnableVertexAttribArray, 4);
    call $galloc(emscripten_webgl_get_vertex_attrib_d, 4);
    call $galloc(glVertexAttrib4f, 4);
    call $galloc(emscripten_webgl_get_vertex_attrib_v, 4);
    call $galloc(glBufferData, 4);
    call $galloc(glVertexAttribPointer, 4);
    call $galloc(emscripten_webgl_get_vertex_attrib_o, 4);
    call $galloc(emscripten_webgl_get_shader_parameter_d, 4);
    call $galloc(emscripten_webgl_get_shader_source_utf8, 4);
    call $galloc(emscripten_webgl_get_shader_info_log_utf8, 4);
    call $galloc(emscripten_webgl_get_program_parameter_d, 4);
    call $galloc(emscripten_webgl_get_program_info_log_utf8, 4);
    call $galloc(emscripten_webgl_get_uniform_d, 4);
    call $galloc(emscripten_webgl_get_uniform_v, 4);
...
implementation compile_shader(shaderType: i32, src: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    call {:cexpr "compile_shader:arg:shaderType"} boogie_si_record_i32(shaderType);
    ...
    assume {:sourceloc "html5_webgl.c", 11, 19} true;
    assume {:verifier.code 0} true;
    call $i3 := glCreateShader(shaderType);
    call {:cexpr "shader"} boogie_si_record_i32($i3);
    assume {:sourceloc "html5_webgl.c", 12, 3} true;
    assume {:verifier.code 0} true;
    call glShaderSource($i3, 1, $p0, $0.ref);
    assume {:sourceloc "html5_webgl.c", 13, 3} true;
    assume {:verifier.code 0} true;
    call glCompileShader($i3);
...
implementation create_program(vertexShader: i32, fragmentShader: i32) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:cexpr "create_program:arg:vertexShader"} boogie_si_record_i32(vertexShader);
    call {:cexpr "create_program:arg:fragmentShader"} boogie_si_record_i32(fragmentShader);
    assume {:sourceloc "html5_webgl.c", 19, 21} true;
    assume {:verifier.code 0} true;
    call $i0 := glCreateProgram();
    call {:cexpr "program"} boogie_si_record_i32($i0);
    assume {:sourceloc "html5_webgl.c", 20, 4} true;
    assume {:verifier.code 0} true;
    call glAttachShader($i0, vertexShader);
    assume {:sourceloc "html5_webgl.c", 21, 4} true;
    assume {:verifier.code 0} true;
    call glAttachShader($i0, fragmentShader);
    assume {:sourceloc "html5_webgl.c", 22, 4} true;
    assume {:verifier.code 0} true;
    call glBindAttribLocation($i0, 0, .str);
    assume {:sourceloc "html5_webgl.c", 23, 4} true;
    assume {:verifier.code 0} true;
    call glBindAttribLocation($i0, 1, .str.1);
    assume {:sourceloc "html5_webgl.c", 24, 4} true;
    assume {:verifier.code 0} true;
    call glLinkProgram($i0);
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call $p0 := $alloc($mul.ref(56, 1));
    assume {:verifier.code 0} true;
    call $p1 := $alloc($mul.ref(4, 1));
    assume {:verifier.code 0} true;
    call $p2 := $alloc($mul.ref(8, 1));
    assume {:verifier.code 0} true;
    call $p3 := $alloc($mul.ref(16, 1));
    assume {:verifier.code 0} true;
    call $p4 := $alloc($mul.ref(16, 1));
    assume {:verifier.code 0} true;
    call $p5 := $alloc($mul.ref(16, 1));
    assume true;
    assume {:sourceloc "html5_webgl.c", 31, 3} true;
    assume {:verifier.code 0} true;
    call emscripten_webgl_init_context_attributes($p0);
    ...
    assume {:verifier.code 0} true;
    call $i15 := emscripten_webgl_create_context(.str.2, $p0);
    call {:cexpr "context"} boogie_si_record_i32($i15);
    assume {:sourceloc "html5_webgl.c", 36, 3} true;
    assume {:verifier.code 0} true;
    call $i16 := emscripten_webgl_make_context_current($i15);
    assume {:sourceloc "html5_webgl.c", 39, 22} true;
    assume {:verifier.code 0} true;
    call $p17 := emscripten_webgl_get_supported_extensions();
  ...
  $bb3:
    ...
    assume {:sourceloc "html5_webgl.c", 40, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.3, .str.4, 40, __func__.main);
    assume {:sourceloc "html5_webgl.c", 40, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb7:
    ...
    assume {:sourceloc "html5_webgl.c", 41, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.5, .str.4, 41, __func__.main);
    assume {:sourceloc "html5_webgl.c", 41, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb11:
    ...
    assume {:sourceloc "html5_webgl.c", 42, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.7, .str.4, 42, __func__.main);
    assume {:sourceloc "html5_webgl.c", 42, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb10:
    ...
    assume {:verifier.code 0} true;
    call $f23 := emscripten_webgl_get_parameter_d(3412);
    assume {:sourceloc "html5_webgl.c", 46, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb15:
    ...
    assume {:sourceloc "html5_webgl.c", 46, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.8, .str.4, 46, __func__.main);
    assume {:sourceloc "html5_webgl.c", 46, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb19:
    ...
    assume {:sourceloc "html5_webgl.c", 51, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.9, .str.4, 51, __func__.main);
    assume {:sourceloc "html5_webgl.c", 51, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb18:
    ...
    assume {:verifier.code 0} true;
    call glBindBuffer(34962, $i31);
    assume {:sourceloc "html5_webgl.c", 53, 3} true;
    assume {:verifier.code 0} true;
    call $i32 := emscripten_webgl_get_parameter_o(34964);
  ...
  $bb23:
    ...
    assume {:sourceloc "html5_webgl.c", 53, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.10, .str.4, 53, __func__.main);
    assume {:sourceloc "html5_webgl.c", 53, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb22:
    ...
    assume {:verifier.code 0} true;
    call $p37 := emscripten_webgl_get_parameter_utf8(7938);
  ...
  $bb27:
    ...
    assume {:sourceloc "html5_webgl.c", 57, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.11, .str.4, 57, __func__.main);
    assume {:sourceloc "html5_webgl.c", 57, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb31:
    ...
    assume {:sourceloc "html5_webgl.c", 58, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.13, .str.4, 58, __func__.main);
    assume {:sourceloc "html5_webgl.c", 58, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb30:
    ...
    assume {:verifier.code 0} true;
    call emscripten_webgl_get_parameter_i64v(35377, $p2);
  ...
  $bb35:
    ...
    assume {:sourceloc "html5_webgl.c", 64, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.14, .str.4, 64, __func__.main);
    assume {:sourceloc "html5_webgl.c", 64, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb34:
    ...
    assume {:sourceloc "html5_webgl.c", 68, 7} true;
    assume {:verifier.code 0} true;
    call $M.7 := $memset.i8($M.7, $p47, 0, 16, false);
    ...
    assume {:verifier.code 0} true;
    call $i52 := emscripten_webgl_get_parameter_v(2978, $p51, 3, 0);
    call {:cexpr "numElements"} boogie_si_record_i32($i52);
  ...
  $bb39:
    ...
    assume {:sourceloc "html5_webgl.c", 70, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.15, .str.4, 70, __func__.main);
    assume {:sourceloc "html5_webgl.c", 70, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb43:
    ...
    assume {:sourceloc "html5_webgl.c", 71, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.16, .str.4, 71, __func__.main);
    assume {:sourceloc "html5_webgl.c", 71, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb47:
    ...
    assume {:sourceloc "html5_webgl.c", 72, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.17, .str.4, 72, __func__.main);
    assume {:sourceloc "html5_webgl.c", 72, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb51:
    ...
    assume {:sourceloc "html5_webgl.c", 73, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.18, .str.4, 73, __func__.main);
    assume {:sourceloc "html5_webgl.c", 73, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb50:
    ...
    call __SMACK_check_memory_safety($p70, $p71);
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb55:
    ...
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.19, .str.4, 74, __func__.main);
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb54:
    ...
    assume {:verifier.code 0} true;
    call $i76 := emscripten_webgl_get_parameter_v(2978, $p75, 4, 0);
    call {:cexpr "numElements"} boogie_si_record_i32($i76);
  ...
  $bb59:
    ...
    assume {:sourceloc "html5_webgl.c", 78, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.15, .str.4, 78, __func__.main);
    assume {:sourceloc "html5_webgl.c", 78, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb58:
    ...
    call __SMACK_check_memory_safety($p79, $p80);
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb63:
    ...
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.16, .str.4, 79, __func__.main);
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb62:
    ...
    call __SMACK_check_memory_safety($p84, $p85);
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb67:
    ...
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.17, .str.4, 80, __func__.main);
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb66:
    ...
    call __SMACK_check_memory_safety($p89, $p90);
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb71:
    ...
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.18, .str.4, 81, __func__.main);
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb75:
    ...
    assume {:sourceloc "html5_webgl.c", 82, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.20, .str.4, 82, __func__.main);
    assume {:sourceloc "html5_webgl.c", 82, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb74:
    ...
    assume {:verifier.code 0} true;
    call $f98 := emscripten_webgl_get_vertex_attrib_d(0, 34338);
    call {:cexpr "enabled"} boogie_si_record_float($f98);
  ...
  $bb79:
    ...
    assume {:sourceloc "html5_webgl.c", 87, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.21, .str.4, 87, __func__.main);
    assume {:sourceloc "html5_webgl.c", 87, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb78:
    ...
    assume {:verifier.code 0} true;
    call glVertexAttrib4f(0, $fp(0, 3, 99999), $fp(0, 3, 99999), $fp(0, 3, 3333340000000), $fp(0, 3, 99999));
    assume true;
    ...
    assume {:sourceloc "html5_webgl.c", 91, 9} true;
    assume {:verifier.code 0} true;
    call $M.8 := $memset.i8($M.8, $p100, 0, 16, false);
    ...
    assume {:verifier.code 0} true;
    call $i105 := emscripten_webgl_get_vertex_attrib_v(0, 34342, $p104, 2, 1);
    call {:cexpr "numElements"} boogie_si_record_i32($i105);
  ...
  $bb83:
    ...
    assume {:sourceloc "html5_webgl.c", 93, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.15, .str.4, 93, __func__.main);
    assume {:sourceloc "html5_webgl.c", 93, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb82:
    ...
    call __SMACK_check_memory_safety($p108, $p109);
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb87:
    ...
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.22, .str.4, 94, __func__.main);
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb86:
    ...
    call __SMACK_check_memory_safety($p113, $p114);
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb91:
    ...
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.23, .str.4, 95, __func__.main);
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb90:
    ...
    call __SMACK_check_memory_safety($p118, $p119);
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb95:
    ...
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.24, .str.4, 96, __func__.main);
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb94:
    ...
    call __SMACK_check_memory_safety($p123, $p124);
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb99:
    ...
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.25, .str.4, 97, __func__.main);
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb98:
    ...
    assume {:verifier.code 0} true;
    call $i129 := emscripten_webgl_get_vertex_attrib_v(0, 34342, $p128, 4, 1);
    call {:cexpr "numElements"} boogie_si_record_i32($i129);
  ...
  $bb103:
    ...
    assume {:sourceloc "html5_webgl.c", 101, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.15, .str.4, 101, __func__.main);
    assume {:sourceloc "html5_webgl.c", 101, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb102:
    ...
    call __SMACK_check_memory_safety($p132, $p133);
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb107:
    ...
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.22, .str.4, 102, __func__.main);
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb106:
    ...
    call __SMACK_check_memory_safety($p137, $p138);
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb111:
    ...
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.23, .str.4, 103, __func__.main);
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb110:
    ...
    call __SMACK_check_memory_safety($p142, $p143);
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb115:
    ...
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.26, .str.4, 104, __func__.main);
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb114:
    ...
    call __SMACK_check_memory_safety($p147, $p148);
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb119:
    ...
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.27, .str.4, 105, __func__.main);
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb118:
    ...
    assume {:verifier.code 0} true;
    call glBufferData(34962, 4, $p152, 35044);
    assume {:sourceloc "html5_webgl.c", 109, 3} true;
    assume {:verifier.code 0} true;
    call glVertexAttribPointer(0, 1, 5126, 0, 0, $0.ref);
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
    call $i153 := emscripten_webgl_get_vertex_attrib_o(0, 34975);
    $p154 := $bitcast.ref.ref($p1);
    $p155 := $bitcast.ref.ref($i2p.i64.ref(4));
    call __SMACK_check_memory_safety($p154, $p155);
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb123:
    ...
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.28, .str.4, 110, __func__.main);
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb122:
    ...
    assume {:verifier.code 0} true;
    call $i158 := compile_shader(35633, main.vertex_shader);
    call {:cexpr "vs"} boogie_si_record_i32($i158);
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
    call $f159 := emscripten_webgl_get_shader_parameter_d($i158, 35712);
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb127:
    ...
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.29, .str.4, 125, __func__.main);
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb126:
    ...
    assume {:verifier.code 0} true;
    call $f161 := emscripten_webgl_get_shader_parameter_d($i158, 35713);
    assume {:sourceloc "html5_webgl.c", 126, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb131:
    ...
    assume {:sourceloc "html5_webgl.c", 126, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.30, .str.4, 126, __func__.main);
    assume {:sourceloc "html5_webgl.c", 126, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb130:
    ...
    assume {:verifier.code 0} true;
    call $f163 := emscripten_webgl_get_shader_parameter_d($i158, 35663);
    assume {:sourceloc "html5_webgl.c", 127, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb135:
    ...
    assume {:sourceloc "html5_webgl.c", 127, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.31, .str.4, 127, __func__.main);
    assume {:sourceloc "html5_webgl.c", 127, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb134:
    ...
    assume {:verifier.code 0} true;
    call $p165 := emscripten_webgl_get_shader_source_utf8($i158);
  ...
  $bb139:
    ...
    assume {:sourceloc "html5_webgl.c", 131, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.32, .str.4, 131, __func__.main);
    assume {:sourceloc "html5_webgl.c", 131, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb143:
    ...
    assume {:sourceloc "html5_webgl.c", 132, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.34, .str.4, 132, __func__.main);
    assume {:sourceloc "html5_webgl.c", 132, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb142:
    ...
    assume {:verifier.code 0} true;
    call $i169 := compile_shader(35633, main.failing_shader);
    call {:cexpr "vs2"} boogie_si_record_i32($i169);
    assume {:sourceloc "html5_webgl.c", 147, 9} true;
    assume {:verifier.code 0} true;
    call $p170 := emscripten_webgl_get_shader_info_log_utf8($i169);
  ...
  $bb147:
    ...
    assume {:sourceloc "html5_webgl.c", 148, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.32, .str.4, 148, __func__.main);
    assume {:sourceloc "html5_webgl.c", 148, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb151:
    ...
    assume {:sourceloc "html5_webgl.c", 149, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.36, .str.4, 149, __func__.main);
    assume {:sourceloc "html5_webgl.c", 149, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb150:
    ...
    assume {:verifier.code 0} true;
    call $i174 := compile_shader(35632, main.fragment_shader);
    call {:cexpr "fs"} boogie_si_record_i32($i174);
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
    call $f175 := emscripten_webgl_get_shader_parameter_d($i174, 35712);
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb155:
    ...
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.37, .str.4, 163, __func__.main);
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb154:
    ...
    assume {:verifier.code 0} true;
    call $f177 := emscripten_webgl_get_shader_parameter_d($i174, 35713);
    assume {:sourceloc "html5_webgl.c", 164, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb159:
    ...
    assume {:sourceloc "html5_webgl.c", 164, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.38, .str.4, 164, __func__.main);
    assume {:sourceloc "html5_webgl.c", 164, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb158:
    ...
    assume {:verifier.code 0} true;
    call $f179 := emscripten_webgl_get_shader_parameter_d($i174, 35663);
    assume {:sourceloc "html5_webgl.c", 165, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb163:
    ...
    assume {:sourceloc "html5_webgl.c", 165, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.39, .str.4, 165, __func__.main);
    assume {:sourceloc "html5_webgl.c", 165, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb162:
    ...
    assume {:verifier.code 0} true;
    call $p181 := emscripten_webgl_get_shader_source_utf8($i174);
  ...
  $bb167:
    ...
    assume {:sourceloc "html5_webgl.c", 169, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.32, .str.4, 169, __func__.main);
    assume {:sourceloc "html5_webgl.c", 169, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb171:
    ...
    assume {:sourceloc "html5_webgl.c", 170, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.41, .str.4, 170, __func__.main);
    assume {:sourceloc "html5_webgl.c", 170, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb170:
    ...
    assume {:verifier.code 0} true;
    call $i185 := create_program($i158, $i174);
    call {:cexpr "program"} boogie_si_record_i32($i185);
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
    call $f186 := emscripten_webgl_get_program_parameter_d($i185, 35721);
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb175:
    ...
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.42, .str.4, 176, __func__.main);
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb174:
    ...
    assume {:verifier.code 0} true;
    call $i188 := create_program($i169, $i174);
    call {:cexpr "program2"} boogie_si_record_i32($i188);
    assume {:sourceloc "html5_webgl.c", 180, 22} true;
    assume {:verifier.code 0} true;
    call $p189 := emscripten_webgl_get_program_info_log_utf8($i188);
  ...
  $bb179:
    ...
    assume {:sourceloc "html5_webgl.c", 181, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.43, .str.4, 181, __func__.main);
    assume {:sourceloc "html5_webgl.c", 181, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb183:
    ...
    assume {:sourceloc "html5_webgl.c", 185, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.45, .str.4, 185, __func__.main);
    assume {:sourceloc "html5_webgl.c", 185, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb182:
    ...
    assume {:verifier.code 0} true;
    call glUseProgram($i185);
    assume {:sourceloc "html5_webgl.c", 189, 15} true;
    assume {:verifier.code 0} true;
    call $i193 := glGetUniformLocation($i185, .str.46);
    assume {:sourceloc "html5_webgl.c", 189, 3} true;
    assume {:verifier.code 0} true;
    call glUniform1f($i193, $fp(2, 0, 0));
    assume {:sourceloc "html5_webgl.c", 190, 15} true;
    assume {:verifier.code 0} true;
    call $i194 := glGetUniformLocation($i185, .str.47);
    assume {:sourceloc "html5_webgl.c", 190, 3} true;
    assume {:verifier.code 0} true;
    call glUniform4f($i194, $fp(1, 0, 0), $fp(2, 0, 0), $fp(3, 0, 0), $fp(4, 0, 0));
    assume {:sourceloc "html5_webgl.c", 193, 67} true;
    assume {:verifier.code 0} true;
    call $i195 := glGetUniformLocation($i185, .str.46);
    assume {:sourceloc "html5_webgl.c", 193, 27} true;
    assume {:verifier.code 0} true;
    call $f196 := emscripten_webgl_get_uniform_d($i185, $i195);
    call {:cexpr "vsUniformFloat"} boogie_si_record_float($f196);
  ...
  $bb187:
    ...
    assume {:sourceloc "html5_webgl.c", 194, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.48, .str.4, 194, __func__.main);
    assume {:sourceloc "html5_webgl.c", 194, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb186:
    ...
    assume {:sourceloc "html5_webgl.c", 196, 9} true;
    assume {:verifier.code 0} true;
    call $M.9 := $memset.i8($M.9, $p198, 0, 16, false);
    assume {:sourceloc "html5_webgl.c", 199, 57} true;
    assume {:verifier.code 0} true;
    call $i201 := glGetUniformLocation($i185, .str.47);
    ...
    assume {:verifier.code 0} true;
    call $i204 := emscripten_webgl_get_uniform_v($i185, $i201, $p203, 3, 1);
    call {:cexpr "numElements"} boogie_si_record_i32($i204);
  ...
  $bb191:
    ...
    assume {:sourceloc "html5_webgl.c", 200, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.15, .str.4, 200, __func__.main);
    assume {:sourceloc "html5_webgl.c", 200, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb195:
    ...
    assume {:sourceloc "html5_webgl.c", 201, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.49, .str.4, 201, __func__.main);
    assume {:sourceloc "html5_webgl.c", 201, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb194:
    ...
    call __SMACK_check_memory_safety($p212, $p213);
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb199:
    ...
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.50, .str.4, 202, __func__.main);
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb198:
    ...
    call __SMACK_check_memory_safety($p217, $p218);
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb203:
    ...
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.51, .str.4, 203, __func__.main);
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb202:
    ...
    call __SMACK_check_memory_safety($p222, $p223);
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb207:
    ...
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.52, .str.4, 204, __func__.main);
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb206:
    ...
    assume {:verifier.code 0} true;
    call $i226 := glGetUniformLocation($i185, .str.47);
    ...
    assume {:verifier.code 0} true;
    call $i229 := emscripten_webgl_get_uniform_v($i185, $i226, $p228, 4, 1);
    call {:cexpr "numElements"} boogie_si_record_i32($i229);
  ...
  $bb211:
    ...
    assume {:sourceloc "html5_webgl.c", 208, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.15, .str.4, 208, __func__.main);
    assume {:sourceloc "html5_webgl.c", 208, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb215:
    ...
    assume {:sourceloc "html5_webgl.c", 209, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.49, .str.4, 209, __func__.main);
    assume {:sourceloc "html5_webgl.c", 209, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb214:
    ...
    call __SMACK_check_memory_safety($p237, $p238);
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb219:
    ...
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.50, .str.4, 210, __func__.main);
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb218:
    ...
    call __SMACK_check_memory_safety($p242, $p243);
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb223:
    ...
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.51, .str.4, 211, __func__.main);
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb222:
    ...
    call __SMACK_check_memory_safety($p247, $p248);
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb227:
    ...
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
    call __assert_fail(.str.53, .str.4, 212, __func__.main);
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
...
implementation __VERIFIER_assume(x: i32)
{
  ...
  $bb0:
    ...
    call {:cexpr "__VERIFIER_assume:arg:x"} boogie_si_record_i32(x);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
    assume true;
...
implementation __SMACK_dummy(v: i32)
{
  ...
  $bb0:
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
    call {:cexpr "__SMACK_dummy:arg:v"} boogie_si_record_i32(v);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
    assume true;
...
procedure {:inline} __SMACK_check_memory_leak();
...
procedure {:entrypoint} CorralMain();
  modifies $M.179, $CurrAddr, $M.0, $exn, $M.1, $M.2, $M.3, $M.6, $M.7, $M.8, $M.9, $Alloc, $allocatedCounter, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.18, $M.19, $M.20, $M.21, $M.22, $M.23, $M.24, $M.25, $M.26, $M.27, $M.28, $M.29, $M.30, $M.31, $M.32, $M.33, $M.34, $M.35, $M.36, $M.37, $M.38, $M.39, $M.40, $M.41, $M.42, $M.43, $M.44, $M.45, $M.46, $M.47, $M.48, $M.49, $M.50, $M.51, $M.52, $M.53, $M.54, $M.55, $M.56, $M.57, $M.58, $M.59, $M.60, $M.61, $M.62, $M.63, $M.64, $M.65, $M.66, $M.67, $M.68, $M.69, $M.70, $M.71, $M.72, $M.73, $M.74, $M.75, $M.76, $M.77, $M.78, $M.79, $M.80, $M.81, $M.82, $M.83, $M.84, $M.85, $M.86, $M.87, $M.88, $M.89, $M.90, $M.91, $M.92, $M.93, $M.94, $M.95, $M.96, $M.97, $M.98, $M.99, $M.100, $M.101, $M.102, $M.103, $M.104, $M.105, $M.106, $M.107, $M.108, $M.109, $M.110, $M.111, $M.112, $M.113, $M.114, $M.115, $M.116, $M.117, $M.118, $M.119, $M.120, $M.121, $M.122, $M.123, $M.124, $M.125, $M.126, $M.127, $M.128, $M.129, $M.130, $M.131, $M.132, $M.133, $M.134, $M.135, $M.136, $M.137, $M.138, $M.139, $M.140, $M.141, $M.142, $M.143, $M.144, $M.145, $M.146, $M.147, $M.148, $M.149, $M.150, $M.151, $M.152, $M.153, $M.154, $M.155, $M.156, $M.157, $M.158, $M.159, $M.160, $M.161, $M.162, $M.163, $M.164, $M.165, $M.166, $M.167, $M.168, $M.169, $M.170, $M.171, $M.172, $M.173, $M.174, $M.175, $M.176, $M.177, $M.178, $M.180;



implementation CorralMain()
{
  var shaderType_compile_shader: i32;
  var src_compile_shader: ref;
  var $r_compile_shader: i32;
  var vertexShader_create_program: i32;
  var fragmentShader_create_program: i32;
  var $r_create_program: i32;
  var $r_main: i32;
  var $p0_free_: ref;
  ...
  var n_$alloc: ref;
  var p_$alloc: ref;
  var $p0___SMACK_check_memory_safety: ref;
  var $p1___SMACK_check_memory_safety: ref;
  var n_$malloc: ref;
  var p_$malloc: ref;
  var base_addr_$galloc: ref;
  var size_$galloc: ref;
  var p_$free: ref;
  var M_$memset.i8: [ref]i8;
  var dst_$memset.i8: ref;
  var val_$memset.i8: i8;
  var len_$memset.i8: ref;
  var isvolatile_$memset.i8: bool;
  var M.ret_$memset.i8: [ref]i8;

  CorralMainStart:
    assume true;
    call {:ConcretizeConstantName "$M.179"} $M.179 := unknown_ref();
    call {:ConcretizeConstantName "$CurrAddr"} $CurrAddr := unknown_ref();
    goto L_BAF_0, L_BAF_1, L_BAF_2, L_BAF_3, L_BAF_4, L_BAF_5, L_BAF_6, L_BAF_7, L_BAF_8, L_BAF_9, L_BAF_10, L_BAF_11, L_BAF_12, L_BAF_13, L_BAF_14, L_BAF_15, L_BAF_16;
  ...
  L_BAF_15:
    assume __block_call_$memset.i8;
    call {:ConcretizeConstantName "dst_$memset.i8"} dst_$memset.i8 := unknown_ref();
    call {:ConcretizeConstantName "len_$memset.i8"} len_$memset.i8 := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} M.ret_$memset.i8 := $memset.i8(M_$memset.i8, dst_$memset.i8, val_$memset.i8, len_$memset.i8, isvolatile_$memset.i8);
    return;
  ...
  L_BAF_9:
    assume __block_call___SMACK_check_memory_safety;
    call {:ConcretizeConstantName "$p0___SMACK_check_memory_safety"} $p0___SMACK_check_memory_safety := unknown_ref();
    call {:ConcretizeConstantName "$p1___SMACK_check_memory_safety"} $p1___SMACK_check_memory_safety := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} __SMACK_check_memory_safety($p0___SMACK_check_memory_safety, $p1___SMACK_check_memory_safety);
    return;
  ...
  L_BAF_7:
    ...
    assume MustReach(true);
    call {:AvhEntryPoint} __SMACK_check_overflow(flag___SMACK_check_overflow);
    return;

  L_BAF_6:
    assume __block_call___SMACK_dummy;
    assume MustReach(true);
    call {:AvhEntryPoint} __SMACK_dummy(v___SMACK_dummy);
    return;

  L_BAF_5:
    assume __block_call___VERIFIER_assume;
    assume MustReach(true);
    call {:AvhEntryPoint} __VERIFIER_assume(x___VERIFIER_assume);
    return;

  L_BAF_4:
    assume __block_call_free_;
    call {:ConcretizeConstantName "$p0_free_"} $p0_free_ := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} free_($p0_free_);
    return;
  ...
  L_BAF_2:
    assume __block_call_create_program;
    assume MustReach(true);
    call {:AvhEntryPoint} $r_create_program := create_program(vertexShader_create_program, fragmentShader_create_program);
    return;

  L_BAF_1:
    assume __block_call_compile_shader;
    call {:ConcretizeConstantName "src_compile_shader"} src_compile_shader := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_compile_shader := compile_shader(shaderType_compile_shader, src_compile_shader);
    return;
