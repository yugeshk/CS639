...
// via /usr/local/bin/smack --no-verify --clang-options=-target wasm32-unknown-emscripten -D__EMSCRIPTEN_major__=1 -D__EMSCRIPTEN_minor__=39 -D__EMSCRIPTEN_tiny__=6 -D_LIBCPP_ABI_VERSION=2 -Dunix -D__unix -D__unix__ -Werror=implicit-function-declaration -Xclang -nostdsysteminc -Xclang -isystem/home/user/emsdk/upstream/emscripten/system/include/libcxx -Xclang -isystem/home/user/emsdk/upstream/emscripten/system/lib/libcxxabi/include -Xclang -isystem/home/user/emsdk/upstream/emscripten/system/include/compat -Xclang -isystem/home/user/emsdk/upstream/emscripten/system/include -Xclang -isystem/home/user/emsdk/upstream/emscripten/system/include/libc -Xclang -isystem/home/user/emsdk/upstream/emscripten/system/lib/libc/musl/arch/emscripten -Xclang -isystem/home/user/emsdk/upstream/emscripten/system/local/include -Xclang -isystem/root/.emscripten_cache/wasm-obj/include -DEMSCRIPTEN -Xclang -isystem/home/user/emsdk/upstream/emscripten/system/include/SDL -mllvm -combiner-global-alias-analysis=false -mllvm -enable-emscripten-sjlj -mllvm -disable-lsr -I/home/user/emscripten/system/include --check=memory-safety -bpl html5_webgl.bpl html5_webgl.c
...
procedure  compile_shader(shaderType: i32, src: ref)
  returns ($r: i32)
{
  var $p0: ref;
  var $p1: ref;
...
procedure  glCreateShader($i0: i32)
  returns ($r: i32);
...
procedure  create_program(vertexShader: i32, fragmentShader: i32)
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
...
procedure  emscripten_webgl_get_parameter_d($i0: i32)
  returns ($r: float);
...
procedure  emscripten_webgl_get_parameter_v($i0: i32, $p1: ref, $i2: i32, $i3: i32)
  returns ($r: i32);
...
procedure  emscripten_webgl_get_vertex_attrib_d($i0: i32, $i1: i32)
  returns ($r: float);
...
procedure  emscripten_webgl_get_vertex_attrib_v($i0: i32, $i1: i32, $p2: ref, $i3: i32, $i4: i32)
  returns ($r: i32);
...
procedure  glGetUniformLocation($i0: i32, $p1: ref)
  returns ($r: i32);
...
procedure  emscripten_webgl_get_uniform_d($i0: i32, $i1: i32)
  returns ($r: float);
const emscripten_webgl_get_uniform_v: ref;
axiom (emscripten_webgl_get_uniform_v == $sub.ref(0, 115866));
procedure  emscripten_webgl_get_uniform_v($i0: i32, $i1: i32, $p2: ref, $i3: i32, $i4: i32)
  returns ($r: i32);
