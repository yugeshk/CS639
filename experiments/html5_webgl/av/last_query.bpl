...
procedure CorralMain();
  ...
  free requires {:BlockingConstraint 2} (forall x_15: ref :: unknownTrigger_3(x_15) ==> $slt.ref.bool($0.ref, x_15));
  modifies $Alloc, assertsPassed;
