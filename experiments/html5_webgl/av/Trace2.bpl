...
implementation $global_allocations()
{
  ...
  anon0:
    ...
    call {:si_unique_call 1} $galloc(compile_shader, 4);
    call {:si_unique_call 2} $galloc(glCreateShader, 4);
    call {:si_unique_call 3} $galloc(glShaderSource, 4);
    call {:si_unique_call 4} $galloc(glCompileShader, 4);
    call {:si_unique_call 5} $galloc(__func__.main, 5);
    call {:si_unique_call 6} $galloc(.str.5, 23);
    call {:si_unique_call 7} $galloc(.str.1, 7);
    call {:si_unique_call 8} $galloc(.str.9, 9);
    call {:si_unique_call 9} $galloc(.str.4, 14);
    call {:si_unique_call 10} $galloc(.str.6, 6);
    call {:si_unique_call 11} $galloc(.str.7, 33);
    call {:si_unique_call 12} $galloc(.str.8, 52);
    call {:si_unique_call 13} $galloc(.str, 5);
    call {:si_unique_call 14} $galloc(.str.2, 8);
    call {:si_unique_call 15} $galloc(.str.3, 11);
    call {:si_unique_call 16} $galloc(.str.10, 65);
    call {:si_unique_call 17} $galloc(.str.11, 8);
    call {:si_unique_call 18} $galloc(.str.12, 6);
    call {:si_unique_call 19} $galloc(.str.13, 30);
    call {:si_unique_call 20} $galloc(.str.14, 15);
    call {:si_unique_call 21} $galloc(.str.15, 17);
    call {:si_unique_call 22} $galloc(.str.16, 17);
    call {:si_unique_call 23} $galloc(.str.17, 17);
    call {:si_unique_call 24} $galloc(.str.18, 17);
    call {:si_unique_call 25} $galloc(.str.19, 17);
    call {:si_unique_call 26} $galloc(.str.20, 17);
    call {:si_unique_call 27} $galloc(.str.21, 15);
    call {:si_unique_call 28} $galloc(.str.22, 16);
    call {:si_unique_call 29} $galloc(.str.23, 16);
    call {:si_unique_call 30} $galloc(.str.24, 16);
    call {:si_unique_call 31} $galloc(.str.25, 16);
    call {:si_unique_call 32} $galloc(.str.26, 16);
    call {:si_unique_call 33} $galloc(.str.27, 16);
    call {:si_unique_call 34} $galloc(.str.28, 86);
    call {:si_unique_call 35} $galloc(main.vertex_shader, 169);
    call {:si_unique_call 36} $galloc(.str.29, 67);
    call {:si_unique_call 37} $galloc(.str.30, 68);
    call {:si_unique_call 38} $galloc(.str.31, 80);
    call {:si_unique_call 39} $galloc(.str.32, 4);
    call {:si_unique_call 40} $galloc(.str.33, 10);
    call {:si_unique_call 41} $galloc(.str.34, 30);
    call {:si_unique_call 42} $galloc(main.failing_shader, 130);
    call {:si_unique_call 43} $galloc(.str.35, 17);
    call {:si_unique_call 44} $galloc(.str.36, 37);
    call {:si_unique_call 45} $galloc(main.fragment_shader, 130);
    call {:si_unique_call 46} $galloc(.str.37, 67);
    call {:si_unique_call 47} $galloc(.str.38, 68);
    call {:si_unique_call 48} $galloc(.str.39, 82);
    call {:si_unique_call 49} $galloc(.str.40, 8);
    call {:si_unique_call 50} $galloc(.str.41, 28);
    call {:si_unique_call 51} $galloc(.str.42, 77);
    call {:si_unique_call 52} $galloc(.str.43, 11);
    call {:si_unique_call 53} $galloc(glAttachShader, 4);
    call {:si_unique_call 54} $galloc(glBindAttribLocation, 4);
    call {:si_unique_call 55} $galloc(glLinkProgram, 4);
    call {:si_unique_call 56} $galloc(main, 4);
    call {:si_unique_call 57} $galloc(.str.44, 7);
    call {:si_unique_call 58} $galloc(emscripten_webgl_init_context_attributes, 4);
    call {:si_unique_call 59} $galloc(emscripten_webgl_create_context, 4);
    call {:si_unique_call 60} $galloc(emscripten_webgl_make_context_current, 4);
    call {:si_unique_call 61} $galloc(emscripten_webgl_get_supported_extensions, 4);
    call {:si_unique_call 62} $galloc(__assert_fail, 4);
    call {:si_unique_call 63} $galloc(strlen, 4);
    call {:si_unique_call 64} $galloc(strstr, 4);
    call {:si_unique_call 65} $galloc(.str.45, 34);
    call {:si_unique_call 66} $galloc(.str.46, 15);
    call {:si_unique_call 67} $galloc(.str.47, 13);
    call {:si_unique_call 68} $galloc(.str.48, 22);
    call {:si_unique_call 69} $galloc(.str.49, 24);
    call {:si_unique_call 70} $galloc(.str.50, 24);
    call {:si_unique_call 71} $galloc(.str.51, 24);
    call {:si_unique_call 72} $galloc(.str.52, 24);
    call {:si_unique_call 73} $galloc(.str.53, 24);
    call {:si_unique_call 74} $galloc(glUseProgram, 4);
    call {:si_unique_call 75} $galloc(glGetUniformLocation, 4);
    call {:si_unique_call 76} $galloc(glUniform1f, 4);
    call {:si_unique_call 77} $galloc(glUniform4f, 4);
    call {:si_unique_call 78} $galloc(.str.24.77, 28);
    call {:si_unique_call 79} $galloc(.str.25.78, 26);
    call {:si_unique_call 80} $galloc(env_value_str, 4);
    call {:si_unique_call 81} $galloc(.str.2.79, 3);
    call {:si_unique_call 82} $galloc(.str.80, 49);
    call {:si_unique_call 83} $galloc(.str.1.81, 14);
    call {:si_unique_call 84} $galloc(errno_global, 4);
    call {:si_unique_call 85} $galloc(create_program, 4);
    call {:si_unique_call 86} $galloc(glCreateProgram, 4);
    call {:si_unique_call 87} $galloc(__SMACK_decls, 4);
    call {:si_unique_call 88} $galloc(__SMACK_top_decl, 4);
    call {:si_unique_call 89} $galloc(__SMACK_check_memory_safety, 4);
    call {:si_unique_call 90} $galloc(__SMACK_check_memory_leak, 4);
    call {:si_unique_call 91} $galloc(__SMACK_init_func_memory_model, 4);
    call {:si_unique_call 92} $galloc(free_, 4);
    call {:si_unique_call 93} $galloc(emscripten_webgl_get_parameter_d, 4);
    call {:si_unique_call 94} $galloc(glGenBuffers, 4);
    call {:si_unique_call 95} $galloc(glBindBuffer, 4);
    call {:si_unique_call 96} $galloc(emscripten_webgl_get_parameter_o, 4);
    call {:si_unique_call 97} $galloc(emscripten_webgl_get_parameter_utf8, 4);
    call {:si_unique_call 98} $galloc(emscripten_webgl_get_parameter_i64v, 4);
    call {:si_unique_call 99} $galloc(glViewport, 4);
    call {:si_unique_call 100} $galloc(llvm.memset.p0i8.i32, 4);
    call {:si_unique_call 101} $galloc(emscripten_webgl_get_parameter_v, 4);
    call {:si_unique_call 102} $galloc(glEnableVertexAttribArray, 4);
    call {:si_unique_call 103} $galloc(emscripten_webgl_get_vertex_attrib_d, 4);
    call {:si_unique_call 104} $galloc(glVertexAttrib4f, 4);
    call {:si_unique_call 105} $galloc(emscripten_webgl_get_vertex_attrib_v, 4);
    call {:si_unique_call 106} $galloc(glBufferData, 4);
    call {:si_unique_call 107} $galloc(glVertexAttribPointer, 4);
    call {:si_unique_call 108} $galloc(emscripten_webgl_get_vertex_attrib_o, 4);
    call {:si_unique_call 109} $galloc(emscripten_webgl_get_shader_parameter_d, 4);
    call {:si_unique_call 110} $galloc(emscripten_webgl_get_shader_source_utf8, 4);
    call {:si_unique_call 111} $galloc(emscripten_webgl_get_shader_info_log_utf8, 4);
    call {:si_unique_call 112} $galloc(emscripten_webgl_get_program_parameter_d, 4);
    call {:si_unique_call 113} $galloc(emscripten_webgl_get_program_info_log_utf8, 4);
    call {:si_unique_call 114} $galloc(emscripten_webgl_get_uniform_d, 4);
    call {:si_unique_call 115} $galloc(emscripten_webgl_get_uniform_v, 4);
    call {:si_unique_call 116} $galloc(__VERIFIER_assume, 4);
    call {:si_unique_call 117} $galloc(__SMACK_code, 4);
    call {:si_unique_call 118} $galloc(__SMACK_nondet_unsigned_long_long, 4);
    call {:si_unique_call 119} $galloc(__SMACK_nondet_unsigned_long_long_int, 4);
    call {:si_unique_call 120} $galloc(__SMACK_dummy, 4);
    call {:si_unique_call 121} $galloc(__SMACK_check_overflow, 4);
    call {:si_unique_call 122} $galloc(__SMACK_nondet_char, 4);
    call {:si_unique_call 123} $galloc(__SMACK_nondet_signed_int, 4);
    call {:si_unique_call 124} $galloc(__SMACK_nondet_signed_char, 4);
    call {:si_unique_call 125} $galloc(__SMACK_nondet_unsigned_char, 4);
    call {:si_unique_call 126} $galloc(__SMACK_nondet_short, 4);
    call {:si_unique_call 127} $galloc(__SMACK_nondet_signed_short, 4);
    call {:si_unique_call 128} $galloc(__SMACK_nondet_signed_short_int, 4);
    call {:si_unique_call 129} $galloc(__SMACK_nondet_unsigned_short, 4);
    call {:si_unique_call 130} $galloc(__SMACK_nondet_unsigned_short_int, 4);
    call {:si_unique_call 131} $galloc(__SMACK_nondet_int, 4);
    call {:si_unique_call 132} $galloc(__SMACK_nondet_unsigned, 4);
    call {:si_unique_call 133} $galloc(__SMACK_nondet_unsigned_int, 4);
    call {:si_unique_call 134} $galloc(__SMACK_nondet_long, 4);
    call {:si_unique_call 135} $galloc(__SMACK_nondet_long_int, 4);
    call {:si_unique_call 136} $galloc(__SMACK_nondet_signed_long, 4);
    call {:si_unique_call 137} $galloc(__SMACK_nondet_signed_long_int, 4);
    call {:si_unique_call 138} $galloc(__SMACK_nondet_unsigned_long, 4);
    call {:si_unique_call 139} $galloc(__SMACK_nondet_unsigned_long_int, 4);
    call {:si_unique_call 140} $galloc(__SMACK_nondet_long_long, 4);
    call {:si_unique_call 141} $galloc(__SMACK_nondet_long_long_int, 4);
    call {:si_unique_call 142} $galloc(__SMACK_nondet_signed_long_long, 4);
    call {:si_unique_call 143} $galloc(__SMACK_nondet_signed_long_long_int, 4);
    call {:si_unique_call 144} $galloc(llvm.dbg.value, 4);
    call {:si_unique_call 145} $galloc(__SMACK_static_init, 4);
    return;
}
...
procedure compile_shader(shaderType: i32, src: ref) returns ($r: i32);
  modifies $M.0, $CurrAddr, $Alloc;



implementation compile_shader(shaderType: i32, src: ref) returns ($r: i32)
{
  var $p0: ref;
  var $p1: ref;
  var $p2: ref;
  ...
  $bb0:
    assume {:sourceloc "html5_webgl.c", 11, 19} true;
    assume {:verifier.code 0} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 146} $p0 := $alloc($mul.ref(4, 1));
    call {:si_unique_call 147} {:cexpr "compile_shader:arg:shaderType"} boogie_si_record_i32(shaderType);
    $p1 := $bitcast.ref.ref($p0);
    $p2 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 148} __SMACK_check_memory_safety($p1, $p2);
    assume {:verifier.code 0} true;
    $M.0 := $store.ref($M.0, $p0, src);
    assume {:sourceloc "html5_webgl.c", 11, 19} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 149} $i3 := glCreateShader(shaderType);
    call {:si_unique_call 150} {:cexpr "shader"} boogie_si_record_i32($i3);
    assume {:sourceloc "html5_webgl.c", 12, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 151} glShaderSource($i3, 1, $p0, $0.ref);
    assume {:sourceloc "html5_webgl.c", 13, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 152} glCompileShader($i3);
    assume {:sourceloc "html5_webgl.c", 14, 3} true;
    assume {:verifier.code 0} true;
    $r := $i3;
    return;
}
...
procedure glCreateShader($i0: i32) returns ($r: i32);
...
procedure glShaderSource($i0: i32, $i1: i32, $p2: ref, $p3: ref);
...
procedure glCompileShader($i0: i32);
...
procedure create_program(vertexShader: i32, fragmentShader: i32) returns ($r: i32);



implementation create_program(vertexShader: i32, fragmentShader: i32) returns ($r: i32)
{
  var $i0: i32;

  $bb0:
    assume {:sourceloc "html5_webgl.c", 19, 21} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 153} {:cexpr "create_program:arg:vertexShader"} boogie_si_record_i32(vertexShader);
    call {:si_unique_call 154} {:cexpr "create_program:arg:fragmentShader"} boogie_si_record_i32(fragmentShader);
    assume {:sourceloc "html5_webgl.c", 19, 21} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 155} $i0 := glCreateProgram();
    call {:si_unique_call 156} {:cexpr "program"} boogie_si_record_i32($i0);
    assume {:sourceloc "html5_webgl.c", 20, 4} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 157} glAttachShader($i0, vertexShader);
    assume {:sourceloc "html5_webgl.c", 21, 4} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 158} glAttachShader($i0, fragmentShader);
    assume {:sourceloc "html5_webgl.c", 22, 4} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 159} glBindAttribLocation($i0, 0, .str);
    assume {:sourceloc "html5_webgl.c", 23, 4} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 160} glBindAttribLocation($i0, 1, .str.1);
    assume {:sourceloc "html5_webgl.c", 24, 4} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 161} glLinkProgram($i0);
    assume {:sourceloc "html5_webgl.c", 25, 4} true;
    assume {:verifier.code 0} true;
    $r := $i0;
    return;
}
...
procedure glCreateProgram() returns ($r: i32);
...
procedure glAttachShader($i0: i32, $i1: i32);
...
procedure glBindAttribLocation($i0: i32, $i1: i32, $p2: ref);
...
procedure glLinkProgram($i0: i32);
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    call {:si_unique_call 162} $initialize();
    assume {:sourceloc "html5_webgl.c", 31, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 163} {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
    assume {:verifier.code 0} true;
    call {:si_unique_call 164} $p0 := $alloc($mul.ref(56, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 165} $p1 := $alloc($mul.ref(4, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 166} $p2 := $alloc($mul.ref(8, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 167} $p3 := $alloc($mul.ref(16, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 168} $p4 := $alloc($mul.ref(16, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 169} $p5 := $alloc($mul.ref(16, 1));
    assume {:sourceloc "html5_webgl.c", 31, 3} true;
    assume {:verifier.code 0} true;
    ...
    call {:si_unique_call 171} __SMACK_check_memory_safety($p7, $p8);
    ...
    call {:si_unique_call 172} __SMACK_check_memory_safety($p10, $p11);
    ...
    call {:si_unique_call 173} __SMACK_check_memory_safety($p13, $p14);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 177} $p17 := emscripten_webgl_get_supported_extensions();
  ...
  $bb3:
    ...
    assume {:sourceloc "html5_webgl.c", 40, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 178} __assert_fail(.str.3, .str.4, 40, __func__.main);
    assume {:sourceloc "html5_webgl.c", 40, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb7:
    ...
    assume {:sourceloc "html5_webgl.c", 41, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 180} __assert_fail(.str.5, .str.4, 41, __func__.main);
    assume {:sourceloc "html5_webgl.c", 41, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb5:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 181} $p21 := strstr($p17, .str.6);
  ...
  $bb11:
    ...
    assume {:sourceloc "html5_webgl.c", 42, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 182} __assert_fail(.str.7, .str.4, 42, __func__.main);
    assume {:sourceloc "html5_webgl.c", 42, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb9:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 183} free_($p17);
    assume {:sourceloc "html5_webgl.c", 46, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 184} $f23 := emscripten_webgl_get_parameter_d(3412);
    assume {:sourceloc "html5_webgl.c", 46, 3} true;
    assume {:verifier.code 0} true;
    $i24 := (if $foeq.float.bool($f23, $fp(8, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 46, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb15:
    ...
    assume {:sourceloc "html5_webgl.c", 46, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 185} __assert_fail(.str.8, .str.4, 46, __func__.main);
    assume {:sourceloc "html5_webgl.c", 46, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb13:
    ...
    assume {:verifier.code 0} true;
    assume $i24 == 1;
    assume {:sourceloc "html5_webgl.c", 50, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 186} glGenBuffers(1, $p1);
    $p25 := $bitcast.ref.ref($p1);
    $p26 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 187} __SMACK_check_memory_safety($p25, $p26);
    assume {:sourceloc "html5_webgl.c", 51, 3} true;
    assume {:verifier.code 0} true;
    $i27 := $load.i32($M.5, $p1);
    assume {:sourceloc "html5_webgl.c", 51, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb19:
    ...
    assume {:sourceloc "html5_webgl.c", 51, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 188} __assert_fail(.str.9, .str.4, 51, __func__.main);
    assume {:sourceloc "html5_webgl.c", 51, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb17:
    ...
    call {:si_unique_call 189} __SMACK_check_memory_safety($p29, $p30);
    assume {:sourceloc "html5_webgl.c", 52, 33} true;
    assume {:verifier.code 0} true;
    $i31 := $load.i32($M.5, $p1);
    assume {:sourceloc "html5_webgl.c", 52, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 190} glBindBuffer(34962, $i31);
    assume {:sourceloc "html5_webgl.c", 53, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 191} $i32 := emscripten_webgl_get_parameter_o(34964);
    $p33 := $bitcast.ref.ref($p1);
    $p34 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 192} __SMACK_check_memory_safety($p33, $p34);
    assume {:sourceloc "html5_webgl.c", 53, 3} true;
    assume {:verifier.code 0} true;
    $i35 := $load.i32($M.5, $p1);
    assume {:sourceloc "html5_webgl.c", 53, 3} true;
  ...
  $bb23:
    ...
    assume {:sourceloc "html5_webgl.c", 53, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 193} __assert_fail(.str.10, .str.4, 53, __func__.main);
    assume {:sourceloc "html5_webgl.c", 53, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb21:
    ...
    assume {:verifier.code 0} true;
    assume $i36 == 1;
    assume {:sourceloc "html5_webgl.c", 56, 19} true;
    assume {:verifier.code 0} true;
    call {:ConcretizeCallId 0} {:si_unique_call 194} $p37 := emscripten_webgl_get_parameter_utf8(7938);
    assume unknownTrigger_0($p37);
    assume $isExternal($p37);
    assume {:sourceloc "html5_webgl.c", 57, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb27:
    ...
    assume {:sourceloc "html5_webgl.c", 57, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 195} __assert_fail(.str.11, .str.4, 57, __func__.main);
    assume {:sourceloc "html5_webgl.c", 57, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb25:
    ...
    assume {:verifier.code 0} true;
    assume $i38 == 1;
    assume {:sourceloc "html5_webgl.c", 58, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 196} $p39 := strstr($p37, .str.12);
  ...
  $bb31:
    ...
    assume {:sourceloc "html5_webgl.c", 58, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 197} __assert_fail(.str.13, .str.4, 58, __func__.main);
    assume {:sourceloc "html5_webgl.c", 58, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb29:
    ...
    assume {:verifier.code 0} true;
    assume $i40 == 1;
    assume {:sourceloc "html5_webgl.c", 59, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 198} free_($p37);
    $p41 := $bitcast.ref.ref($p2);
    $p42 := $bitcast.ref.ref($i2p.i64.ref(8));
    call {:si_unique_call 199} __SMACK_check_memory_safety($p41, $p42);
    assume {:sourceloc "html5_webgl.c", 62, 11} true;
    assume {:verifier.code 0} true;
    $M.6 := $store.i64($M.6, $p2, 0);
    assume {:sourceloc "html5_webgl.c", 63, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 200} emscripten_webgl_get_parameter_i64v(35377, $p2);
    $p43 := $bitcast.ref.ref($p2);
    $p44 := $bitcast.ref.ref($i2p.i64.ref(8));
    call {:si_unique_call 201} __SMACK_check_memory_safety($p43, $p44);
    assume {:sourceloc "html5_webgl.c", 64, 3} true;
    assume {:verifier.code 0} true;
    $i45 := $load.i64($M.6, $p2);
    assume {:sourceloc "html5_webgl.c", 64, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb35:
    ...
    assume {:sourceloc "html5_webgl.c", 64, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 202} __assert_fail(.str.14, .str.4, 64, __func__.main);
    assume {:sourceloc "html5_webgl.c", 64, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb33:
    ...
    assume {:verifier.code 0} true;
    assume $i46 == 1;
    assume {:sourceloc "html5_webgl.c", 67, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 203} glViewport(1, 2, 3, 4);
    assume {:sourceloc "html5_webgl.c", 68, 7} true;
    assume {:verifier.code 0} true;
    $p47 := $bitcast.ref.ref($p3);
    $p48 := $bitcast.ref.ref($p3);
    $p49 := $i2p.i32.ref(16);
    call {:si_unique_call 204} __SMACK_check_memory_safety($p48, $p49);
    assume {:sourceloc "html5_webgl.c", 68, 7} true;
    assume {:verifier.code 0} true;
    cmdloc_dummy_var_0 := $M.7;
    call {:si_unique_call 205} cmdloc_dummy_var_1 := $memset.i8(cmdloc_dummy_var_0, $p47, 0, 16, false);
    $M.7 := cmdloc_dummy_var_1;
    assume {:sourceloc "html5_webgl.c", 69, 67} true;
    assume {:verifier.code 0} true;
    $p50 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 4));
    assume {:sourceloc "html5_webgl.c", 69, 67} true;
    assume {:verifier.code 0} true;
    $p51 := $bitcast.ref.ref($p50);
    assume {:sourceloc "html5_webgl.c", 69, 21} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 206} $i52 := emscripten_webgl_get_parameter_v(2978, $p51, 3, 0);
    call {:si_unique_call 207} {:cexpr "numElements"} boogie_si_record_i32($i52);
    assume {:sourceloc "html5_webgl.c", 70, 3} true;
    assume {:verifier.code 0} true;
    $i53 := $eq.i32($i52, 4);
    assume {:sourceloc "html5_webgl.c", 70, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb39:
    ...
    assume {:sourceloc "html5_webgl.c", 70, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 208} __assert_fail(.str.15, .str.4, 70, __func__.main);
    assume {:sourceloc "html5_webgl.c", 70, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb37:
    ...
    assume {:verifier.code 0} true;
    assume $i53 == 1;
    assume {:sourceloc "html5_webgl.c", 71, 3} true;
    assume {:verifier.code 0} true;
    $p54 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 4));
    $p55 := $bitcast.ref.ref($p54);
    $p56 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 209} __SMACK_check_memory_safety($p55, $p56);
    assume {:sourceloc "html5_webgl.c", 71, 3} true;
    assume {:verifier.code 0} true;
    $i57 := $load.i32($M.7, $p54);
    assume {:sourceloc "html5_webgl.c", 71, 3} true;
    assume {:verifier.code 0} true;
    $i58 := $eq.i32($i57, 1);
    assume {:sourceloc "html5_webgl.c", 71, 3} true;
  ...
  $bb43:
    ...
    assume {:sourceloc "html5_webgl.c", 71, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 210} __assert_fail(.str.16, .str.4, 71, __func__.main);
    assume {:sourceloc "html5_webgl.c", 71, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb41:
    ...
    assume {:verifier.code 0} true;
    assume $i58 == 1;
    assume {:sourceloc "html5_webgl.c", 72, 3} true;
    assume {:verifier.code 0} true;
    $p59 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(1, 4));
    $p60 := $bitcast.ref.ref($p59);
    $p61 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 211} __SMACK_check_memory_safety($p60, $p61);
    assume {:sourceloc "html5_webgl.c", 72, 3} true;
    assume {:verifier.code 0} true;
    $i62 := $load.i32($M.7, $p59);
    assume {:sourceloc "html5_webgl.c", 72, 3} true;
    assume {:verifier.code 0} true;
    $i63 := $eq.i32($i62, 2);
    assume {:sourceloc "html5_webgl.c", 72, 3} true;
  ...
  $bb47:
    ...
    assume {:sourceloc "html5_webgl.c", 72, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 212} __assert_fail(.str.17, .str.4, 72, __func__.main);
    assume {:sourceloc "html5_webgl.c", 72, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb45:
    ...
    assume {:verifier.code 0} true;
    assume $i63 == 1;
    assume {:sourceloc "html5_webgl.c", 73, 3} true;
    assume {:verifier.code 0} true;
    $p64 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(2, 4));
    $p65 := $bitcast.ref.ref($p64);
    $p66 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 213} __SMACK_check_memory_safety($p65, $p66);
    assume {:sourceloc "html5_webgl.c", 73, 3} true;
    assume {:verifier.code 0} true;
    $i67 := $load.i32($M.7, $p64);
    assume {:sourceloc "html5_webgl.c", 73, 3} true;
    assume {:verifier.code 0} true;
    $i68 := $eq.i32($i67, 3);
    assume {:sourceloc "html5_webgl.c", 73, 3} true;
  ...
  $bb51:
    ...
    assume {:sourceloc "html5_webgl.c", 73, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 214} __assert_fail(.str.18, .str.4, 73, __func__.main);
    assume {:sourceloc "html5_webgl.c", 73, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb49:
    ...
    assume {:verifier.code 0} true;
    assume $i68 == 1;
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
    assume {:verifier.code 0} true;
    $p69 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(3, 4));
    $p70 := $bitcast.ref.ref($p69);
    $p71 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 215} __SMACK_check_memory_safety($p70, $p71);
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
    assume {:verifier.code 0} true;
    $i72 := $load.i32($M.7, $p69);
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
    assume {:verifier.code 0} true;
    $i73 := $eq.i32($i72, 0);
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
  ...
  $bb55:
    ...
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 216} __assert_fail(.str.19, .str.4, 74, __func__.main);
    assume {:sourceloc "html5_webgl.c", 74, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb53:
    ...
    assume {:verifier.code 0} true;
    assume $i73 == 1;
    assume {:sourceloc "html5_webgl.c", 77, 63} true;
    assume {:verifier.code 0} true;
    $p74 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 4));
    assume {:sourceloc "html5_webgl.c", 77, 63} true;
    assume {:verifier.code 0} true;
    $p75 := $bitcast.ref.ref($p74);
    assume {:sourceloc "html5_webgl.c", 77, 17} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 217} $i76 := emscripten_webgl_get_parameter_v(2978, $p75, 4, 0);
    call {:si_unique_call 218} {:cexpr "numElements"} boogie_si_record_i32($i76);
    assume {:sourceloc "html5_webgl.c", 78, 3} true;
    assume {:verifier.code 0} true;
    $i77 := $eq.i32($i76, 4);
    assume {:sourceloc "html5_webgl.c", 78, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb59:
    ...
    assume {:sourceloc "html5_webgl.c", 78, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 219} __assert_fail(.str.15, .str.4, 78, __func__.main);
    assume {:sourceloc "html5_webgl.c", 78, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb57:
    ...
    assume {:verifier.code 0} true;
    assume $i77 == 1;
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
    assume {:verifier.code 0} true;
    $p78 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 4));
    $p79 := $bitcast.ref.ref($p78);
    $p80 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 220} __SMACK_check_memory_safety($p79, $p80);
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
    assume {:verifier.code 0} true;
    $i81 := $load.i32($M.7, $p78);
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
    assume {:verifier.code 0} true;
    $i82 := $eq.i32($i81, 1);
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
  ...
  $bb63:
    ...
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 221} __assert_fail(.str.16, .str.4, 79, __func__.main);
    assume {:sourceloc "html5_webgl.c", 79, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb61:
    ...
    assume {:verifier.code 0} true;
    assume $i82 == 1;
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
    assume {:verifier.code 0} true;
    $p83 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(1, 4));
    $p84 := $bitcast.ref.ref($p83);
    $p85 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 222} __SMACK_check_memory_safety($p84, $p85);
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
    assume {:verifier.code 0} true;
    $i86 := $load.i32($M.7, $p83);
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
    assume {:verifier.code 0} true;
    $i87 := $eq.i32($i86, 2);
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
  ...
  $bb67:
    ...
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 223} __assert_fail(.str.17, .str.4, 80, __func__.main);
    assume {:sourceloc "html5_webgl.c", 80, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb65:
    ...
    assume {:verifier.code 0} true;
    assume $i87 == 1;
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
    assume {:verifier.code 0} true;
    $p88 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(2, 4));
    $p89 := $bitcast.ref.ref($p88);
    $p90 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 224} __SMACK_check_memory_safety($p89, $p90);
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
    assume {:verifier.code 0} true;
    $i91 := $load.i32($M.7, $p88);
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
    assume {:verifier.code 0} true;
    $i92 := $eq.i32($i91, 3);
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
  ...
  $bb71:
    ...
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 225} __assert_fail(.str.18, .str.4, 81, __func__.main);
    assume {:sourceloc "html5_webgl.c", 81, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb69:
    ...
    assume {:verifier.code 0} true;
    assume $i92 == 1;
    assume {:sourceloc "html5_webgl.c", 82, 3} true;
    assume {:verifier.code 0} true;
    $p93 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(3, 4));
    $p94 := $bitcast.ref.ref($p93);
    $p95 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 226} __SMACK_check_memory_safety($p94, $p95);
    assume {:sourceloc "html5_webgl.c", 82, 3} true;
    assume {:verifier.code 0} true;
    $i96 := $load.i32($M.7, $p93);
    assume {:sourceloc "html5_webgl.c", 82, 3} true;
    assume {:verifier.code 0} true;
    $i97 := $eq.i32($i96, 4);
    assume {:sourceloc "html5_webgl.c", 82, 3} true;
  ...
  $bb75:
    ...
    assume {:sourceloc "html5_webgl.c", 82, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 227} __assert_fail(.str.20, .str.4, 82, __func__.main);
    assume {:sourceloc "html5_webgl.c", 82, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb73:
    ...
    assume {:verifier.code 0} true;
    assume $i97 == 1;
    assume {:sourceloc "html5_webgl.c", 85, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 228} glEnableVertexAttribArray(0);
    assume {:sourceloc "html5_webgl.c", 86, 20} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 229} $f98 := emscripten_webgl_get_vertex_attrib_d(0, 34338);
    call {:si_unique_call 230} {:cexpr "enabled"} boogie_si_record_float($f98);
    assume {:sourceloc "html5_webgl.c", 87, 3} true;
    assume {:verifier.code 0} true;
    $i99 := (if $foeq.float.bool($f98, $fp(1, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 87, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb79:
    ...
    assume {:sourceloc "html5_webgl.c", 87, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 231} __assert_fail(.str.21, .str.4, 87, __func__.main);
    assume {:sourceloc "html5_webgl.c", 87, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb77:
    ...
    assume {:verifier.code 0} true;
    assume $i99 == 1;
    assume {:sourceloc "html5_webgl.c", 90, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 232} glVertexAttrib4f(0, $fp(0, 3, 99999), $fp(0, 3, 99999), $fp(0, 3, 3333340000000), $fp(0, 3, 99999));
    assume {:sourceloc "html5_webgl.c", 91, 9} true;
    assume {:verifier.code 0} true;
    $p100 := $bitcast.ref.ref($p4);
    $p101 := $bitcast.ref.ref($p4);
    $p102 := $i2p.i32.ref(16);
    call {:si_unique_call 233} __SMACK_check_memory_safety($p101, $p102);
    assume {:sourceloc "html5_webgl.c", 91, 9} true;
    assume {:verifier.code 0} true;
    cmdloc_dummy_var_2 := $M.8;
    call {:si_unique_call 234} cmdloc_dummy_var_3 := $memset.i8(cmdloc_dummy_var_2, $p100, 0, 16, false);
    $M.8 := cmdloc_dummy_var_3;
    assume {:sourceloc "html5_webgl.c", 92, 83} true;
    assume {:verifier.code 0} true;
    $p103 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(0, 4));
    assume {:sourceloc "html5_webgl.c", 92, 83} true;
    assume {:verifier.code 0} true;
    $p104 := $bitcast.ref.ref($p103);
    assume {:sourceloc "html5_webgl.c", 92, 17} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 235} $i105 := emscripten_webgl_get_vertex_attrib_v(0, 34342, $p104, 2, 1);
    call {:si_unique_call 236} {:cexpr "numElements"} boogie_si_record_i32($i105);
    assume {:sourceloc "html5_webgl.c", 93, 3} true;
    assume {:verifier.code 0} true;
    $i106 := $eq.i32($i105, 4);
    assume {:sourceloc "html5_webgl.c", 93, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb83:
    ...
    assume {:sourceloc "html5_webgl.c", 93, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 237} __assert_fail(.str.15, .str.4, 93, __func__.main);
    assume {:sourceloc "html5_webgl.c", 93, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb81:
    ...
    assume {:verifier.code 0} true;
    assume $i106 == 1;
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
    $p107 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(0, 4));
    $p108 := $bitcast.ref.ref($p107);
    $p109 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 238} __SMACK_check_memory_safety($p108, $p109);
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
    $f110 := $load.unsafe.float($M.8, $p107);
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
    $i111 := (if $foeq.float.bool($f110, $fp(0, 3, 99999)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb87:
    ...
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 239} __assert_fail(.str.22, .str.4, 94, __func__.main);
    assume {:sourceloc "html5_webgl.c", 94, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb85:
    ...
    assume {:verifier.code 0} true;
    assume $i111 == 1;
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
    $p112 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(1, 4));
    $p113 := $bitcast.ref.ref($p112);
    $p114 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 240} __SMACK_check_memory_safety($p113, $p114);
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
    $f115 := $load.unsafe.float($M.8, $p112);
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
    $i116 := (if $foeq.float.bool($f115, $fp(0, 3, 99999)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb91:
    ...
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 241} __assert_fail(.str.23, .str.4, 95, __func__.main);
    assume {:sourceloc "html5_webgl.c", 95, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb89:
    ...
    assume {:verifier.code 0} true;
    assume $i116 == 1;
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
    $p117 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(2, 4));
    $p118 := $bitcast.ref.ref($p117);
    $p119 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 242} __SMACK_check_memory_safety($p118, $p119);
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
    $f120 := $load.unsafe.float($M.8, $p117);
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
    $i121 := (if $foeq.float.bool($f120, $fp(0, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb95:
    ...
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 243} __assert_fail(.str.24, .str.4, 96, __func__.main);
    assume {:sourceloc "html5_webgl.c", 96, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb93:
    ...
    assume {:verifier.code 0} true;
    assume $i121 == 1;
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
    $p122 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(3, 4));
    $p123 := $bitcast.ref.ref($p122);
    $p124 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 244} __SMACK_check_memory_safety($p123, $p124);
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
    $f125 := $load.unsafe.float($M.8, $p122);
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
    $i126 := (if $foeq.float.bool($f125, $fp(0, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb99:
    ...
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 245} __assert_fail(.str.25, .str.4, 97, __func__.main);
    assume {:sourceloc "html5_webgl.c", 97, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb97:
    ...
    assume {:verifier.code 0} true;
    assume $i126 == 1;
    assume {:sourceloc "html5_webgl.c", 100, 83} true;
    assume {:verifier.code 0} true;
    $p127 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(0, 4));
    assume {:sourceloc "html5_webgl.c", 100, 83} true;
    assume {:verifier.code 0} true;
    $p128 := $bitcast.ref.ref($p127);
    assume {:sourceloc "html5_webgl.c", 100, 17} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 246} $i129 := emscripten_webgl_get_vertex_attrib_v(0, 34342, $p128, 4, 1);
    call {:si_unique_call 247} {:cexpr "numElements"} boogie_si_record_i32($i129);
    assume {:sourceloc "html5_webgl.c", 101, 3} true;
    assume {:verifier.code 0} true;
    $i130 := $eq.i32($i129, 4);
    assume {:sourceloc "html5_webgl.c", 101, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb103:
    ...
    assume {:sourceloc "html5_webgl.c", 101, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 248} __assert_fail(.str.15, .str.4, 101, __func__.main);
    assume {:sourceloc "html5_webgl.c", 101, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb101:
    ...
    assume {:verifier.code 0} true;
    assume $i130 == 1;
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
    $p131 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(0, 4));
    $p132 := $bitcast.ref.ref($p131);
    $p133 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 249} __SMACK_check_memory_safety($p132, $p133);
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
    $f134 := $load.unsafe.float($M.8, $p131);
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
    $i135 := (if $foeq.float.bool($f134, $fp(0, 3, 99999)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb107:
    ...
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 250} __assert_fail(.str.22, .str.4, 102, __func__.main);
    assume {:sourceloc "html5_webgl.c", 102, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb105:
    ...
    assume {:verifier.code 0} true;
    assume $i135 == 1;
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
    $p136 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(1, 4));
    $p137 := $bitcast.ref.ref($p136);
    $p138 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 251} __SMACK_check_memory_safety($p137, $p138);
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
    $f139 := $load.unsafe.float($M.8, $p136);
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
    $i140 := (if $foeq.float.bool($f139, $fp(0, 3, 99999)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb111:
    ...
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 252} __assert_fail(.str.23, .str.4, 103, __func__.main);
    assume {:sourceloc "html5_webgl.c", 103, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb109:
    ...
    assume {:verifier.code 0} true;
    assume $i140 == 1;
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
    $p141 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(2, 4));
    $p142 := $bitcast.ref.ref($p141);
    $p143 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 253} __SMACK_check_memory_safety($p142, $p143);
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
    $f144 := $load.unsafe.float($M.8, $p141);
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
    $i145 := (if $foeq.float.bool($f144, $fp(0, 3, 3333340000000)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb115:
    ...
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 254} __assert_fail(.str.26, .str.4, 104, __func__.main);
    assume {:sourceloc "html5_webgl.c", 104, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb113:
    ...
    assume {:verifier.code 0} true;
    assume $i145 == 1;
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
    $p146 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(3, 4));
    $p147 := $bitcast.ref.ref($p146);
    $p148 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 255} __SMACK_check_memory_safety($p147, $p148);
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
    $f149 := $load.unsafe.float($M.8, $p146);
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
    $i150 := (if $foeq.float.bool($f149, $fp(0, 3, 99999)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb119:
    ...
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 256} __assert_fail(.str.27, .str.4, 105, __func__.main);
    assume {:sourceloc "html5_webgl.c", 105, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb117:
    ...
    assume {:verifier.code 0} true;
    assume $i150 == 1;
    assume {:sourceloc "html5_webgl.c", 108, 36} true;
    assume {:verifier.code 0} true;
    $p151 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(0, 4));
    assume {:sourceloc "html5_webgl.c", 108, 36} true;
    assume {:verifier.code 0} true;
    $p152 := $bitcast.ref.ref($p151);
    assume {:sourceloc "html5_webgl.c", 108, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 257} glBufferData(34962, 4, $p152, 35044);
    assume {:sourceloc "html5_webgl.c", 109, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 258} glVertexAttribPointer(0, 1, 5126, 0, 0, $0.ref);
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 259} $i153 := emscripten_webgl_get_vertex_attrib_o(0, 34975);
    $p154 := $bitcast.ref.ref($p1);
    $p155 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 260} __SMACK_check_memory_safety($p154, $p155);
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
    $i156 := $load.i32($M.5, $p1);
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb123:
    ...
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 261} __assert_fail(.str.28, .str.4, 110, __func__.main);
    assume {:sourceloc "html5_webgl.c", 110, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb121:
    ...
    assume {:verifier.code 0} true;
    assume $i157 == 1;
    assume {:sourceloc "html5_webgl.c", 122, 15} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 262} $i158 := compile_shader(35633, main.vertex_shader);
    call {:si_unique_call 263} {:cexpr "vs"} boogie_si_record_i32($i158);
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 264} $f159 := emscripten_webgl_get_shader_parameter_d($i158, 35712);
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
    $i160 := (if $foeq.float.bool($f159, $fp(0, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb127:
    ...
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 265} __assert_fail(.str.29, .str.4, 125, __func__.main);
    assume {:sourceloc "html5_webgl.c", 125, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb125:
    ...
    assume {:verifier.code 0} true;
    assume $i160 == 1;
    assume {:sourceloc "html5_webgl.c", 126, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 266} $f161 := emscripten_webgl_get_shader_parameter_d($i158, 35713);
    assume {:sourceloc "html5_webgl.c", 126, 3} true;
    assume {:verifier.code 0} true;
    $i162 := (if $foeq.float.bool($f161, $fp(1, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 126, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb131:
    ...
    assume {:sourceloc "html5_webgl.c", 126, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 267} __assert_fail(.str.30, .str.4, 126, __func__.main);
    assume {:sourceloc "html5_webgl.c", 126, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb129:
    ...
    assume {:verifier.code 0} true;
    assume $i162 == 1;
    assume {:sourceloc "html5_webgl.c", 127, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 268} $f163 := emscripten_webgl_get_shader_parameter_d($i158, 35663);
    assume {:sourceloc "html5_webgl.c", 127, 3} true;
    assume {:verifier.code 0} true;
    $i164 := (if $foeq.float.bool($f163, $fp(3, 563300, 4)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 127, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb135:
    ...
    assume {:sourceloc "html5_webgl.c", 127, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 269} __assert_fail(.str.31, .str.4, 127, __func__.main);
    assume {:sourceloc "html5_webgl.c", 127, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb133:
    ...
    assume {:verifier.code 0} true;
    assume $i164 == 1;
    assume {:sourceloc "html5_webgl.c", 130, 15} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 270} $p165 := emscripten_webgl_get_shader_source_utf8($i158);
    assume $isExternal($p165);
    assume {:sourceloc "html5_webgl.c", 131, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb139:
    ...
    assume {:sourceloc "html5_webgl.c", 131, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 271} __assert_fail(.str.32, .str.4, 131, __func__.main);
    assume {:sourceloc "html5_webgl.c", 131, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb137:
    ...
    assume {:verifier.code 0} true;
    assume $i166 == 1;
    assume {:sourceloc "html5_webgl.c", 132, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 272} $p167 := strstr($p165, .str.33);
    assume $isExternal($p167);
    assume {:sourceloc "html5_webgl.c", 132, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb143:
    ...
    assume {:sourceloc "html5_webgl.c", 132, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 273} __assert_fail(.str.34, .str.4, 132, __func__.main);
    assume {:sourceloc "html5_webgl.c", 132, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb141:
    ...
    assume {:verifier.code 0} true;
    assume $i168 == 1;
    assume {:sourceloc "html5_webgl.c", 133, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 274} free_($p165);
    assume {:sourceloc "html5_webgl.c", 144, 16} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 275} $i169 := compile_shader(35633, main.failing_shader);
    call {:si_unique_call 276} {:cexpr "vs2"} boogie_si_record_i32($i169);
    assume {:sourceloc "html5_webgl.c", 147, 9} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 277} $p170 := emscripten_webgl_get_shader_info_log_utf8($i169);
    assume $isExternal($p170);
    assume {:sourceloc "html5_webgl.c", 148, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb147:
    ...
    assume {:sourceloc "html5_webgl.c", 148, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 278} __assert_fail(.str.32, .str.4, 148, __func__.main);
    assume {:sourceloc "html5_webgl.c", 148, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb145:
    ...
    assume {:verifier.code 0} true;
    assume $i171 == 1;
    assume {:sourceloc "html5_webgl.c", 149, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 279} $p172 := strstr($p170, .str.35);
    assume $isExternal($p172);
    assume {:sourceloc "html5_webgl.c", 149, 3} true;
    assume {:verifier.code 0} true;
    $i173 := $ne.ref($p172, $0.ref);
    assume {:sourceloc "html5_webgl.c", 149, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb151:
    ...
    assume {:sourceloc "html5_webgl.c", 149, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 280} __assert_fail(.str.36, .str.4, 149, __func__.main);
    assume {:sourceloc "html5_webgl.c", 149, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb149:
    ...
    assume {:verifier.code 0} true;
    assume $i173 == 1;
    assume {:sourceloc "html5_webgl.c", 150, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 281} free_($p170);
    assume {:sourceloc "html5_webgl.c", 160, 15} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 282} $i174 := compile_shader(35632, main.fragment_shader);
    call {:si_unique_call 283} {:cexpr "fs"} boogie_si_record_i32($i174);
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 284} $f175 := emscripten_webgl_get_shader_parameter_d($i174, 35712);
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
    $i176 := (if $foeq.float.bool($f175, $fp(0, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb155:
    ...
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 285} __assert_fail(.str.37, .str.4, 163, __func__.main);
    assume {:sourceloc "html5_webgl.c", 163, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb153:
    ...
    assume {:verifier.code 0} true;
    assume $i176 == 1;
    assume {:sourceloc "html5_webgl.c", 164, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 286} $f177 := emscripten_webgl_get_shader_parameter_d($i174, 35713);
    assume {:sourceloc "html5_webgl.c", 164, 3} true;
    assume {:verifier.code 0} true;
    $i178 := (if $foeq.float.bool($f177, $fp(1, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 164, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb159:
    ...
    assume {:sourceloc "html5_webgl.c", 164, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 287} __assert_fail(.str.38, .str.4, 164, __func__.main);
    assume {:sourceloc "html5_webgl.c", 164, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb157:
    ...
    assume {:verifier.code 0} true;
    assume $i178 == 1;
    assume {:sourceloc "html5_webgl.c", 165, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 288} $f179 := emscripten_webgl_get_shader_parameter_d($i174, 35663);
    assume {:sourceloc "html5_webgl.c", 165, 3} true;
    assume {:verifier.code 0} true;
    $i180 := (if $foeq.float.bool($f179, $fp(3, 563200, 4)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 165, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb163:
    ...
    assume {:sourceloc "html5_webgl.c", 165, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 289} __assert_fail(.str.39, .str.4, 165, __func__.main);
    assume {:sourceloc "html5_webgl.c", 165, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb161:
    ...
    assume {:verifier.code 0} true;
    assume $i180 == 1;
    assume {:sourceloc "html5_webgl.c", 168, 9} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 290} $p181 := emscripten_webgl_get_shader_source_utf8($i174);
    assume $isExternal($p181);
    assume {:sourceloc "html5_webgl.c", 169, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb167:
    ...
    assume {:sourceloc "html5_webgl.c", 169, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 291} __assert_fail(.str.32, .str.4, 169, __func__.main);
    assume {:sourceloc "html5_webgl.c", 169, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb165:
    ...
    assume {:verifier.code 0} true;
    assume $i182 == 1;
    assume {:sourceloc "html5_webgl.c", 170, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 292} $p183 := strstr($p181, .str.40);
    assume $isExternal($p183);
    assume {:sourceloc "html5_webgl.c", 170, 3} true;
    assume {:verifier.code 0} true;
    $i184 := $ne.ref($p183, $0.ref);
    assume {:sourceloc "html5_webgl.c", 170, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb171:
    ...
    assume {:sourceloc "html5_webgl.c", 170, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 293} __assert_fail(.str.41, .str.4, 170, __func__.main);
    assume {:sourceloc "html5_webgl.c", 170, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb169:
    ...
    assume {:verifier.code 0} true;
    assume $i184 == 1;
    assume {:sourceloc "html5_webgl.c", 171, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 294} free_($p181);
    assume {:sourceloc "html5_webgl.c", 173, 20} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 295} $i185 := create_program($i158, $i174);
    call {:si_unique_call 296} {:cexpr "program"} boogie_si_record_i32($i185);
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 297} $f186 := emscripten_webgl_get_program_parameter_d($i185, 35721);
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
    $i187 := (if $foeq.float.bool($f186, $fp(2, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb175:
    ...
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 298} __assert_fail(.str.42, .str.4, 176, __func__.main);
    assume {:sourceloc "html5_webgl.c", 176, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb173:
    ...
    assume {:verifier.code 0} true;
    assume $i187 == 1;
    assume {:sourceloc "html5_webgl.c", 179, 21} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 299} $i188 := create_program($i169, $i174);
    call {:si_unique_call 300} {:cexpr "program2"} boogie_si_record_i32($i188);
    assume {:sourceloc "html5_webgl.c", 180, 22} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 301} $p189 := emscripten_webgl_get_program_info_log_utf8($i188);
    assume $isExternal($p189);
    assume {:sourceloc "html5_webgl.c", 181, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb179:
    ...
    assume {:sourceloc "html5_webgl.c", 181, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 302} __assert_fail(.str.43, .str.4, 181, __func__.main);
    assume {:sourceloc "html5_webgl.c", 181, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb177:
    ...
    assume {:verifier.code 0} true;
    assume $i190 == 1;
    assume {:sourceloc "html5_webgl.c", 185, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 303} $p191 := strstr($p189, .str.44);
    assume $isExternal($p191);
    assume {:sourceloc "html5_webgl.c", 185, 3} true;
    assume {:verifier.code 0} true;
    $i192 := $ne.ref($p191, $0.ref);
    assume {:sourceloc "html5_webgl.c", 185, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb183:
    ...
    assume {:sourceloc "html5_webgl.c", 185, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 304} __assert_fail(.str.45, .str.4, 185, __func__.main);
    assume {:sourceloc "html5_webgl.c", 185, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb181:
    ...
    assume {:verifier.code 0} true;
    assume $i192 == 1;
    assume {:sourceloc "html5_webgl.c", 186, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 305} free_($p189);
    assume {:sourceloc "html5_webgl.c", 188, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 306} glUseProgram($i185);
    assume {:sourceloc "html5_webgl.c", 189, 15} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 307} $i193 := glGetUniformLocation($i185, .str.46);
    assume {:sourceloc "html5_webgl.c", 189, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 308} glUniform1f($i193, $fp(2, 0, 0));
    assume {:sourceloc "html5_webgl.c", 190, 15} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 309} $i194 := glGetUniformLocation($i185, .str.47);
    assume {:sourceloc "html5_webgl.c", 190, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 310} glUniform4f($i194, $fp(1, 0, 0), $fp(2, 0, 0), $fp(3, 0, 0), $fp(4, 0, 0));
    assume {:sourceloc "html5_webgl.c", 193, 67} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 311} $i195 := glGetUniformLocation($i185, .str.46);
    assume {:sourceloc "html5_webgl.c", 193, 27} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 312} $f196 := emscripten_webgl_get_uniform_d($i185, $i195);
    call {:si_unique_call 313} {:cexpr "vsUniformFloat"} boogie_si_record_float($f196);
    assume {:sourceloc "html5_webgl.c", 194, 3} true;
    assume {:verifier.code 0} true;
    $i197 := (if $foeq.float.bool($f196, $fp(2, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 194, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb187:
    ...
    assume {:sourceloc "html5_webgl.c", 194, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 314} __assert_fail(.str.48, .str.4, 194, __func__.main);
    assume {:sourceloc "html5_webgl.c", 194, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb185:
    ...
    assume {:verifier.code 0} true;
    assume $i197 == 1;
    assume {:sourceloc "html5_webgl.c", 196, 9} true;
    assume {:verifier.code 0} true;
    $p198 := $bitcast.ref.ref($p5);
    $p199 := $bitcast.ref.ref($p5);
    $p200 := $i2p.i32.ref(16);
    call {:si_unique_call 315} __SMACK_check_memory_safety($p199, $p200);
    assume {:sourceloc "html5_webgl.c", 196, 9} true;
    assume {:verifier.code 0} true;
    cmdloc_dummy_var_4 := $M.9;
    call {:si_unique_call 316} cmdloc_dummy_var_5 := $memset.i8(cmdloc_dummy_var_4, $p198, 0, 16, false);
    $M.9 := cmdloc_dummy_var_5;
    assume {:sourceloc "html5_webgl.c", 199, 57} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 317} $i201 := glGetUniformLocation($i185, .str.47);
    assume {:sourceloc "html5_webgl.c", 199, 104} true;
    assume {:verifier.code 0} true;
    $p202 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(0, 4));
    assume {:sourceloc "html5_webgl.c", 199, 104} true;
    assume {:verifier.code 0} true;
    $p203 := $bitcast.ref.ref($p202);
    assume {:sourceloc "html5_webgl.c", 199, 17} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 318} $i204 := emscripten_webgl_get_uniform_v($i185, $i201, $p203, 3, 1);
    call {:si_unique_call 319} {:cexpr "numElements"} boogie_si_record_i32($i204);
    assume {:sourceloc "html5_webgl.c", 200, 3} true;
    assume {:verifier.code 0} true;
    $i205 := $eq.i32($i204, 4);
    assume {:sourceloc "html5_webgl.c", 200, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb191:
    ...
    assume {:sourceloc "html5_webgl.c", 200, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 320} __assert_fail(.str.15, .str.4, 200, __func__.main);
    assume {:sourceloc "html5_webgl.c", 200, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb189:
    ...
    assume {:verifier.code 0} true;
    assume $i205 == 1;
    assume {:sourceloc "html5_webgl.c", 201, 3} true;
    assume {:verifier.code 0} true;
    $p206 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(0, 4));
    $p207 := $bitcast.ref.ref($p206);
    $p208 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 321} __SMACK_check_memory_safety($p207, $p208);
    assume {:sourceloc "html5_webgl.c", 201, 3} true;
    assume {:verifier.code 0} true;
    $f209 := $load.unsafe.float($M.9, $p206);
    assume {:sourceloc "html5_webgl.c", 201, 3} true;
    assume {:verifier.code 0} true;
    $i210 := (if $foeq.float.bool($f209, $fp(1, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 201, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb195:
    ...
    assume {:sourceloc "html5_webgl.c", 201, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 322} __assert_fail(.str.49, .str.4, 201, __func__.main);
    assume {:sourceloc "html5_webgl.c", 201, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb193:
    ...
    assume {:verifier.code 0} true;
    assume $i210 == 1;
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
    $p211 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(1, 4));
    $p212 := $bitcast.ref.ref($p211);
    $p213 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 323} __SMACK_check_memory_safety($p212, $p213);
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
    $f214 := $load.unsafe.float($M.9, $p211);
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
    $i215 := (if $foeq.float.bool($f214, $fp(2, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb199:
    ...
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 324} __assert_fail(.str.50, .str.4, 202, __func__.main);
    assume {:sourceloc "html5_webgl.c", 202, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb197:
    ...
    assume {:verifier.code 0} true;
    assume $i215 == 1;
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
    $p216 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(2, 4));
    $p217 := $bitcast.ref.ref($p216);
    $p218 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 325} __SMACK_check_memory_safety($p217, $p218);
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
    $f219 := $load.unsafe.float($M.9, $p216);
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
    $i220 := (if $foeq.float.bool($f219, $fp(3, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb203:
    ...
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 326} __assert_fail(.str.51, .str.4, 203, __func__.main);
    assume {:sourceloc "html5_webgl.c", 203, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb201:
    ...
    assume {:verifier.code 0} true;
    assume $i220 == 1;
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
    $p221 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(3, 4));
    $p222 := $bitcast.ref.ref($p221);
    $p223 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 327} __SMACK_check_memory_safety($p222, $p223);
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
    $f224 := $load.unsafe.float($M.9, $p221);
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
    $i225 := (if $foeq.float.bool($f224, $fp(0, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb207:
    ...
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 328} __assert_fail(.str.52, .str.4, 204, __func__.main);
    assume {:sourceloc "html5_webgl.c", 204, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb205:
    ...
    assume {:verifier.code 0} true;
    assume $i225 == 1;
    assume {:sourceloc "html5_webgl.c", 207, 57} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 329} $i226 := glGetUniformLocation($i185, .str.47);
    assume {:sourceloc "html5_webgl.c", 207, 104} true;
    assume {:verifier.code 0} true;
    $p227 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(0, 4));
    assume {:sourceloc "html5_webgl.c", 207, 104} true;
    assume {:verifier.code 0} true;
    $p228 := $bitcast.ref.ref($p227);
    assume {:sourceloc "html5_webgl.c", 207, 17} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 330} $i229 := emscripten_webgl_get_uniform_v($i185, $i226, $p228, 4, 1);
    call {:si_unique_call 331} {:cexpr "numElements"} boogie_si_record_i32($i229);
    assume {:sourceloc "html5_webgl.c", 208, 3} true;
    assume {:verifier.code 0} true;
    $i230 := $eq.i32($i229, 4);
    assume {:sourceloc "html5_webgl.c", 208, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb211:
    ...
    assume {:sourceloc "html5_webgl.c", 208, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 332} __assert_fail(.str.15, .str.4, 208, __func__.main);
    assume {:sourceloc "html5_webgl.c", 208, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb209:
    ...
    assume {:verifier.code 0} true;
    assume $i230 == 1;
    assume {:sourceloc "html5_webgl.c", 209, 3} true;
    assume {:verifier.code 0} true;
    $p231 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(0, 4));
    $p232 := $bitcast.ref.ref($p231);
    $p233 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 333} __SMACK_check_memory_safety($p232, $p233);
    assume {:sourceloc "html5_webgl.c", 209, 3} true;
    assume {:verifier.code 0} true;
    $f234 := $load.unsafe.float($M.9, $p231);
    assume {:sourceloc "html5_webgl.c", 209, 3} true;
    assume {:verifier.code 0} true;
    $i235 := (if $foeq.float.bool($f234, $fp(1, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 209, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb215:
    ...
    assume {:sourceloc "html5_webgl.c", 209, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 334} __assert_fail(.str.49, .str.4, 209, __func__.main);
    assume {:sourceloc "html5_webgl.c", 209, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb213:
    ...
    assume {:verifier.code 0} true;
    assume $i235 == 1;
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
    $p236 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(1, 4));
    $p237 := $bitcast.ref.ref($p236);
    $p238 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 335} __SMACK_check_memory_safety($p237, $p238);
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
    $f239 := $load.unsafe.float($M.9, $p236);
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
    $i240 := (if $foeq.float.bool($f239, $fp(2, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb219:
    ...
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 336} __assert_fail(.str.50, .str.4, 210, __func__.main);
    assume {:sourceloc "html5_webgl.c", 210, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb217:
    ...
    assume {:verifier.code 0} true;
    assume $i240 == 1;
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
    $p241 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(2, 4));
    $p242 := $bitcast.ref.ref($p241);
    $p243 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 337} __SMACK_check_memory_safety($p242, $p243);
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
    $f244 := $load.unsafe.float($M.9, $p241);
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
    $i245 := (if $foeq.float.bool($f244, $fp(3, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb223:
    ...
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 338} __assert_fail(.str.51, .str.4, 211, __func__.main);
    assume {:sourceloc "html5_webgl.c", 211, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb221:
    ...
    assume {:verifier.code 0} true;
    assume $i245 == 1;
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
    $p246 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(3, 4));
    $p247 := $bitcast.ref.ref($p246);
    $p248 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 339} __SMACK_check_memory_safety($p247, $p248);
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
    $f249 := $load.unsafe.float($M.9, $p246);
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
    $i250 := (if $foeq.float.bool($f249, $fp(4, 0, 0)) then 1 else 0);
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb227:
    ...
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 340} __assert_fail(.str.53, .str.4, 212, __func__.main);
    assume {:sourceloc "html5_webgl.c", 212, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb225:
    ...
    assume {:verifier.code 0} true;
    assume $i250 == 1;
    call {:si_unique_call 341} __SMACK_check_memory_leak();
    assume {:sourceloc "html5_webgl.c", 217, 1} true;
    assume {:verifier.code 0} true;
    $r := 0;
    return;
}
...
procedure emscripten_webgl_get_supported_extensions() returns ($r: ref);
...
implementation free_($p0: ref)
{
  ...
  anon0:
    call {:si_unique_call 342} $free($p0);
    return;
}
...
procedure emscripten_webgl_get_parameter_d($i0: i32) returns ($r: float);
...
procedure glGenBuffers($i0: i32, $p1: ref);
...
procedure glBindBuffer($i0: i32, $i1: i32);
...
procedure emscripten_webgl_get_parameter_o($i0: i32) returns ($r: i32);
...
procedure {:AngelicUnknown} emscripten_webgl_get_parameter_utf8($i0: i32) returns ($r: ref);
...
procedure emscripten_webgl_get_parameter_i64v($i0: i32, $p1: ref);
...
procedure glViewport($i0: i32, $i1: i32, $i2: i32, $i3: i32);
...
procedure emscripten_webgl_get_parameter_v($i0: i32, $p1: ref, $i2: i32, $i3: i32) returns ($r: i32);
...
procedure glEnableVertexAttribArray($i0: i32);
...
procedure emscripten_webgl_get_vertex_attrib_d($i0: i32, $i1: i32) returns ($r: float);
...
procedure glVertexAttrib4f($i0: i32, $f1: float, $f2: float, $f3: float, $f4: float);
...
procedure emscripten_webgl_get_vertex_attrib_v($i0: i32, $i1: i32, $p2: ref, $i3: i32, $i4: i32) returns ($r: i32);
...
procedure glBufferData($i0: i32, $i1: i32, $p2: ref, $i3: i32);
...
procedure glVertexAttribPointer($i0: i32, $i1: i32, $i2: i32, $i3: i8, $i4: i32, $p5: ref);
...
procedure emscripten_webgl_get_vertex_attrib_o($i0: i32, $i1: i32) returns ($r: i32);
...
procedure emscripten_webgl_get_shader_parameter_d($i0: i32, $i1: i32) returns ($r: float);
...
procedure emscripten_webgl_get_shader_source_utf8($i0: i32) returns ($r: ref);
...
procedure emscripten_webgl_get_shader_info_log_utf8($i0: i32) returns ($r: ref);
...
procedure emscripten_webgl_get_program_parameter_d($i0: i32, $i1: i32) returns ($r: float);
...
procedure emscripten_webgl_get_program_info_log_utf8($i0: i32) returns ($r: ref);
...
procedure glGetUniformLocation($i0: i32, $p1: ref) returns ($r: i32);
...
procedure glUniform1f($i0: i32, $f1: float);
...
procedure glUniform4f($i0: i32, $f1: float, $f2: float, $f3: float, $f4: float);
...
procedure emscripten_webgl_get_uniform_d($i0: i32, $i1: i32) returns ($r: float);
...
procedure emscripten_webgl_get_uniform_v($i0: i32, $i1: i32, $p2: ref, $i3: i32, $i4: i32) returns ($r: i32);
...
implementation __SMACK_check_overflow(flag: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 343} {:cexpr "__SMACK_check_overflow:arg:flag"} boogie_si_record_i32(flag);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    ...
    inline$$$alloc$0$n := n;
    call {:si_unique_call 345} inline$$$alloc$0$p := havocNonDetAvh.ref();
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 347} cmdloc_dummy_var_6 := havocNonDetAvh.ref();
...
implementation $free(p: ref)
{
  ...
  anon2:
    call {:si_unique_call 349} corral_atomic_end();
    return;
...
implementation $initialize()
{
  ...
  anon0:
    call {:si_unique_call 351} $global_allocations();
    call {:si_unique_call 352} __SMACK_static_init();
    call {:si_unique_call 353} __SMACK_init_func_memory_model();
    return;
}
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    ...
    call {:si_unique_call 356} {:AvhEntryPoint} vslice_dummy_var_1 := main();
    return;
}



implementation emscripten_webgl_get_supported_extensions() returns ($r: ref)
{
...
implementation strstr($p0: ref, $p1: ref) returns ($r: ref)
{
...
implementation emscripten_webgl_get_parameter_utf8($i0: i32) returns ($r: ref)
{

  L_BAF_19:
    call {:ConcretizeCallId 5} {:si_unique_call 359} {:ConcretizeConstantName "$r"} $r := unknown_ref();
    assume unknownTrigger_5($r);
    return;
}



implementation emscripten_webgl_get_shader_source_utf8($i0: i32) returns ($r: ref)
{

  L_BAF_20:
    call {:ConcretizeCallId 6} {:si_unique_call 360} {:ConcretizeConstantName "$r"} $r := unknown_ref();
    assume unknownTrigger_6($r);
    return;
}



implementation emscripten_webgl_get_shader_info_log_utf8($i0: i32) returns ($r: ref)
{

  L_BAF_21:
    call {:ConcretizeCallId 7} {:si_unique_call 361} {:ConcretizeConstantName "$r"} $r := unknown_ref();
    assume unknownTrigger_7($r);
    return;
}



implementation emscripten_webgl_get_program_info_log_utf8($i0: i32) returns ($r: ref)
{

  L_BAF_22:
    call {:ConcretizeCallId 8} {:si_unique_call 362} {:ConcretizeConstantName "$r"} $r := unknown_ref();
