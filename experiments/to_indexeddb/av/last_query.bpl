...
procedure CorralMain_trace_1();
  free requires assertsPassed;
  free requires {:BlockingConstraint 0} (forall x_5: ref :: unknownTrigger_7(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 208)), $mul.ref(32, 1))))]);
  free requires {:BlockingConstraint 1} (forall x_6: ref :: unknownTrigger_9(x_6) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(42, 1))))]);
  free requires {:BlockingConstraint 2} (forall x_5: ref :: unknownTrigger_7(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 208)), $mul.ref(32, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 208)), $mul.ref(32, 1)))));
  free requires {:BlockingConstraint 3} (forall x_6: ref :: unknownTrigger_6(x_6) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1))))]);
  free requires {:BlockingConstraint 4} (forall x_6: ref :: unknownTrigger_9(x_6) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(42, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(42, 1)))));
  free requires {:BlockingConstraint 5} (forall x_6: ref :: unknownTrigger_9(x_6) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(42, 1))), $bitcast.ref.ref($i2p.i64.ref(2))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(42, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(42, 1))))))));
  free requires {:BlockingConstraint 6} (forall x_6: ref :: unknownTrigger_9(x_6) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1))))]);
  free requires {:BlockingConstraint 7} (forall x_6: ref :: unknownTrigger_9(x_6) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1)))));
  free requires {:BlockingConstraint 8} (forall x_6: ref :: unknownTrigger_9(x_6) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(16, 1))), $bitcast.ref.ref($i2p.i64.ref(8))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(16, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(16, 1))))))));
  free requires {:BlockingConstraint 9} (forall x_6: ref :: unknownTrigger_9(x_6) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(16, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(16, 1)))));
  free requires {:BlockingConstraint 10} (forall x_6: ref :: unknownTrigger_9(x_6) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1))), $bitcast.ref.ref($i2p.i64.ref(8))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1))))))));
  free requires {:BlockingConstraint 11} (forall x_6: ref :: unknownTrigger_6(x_6) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1)))));
  free requires {:BlockingConstraint 12} (forall x_6: ref :: unknownTrigger_6(x_6) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1))), $bitcast.ref.ref($i2p.i64.ref(8))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_6, $mul.ref(0, 208)), $mul.ref(32, 1))))))));
  modifies $M.14, $exnv, $allocatedCounter, $CurrAddr, assertsPassed, $M.1, $M.2, $M.3, $M.4, $M.5, $Alloc;



procedure _ZZ4mainENK3$_1clEP18emscripten_fetch_t_trace_1(this: ref, fetch: ref);
  free requires assertsPassed;
  modifies assertsPassed;



implementation {:origRTname "_ZZ4mainENK3$_1clEP18emscripten_fetch_t"} _ZZ4mainENK3$_1clEP18emscripten_fetch_t_trace_1(this: ref, fetch: ref)
{
  var $i0: i1;
  var $p1: ref;
  var $p2: ref;
  ...
  $bb0__unique__1:
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i4 := init_locals_nondet_tmp_i16();
    call boogie_si_record_sdvcp_int($i4);
    call {:ConcretizeConstantName "InitLocalVar"} $i5 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i5);
    call {:ConcretizeConstantName "InitLocalVar"} $i6 := init_locals_nondet_tmp_i1();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i10 := init_locals_nondet_tmp_i64();
    call boogie_si_record_sdvcp_int($i10);
    call {:ConcretizeConstantName "InitLocalVar"} $i11 := init_locals_nondet_tmp_i1();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i15 := init_locals_nondet_tmp_i64();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i19 := init_locals_nondet_tmp_i64();
    call boogie_si_record_sdvcp_int($i19);
    call {:ConcretizeConstantName "InitLocalVar"} $i20 := init_locals_nondet_tmp_i64();
    call boogie_si_record_sdvcp_int($i20);
    call {:ConcretizeConstantName "InitLocalVar"} $f21 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f21);
    call {:ConcretizeConstantName "InitLocalVar"} $f22 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f22);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i26 := init_locals_nondet_tmp_i64();
    call boogie_si_record_sdvcp_int($i26);
    call {:ConcretizeConstantName "InitLocalVar"} $f27 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f27);
    call {:ConcretizeConstantName "InitLocalVar"} $f28 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f28);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i33 := init_locals_nondet_tmp_i64();
    call boogie_si_record_sdvcp_int($i33);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i37 := init_locals_nondet_tmp_i64();
    call boogie_si_record_sdvcp_int($i37);
    call {:ConcretizeConstantName "InitLocalVar"} $i38 := init_locals_nondet_tmp_i64();
  ...
  $bb1__unique__2:
    ...
    goto AvnSeqInstr_53__unique__3;

  AvnSeqInstr_53__unique__3:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_54__unique__4;

  AvnSeqInstr_54__unique__4:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$0$p), inline$__SMACK_check_memory_safety$0$p);
    goto AvnSeqInstr_56__unique__5;

  AvnSeqInstr_56__unique__5:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_57__unique__6;

  AvnSeqInstr_57__unique__6:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_59__unique__7;

  AvnSeqInstr_59__unique__7:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_60__unique__8;

  AvnSeqInstr_60__unique__8:
    call corral_fix_context_0();
    assume {:sourceloc "to_indexeddb.cpp", 38, 16} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
  ...
  $bb6__unique__9:
    ...
    goto AvnSeqInstr_62__unique__10;

  AvnSeqInstr_62__unique__10:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_63__unique__11;

  AvnSeqInstr_63__unique__11:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$1$p), inline$__SMACK_check_memory_safety$1$p);
    goto AvnSeqInstr_65__unique__12;

  AvnSeqInstr_65__unique__12:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_66__unique__13;

  AvnSeqInstr_66__unique__13:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_68__unique__14;

  AvnSeqInstr_68__unique__14:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_69__unique__15;

  AvnSeqInstr_69__unique__15:
    call corral_fix_context_0();
    assume {:sourceloc "to_indexeddb.cpp", 39, 16} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
  ...
  $bb8__unique__16:
    ...
    goto AvnSeqInstr_89__unique__17;

  AvnSeqInstr_89__unique__17:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_90__unique__18;

  AvnSeqInstr_90__unique__18:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$2$p), inline$__SMACK_check_memory_safety$2$p);
    goto AvnSeqInstr_92__unique__19;

  AvnSeqInstr_92__unique__19:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_93__unique__20;

  AvnSeqInstr_93__unique__20:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_95__unique__21;

  AvnSeqInstr_95__unique__21:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_96__unique__22;

  AvnSeqInstr_96__unique__22:
    call corral_fix_context_0();
    assume {:sourceloc "to_indexeddb.cpp", 40, 58} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    ...
    goto AvnSeqInstr_97__unique__23;

  AvnSeqInstr_97__unique__23:
    call corral_fix_context_0();
...
implementation {:origRTname "CorralMain"} CorralMain_trace_1()
{
  ...
  CorralMainStart__unique__1:
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 1} {:si_unique_call 119} {:ConcretizeConstantName "$M.14"} cmdloc_dummy_var_1 := unknown_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_1);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    $M.14 := cmdloc_dummy_var_1;
    call corral_fix_context_0();
    assume unknownTrigger_1($M.14);
    call corral_fix_context_0();
    call {:ConcretizeCallId 2} {:si_unique_call 120} {:ConcretizeConstantName "$exnv"} cmdloc_dummy_var_2 := unknown_int();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_2);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 3} {:si_unique_call 121} {:ConcretizeConstantName "$allocatedCounter"} cmdloc_dummy_var_3 := unknown_int();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_3);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 4} {:si_unique_call 122} {:ConcretizeConstantName "$CurrAddr"} cmdloc_dummy_var_4 := unknown_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_4);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
  ...
  L_BAF_2__unique__2:
    ...
    call corral_fix_context_0();
    call {:si_unique_call 130} {:AvhEntryPoint} _ZZ4mainENK3$_1clEP18emscripten_fetch_t_trace_1(this__ZZ4mainENK3$_1clEP18emscripten_fetch_t, fetch__ZZ4mainENK3$_1clEP18emscripten_fetch_t);
    goto AvnSeqInstr_181__unique__3;

  AvnSeqInstr_181__unique__3:
    call corral_fix_context_0();
    assume !assertsPassed;
    return;
}
