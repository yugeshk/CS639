...
procedure main() returns ($r: i32);
  modifies $M.1, $M.2, $M.3, $M.4, $M.5, $M.14, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation _ZZ4mainENK3$_1clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  ...
  $bb9:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 96} vslice_dummy_var_0 := printf.ref.i64(.str.12, $i38);
    assume {:verifier.code 0} true;
    goto $bb7;
  ...
  $bb8:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 97} vslice_dummy_var_1 := printf.ref.float(.str.11, $f28);
...
implementation _ZZ4mainENK3$_0clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  ...
  $bb1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 100} vslice_dummy_var_2 := printf.ref.i64(.str.5, $i4);
  ...
  $bb21:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 106} vslice_dummy_var_3 := emscripten_fetch_close(fetch);
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 112} cmdloc_dummy_var_0 := havocNonDetAvh.ref();
...
procedure $initialize();
  modifies $M.14, $CurrAddr, $allocatedCounter, $Alloc;
...
procedure {:entrypoint} CorralMain();
  modifies $M.14, $exnv, $allocatedCounter, $CurrAddr, $M.1, $M.2, $M.3, $M.4, $M.5, $Alloc;
...
implementation CorralMain()
{
  ...
  L_BAF_0:
    ...
    assume MustReach(true);
    call {:si_unique_call 133} {:AvhEntryPoint} vslice_dummy_var_4 := main();
    return;
}
