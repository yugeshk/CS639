...
implementation _ZZ4mainENK3$_0clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  ...
  $bb3:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 21, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 3} __assert_fail(.str.4, .str.3, 21, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 21, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb4;
  ...
  $bb7:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 23, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 6} __assert_fail(.str.6, .str.3, 23, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 23, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb8;
  ...
  $bb9:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 24, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 7} __assert_fail(.str.7, .str.3, 24, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 24, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb10;
  ...
  $bb15:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 25, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 10} __assert_fail(.str.8, .str.3, 25, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 25, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb16;
  ...
  $bb19:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 26, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 12} __assert_fail(.str.9, .str.3, 26, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 26, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb20;
  ...
  $bb22:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 13} vslice_dummy_var_1 := emscripten_fetch_close(fetch);
  ...
  $bb23:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 27, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 14} __assert_fail(.str.10, .str.3, 27, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 27, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb24;
