...
axiom $GLOBALS_BOTTOM == $sub.ref(0, 82585);
...
implementation $global_allocations()
{
  ...
  anon0:
    ...
    call {:si_unique_call 6} $galloc(.str.2, 11);
    call {:si_unique_call 7} $galloc(.str.1, 10);
    call {:si_unique_call 8} $galloc(.str, 4);
    call {:si_unique_call 9} $galloc(.str.13, 18);
    call {:si_unique_call 10} $galloc(.str.4, 6);
    call {:si_unique_call 11} $galloc(__func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t, 11);
    call {:si_unique_call 12} $galloc(.str.11, 32);
    call {:si_unique_call 13} $galloc(.str.12, 36);
    call {:si_unique_call 14} $galloc(.str.3, 17);
    call {:si_unique_call 15} $galloc(.str.5, 33);
    call {:si_unique_call 16} $galloc(.str.6, 11);
    call {:si_unique_call 17} $galloc(.str.7, 33);
    call {:si_unique_call 18} $galloc(.str.8, 15);
    call {:si_unique_call 19} $galloc(.str.9, 41);
    call {:si_unique_call 20} $galloc(.str.10, 26);
    call {:si_unique_call 21} $galloc(__SMACK_nondet_unsigned_char, 4);
    call {:si_unique_call 22} $galloc(_ZZ4mainENK3$_0clEP18emscripten_fetch_t, 4);
    ...
    call {:si_unique_call 26} $galloc(.str.2.28, 3);
    call {:si_unique_call 27} $galloc(.str.29, 49);
    call {:si_unique_call 28} $galloc(.str.1.30, 14);
    call {:si_unique_call 29} $galloc(errno_global, 4);
    call {:si_unique_call 30} $galloc(_ZTISt9bad_alloc, 4);
    call {:si_unique_call 31} $galloc(__gxx_personality_v0, 4);
    call {:si_unique_call 32} $galloc(__SMACK_nondet_unsigned_int, 4);
    ...
    call {:si_unique_call 38} $galloc(__SMACK_nondet_signed_long, 4);
    call {:si_unique_call 39} $galloc(_ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv, 4);
    call {:si_unique_call 40} $galloc(_ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv, 4);
    call {:si_unique_call 41} $galloc(malloc, 4);
    ...
    call {:si_unique_call 51} $galloc(__SMACK_top_decl, 4);
    call {:si_unique_call 52} $galloc(__SMACK_check_memory_safety, 4);
    call {:si_unique_call 53} $galloc(__SMACK_check_memory_leak, 4);
    call {:si_unique_call 54} $galloc(__SMACK_init_func_memory_model, 4);
    call {:si_unique_call 55} $galloc(_Z6strcmpPKcS0_, 4);
    ...
    call {:si_unique_call 68} $galloc(__SMACK_nondet_int, 4);
    call {:si_unique_call 69} $galloc(__SMACK_nondet_signed_int, 4);
    call {:si_unique_call 70} $galloc(__SMACK_nondet_unsigned, 4);
    ...
    call {:si_unique_call 78} $galloc(devirtbounce, 4);
...
implementation {:entrypoint} main() returns ($r: i32)
{
  ...
  $bb0:
    call {:si_unique_call 81} $initialize();
    assume {:sourceloc "to_indexeddb.cpp", 15, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 82} {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
    assume {:verifier.code 0} true;
    call {:si_unique_call 83} $p0 := $alloc($mul.ref(92, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 84} $p1 := $alloc($mul.ref(1, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 85} $p2 := $alloc($mul.ref(1, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 86} $p3 := $alloc($mul.ref(1, 1));
    assume true;
    assume {:sourceloc "to_indexeddb.cpp", 15, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 87} emscripten_fetch_attr_init($p0);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 88} $p6 := _Z6strcpyPcPKc($p5, .str);
    ...
    call {:si_unique_call 89} __SMACK_check_memory_safety($p8, $p9);
    ...
    call {:si_unique_call 90} __SMACK_check_memory_safety($p11, $p12);
    assume {:sourceloc "to_indexeddb.cpp", 18, 19} true;
    assume {:verifier.code 0} true;
    $M.2 := $store.i32($M.2, $p10, 20);
    assume {:sourceloc "to_indexeddb.cpp", 20, 20} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 91} $p13 := _ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv($p1);
    ...
    call {:si_unique_call 92} __SMACK_check_memory_safety($p15, $p16);
    assume {:sourceloc "to_indexeddb.cpp", 20, 18} true;
    assume {:verifier.code 0} true;
    $M.3 := $store.ref($M.3, $p14, $p13);
    assume {:sourceloc "to_indexeddb.cpp", 36, 21} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 93} $p17 := _ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv($p2);
    ...
    call {:si_unique_call 94} __SMACK_check_memory_safety($p19, $p20);
    assume {:sourceloc "to_indexeddb.cpp", 36, 19} true;
    assume {:verifier.code 0} true;
    $M.4 := $store.ref($M.4, $p18, $p17);
    assume {:sourceloc "to_indexeddb.cpp", 46, 18} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} $p21 := _ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv($p3);
    ...
    call {:si_unique_call 96} __SMACK_check_memory_safety($p23, $p24);
    assume {:sourceloc "to_indexeddb.cpp", 46, 16} true;
    assume {:verifier.code 0} true;
    $M.5 := $store.ref($M.5, $p22, $p21);
    assume {:sourceloc "to_indexeddb.cpp", 50, 62} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 97} $p25 := malloc(208);
    assume {:sourceloc "to_indexeddb.cpp", 50, 40} true;
    assume {:verifier.code 0} true;
    $p26 := $bitcast.ref.ref($p25);
    assume {:sourceloc "to_indexeddb.cpp", 51, 8} true;
    assume {:verifier.code 0} true;
    $p27 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(36, 1));
    $p28 := $bitcast.ref.ref($p27);
    $p29 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 98} __SMACK_check_memory_safety($p28, $p29);
    assume {:sourceloc "to_indexeddb.cpp", 51, 8} true;
    assume {:verifier.code 0} true;
    $p30 := $load.ref($M.3, $p27);
    call {:si_unique_call 99} devirtbounce($p30, $p26);
    assume {:sourceloc "to_indexeddb.cpp", 52, 31} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 100} $p31 := emscripten_fetch($p0, .str.1);
    assume $isExternal($p31);
    assume {:sourceloc "to_indexeddb.cpp", 53, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb2:
    assume {:sourceloc "to_indexeddb.cpp", 54, 10} true;
    assume {:verifier.code 0} true;
    $p33 := $bitcast.ref.ref($p0);
    assume {:sourceloc "to_indexeddb.cpp", 54, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 101} $p34 := _Z6memsetPvim($p33, 0, 92);
    assume $isExternal($p34);
    call {:si_unique_call 102} __SMACK_check_memory_leak();
    assume {:sourceloc "to_indexeddb.cpp", 57, 1} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
  ...
  $bb3:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 53, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 103} __assert_fail(.str.2, .str.3, 53, __func__.main);
    assume {:sourceloc "to_indexeddb.cpp", 53, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb4;
...
procedure _ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv($p0: ref) returns ($r: ref);
  modifies $exn;



implementation _ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv($p0: ref) returns ($r: ref)
{
...
procedure _ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv($p0: ref) returns ($r: ref);
  modifies $exn;



implementation _ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv($p0: ref) returns ($r: ref)
{
...
procedure _ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv($p0: ref) returns ($r: ref);
  modifies $exn;



implementation _ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv($p0: ref) returns ($r: ref)
{
...
implementation malloc($i0: i32) returns ($r: ref)
{
  ...
  anon0:
    call {:si_unique_call 104} $r := $malloc($i0);
    return;
}
...
axiom emscripten_fetch == $sub.ref(0, 33241);

procedure emscripten_fetch($p0: ref, $p1: ref) returns ($r: ref);



const __assert_fail: ref;

axiom __assert_fail == $sub.ref(0, 34269);
...
axiom _Z6memsetPvim == $sub.ref(0, 35297);
...
axiom _ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t == $sub.ref(0, 36325);
...
axiom _ZZ4mainENK3$_2clEP18emscripten_fetch_t == $sub.ref(0, 37353);
...
axiom _ZZ4mainEN3$_18__invokeEP18emscripten_fetch_t == $sub.ref(0, 39409);
...
axiom _ZZ4mainENK3$_1clEP18emscripten_fetch_t == $sub.ref(0, 40437);
...
axiom _ZZ4mainEN3$_08__invokeEP18emscripten_fetch_t == $sub.ref(0, 41465);
...
implementation _ZZ4mainEN3$_08__invokeEP18emscripten_fetch_t($p0: ref)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 20, 20} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 105} _ZZ4mainENK3$_0clEP18emscripten_fetch_t($u0, $p0);
    assume {:sourceloc "to_indexeddb.cpp", 20, 20} true;
    assume {:verifier.code 0} true;
    $exn := false;
    return;
...
axiom _ZZ4mainENK3$_0clEP18emscripten_fetch_t == $sub.ref(0, 42493);
...
implementation _ZZ4mainENK3$_0clEP18emscripten_fetch_t($p0: ref, $p1: ref)
{
  var $i2: i1;
  var $p3: ref;
  var $p4: ref;
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    $p3 := $add.ref($add.ref($p1, $mul.ref(0, 208)), $mul.ref(32, 1));
    $p4 := $bitcast.ref.ref($p3);
    $p5 := $bitcast.ref.ref($i2p.i64.ref(8));
    call {:si_unique_call 106} __SMACK_check_memory_safety($p4, $p5);
    assume {:sourceloc "to_indexeddb.cpp", 22, 56} true;
    assume {:verifier.code 0} true;
    $i6 := $load.i64($M.10, $p3);
    assume {:sourceloc "to_indexeddb.cpp", 22, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 107} $i7 := printf.ref.i64(.str.5, $i6);
    ...
    call {:si_unique_call 108} __SMACK_check_memory_safety($p9, $p10);
    assume {:sourceloc "to_indexeddb.cpp", 23, 5} true;
    assume {:verifier.code 0} true;
    $p11 := $load.ref($M.11, $p8);
    assume {:sourceloc "to_indexeddb.cpp", 23, 5} true;
    assume {:verifier.code 0} true;
  ...
  $bb3:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 21, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 109} __assert_fail(.str.4, .str.3, 21, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 21, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb4;
  ...
  $bb6:
    ...
    call {:si_unique_call 110} __SMACK_check_memory_safety($p14, $p15);
    assume {:sourceloc "to_indexeddb.cpp", 24, 5} true;
    assume {:verifier.code 0} true;
    $p16 := $load.ref($M.11, $p13);
    assume {:sourceloc "to_indexeddb.cpp", 24, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 111} $i17 := _Z6strcmpPKcS0_($p16, .str.1);
    assume {:sourceloc "to_indexeddb.cpp", 24, 5} true;
    assume {:verifier.code 0} true;
    $i18 := $ne.i32($i17, 0);
    assume {:sourceloc "to_indexeddb.cpp", 24, 5} true;
  ...
  $bb7:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 23, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 112} __assert_fail(.str.6, .str.3, 23, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 23, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb8;
  ...
  $bb9:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 24, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 113} __assert_fail(.str.7, .str.3, 24, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 24, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb10;
  ...
  $bb11:
    ...
    call {:si_unique_call 114} __SMACK_check_memory_safety($p20, $p21);
    assume {:sourceloc "to_indexeddb.cpp", 25, 5} true;
    assume {:verifier.code 0} true;
    $i22 := $load.i32($M.12, $p19);
    assume {:sourceloc "to_indexeddb.cpp", 25, 5} true;
    assume {:verifier.code 0} true;
    $i23 := $ne.i32($i22, 0);
    assume {:sourceloc "to_indexeddb.cpp", 25, 5} true;
  ...
  $bb14:
    ...
    call {:si_unique_call 115} __SMACK_check_memory_safety($p25, $p26);
    assume {:sourceloc "to_indexeddb.cpp", 26, 5} true;
    assume {:verifier.code 0} true;
    $p27 := $load.ref($M.13, $p24);
    assume {:sourceloc "to_indexeddb.cpp", 26, 5} true;
    assume {:verifier.code 0} true;
    $i28 := $p2i.ref.i32($p27);
    assume {:sourceloc "to_indexeddb.cpp", 26, 5} true;
  ...
  $bb15:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 25, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 116} __assert_fail(.str.8, .str.3, 25, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 25, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb16;
  ...
  $bb18:
    ...
    call {:si_unique_call 117} __SMACK_check_memory_safety($p31, $p32);
    assume {:sourceloc "to_indexeddb.cpp", 27, 5} true;
    assume {:verifier.code 0} true;
    $i33 := $load.i64($M.10, $p30);
    assume {:sourceloc "to_indexeddb.cpp", 27, 5} true;
    assume {:verifier.code 0} true;
    $i34 := $eq.i64($i33, 6407);
    assume {:sourceloc "to_indexeddb.cpp", 27, 5} true;
  ...
  $bb19:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 26, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 118} __assert_fail(.str.9, .str.3, 26, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 26, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb20;
  ...
  $bb22:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 119} $i35 := emscripten_fetch_close($p1);
  ...
  $bb23:
    ...
    assume {:sourceloc "to_indexeddb.cpp", 27, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 120} __assert_fail(.str.10, .str.3, 27, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_indexeddb.cpp", 27, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb24;
...
axiom _Z6strcmpPKcS0_ == $sub.ref(0, 43521);
...
axiom emscripten_fetch_close == $sub.ref(0, 44549);
...
axiom __VERIFIER_assume == $sub.ref(0, 45577);
...
axiom __SMACK_code == $sub.ref(0, 46605);
...
axiom __SMACK_dummy == $sub.ref(0, 47633);
...
axiom __SMACK_check_overflow == $sub.ref(0, 48661);
...
axiom __SMACK_nondet_char == $sub.ref(0, 49689);
...
axiom __SMACK_nondet_signed_char == $sub.ref(0, 50717);
...
axiom __SMACK_nondet_unsigned_char == $sub.ref(0, 51745);
...
axiom __SMACK_nondet_short == $sub.ref(0, 52773);
...
axiom __SMACK_nondet_signed_short == $sub.ref(0, 53801);
...
axiom __SMACK_nondet_signed_short_int == $sub.ref(0, 54829);
...
axiom __SMACK_nondet_unsigned_short == $sub.ref(0, 55857);
...
axiom __SMACK_nondet_unsigned_short_int == $sub.ref(0, 56885);
...
axiom __SMACK_nondet_int == $sub.ref(0, 57913);
...
axiom __SMACK_nondet_signed_int == $sub.ref(0, 58941);
...
axiom __SMACK_nondet_unsigned == $sub.ref(0, 59969);
...
axiom __SMACK_nondet_unsigned_int == $sub.ref(0, 60997);
...
axiom __SMACK_nondet_long == $sub.ref(0, 62025);
...
axiom __SMACK_nondet_long_int == $sub.ref(0, 63053);
...
axiom __SMACK_nondet_signed_long == $sub.ref(0, 64081);
...
axiom __SMACK_nondet_signed_long_int == $sub.ref(0, 65109);
...
axiom __SMACK_nondet_unsigned_long == $sub.ref(0, 66137);
...
axiom __SMACK_nondet_unsigned_long_int == $sub.ref(0, 67165);
...
axiom __SMACK_nondet_long_long == $sub.ref(0, 68193);
...
axiom __SMACK_nondet_long_long_int == $sub.ref(0, 69221);
...
axiom __SMACK_nondet_signed_long_long == $sub.ref(0, 70249);
...
axiom __SMACK_nondet_signed_long_long_int == $sub.ref(0, 71277);
...
axiom __SMACK_nondet_unsigned_long_long == $sub.ref(0, 72305);
...
axiom __SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 73333);
...
axiom __SMACK_decls == $sub.ref(0, 74361);
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 121} corral_atomic_begin();
    call {:si_unique_call 122} p := $$alloc(n);
    call {:si_unique_call 123} corral_atomic_end();
    return;
}
...
implementation $malloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 124} corral_atomic_begin();
  ...
  anon2:
    call {:si_unique_call 125} p := $$alloc(n);
    call {:si_unique_call 126} corral_atomic_end();
    return;
}
...
axiom __SMACK_top_decl == $sub.ref(0, 75389);
...
axiom __SMACK_check_memory_safety == $sub.ref(0, 76417);
...
axiom __SMACK_check_memory_leak == $sub.ref(0, 77445);
...
axiom __SMACK_init_func_memory_model == $sub.ref(0, 78473);
...
axiom __gxx_personality_v0 == $sub.ref(0, 79501);
...
axiom llvm.dbg.value == $sub.ref(0, 80529);
...
axiom __SMACK_static_init == $sub.ref(0, 81557);
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    $M.14 := .str.2.28;
    $M.15 := 0;
    call {:si_unique_call 127} {:cexpr "errno_global"} boogie_si_record_i32(0);
    $exn := false;
    return;
}
...
axiom devirtbounce == $sub.ref(0, 82585);
...
implementation devirtbounce(funcPtr: ref, arg: ref)
{
  ...
  $bb1:
    $i1 := $eq.ref(_ZZ4mainEN3$_08__invokeEP18emscripten_fetch_t, $p0);
    assume {:branchcond $i1} true;
    goto $bb2, $bb3;

  $bb2:
    assume $i1 == 1;
    call {:si_unique_call 128} _ZZ4mainEN3$_08__invokeEP18emscripten_fetch_t(arg);
    $exn := false;
    return;
...
implementation $initialize()
{
  ...
  anon0:
    call {:si_unique_call 129} $global_allocations();
    call {:si_unique_call 130} __SMACK_static_init();
    call {:si_unique_call 131} __SMACK_init_func_memory_model();
    return;
}
