...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 83613));
...
$bb0:
  ...
  call devirtbounce($p30, $p26);
  assume {:sourceloc "to_indexeddb.cpp", 52, 31} true;
  assume {:verifier.code 0} true;
  call $p31 := emscripten_fetch($p0, .str.1);
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call $p34 := _Z6memsetPvim($p33, 0, 92);
  assume $isExternal($p34);
  assume {:sourceloc "to_indexeddb.cpp", 55, 8} true;
  assume {:verifier.code 0} true;
  $p35 := $bitcast.ref.ref($p26);
  assume {:sourceloc "to_indexeddb.cpp", 55, 3} true;
  assume {:verifier.code 0} true;
  call free_($p35);
...
$bb3:
  ...
  assume {:sourceloc "to_indexeddb.cpp", 53, 3} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.2, .str.3, 53, __func__.main);
  assume {:sourceloc "to_indexeddb.cpp", 53, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb4:
...
procedure  _Z6memsetPvim($p0: ref, $i1: i32, $i2: i32)
  returns ($r: ref);
const free_: ref;
axiom (free_ == $sub.ref(0, 36325));
procedure  free_($p0: ref)
{
  call $free($p0);
}
const _ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t: ref;
axiom (_ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t == $sub.ref(0, 37353));
...
axiom (_ZZ4mainENK3$_2clEP18emscripten_fetch_t == $sub.ref(0, 38381));
...
axiom (_ZZ4mainEN3$_18__invokeEP18emscripten_fetch_t == $sub.ref(0, 40437));
...
axiom (_ZZ4mainENK3$_1clEP18emscripten_fetch_t == $sub.ref(0, 41465));
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  $f23 := $ui2fp.i64.float($i22);
  assume {:sourceloc "to_indexeddb.cpp", 40, 88} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: to_indexeddb.cpp:40:88: warning: over-approximating floating-point arithmetic fmul;
  $f24 := $fmul.float($f23, $fp(1, 0, 2));
  ...
  assume {:verifier.code 0} true;
  $f29 := $ui2fp.i64.float($i28);
  assume {:sourceloc "to_indexeddb.cpp", 40, 96} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: to_indexeddb.cpp:40:96: warning: over-approximating floating-point arithmetic fdiv;
  $f30 := $fdiv.float($f24, $f29);
  assume {:sourceloc "to_indexeddb.cpp", 40, 7} true;
  assume {:verifier.code 0} true;
  call $i31 := printf.ref.float(.str.11, $f30);
...
axiom (_ZZ4mainEN3$_08__invokeEP18emscripten_fetch_t == $sub.ref(0, 42493));
...
axiom (_ZZ4mainENK3$_0clEP18emscripten_fetch_t == $sub.ref(0, 43521));
...
axiom (_Z6strcmpPKcS0_ == $sub.ref(0, 44549));
procedure  _Z6strcmpPKcS0_($p0: ref, $p1: ref)
  returns ($r: i32);
const emscripten_fetch_close: ref;
axiom (emscripten_fetch_close == $sub.ref(0, 45577));
procedure  emscripten_fetch_close($p0: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 46605));
...
axiom (__SMACK_code == $sub.ref(0, 47633));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 48661));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 49689));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 50717));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 51745));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 52773));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 53801));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 54829));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 55857));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 56885));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 57913));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 58941));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 59969));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 60997));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 62025));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 63053));
procedure  __SMACK_nondet_long()
  returns ($r: i32);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 64081));
procedure  __SMACK_nondet_long_int()
  returns ($r: i32);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 65109));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i32);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 66137));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 67165));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 68193));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i32);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 69221));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 70249));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 71277));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 72305));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 73333));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 74361));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 75389));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 76417));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_check_memory_safety: ref;
axiom (__SMACK_check_memory_safety == $sub.ref(0, 77445));
procedure  __SMACK_check_memory_safety($p0: ref, $p1: ref);
const __SMACK_check_memory_leak: ref;
axiom (__SMACK_check_memory_leak == $sub.ref(0, 78473));
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 79501));
...
axiom (__gxx_personality_v0 == $sub.ref(0, 80529));
procedure  __gxx_personality_v0()
  returns ($r: i32);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 81557));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 82585));
...
axiom (devirtbounce == $sub.ref(0, 83613));
...
$bb2:
  assume ($i1 == 1);
  call _ZZ4mainEN3$_08__invokeEP18emscripten_fetch_t(arg);
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
