...
axiom $GLOBALS_BOTTOM == $sub.ref(0, 72556);
...
implementation $global_allocations()
{
  ...
  anon0:
    call {:si_unique_call 0} $galloc(main, 4);
    call {:si_unique_call 1} $galloc(malloc, 4);
    call {:si_unique_call 2} $galloc(click_callback, 4);
    call {:si_unique_call 3} $galloc(.str, 18);
    call {:si_unique_call 4} $galloc(.str.16, 43);
    call {:si_unique_call 5} $galloc(.str.13, 17);
    call {:si_unique_call 6} $galloc(.str.14, 4);
    call {:si_unique_call 7} $galloc(.str.15, 49);
    call {:si_unique_call 8} $galloc(.str.2, 26);
    call {:si_unique_call 9} $galloc(gotClick, 4);
    call {:si_unique_call 10} $galloc(.str.12, 25);
    call {:si_unique_call 11} $galloc(.str.1, 14);
    call {:si_unique_call 12} $galloc(.str.3, 27);
    call {:si_unique_call 13} $galloc(.str.4, 32);
    call {:si_unique_call 14} $galloc(.str.5, 38);
    call {:si_unique_call 15} $galloc(.str.6, 33);
    call {:si_unique_call 16} $galloc(.str.7, 33);
    call {:si_unique_call 17} $galloc(.str.8, 32);
    call {:si_unique_call 18} $galloc(.str.9, 25);
    call {:si_unique_call 19} $galloc(.str.10, 26);
    call {:si_unique_call 20} $galloc(.str.11, 27);
    call {:si_unique_call 21} $galloc(.str.17, 59);
    call {:si_unique_call 22} $galloc(.str.18, 44);
    call {:si_unique_call 23} $galloc(__SMACK_nondet_unsigned_short, 4);
    call {:si_unique_call 24} $galloc(__SMACK_check_overflow, 4);
    ...
    call {:si_unique_call 28} $galloc(.str.2.38, 3);
    ...
    call {:si_unique_call 31} $galloc(.str.39, 49);
    call {:si_unique_call 32} $galloc(__SMACK_nondet_unsigned_long_int, 4);
    call {:si_unique_call 33} $galloc(__SMACK_nondet_long_long, 4);
    call {:si_unique_call 34} $galloc(__SMACK_nondet_long_long_int, 4);
    call {:si_unique_call 35} $galloc(.str.1.40, 14);
    call {:si_unique_call 36} $galloc(errno_global, 4);
    call {:si_unique_call 37} $galloc(pointerlockchange_callback, 4);
    call {:si_unique_call 38} $galloc(printf, 4);
    call {:si_unique_call 39} $galloc(report_result, 4);
    call {:si_unique_call 40} $galloc(emscripten_request_pointerlock, 4);
    call {:si_unique_call 41} $galloc(emscripten_result_to_string, 4);
    call {:si_unique_call 42} $galloc(__VERIFIER_assume, 4);
    call {:si_unique_call 43} $galloc(__SMACK_code, 4);
    call {:si_unique_call 44} $galloc(__SMACK_dummy, 4);
    call {:si_unique_call 45} $galloc(__SMACK_nondet_char, 4);
    call {:si_unique_call 46} $galloc(__SMACK_nondet_signed_char, 4);
    call {:si_unique_call 47} $galloc(__SMACK_nondet_unsigned_char, 4);
    call {:si_unique_call 48} $galloc(__SMACK_nondet_short, 4);
    call {:si_unique_call 49} $galloc(__SMACK_nondet_signed_short, 4);
    call {:si_unique_call 50} $galloc(__SMACK_nondet_signed_short_int, 4);
    call {:si_unique_call 51} $galloc(__SMACK_nondet_unsigned_short_int, 4);
    call {:si_unique_call 52} $galloc(__SMACK_nondet_int, 4);
    call {:si_unique_call 53} $galloc(__SMACK_nondet_signed_int, 4);
    call {:si_unique_call 54} $galloc(__SMACK_nondet_unsigned, 4);
    call {:si_unique_call 55} $galloc(__SMACK_nondet_unsigned_int, 4);
    call {:si_unique_call 56} $galloc(__SMACK_nondet_long, 4);
    call {:si_unique_call 57} $galloc(__SMACK_nondet_long_int, 4);
    call {:si_unique_call 58} $galloc(__SMACK_nondet_signed_long, 4);
    call {:si_unique_call 59} $galloc(__SMACK_nondet_signed_long_long, 4);
    call {:si_unique_call 60} $galloc(__SMACK_nondet_signed_long_long_int, 4);
    call {:si_unique_call 61} $galloc(__SMACK_nondet_unsigned_long_long, 4);
    call {:si_unique_call 62} $galloc(__SMACK_nondet_unsigned_long_long_int, 4);
    call {:si_unique_call 63} $galloc(__SMACK_decls, 4);
    call {:si_unique_call 64} $galloc(__SMACK_top_decl, 4);
    call {:si_unique_call 65} $galloc(__SMACK_check_memory_safety, 4);
    call {:si_unique_call 66} $galloc(__SMACK_check_memory_leak, 4);
    call {:si_unique_call 67} $galloc(__SMACK_init_func_memory_model, 4);
    call {:si_unique_call 68} $galloc(llvm.dbg.value, 4);
    call {:si_unique_call 69} $galloc(__SMACK_static_init, 4);
    return;
}
...
axiom .str.1 == $sub.ref(0, 4175);

const {:count 25} .str.12: ref;

axiom .str.12 == $sub.ref(0, 5224);

const {:count 17} .str.13: ref;

axiom .str.13 == $sub.ref(0, 6265);

const {:count 4} .str.14: ref;

axiom .str.14 == $sub.ref(0, 7293);

const {:count 49} .str.15: ref;

axiom .str.15 == $sub.ref(0, 8366);

const {:count 26} .str.2: ref;

axiom .str.2 == $sub.ref(0, 9416);

const {:count 27} .str.3: ref;

axiom .str.3 == $sub.ref(0, 10467);

const {:count 32} .str.4: ref;

axiom .str.4 == $sub.ref(0, 11523);

const {:count 38} .str.5: ref;

axiom .str.5 == $sub.ref(0, 12585);

const {:count 33} .str.6: ref;

axiom .str.6 == $sub.ref(0, 13642);

const {:count 33} .str.7: ref;

axiom .str.7 == $sub.ref(0, 14699);

const {:count 32} .str.8: ref;

axiom .str.8 == $sub.ref(0, 15755);

const {:count 25} .str.9: ref;

axiom .str.9 == $sub.ref(0, 16804);

const {:count 26} .str.10: ref;

axiom .str.10 == $sub.ref(0, 17854);

const {:count 27} .str.11: ref;

axiom .str.11 == $sub.ref(0, 18905);
...
axiom .str.24 == $sub.ref(0, 22108);

const {:count 26} .str.25: ref;

axiom .str.25 == $sub.ref(0, 23158);

const env_value_str: ref;

axiom env_value_str == $sub.ref(0, 24186);

const {:count 3} .str.2.38: ref;

axiom .str.2.38 == $sub.ref(0, 25213);

const {:count 49} .str.39: ref;

axiom .str.39 == $sub.ref(0, 26286);

const {:count 14} .str.1.40: ref;

axiom .str.1.40 == $sub.ref(0, 27324);

const errno_global: ref;

axiom errno_global == $sub.ref(0, 28352);

const main: ref;

axiom main == $sub.ref(0, 29380);

procedure {:entrypoint} main() returns ($r: i32);
  modifies $exn, $M.8, $M.9, $M.10, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation {:entrypoint} main() returns ($r: i32)
{
  ...
  $bb0:
    call {:si_unique_call 70} $initialize();
    assume {:sourceloc "harness.c", 11, 59} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 71} {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
    assume {:sourceloc "harness.c", 11, 59} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 72} $p0 := malloc(64);
    assume {:sourceloc "harness.c", 11, 36} true;
    assume {:verifier.code 0} true;
    $p1 := $bitcast.ref.ref($p0);
    assume {:sourceloc "harness.c", 12, 84} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 73} $p2 := malloc(260);
    assume {:sourceloc "harness.c", 12, 49} true;
    assume {:verifier.code 0} true;
    $p3 := $bitcast.ref.ref($p2);
    assume {:sourceloc "harness.c", 17, 1} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 74} $i4 := click_callback($u0, $p1, $u1);
    assume {:sourceloc "harness.c", 18, 1} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 75} $i5 := pointerlockchange_callback($u0, $p3, $u1);
    call {:si_unique_call 76} __SMACK_check_memory_leak();
    assume {:sourceloc "harness.c", 19, 1} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
...
implementation malloc($i0: i32) returns ($r: ref)
{
  ...
  anon0:
    call {:si_unique_call 77} $r := $malloc($i0);
    return;
}
...
axiom click_callback == $sub.ref(0, 31436);
...
implementation click_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 78} {:cexpr "click_callback:arg:eventType"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 10} true;
    assume {:verifier.code 0} true;
    $p3 := $add.ref($add.ref($p1, $mul.ref(0, 64)), $mul.ref(0, 1));
    $p4 := $bitcast.ref.ref($p3);
    $p5 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 79} __SMACK_check_memory_safety($p4, $p5);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 10} true;
    assume {:verifier.code 0} true;
    $i6 := $load.i32($M.0, $p3);
  ...
  $bb1:
    ...
    call {:si_unique_call 80} __SMACK_check_memory_safety($p9, $p10);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 29} true;
    assume {:verifier.code 0} true;
    $i11 := $load.i32($M.1, $p8);
  ...
  $bb4:
    ...
    call {:si_unique_call 81} __SMACK_check_memory_safety($p14, $p15);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 48} true;
    assume {:verifier.code 0} true;
  ...
  $bb6:
    ...
    call {:si_unique_call 82} __SMACK_check_memory_safety($p19, $p20);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 67} true;
    assume {:verifier.code 0} true;
  ...
  $bb8:
    ...
    call {:si_unique_call 83} __SMACK_check_memory_safety($p24, $p25);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 86} true;
    assume {:verifier.code 0} true;
  ...
  $bb10:
    ...
    call {:si_unique_call 84} __SMACK_check_memory_safety($p29, $p30);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 105} true;
    assume {:verifier.code 0} true;
  ...
  $bb12:
    ...
    call {:si_unique_call 85} __SMACK_check_memory_safety($p34, $p35);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 124} true;
    assume {:verifier.code 0} true;
  ...
  $bb14:
    ...
    call {:si_unique_call 86} __SMACK_check_memory_safety($p39, $p40);
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 143} true;
    assume {:verifier.code 0} true;
  ...
  $bb18:
    ...
    call {:si_unique_call 87} __SMACK_check_memory_safety($p44, $p45);
  ...
  $bb22:
    ...
    call {:si_unique_call 88} __SMACK_check_memory_safety($p48, $p49);
    assume {:sourceloc "test_html5_pointerlockerror.c", 47, 16} true;
    assume {:verifier.code 0} true;
    $M.8 := 1;
    call {:si_unique_call 89} {:cexpr "gotClick"} boogie_si_record_i32(1);
    assume {:sourceloc "test_html5_pointerlockerror.c", 48, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 90} $i50 := printf.ref(.str.12);
    assume {:sourceloc "test_html5_pointerlockerror.c", 49, 31} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 91} $i51 := emscripten_request_pointerlock($0.ref, 0);
    call {:si_unique_call 92} {:cexpr "ret"} boogie_si_record_i32($i51);
  ...
  $bb23:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 50, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 93} $p53 := emscripten_result_to_string($i51);
    assume {:sourceloc "test_html5_pointerlockerror.c", 50, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 94} $i54 := printf.ref.ref.ref(.str.13, .str.14, $p53);
    assume {:sourceloc "test_html5_pointerlockerror.c", 50, 7} true;
    assume {:verifier.code 0} true;
    goto $bb25;
  ...
  $bb26:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} $i56 := printf.ref(.str.15);
    assume {:sourceloc "test_html5_pointerlockerror.c", 53, 9} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 96} report_result(1);
...
axiom pointerlockchange_callback == $sub.ref(0, 32464);

procedure pointerlockchange_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  modifies $exn;



implementation pointerlockchange_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  var $i3: i32;

  $bb0:
    assume {:sourceloc "test_html5_pointerlockerror.c", 62, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 97} {:cexpr "pointerlockchange_callback:arg:eventType"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_html5_pointerlockerror.c", 62, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 98} $i3 := printf.ref(.str.16);
    assume {:sourceloc "test_html5_pointerlockerror.c", 63, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 99} report_result(1);
    assume {:sourceloc "test_html5_pointerlockerror.c", 65, 3} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
...
axiom report_result == $sub.ref(0, 34520);
...
implementation report_result($i0: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 100} {:cexpr "report_result:arg:result"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_html5_pointerlockerror.c", 15, 14} true;
    assume {:verifier.code 0} true;
    $i1 := $eq.i32($i0, 0);
  ...
  $bb1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 101} $i2 := printf.ref(.str);
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 102} $i3 := printf.ref(.str.1);
    assume {:verifier.code 0} true;
    goto $bb3;
...
axiom emscripten_request_pointerlock == $sub.ref(0, 35548);
...
axiom emscripten_result_to_string == $sub.ref(0, 36576);
...
implementation emscripten_result_to_string($i0: i32) returns ($r: ref)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 103} {:cexpr "emscripten_result_to_string:arg:result"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_html5_pointerlockerror.c", 26, 14} true;
    assume {:verifier.code 0} true;
    $i1 := $eq.i32($i0, 0);
...
axiom __VERIFIER_assume == $sub.ref(0, 37604);
...
axiom __SMACK_code == $sub.ref(0, 38632);
...
axiom __SMACK_dummy == $sub.ref(0, 39660);
...
axiom __SMACK_check_overflow == $sub.ref(0, 40688);
...
axiom __SMACK_nondet_char == $sub.ref(0, 41716);
...
axiom __SMACK_nondet_signed_char == $sub.ref(0, 42744);
...
axiom __SMACK_nondet_unsigned_char == $sub.ref(0, 43772);
...
axiom __SMACK_nondet_short == $sub.ref(0, 44800);
...
axiom __SMACK_nondet_signed_short == $sub.ref(0, 45828);
...
axiom __SMACK_nondet_signed_short_int == $sub.ref(0, 46856);
...
axiom __SMACK_nondet_unsigned_short == $sub.ref(0, 47884);
...
axiom __SMACK_nondet_unsigned_short_int == $sub.ref(0, 48912);
...
axiom __SMACK_nondet_int == $sub.ref(0, 49940);
...
axiom __SMACK_nondet_signed_int == $sub.ref(0, 50968);
...
axiom __SMACK_nondet_unsigned == $sub.ref(0, 51996);
...
axiom __SMACK_nondet_unsigned_int == $sub.ref(0, 53024);
...
axiom __SMACK_nondet_long == $sub.ref(0, 54052);
...
axiom __SMACK_nondet_long_int == $sub.ref(0, 55080);
...
axiom __SMACK_nondet_signed_long == $sub.ref(0, 56108);
...
axiom __SMACK_nondet_signed_long_int == $sub.ref(0, 57136);
...
axiom __SMACK_nondet_unsigned_long == $sub.ref(0, 58164);
...
axiom __SMACK_nondet_unsigned_long_int == $sub.ref(0, 59192);
...
axiom __SMACK_nondet_long_long == $sub.ref(0, 60220);
...
axiom __SMACK_nondet_long_long_int == $sub.ref(0, 61248);
...
axiom __SMACK_nondet_signed_long_long == $sub.ref(0, 62276);
...
axiom __SMACK_nondet_signed_long_long_int == $sub.ref(0, 63304);
...
axiom __SMACK_nondet_unsigned_long_long == $sub.ref(0, 64332);
...
axiom __SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 65360);
...
axiom __SMACK_decls == $sub.ref(0, 66388);
...
implementation $malloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 104} corral_atomic_begin();
  ...
  anon2:
    call {:si_unique_call 105} p := $$alloc(n);
    call {:si_unique_call 106} corral_atomic_end();
    return;
}
...
axiom __SMACK_top_decl == $sub.ref(0, 67416);
...
axiom __SMACK_check_memory_safety == $sub.ref(0, 68444);
...
axiom __SMACK_check_memory_leak == $sub.ref(0, 69472);
...
axiom __SMACK_init_func_memory_model == $sub.ref(0, 70500);
...
axiom llvm.dbg.value == $sub.ref(0, 71528);
...
axiom __SMACK_static_init == $sub.ref(0, 72556);

procedure __SMACK_static_init();
  modifies $M.8, $M.9, $M.10, $exn;
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    $M.8 := 0;
    call {:si_unique_call 107} {:cexpr "gotClick"} boogie_si_record_i32(0);
    $M.9 := .str.2.38;
    $M.10 := 0;
    call {:si_unique_call 108} {:cexpr "errno_global"} boogie_si_record_i32(0);
    $exn := false;
    return;
}
...
procedure $initialize();
  modifies $M.8, $M.9, $M.10, $exn, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation $initialize()
{
  ...
  anon0:
    call {:si_unique_call 109} $global_allocations();
    call {:si_unique_call 110} __SMACK_static_init();
    call {:si_unique_call 111} __SMACK_init_func_memory_model();
    return;
}
