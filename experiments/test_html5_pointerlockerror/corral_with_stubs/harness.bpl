...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 73584));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i4 := click_callback($u0, $p1, $u1);
  assume {:sourceloc "harness.c", 18, 1} true;
  assume {:verifier.code 0} true;
  call $i5 := pointerlockchange_callback($u0, $p3, $u1);
  assume {:sourceloc "harness.c", 19, 6} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p1);
  assume {:sourceloc "harness.c", 19, 1} true;
  assume {:verifier.code 0} true;
  call free_($p6);
  assume {:sourceloc "harness.c", 20, 6} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p3);
  assume {:sourceloc "harness.c", 20, 1} true;
  assume {:verifier.code 0} true;
  call free_($p7);
  call __SMACK_check_memory_leak();
  assume {:sourceloc "harness.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure  click_callback($i0: i32, $p1: ref, $p2: ref)
  returns ($r: i32)
{
  var $p3: ref;
  var $p4: ref;
...
procedure  pointerlockchange_callback($i0: i32, $p1: ref, $p2: ref)
  returns ($r: i32)
{
  var $i3: i32;
$bb0:
...
const free_: ref;
axiom (free_ == $sub.ref(0, 33492));
procedure  free_($p0: ref)
{
  call $free($p0);
}
const printf: ref;
axiom (printf == $sub.ref(0, 34520));
procedure  printf.ref($p0: ref)
  returns ($r: i32);
procedure  printf.ref.ref.ref($p0: ref, p.1: ref, p.2: ref)
  returns ($r: i32);
const report_result: ref;
axiom (report_result == $sub.ref(0, 35548));
...
axiom (emscripten_request_pointerlock == $sub.ref(0, 36576));
procedure  emscripten_request_pointerlock($p0: ref, $i1: i32)
  returns ($r: i32);
const emscripten_result_to_string: ref;
axiom (emscripten_result_to_string == $sub.ref(0, 37604));
procedure  emscripten_result_to_string($i0: i32)
  returns ($r: ref)
{
  var $i1: i1;
  var $i3: i1;
...
axiom (__VERIFIER_assume == $sub.ref(0, 38632));
...
axiom (__SMACK_code == $sub.ref(0, 39660));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 40688));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 41716));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 42744));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 43772));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 44800));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 45828));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 46856));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 47884));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 48912));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 49940));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 50968));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 51996));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 53024));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 54052));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 55080));
procedure  __SMACK_nondet_long()
  returns ($r: i32);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 56108));
procedure  __SMACK_nondet_long_int()
  returns ($r: i32);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 57136));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i32);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 58164));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 59192));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 60220));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i32);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 61248));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 62276));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 63304));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 64332));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 65360));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 66388));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 67416));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 68444));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_check_memory_safety: ref;
axiom (__SMACK_check_memory_safety == $sub.ref(0, 69472));
procedure  __SMACK_check_memory_safety($p0: ref, $p1: ref);
const __SMACK_check_memory_leak: ref;
axiom (__SMACK_check_memory_leak == $sub.ref(0, 70500));
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 71528));
...
axiom (llvm.dbg.value == $sub.ref(0, 72556));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 73584));
