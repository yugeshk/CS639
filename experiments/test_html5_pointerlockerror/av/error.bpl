...
implementation $global_allocations()
{
  ...
  anon0:
    call {:si_unique_call 0} $galloc(report_result, 4);
    assume true;
    call {:si_unique_call 1} $galloc(printf, 4);
    assume true;
    call {:si_unique_call 2} $galloc(emscripten_result_to_string, 4);
    assume true;
    call {:si_unique_call 3} $galloc(.str.4, 32);
    assume true;
    call {:si_unique_call 4} $galloc(.str.5, 38);
    assume true;
    call {:si_unique_call 5} $galloc(.str.6, 33);
    assume true;
    call {:si_unique_call 6} $galloc(.str.7, 33);
    assume true;
    call {:si_unique_call 7} $galloc(.str.1, 14);
    assume true;
    call {:si_unique_call 8} $galloc(.str.2, 26);
    assume true;
    call {:si_unique_call 9} $galloc(gotClick, 4);
    assume true;
    call {:si_unique_call 10} $galloc(.str, 18);
    assume true;
    call {:si_unique_call 11} $galloc(.str.3, 27);
    assume true;
    call {:si_unique_call 12} $galloc(.str.8, 32);
    assume true;
    call {:si_unique_call 13} $galloc(.str.9, 25);
    assume true;
    call {:si_unique_call 14} $galloc(.str.10, 26);
    assume true;
    call {:si_unique_call 15} $galloc(.str.11, 27);
    assume true;
    call {:si_unique_call 16} $galloc(.str.12, 25);
    assume true;
    call {:si_unique_call 17} $galloc(.str.13, 17);
    assume true;
    call {:si_unique_call 18} $galloc(.str.14, 4);
    assume true;
    call {:si_unique_call 19} $galloc(.str.15, 49);
    assume true;
    call {:si_unique_call 20} $galloc(.str.16, 43);
    assume true;
    call {:si_unique_call 21} $galloc(.str.17, 59);
    assume true;
    call {:si_unique_call 22} $galloc(.str.18, 44);
    assume true;
    call {:si_unique_call 23} $galloc(.str.19, 32);
    assume true;
    call {:si_unique_call 24} $galloc(.str.20, 59);
    assume true;
    call {:si_unique_call 25} $galloc(.str.21, 8);
    assume true;
    call {:si_unique_call 26} $galloc(.str.22, 50);
    assume true;
    call {:si_unique_call 27} $galloc(.str.23, 30);
    assume true;
    call {:si_unique_call 28} $galloc(.str.24, 42);
    assume true;
    call {:si_unique_call 29} $galloc(.str.25, 41);
    assume true;
    call {:si_unique_call 30} $galloc(.str.26, 21);
    assume true;
    call {:si_unique_call 31} $galloc(pointerlockchange_callback, 4);
    assume true;
    call {:si_unique_call 32} $galloc(pointerlockerror_callback, 4);
    assume true;
    call {:si_unique_call 33} $galloc(__SMACK_nondet_signed_int, 4);
    assume true;
    ...
    assume true;
    call {:si_unique_call 37} $galloc(__SMACK_nondet_long_int, 4);
    assume true;
    call {:si_unique_call 38} $galloc(.str.24.50, 28);
    assume true;
    call {:si_unique_call 39} $galloc(.str.25.51, 26);
    assume true;
    call {:si_unique_call 40} $galloc(env_value_str, 4);
    assume true;
    call {:si_unique_call 41} $galloc(.str.2.52, 3);
    assume true;
    call {:si_unique_call 42} $galloc(.str.53, 49);
    assume true;
    call {:si_unique_call 43} $galloc(.str.1.54, 14);
    assume true;
    call {:si_unique_call 44} $galloc(errno_global, 4);
    assume true;
    call {:si_unique_call 45} $galloc(click_callback, 4);
    assume true;
    call {:si_unique_call 46} $galloc(emscripten_request_pointerlock, 4);
    assume true;
    call {:si_unique_call 47} $galloc(main, 4);
    assume true;
    call {:si_unique_call 48} $galloc(emscripten_set_canvas_element_size, 4);
    assume true;
    call {:si_unique_call 49} $galloc(emscripten_asm_const_int, 4);
    assume true;
    call {:si_unique_call 50} $galloc(emscripten_set_click_callback_on_thread, 4);
    assume true;
    call {:si_unique_call 51} $galloc(emscripten_set_pointerlockchange_callback_on_thread, 4);
    assume true;
    call {:si_unique_call 52} $galloc(emscripten_set_pointerlockerror_callback_on_thread, 4);
    assume true;
    call {:si_unique_call 53} $galloc(__VERIFIER_assume, 4);
    assume true;
    call {:si_unique_call 54} $galloc(__SMACK_code, 4);
    assume true;
    call {:si_unique_call 55} $galloc(__SMACK_dummy, 4);
    assume true;
    call {:si_unique_call 56} $galloc(__SMACK_nondet_unsigned_short, 4);
    assume true;
    call {:si_unique_call 57} $galloc(__SMACK_check_overflow, 4);
    assume true;
    call {:si_unique_call 58} $galloc(__SMACK_nondet_char, 4);
    assume true;
    call {:si_unique_call 59} $galloc(__SMACK_nondet_signed_char, 4);
    assume true;
    call {:si_unique_call 60} $galloc(__SMACK_nondet_unsigned_char, 4);
    assume true;
    call {:si_unique_call 61} $galloc(__SMACK_nondet_short, 4);
    assume true;
    call {:si_unique_call 62} $galloc(__SMACK_nondet_signed_short, 4);
    assume true;
    call {:si_unique_call 63} $galloc(__SMACK_nondet_signed_short_int, 4);
    assume true;
    call {:si_unique_call 64} $galloc(__SMACK_nondet_unsigned_short_int, 4);
    assume true;
    call {:si_unique_call 65} $galloc(__SMACK_nondet_int, 4);
    assume true;
    call {:si_unique_call 66} $galloc(llvm.dbg.value, 4);
    assume true;
    call {:si_unique_call 67} $galloc(__SMACK_nondet_signed_long, 4);
    assume true;
    call {:si_unique_call 68} $galloc(__SMACK_nondet_signed_long_int, 4);
    assume true;
    call {:si_unique_call 69} $galloc(__SMACK_nondet_unsigned_long, 4);
    assume true;
    call {:si_unique_call 70} $galloc(__SMACK_nondet_unsigned_long_int, 4);
    assume true;
    call {:si_unique_call 71} $galloc(__SMACK_nondet_long_long, 4);
    assume true;
    call {:si_unique_call 72} $galloc(__SMACK_nondet_long_long_int, 4);
    assume true;
    call {:si_unique_call 73} $galloc(__SMACK_nondet_signed_long_long, 4);
    assume true;
    call {:si_unique_call 74} $galloc(__SMACK_nondet_signed_long_long_int, 4);
    assume true;
    call {:si_unique_call 75} $galloc(__SMACK_nondet_unsigned_long_long, 4);
    assume true;
    call {:si_unique_call 76} $galloc(__SMACK_nondet_unsigned_long_long_int, 4);
    assume true;
    call {:si_unique_call 77} $galloc(__SMACK_decls, 4);
    assume true;
    call {:si_unique_call 78} $galloc(__SMACK_top_decl, 4);
    assume true;
    call {:si_unique_call 79} $galloc(__SMACK_check_memory_safety, 4);
    assume true;
    call {:si_unique_call 80} $galloc(__SMACK_check_memory_leak, 4);
    assume true;
    call {:si_unique_call 81} $galloc(__SMACK_init_func_memory_model, 4);
    assume true;
    call {:si_unique_call 82} $galloc(__SMACK_static_init, 4);
    assume true;
    return;
}
...
implementation report_result($i0: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 83} {:cexpr "report_result:arg:result"} boogie_si_record_i32($i0);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 15, 14} true;
    assume {:verifier.code 0} true;
    $i1 := $eq.i32($i0, 0);
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 84} vslice_dummy_var_0 := printf.ref(.str.1);
    assume true;
    assume {:verifier.code 0} true;
    goto $bb3;
  ...
  $bb1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 85} vslice_dummy_var_1 := printf.ref(.str);
    assume true;
...
implementation emscripten_result_to_string($i0: i32) returns ($r: ref)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 86} {:cexpr "emscripten_result_to_string:arg:result"} boogie_si_record_i32($i0);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 26, 14} true;
    assume {:verifier.code 0} true;
    $i1 := $eq.i32($i0, 0);
...
implementation click_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  AvnSeqInstr_90:
    ...
    assume {:verifier.code 0} true;
    $M.8 := 1;
    call {:si_unique_call 88} {:cexpr "gotClick"} boogie_si_record_i32(1);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 48, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 89} vslice_dummy_var_2 := printf.ref(.str.12);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 49, 31} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 90} $i51 := emscripten_request_pointerlock($0.ref, 0);
    assume true;
    call {:si_unique_call 91} {:cexpr "ret"} boogie_si_record_i32($i51);
    assume true;
  ...
  $bb26:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 92} vslice_dummy_var_3 := printf.ref(.str.15);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 53, 9} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 93} report_result(1);
    assume true;
  ...
  $bb23:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 50, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 94} $p53 := emscripten_result_to_string($i51);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 50, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} vslice_dummy_var_4 := printf.ref.ref.ref(.str.13, .str.14, $p53);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 50, 7} true;
    assume {:verifier.code 0} true;
    goto $bb25;
...
procedure main() returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.9, $M.10, $M.8, $M.11, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    call {:si_unique_call 96} $initialize();
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 83, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 97} {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
    assume true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 98} $p0 := $alloc($mul.ref(1, 1));
    assume true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 99} $p1 := $alloc($mul.ref(1, 1));
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 83, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 100} vslice_dummy_var_5 := printf.ref(.str.19);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 84, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 101} vslice_dummy_var_6 := printf.ref(.str.20);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 87, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 102} vslice_dummy_var_7 := emscripten_set_canvas_element_size(.str.21, 400, 300);
    assume true;
  ...
  AvnSeqInstr_99:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 88, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 103} vslice_dummy_var_8 := emscripten_asm_const_int.ref.ref(.str.22, $p8);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 90, 27} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 104} $i10 := emscripten_set_click_callback_on_thread($i2p.i32.ref(2), $0.ref, 1, click_callback, $i2p.i32.ref(2));
    assume true;
    call {:si_unique_call 105} {:cexpr "ret"} boogie_si_record_i32($i10);
    assume true;
  ...
  $bb3:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 106} $i14 := emscripten_set_pointerlockchange_callback_on_thread($i2p.i32.ref(2), $0.ref, 1, pointerlockchange_callback, $i2p.i32.ref(2));
    assume true;
    call {:si_unique_call 107} {:cexpr "ret"} boogie_si_record_i32($i14);
    assume true;
  ...
  $bb6:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 108} $i18 := emscripten_set_pointerlockerror_callback_on_thread($i2p.i32.ref(2), $0.ref, 1, pointerlockerror_callback, $i2p.i32.ref(2));
    assume true;
    call {:si_unique_call 109} {:cexpr "ret"} boogie_si_record_i32($i18);
    assume true;
  ...
  AvnSeqInstr_108:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 99, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 110} vslice_dummy_var_9 := emscripten_asm_const_int.ref.ref(.str.26, $p25);
    assume true;
    call {:si_unique_call 111} __SMACK_check_memory_leak();
  ...
  $bb7:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 95, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 112} $p20 := emscripten_result_to_string($i18);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 95, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 113} vslice_dummy_var_10 := printf.ref.ref.ref(.str.13, .str.25, $p20);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 95, 3} true;
    assume {:verifier.code 0} true;
    goto $bb9;
  ...
  $bb4:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 93, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 114} $p16 := emscripten_result_to_string($i14);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 93, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 115} vslice_dummy_var_11 := printf.ref.ref.ref(.str.13, .str.24, $p16);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 93, 3} true;
    assume {:verifier.code 0} true;
    goto $bb6;
  ...
  $bb1:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 91, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 116} $p12 := emscripten_result_to_string($i10);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 91, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 117} vslice_dummy_var_12 := printf.ref.ref.ref(.str.13, .str.23, $p12);
    assume true;
    assume {:sourceloc "test_html5_pointerlockerror.c", 91, 3} true;
    assume {:verifier.code 0} true;
    goto $bb3;
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 119} corral_atomic_begin();
    assume true;
    inline$$$alloc$0$n := n;
    call {:si_unique_call 120} inline$$$alloc$0$p := havocNonDetAvh.ref();
    assume true;
  ...
  inline$$$alloc$0$Return:
    p := inline$$$alloc$0$p;
    call {:si_unique_call 121} corral_atomic_end();
    assume true;
    return;
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 122} cmdloc_dummy_var_0 := havocNonDetAvh.ref();
    assume true;
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    $M.8 := 0;
    call {:si_unique_call 123} {:cexpr "gotClick"} boogie_si_record_i32(0);
    assume true;
    $M.11 := .str.2.52;
    call {:si_unique_call 124} {:cexpr "errno_global"} boogie_si_record_i32(0);
    assume true;
    return;
}
...
procedure $initialize();
  free requires assertsPassed;
  modifies $M.8, $M.11, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation $initialize()
{
  ...
  anon0:
    call {:si_unique_call 125} $global_allocations();
    assume true;
    call {:si_unique_call 126} __SMACK_static_init();
    assume true;
    call {:si_unique_call 127} __SMACK_init_func_memory_model();
    assume true;
    return;
}
...
implementation CorralMain()
{
  ...
  L_BAF_1:
    ...
    call {:si_unique_call 132} {:AvhEntryPoint} vslice_dummy_var_13 := main();
  ...
  L_BAF_0:
    ...
    assume MustReach(true);
    call {:si_unique_call 135} {:AvhEntryPoint} vslice_dummy_var_14 := click_callback($i0_click_callback, $p1_click_callback, $p2_click_callback);
