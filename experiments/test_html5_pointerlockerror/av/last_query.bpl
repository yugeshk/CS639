...
procedure CorralMain_trace_1();
  free requires assertsPassed;
  free requires {:BlockingConstraint 0} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(4, 1))))]);
  free requires {:BlockingConstraint 1} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(4, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(4, 1)))));
  free requires {:BlockingConstraint 2} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(0, 1))))]);
  free requires {:BlockingConstraint 3} true ==> $sle.ref.bool($add.ref($bitcast.ref.ref(gotClick), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref(gotClick)), $Size($base($bitcast.ref.ref(gotClick)))));
  free requires {:BlockingConstraint 4} true ==> $sle.ref.bool($base($bitcast.ref.ref(gotClick)), $bitcast.ref.ref(gotClick));
  free requires {:BlockingConstraint 5} true ==> $Alloc[$base($bitcast.ref.ref(gotClick))];
  ...
  free requires {:BlockingConstraint 7} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(0, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(0, 1)))));
  free requires {:BlockingConstraint 8} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(48, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(48, 1)))));
  free requires {:BlockingConstraint 9} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(44, 1))), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(44, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(44, 1))))))));
  free requires {:BlockingConstraint 10} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 64)), $mul.ref(12, 1))))]);
  modifies $M.11, $exnv, $allocatedCounter, $CurrAddr, assertsPassed, $M.9, $M.10, $M.8, $Alloc;



procedure click_callback_trace_1($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.8;



implementation {:origRTname "click_callback"} click_callback_trace_1($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  var $p3: ref;
  var $p4: ref;
  var $p5: ref;
  ...
  $bb0__unique__1:
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i6 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i6);
    call {:ConcretizeConstantName "InitLocalVar"} $i7 := init_locals_nondet_tmp_i1();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i12 := init_locals_nondet_tmp_i1();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i16 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i16);
    call {:ConcretizeConstantName "InitLocalVar"} $i17 := init_locals_nondet_tmp_i1();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i22 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i22);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i31 := init_locals_nondet_tmp_i32();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i42 := init_locals_nondet_tmp_i1();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i47 := init_locals_nondet_tmp_i1();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p49 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p49);
    call {:ConcretizeConstantName "InitLocalVar"} $i51 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i51);
    call {:ConcretizeConstantName "InitLocalVar"} $i52 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i52);
    call {:ConcretizeConstantName "InitLocalVar"} $p53 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p53);
    call {:ConcretizeConstantName "InitLocalVar"} $i55 := init_locals_nondet_tmp_i1();
    ...
    call corral_fix_context_0();
    call {:si_unique_call 87} {:cexpr "click_callback:arg:eventType"} boogie_si_record_i32($i0);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 10} true;
  ...
  $bb1__unique__8:
    ...
    goto AvnSeqInstr_11__unique__9;

  AvnSeqInstr_11__unique__9:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_12__unique__10;

  AvnSeqInstr_12__unique__10:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$1$p), inline$__SMACK_check_memory_safety$1$p);
    goto AvnSeqInstr_14__unique__11;

  AvnSeqInstr_14__unique__11:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_15__unique__12;

  AvnSeqInstr_15__unique__12:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_17__unique__13;

  AvnSeqInstr_17__unique__13:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_18__unique__14;

  AvnSeqInstr_18__unique__14:
    call corral_fix_context_0();
    assume {:sourceloc "test_html5_pointerlockerror.c", 44, 29} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
  ...
  $bb4__unique__15:
    ...
    goto AvnSeqInstr_19__unique__16;

  AvnSeqInstr_19__unique__16:
    call corral_fix_context_0();
...
implementation {:origRTname "CorralMain"} CorralMain_trace_1()
{
  ...
  CorralMainStart__unique__1:
    ...
    call boogie_si_record_sdvcp_int(vslice_dummy_var_13);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_14 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_14);
    call corral_fix_context_0();
    call {:ConcretizeCallId 0} {:si_unique_call 128} {:ConcretizeConstantName "$M.11"} cmdloc_dummy_var_1 := unknown_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_1);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 1} {:si_unique_call 129} {:ConcretizeConstantName "$exnv"} cmdloc_dummy_var_2 := unknown_int();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_2);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 2} {:si_unique_call 130} {:ConcretizeConstantName "$allocatedCounter"} cmdloc_dummy_var_3 := unknown_int();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_3);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 3} {:si_unique_call 131} {:ConcretizeConstantName "$CurrAddr"} cmdloc_dummy_var_4 := unknown_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_4);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
  ...
  L_BAF_0__unique__2:
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 4} {:si_unique_call 133} {:ConcretizeConstantName "$p1_click_callback"} $p1_click_callback := unknown_ref();
    call boogie_si_record_sdvcp_int($p1_click_callback);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume unknownTrigger_4($p1_click_callback);
    call corral_fix_context_0();
    call {:ConcretizeCallId 5} {:si_unique_call 134} {:ConcretizeConstantName "$p2_click_callback"} $p2_click_callback := unknown_ref();
    call boogie_si_record_sdvcp_int($p2_click_callback);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume unknownTrigger_5($p2_click_callback);
    call corral_fix_context_0();
    assume MustReach(true);
    call corral_fix_context_0();
    call {:si_unique_call 135} {:AvhEntryPoint} vslice_dummy_var_14 := click_callback_trace_1($i0_click_callback, $p1_click_callback, $p2_click_callback);
    goto AvnSeqInstr_118__unique__3;

  AvnSeqInstr_118__unique__3:
    call corral_fix_context_0();
    assume !assertsPassed;
    return;
}
