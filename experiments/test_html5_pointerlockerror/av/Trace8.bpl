...
procedure main() returns ($r: i32);
  modifies $M.9, $M.10, $M.8, $M.11, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation __SMACK_check_overflow($i0: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 118} {:cexpr "__SMACK_check_overflow:arg:flag"} boogie_si_record_i32($i0);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
...
procedure {:entrypoint} CorralMain();
  modifies $M.11, $exnv, $allocatedCounter, $CurrAddr, $M.9, $M.10, $M.8, $Alloc;
...
implementation havocNonDetAvh.ref() returns (o: ref)
{
  ...
  L_BAF_17:
    call {:ConcretizeCallId 6} {:si_unique_call 136} {:ConcretizeConstantName "o"} o := unknown_ref();
    assume unknownTrigger_6(o);
    return;
}
