...
implementation report_result($i0: i32)
{
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 84} $i3 := printf.ref(.str.1);
    assume {:verifier.code 0} true;
    goto $bb3;
  ...
  $bb1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 85} $i2 := printf.ref(.str);
...
implementation click_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb22$1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 89} $i50 := printf.ref(.str.12);
  ...
  $bb26:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 92} $i56 := printf.ref(.str.15);
  ...
  $bb23:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 50, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} $i54 := printf.ref.ref.ref(.str.13, .str.14, $p53);
    assume {:sourceloc "test_html5_pointerlockerror.c", 50, 7} true;
    assume {:verifier.code 0} true;
    goto $bb25;
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 83, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 100} $i2 := printf.ref(.str.19);
    assume {:sourceloc "test_html5_pointerlockerror.c", 84, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 101} $i3 := printf.ref(.str.20);
    assume {:sourceloc "test_html5_pointerlockerror.c", 87, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 102} $i4 := emscripten_set_canvas_element_size(.str.21, 400, 300);
  ...
  $bb0$1:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 88, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 103} $i9 := emscripten_asm_const_int.ref.ref(.str.22, $p8);
  ...
  $bb9$1:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 99, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 110} $i26 := emscripten_asm_const_int.ref.ref(.str.26, $p25);
  ...
  $bb7:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 95, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 113} $i21 := printf.ref.ref.ref(.str.13, .str.25, $p20);
    assume {:sourceloc "test_html5_pointerlockerror.c", 95, 3} true;
    assume {:verifier.code 0} true;
    goto $bb9;
  ...
  $bb4:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 93, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 115} $i17 := printf.ref.ref.ref(.str.13, .str.24, $p16);
    assume {:sourceloc "test_html5_pointerlockerror.c", 93, 3} true;
    assume {:verifier.code 0} true;
    goto $bb6;
  ...
  $bb1:
    ...
    assume {:sourceloc "test_html5_pointerlockerror.c", 91, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 117} $i13 := printf.ref.ref.ref(.str.13, .str.23, $p12);
    assume {:sourceloc "test_html5_pointerlockerror.c", 91, 3} true;
    assume {:verifier.code 0} true;
    goto $bb3;
}
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 122} $CurrAddr := havocNonDetAvh.ref();
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeCallId 0} {:si_unique_call 128} {:ConcretizeConstantName "$M.11"} $M.11 := unknown_ref();
    assume unknownTrigger_0($M.11);
    call {:ConcretizeCallId 1} {:si_unique_call 129} {:ConcretizeConstantName "$exnv"} $exnv := unknown_int();
    assume unknownTrigger_1($exnv);
    call {:ConcretizeCallId 2} {:si_unique_call 130} {:ConcretizeConstantName "$allocatedCounter"} $allocatedCounter := unknown_int();
    assume unknownTrigger_2($allocatedCounter);
    call {:ConcretizeCallId 3} {:si_unique_call 131} {:ConcretizeConstantName "$CurrAddr"} $CurrAddr := unknown_ref();
  ...
  L_BAF_1:
    ...
    call {:si_unique_call 132} {:AvhEntryPoint} $r_main := main();
    return;
  ...
  L_BAF_0:
    ...
    assume MustReach(true);
    call {:si_unique_call 135} {:AvhEntryPoint} $r_click_callback := click_callback($i0_click_callback, $p1_click_callback, $p2_click_callback);
    return;
}
