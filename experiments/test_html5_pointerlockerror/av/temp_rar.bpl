...
implementation pointerlockchange_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:cexpr "pointerlockchange_callback:arg:eventType"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_html5_pointerlockerror.c", 62, 3} true;
    assume {:verifier.code 0} true;
...
procedure pointerlockerror_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  modifies $exn;



implementation pointerlockerror_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  var $i3: i1;
  var $i4: i32;
  var $i5: i32;
  ...
  $bb0:
    assume {:sourceloc "test_html5_pointerlockerror.c", 69, 17} true;
    assume {:verifier.code 0} true;
    call {:cexpr "pointerlockerror_callback:arg:eventType"} boogie_si_record_i32($i0);
    assume {:sourceloc "test_html5_pointerlockerror.c", 69, 17} true;
    assume {:verifier.code 0} true;
    $i3 := $ne.i32($i0, 38);
    assume {:sourceloc "test_html5_pointerlockerror.c", 69, 7} true;
    assume {:verifier.code 0} true;
    assume {:branchcond $i3} true;
    goto $bb1, $bb2;
  ...
  $bb2:
    assume !($i3 == 1);
    assume {:sourceloc "test_html5_pointerlockerror.c", 75, 3} true;
    assume {:verifier.code 0} true;
    call $i5 := printf.ref(.str.18);
    assume {:sourceloc "test_html5_pointerlockerror.c", 76, 3} true;
    assume {:verifier.code 0} true;
    call report_result(0);
    assume {:sourceloc "test_html5_pointerlockerror.c", 78, 3} true;
    assume {:verifier.code 0} true;
    goto $bb3;

  $bb3:
    assume {:sourceloc "test_html5_pointerlockerror.c", 79, 1} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
  ...
  $bb1:
    assume $i3 == 1;
    assume {:sourceloc "test_html5_pointerlockerror.c", 70, 5} true;
    assume {:verifier.code 0} true;
    call $i4 := printf.ref(.str.17);
    assume {:sourceloc "test_html5_pointerlockerror.c", 71, 5} true;
    assume {:verifier.code 0} true;
    call report_result(1);
    assume {:sourceloc "test_html5_pointerlockerror.c", 72, 5} true;
    assume {:verifier.code 0} true;
    goto $bb3;
}
...
implementation CorralMain()
{
  ...
  L_BAF_5:
    assume __block_call_pointerlockerror_callback;
    call {:ConcretizeConstantName "$p1_pointerlockerror_callback"} $p1_pointerlockerror_callback := unknown_ref();
    call {:ConcretizeConstantName "$p2_pointerlockerror_callback"} $p2_pointerlockerror_callback := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_pointerlockerror_callback := pointerlockerror_callback($i0_pointerlockerror_callback, $p1_pointerlockerror_callback, $p2_pointerlockerror_callback);
    return;

  L_BAF_4:
    assume __block_call_pointerlockchange_callback;
    call {:ConcretizeConstantName "$p1_pointerlockchange_callback"} $p1_pointerlockchange_callback := unknown_ref();
    call {:ConcretizeConstantName "$p2_pointerlockchange_callback"} $p2_pointerlockchange_callback := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_pointerlockchange_callback := pointerlockchange_callback($i0_pointerlockchange_callback, $p1_pointerlockchange_callback, $p2_pointerlockchange_callback);
    return;
