...
procedure CorralMain_trace_1();
  free requires assertsPassed;
  free requires {:BlockingConstraint 0} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1))))]);
  free requires {:BlockingConstraint 1} (forall x_5: ref :: unknownTrigger_6(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(4, 1))))]);
  free requires {:BlockingConstraint 2} (forall x_5: ref :: unknownTrigger_6(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(4, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(4, 1)))));
  free requires {:BlockingConstraint 3} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1)))));
  free requires {:BlockingConstraint 4} (forall x_5: ref :: unknownTrigger_6(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(4, 1))), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(4, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(4, 1))))))));
  free requires {:BlockingConstraint 5} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1))), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(4, 1))))))));
  free requires {:BlockingConstraint 6} (forall x_5: ref :: unknownTrigger_6(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(8, 1))), $bitcast.ref.ref($i2p.i64.ref(2))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(8, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(8, 1))))))));
  free requires {:BlockingConstraint 7} (forall x_5: ref :: unknownTrigger_6(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(8, 1))))]);
  free requires {:BlockingConstraint 8} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1))), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1))))))));
  free requires {:BlockingConstraint 9} (forall x_5: ref :: unknownTrigger_6(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(8, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 524)), $mul.ref(8, 1)))));
  free requires {:BlockingConstraint 10} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1))))]);
  free requires {:BlockingConstraint 11} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 16)), $mul.ref(8, 1)))));
  modifies $M.11, $exnv, $allocatedCounter, $CurrAddr, assertsPassed, $M.2, $Alloc;



procedure WebSocketMessage_trace_1(eventType: i32, e: ref, userData: ref) returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed;



implementation {:origRTname "WebSocketMessage"} WebSocketMessage_trace_1(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  var $i0: i32;
  var $p1: ref;
  var $p2: ref;
  ...
  $bb0__unique__1:
    call {:ConcretizeConstantName "InitLocalVar"} $i0 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i0);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p9 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p9);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i12 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i12);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i17 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i17);
    call {:ConcretizeConstantName "InitLocalVar"} $i18 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i18);
    call {:ConcretizeConstantName "InitLocalVar"} $p19 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p19);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i25 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i25);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p28 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p28);
    call {:ConcretizeConstantName "InitLocalVar"} $i29 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i29);
    call {:ConcretizeConstantName "InitLocalVar"} $i30 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i30);
    call {:ConcretizeConstantName "InitLocalVar"} $p31 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p31);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p35 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p35);
    call {:ConcretizeConstantName "InitLocalVar"} $p36 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p36);
    call {:ConcretizeConstantName "InitLocalVar"} $p37 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p37);
    call {:ConcretizeConstantName "InitLocalVar"} $i38 := init_locals_nondet_tmp_i8();
    call boogie_si_record_sdvcp_int($i38);
    call {:ConcretizeConstantName "InitLocalVar"} $i39 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i39);
    call {:ConcretizeConstantName "InitLocalVar"} $i41 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i41);
    call {:ConcretizeConstantName "InitLocalVar"} $p43 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p43);
    call {:ConcretizeConstantName "InitLocalVar"} $p44 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p44);
    call {:ConcretizeConstantName "InitLocalVar"} $p45 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p45);
    call {:ConcretizeConstantName "InitLocalVar"} $i46 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i46);
    ...
    call boogie_si_record_sdvcp_int(vslice_dummy_var_5);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_6 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_6);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_7 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_7);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_8 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_8);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_9 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_9);
    ...
    call corral_fix_context_0();
    call {:si_unique_call 82} {:cexpr "WebSocketMessage:arg:eventType"} boogie_si_record_i32(eventType);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume {:sourceloc "websocket.c", 32, 93} true;
    ...
    assume {:verifier.code 0} true;
    call corral_fix_context_0();
    $i0 := $p2i.ref.i32(userData);
    call corral_fix_context_0();
    assume {:sourceloc "websocket.c", 32, 111} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    call corral_fix_context_0();
    $p1 := $add.ref($add.ref(e, $mul.ref(0, 16)), $mul.ref(4, 1));
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_65__unique__2;

  AvnSeqInstr_65__unique__2:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_66__unique__3;

  AvnSeqInstr_66__unique__3:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$0$p), inline$__SMACK_check_memory_safety$0$p);
    goto AvnSeqInstr_68__unique__4;

  AvnSeqInstr_68__unique__4:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_69__unique__5;

  AvnSeqInstr_69__unique__5:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_71__unique__6;

  AvnSeqInstr_71__unique__6:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_72__unique__7;

  AvnSeqInstr_72__unique__7:
    call corral_fix_context_0();
    assume {:sourceloc "websocket.c", 32, 111} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    ...
    assume {:verifier.code 0} true;
    call corral_fix_context_0();
    $p5 := $add.ref($add.ref(e, $mul.ref(0, 16)), $mul.ref(8, 1));
    call corral_fix_context_0();
    $p6 := $bitcast.ref.ref($p5);
    call corral_fix_context_0();
    $p7 := $bitcast.ref.ref($i2p.i64.ref(4));
    call corral_fix_context_0();
    inline$__SMACK_check_memory_safety$1$p := $p6;
    call corral_fix_context_0();
    inline$__SMACK_check_memory_safety$1$size := $p7;
    call corral_fix_context_0();
    assertsPassed := $Alloc[$base(inline$__SMACK_check_memory_safety$1$p)];
    goto AvnSeqInstr_74__unique__8;

  AvnSeqInstr_74__unique__8:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_75__unique__9;

  AvnSeqInstr_75__unique__9:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$1$p), inline$__SMACK_check_memory_safety$1$p);
    goto AvnSeqInstr_77__unique__10;

  AvnSeqInstr_77__unique__10:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_78__unique__11;

  AvnSeqInstr_78__unique__11:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_80__unique__12;

  AvnSeqInstr_80__unique__12:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_81__unique__13;

  AvnSeqInstr_81__unique__13:
    call corral_fix_context_0();
    assume {:sourceloc "websocket.c", 32, 120} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    ...
    assume {:verifier.code 0} true;
    call corral_fix_context_0();
    $p9 := $add.ref($add.ref(e, $mul.ref(0, 16)), $mul.ref(12, 1));
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_82__unique__14;

  AvnSeqInstr_82__unique__14:
    call corral_fix_context_0();
...
implementation {:origRTname "CorralMain"} CorralMain_trace_1()
{
  ...
  CorralMainStart__unique__1:
    ...
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_8);
    call {:ConcretizeConstantName "InitLocalVar"} cmdloc_dummy_var_9 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_9);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_17 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_17);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_18 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_18);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_19 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_19);
    call corral_fix_context_0();
    call {:ConcretizeCallId 0} {:si_unique_call 119} {:ConcretizeConstantName "$M.11"} cmdloc_dummy_var_6 := unknown_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_6);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    $M.11 := cmdloc_dummy_var_6;
    call corral_fix_context_0();
    assume unknownTrigger_0($M.11);
    call corral_fix_context_0();
    call {:ConcretizeCallId 1} {:si_unique_call 120} {:ConcretizeConstantName "$exnv"} cmdloc_dummy_var_7 := unknown_int();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_7);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 2} {:si_unique_call 121} {:ConcretizeConstantName "$allocatedCounter"} cmdloc_dummy_var_8 := unknown_int();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_8);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 3} {:si_unique_call 122} {:ConcretizeConstantName "$CurrAddr"} cmdloc_dummy_var_9 := unknown_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_9);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    goto L_BAF_2__unique__2;

  L_BAF_2__unique__2:
    call corral_fix_context_0();
    assume __block_call_WebSocketMessage;
    call corral_fix_context_0();
    call {:ConcretizeCallId 4} {:si_unique_call 123} {:ConcretizeConstantName "e_WebSocketMessage"} e_WebSocketMessage := unknown_ref();
    call boogie_si_record_sdvcp_int(e_WebSocketMessage);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume unknownTrigger_4(e_WebSocketMessage);
    call corral_fix_context_0();
    call {:ConcretizeCallId 5} {:si_unique_call 124} {:ConcretizeConstantName "userData_WebSocketMessage"} userData_WebSocketMessage := unknown_ref();
    call boogie_si_record_sdvcp_int(userData_WebSocketMessage);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume unknownTrigger_5(userData_WebSocketMessage);
    call corral_fix_context_0();
    assume MustReach(true);
    call corral_fix_context_0();
    call {:si_unique_call 125} {:AvhEntryPoint} vslice_dummy_var_17 := WebSocketMessage_trace_1(eventType_WebSocketMessage, e_WebSocketMessage, userData_WebSocketMessage);
    goto AvnSeqInstr_151__unique__3;

  AvnSeqInstr_151__unique__3:
    call corral_fix_context_0();
    assume !assertsPassed;
    return;
}
