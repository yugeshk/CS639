...
implementation WebSocketOpen(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 75} vslice_dummy_var_0 := printf.ref.i32.i32(.str, eventType, $i1);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 76} vslice_dummy_var_1 := emscripten_websocket_send_utf8_text($i6, .str.1);
    ...
    call {:si_unique_call 77} cmdloc_dummy_var_2 := $memcpy.i8(cmdloc_dummy_var_0, cmdloc_dummy_var_1, $p8, __const.WebSocketOpen.data, 11, false);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 78} vslice_dummy_var_2 := emscripten_websocket_send_binary($i16, $p17, 11);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 79} vslice_dummy_var_3 := emscripten_websocket_close($i22, 0, $0.ref);
...
implementation WebSocketClose(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 81} vslice_dummy_var_4 := printf.ref.i32.i32.i32.ref.i32(.str.2, eventType, $i3, $i8, $p10, $i11);
...
implementation WebSocketMessage(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 83} vslice_dummy_var_5 := printf.ref.i32.i32.ref.i32.i32(.str.4, eventType, $i0, $p4, $i8, $i12);
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 84} vslice_dummy_var_6 := printf.ref(.str.6);
  ...
  $bb6:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 85} vslice_dummy_var_7 := printf.ref(.str.8);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 86} vslice_dummy_var_8 := emscripten_websocket_delete($i46);
  ...
  $bb5:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 88} vslice_dummy_var_9 := printf.ref.i32(.str.7, $i39);
    assume {:sourceloc "websocket.c", 39, 4} true;
    assume {:verifier.code 0} true;
  ...
  $bb1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 90} vslice_dummy_var_10 := printf.ref.ref(.str.5, $p22);
    assume {:sourceloc "websocket.c", 34, 3} true;
    assume {:verifier.code 0} true;
...
procedure main() returns ($r: i32);
  modifies $M.10, $M.1, $M.11, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation main() returns ($r: i32)
{
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} vslice_dummy_var_11 := printf.ref(.str.9);
  ...
  $bb1:
    ...
    call {:si_unique_call 97} cmdloc_dummy_var_4 := $memset.i8(cmdloc_dummy_var_3, $p4, 0, 12, false);
    $M.10 := cmdloc_dummy_var_4;
    assume {:sourceloc "websocket.c", 57, 2} true;
    assume {:verifier.code 0} true;
  ...
  $bb6:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 100} vslice_dummy_var_12 := emscripten_websocket_set_onopen_callback_on_thread($i10, $i2p.i32.ref(42), WebSocketOpen, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 69, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 101} vslice_dummy_var_13 := emscripten_websocket_set_onclose_callback_on_thread($i10, $i2p.i32.ref(43), WebSocketClose, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 70, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 102} vslice_dummy_var_14 := emscripten_websocket_set_onerror_callback_on_thread($i10, $i2p.i32.ref(44), WebSocketError, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 71, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 103} vslice_dummy_var_15 := emscripten_websocket_set_onmessage_callback_on_thread($i10, $i2p.i32.ref(45), WebSocketMessage, $i2p.i32.ref(2));
  ...
  $bb5:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 105} vslice_dummy_var_16 := printf.ref.i32(.str.11, $i10);
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 111} cmdloc_dummy_var_5 := havocNonDetAvh.ref();
...
procedure $initialize();
  modifies $M.1, $M.11, $CurrAddr, $allocatedCounter, $Alloc;
...
procedure {:entrypoint} CorralMain();
  modifies $M.11, $exnv, $allocatedCounter, $CurrAddr, $M.2, $Alloc;
...
implementation CorralMain()
{
  ...
  L_BAF_2:
    ...
    call {:si_unique_call 125} {:AvhEntryPoint} vslice_dummy_var_17 := WebSocketMessage(eventType_WebSocketMessage, e_WebSocketMessage, userData_WebSocketMessage);
    return;
  ...
  L_BAF_1:
    ...
    assume MustReach(true);
    call {:si_unique_call 128} {:AvhEntryPoint} vslice_dummy_var_18 := WebSocketClose(eventType_WebSocketClose, e_WebSocketClose, userData_WebSocketClose);
    return;
  ...
  L_BAF_0:
    ...
    assume MustReach(true);
    call {:si_unique_call 131} {:AvhEntryPoint} vslice_dummy_var_19 := WebSocketOpen(eventType_WebSocketOpen, e_WebSocketOpen, userData_WebSocketOpen);
    return;
}
