...
implementation $global_allocations()
{
  ...
  anon0:
    ...
    call $galloc(WebSocketOpen, 4);
    call $galloc(printf, 4);
    call $galloc(emscripten_websocket_send_utf8_text, 4);
    call $galloc(llvm.memcpy.p0i8.p0i8.i32, 4);
    call $galloc(emscripten_websocket_send_binary, 4);
    call $galloc(.str.6, 13);
    call $galloc(.str.7, 6);
    call $galloc(.str.1, 24);
    call $galloc(__const.WebSocketOpen.data, 11);
    call $galloc(.str.2, 67);
    call $galloc(.str.3, 34);
    call $galloc(.str.5, 17);
    call $galloc(.str, 33);
    call $galloc(.str.4, 69);
    call $galloc(.str.8, 2);
    call $galloc(.str.9, 48);
    call $galloc(.str.10, 20);
    call $galloc(.str.11, 43);
    ...
    call $galloc(emscripten_websocket_close, 4);
    call $galloc(WebSocketClose, 4);
    call $galloc(WebSocketError, 4);
    call $galloc(WebSocketMessage, 4);
    call $galloc(emscripten_websocket_delete, 4);
    call $galloc(main, 4);
    call $galloc(emscripten_websocket_is_supported, 4);
    call $galloc(llvm.memset.p0i8.i32, 4);
    call $galloc(emscripten_websocket_new, 4);
    call $galloc(emscripten_websocket_set_onopen_callback_on_thread, 4);
    call $galloc(emscripten_websocket_set_onclose_callback_on_thread, 4);
    call $galloc(emscripten_websocket_set_onerror_callback_on_thread, 4);
    call $galloc(emscripten_websocket_set_onmessage_callback_on_thread, 4);
...
procedure WebSocketOpen(eventType: i32, e: ref, userData: ref) returns ($r: i32);
  modifies $M.2, $exn, $CurrAddr, $Alloc;



implementation WebSocketOpen(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  var $p0: ref;
  var $i1: i32;
  var $i2: i32;
  ...
  $bb0:
    assume {:sourceloc "websocket.c", 7, 57} true;
    assume {:verifier.code 0} true;
    assume {:verifier.code 0} true;
    call $p0 := $alloc($mul.ref(11, 1));
    call {:cexpr "WebSocketOpen:arg:eventType"} boogie_si_record_i32(eventType);
    assume {:sourceloc "websocket.c", 7, 57} true;
    assume {:verifier.code 0} true;
    $i1 := $p2i.ref.i32(userData);
    assume {:sourceloc "websocket.c", 7, 2} true;
    assume {:verifier.code 0} true;
    call $i2 := printf.ref.i32.i32(.str, eventType, $i1);
    assume {:sourceloc "websocket.c", 9, 41} true;
    assume {:verifier.code 0} true;
    $p3 := $add.ref($add.ref(e, $mul.ref(0, 4)), $mul.ref(0, 1));
  ...
  $bb0$1:
    ...
    assume {:verifier.code 0} true;
    $i6 := $load.i32($M.0, $p3);
    assume {:sourceloc "websocket.c", 9, 2} true;
    assume {:verifier.code 0} true;
    call $i7 := emscripten_websocket_send_utf8_text($i6, .str.1);
    assume true;
    assume {:sourceloc "websocket.c", 11, 7} true;
    assume {:verifier.code 0} true;
  ...
  $bb0$2:
    $p11 := $bitcast.ref.ref(__const.WebSocketOpen.data);
    $p12 := $i2p.i32.ref(11);
    goto inline$__SMACK_check_memory_safety$2$Entry;

  inline$__SMACK_check_memory_safety$2$Entry:
    inline$__SMACK_check_memory_safety$2$p := $p11;
    inline$__SMACK_check_memory_safety$2$size := $p12;
  ...
  $bb0$3:
    assume {:sourceloc "websocket.c", 11, 7} true;
    assume {:verifier.code 0} true;
    call $M.2 := $memcpy.i8($M.2, $M.1, $p8, __const.WebSocketOpen.data, 11, false);
    assume {:sourceloc "websocket.c", 12, 38} true;
    assume {:verifier.code 0} true;
    $p13 := $add.ref($add.ref(e, $mul.ref(0, 4)), $mul.ref(0, 1));
  ...
  inline$__SMACK_check_memory_safety$3$Entry:
    inline$__SMACK_check_memory_safety$3$p := $p14;
    inline$__SMACK_check_memory_safety$3$size := $p15;
  ...
  $bb0$4:
    assume {:sourceloc "websocket.c", 12, 38} true;
    assume {:verifier.code 0} true;
    $i16 := $load.i32($M.0, $p13);
    assume {:sourceloc "websocket.c", 12, 46} true;
    assume {:verifier.code 0} true;
    $p17 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(0, 1));
    assume {:sourceloc "websocket.c", 12, 2} true;
    assume {:verifier.code 0} true;
    call $i18 := emscripten_websocket_send_binary($i16, $p17, 11);
    assume {:sourceloc "websocket.c", 14, 32} true;
    assume {:verifier.code 0} true;
    $p19 := $add.ref($add.ref(e, $mul.ref(0, 4)), $mul.ref(0, 1));
  ...
  $bb0$5:
    assume {:sourceloc "websocket.c", 14, 32} true;
    assume {:verifier.code 0} true;
    $i22 := $load.i32($M.0, $p19);
    assume {:sourceloc "websocket.c", 14, 2} true;
    assume {:verifier.code 0} true;
    call $i23 := emscripten_websocket_close($i22, 0, $0.ref);
    assume {:sourceloc "websocket.c", 15, 2} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
...
procedure WebSocketClose(eventType: i32, e: ref, userData: ref) returns ($r: i32);
  modifies $exn;



implementation WebSocketClose(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  var $p0: ref;
  var $p1: ref;
  var $p2: ref;
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:cexpr "WebSocketClose:arg:eventType"} boogie_si_record_i32(eventType);
    assume {:sourceloc "websocket.c", 20, 94} true;
    assume {:verifier.code 0} true;
    $p0 := $add.ref($add.ref(e, $mul.ref(0, 524)), $mul.ref(4, 1));
    $p1 := $bitcast.ref.ref($p0);
    $p2 := $bitcast.ref.ref($i2p.i64.ref(4));
    goto inline$__SMACK_check_memory_safety$0$Entry;

  inline$__SMACK_check_memory_safety$0$Entry:
    inline$__SMACK_check_memory_safety$0$p := $p1;
    inline$__SMACK_check_memory_safety$0$size := $p2;
    goto inline$__SMACK_check_memory_safety$0$anon0;
  ...
  $bb0$1:
    ...
    assume {:verifier.code 0} true;
    $p4 := $add.ref($add.ref(e, $mul.ref(0, 524)), $mul.ref(8, 1));
    $p5 := $bitcast.ref.ref($p4);
    $p6 := $bitcast.ref.ref($i2p.i64.ref(2));
    goto inline$__SMACK_check_memory_safety$1$Entry;
  ...
  $bb0$2:
    ...
    assume {:verifier.code 0} true;
    $i7 := $load.i16($M.4, $p4);
    assume {:sourceloc "websocket.c", 20, 104} true;
    assume {:verifier.code 0} true;
    $i8 := $zext.i16.i32($i7);
    assume {:sourceloc "websocket.c", 20, 116} true;
    assume {:verifier.code 0} true;
    $p9 := $add.ref($add.ref(e, $mul.ref(0, 524)), $mul.ref(10, 1));
    $p10 := $add.ref($add.ref($add.ref(e, $mul.ref(0, 524)), $mul.ref(10, 1)), $mul.ref(0, 1));
    assume {:sourceloc "websocket.c", 20, 124} true;
    assume {:verifier.code 0} true;
    $i11 := $p2i.ref.i32(userData);
    assume {:sourceloc "websocket.c", 20, 2} true;
    assume {:verifier.code 0} true;
    call $i12 := printf.ref.i32.i32.i32.ref.i32(.str.2, eventType, $i3, $i8, $p10, $i11);
    assume {:sourceloc "websocket.c", 21, 2} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
...
procedure WebSocketError(eventType: i32, e: ref, userData: ref) returns ($r: i32);
  modifies $exn;



implementation WebSocketError(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  var $i0: i32;
  var $i1: i32;

  $bb0:
    assume {:sourceloc "websocket.c", 26, 58} true;
    assume {:verifier.code 0} true;
    call {:cexpr "WebSocketError:arg:eventType"} boogie_si_record_i32(eventType);
    assume {:sourceloc "websocket.c", 26, 58} true;
    assume {:verifier.code 0} true;
    $i0 := $p2i.ref.i32(userData);
    assume {:sourceloc "websocket.c", 26, 2} true;
    assume {:verifier.code 0} true;
    call $i1 := printf.ref.i32.i32(.str.3, eventType, $i0);
    assume {:sourceloc "websocket.c", 27, 2} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
...
procedure WebSocketMessage(eventType: i32, e: ref, userData: ref) returns ($r: i32);
  modifies $exn;



implementation WebSocketMessage(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  var $i0: i32;
  var $p1: ref;
  var $p2: ref;
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:cexpr "WebSocketMessage:arg:eventType"} boogie_si_record_i32(eventType);
    assume {:sourceloc "websocket.c", 32, 93} true;
    assume {:verifier.code 0} true;
    $i0 := $p2i.ref.i32(userData);
  ...
  $bb0$3:
    ...
    assume {:verifier.code 0} true;
    $i12 := $load.i32($M.7, $p9);
    assume {:sourceloc "websocket.c", 32, 2} true;
    assume {:verifier.code 0} true;
    call $i13 := printf.ref.i32.i32.ref.i32.i32(.str.4, eventType, $i0, $p4, $i8, $i12);
    assume {:sourceloc "websocket.c", 33, 9} true;
    assume {:verifier.code 0} true;
    $p14 := $add.ref($add.ref(e, $mul.ref(0, 16)), $mul.ref(12, 1));
  ...
  $bb0$4:
    assume {:sourceloc "websocket.c", 33, 9} true;
    assume {:verifier.code 0} true;
    $i17 := $load.i32($M.7, $p14);
    assume {:sourceloc "websocket.c", 33, 6} true;
    assume {:verifier.code 0} true;
    $i18 := $ne.i32($i17, 0);
    assume {:sourceloc "websocket.c", 33, 6} true;
    assume {:verifier.code 0} true;
  ...
  $bb2:
    assume !($i18 == 1);
    assume {:sourceloc "websocket.c", 37, 3} true;
    assume {:verifier.code 0} true;
    call $i24 := printf.ref(.str.6);
    assume {:sourceloc "websocket.c", 38, 7} true;
    assume {:verifier.code 0} true;
    $i25 := 0;
    goto $bb4;

  $bb4:
    call $i25, $p26, $p27, $p28, $i29, $i30, $p31, $p32, $p33, $p34, $p35, $p36, $p37, $i38, $i39, $i40, $i41, inline$__SMACK_check_memory_safety$5$p, inline$__SMACK_check_memory_safety$5$size, inline$__SMACK_check_memory_safety$6$p, inline$__SMACK_check_memory_safety$6$size, inline$__SMACK_check_memory_safety$7$p, inline$__SMACK_check_memory_safety$7$size := WebSocketMessage_loop_$bb4(e, $i25, $p26, $p27, $p28, $i29, $i30, $p31, $p32, $p33, $p34, $p35, $p36, $p37, $i38, $i39, $i40, $i41, inline$__SMACK_check_memory_safety$5$p, inline$__SMACK_check_memory_safety$5$size, inline$__SMACK_check_memory_safety$6$p, inline$__SMACK_check_memory_safety$6$size, inline$__SMACK_check_memory_safety$7$p, inline$__SMACK_check_memory_safety$7$size);
    goto $bb4_last;
  ...
  $bb4$1:
    assume {:sourceloc "websocket.c", 38, 25} true;
    assume {:verifier.code 0} true;
    $i29 := $load.i32($M.6, $p26);
    assume {:sourceloc "websocket.c", 38, 20} true;
    assume {:verifier.code 0} true;
    $i30 := $ult.i32($i25, $i29);
    assume {:sourceloc "websocket.c", 38, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb6:
    assume !($i30 == 1);
    assume {:sourceloc "websocket.c", 40, 3} true;
    assume {:verifier.code 0} true;
    call $i42 := printf.ref(.str.8);
    assume {:sourceloc "websocket.c", 42, 34} true;
    assume {:verifier.code 0} true;
    $p43 := $add.ref($add.ref(e, $mul.ref(0, 16)), $mul.ref(0, 1));
  ...
  $bb6$1:
    assume {:sourceloc "websocket.c", 42, 34} true;
    assume {:verifier.code 0} true;
    $i46 := $load.i32($M.9, $p43);
    assume {:sourceloc "websocket.c", 42, 3} true;
    assume {:verifier.code 0} true;
    call $i47 := emscripten_websocket_delete($i46);
    assume {:sourceloc "websocket.c", 43, 3} true;
    assume {:verifier.code 0} true;
    call exit(0);
    assume {:sourceloc "websocket.c", 43, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb5:
    assume $i30 == 1;
    assume {:sourceloc "websocket.c", 39, 23} true;
    assume {:verifier.code 0} true;
    $p31 := $add.ref($add.ref(e, $mul.ref(0, 16)), $mul.ref(4, 1));
  ...
  inline$__SMACK_check_memory_safety$6$Entry:
    inline$__SMACK_check_memory_safety$6$p := $p32;
    inline$__SMACK_check_memory_safety$6$size := $p33;
  ...
  $bb5$1:
    assume {:sourceloc "websocket.c", 39, 23} true;
    assume {:verifier.code 0} true;
    $p34 := $load.ref($M.5, $p31);
    assume {:sourceloc "websocket.c", 39, 20} true;
    assume {:verifier.code 0} true;
    $p35 := $add.ref($p34, $mul.ref($i25, 1));
    $p36 := $bitcast.ref.ref($p35);
    $p37 := $bitcast.ref.ref($i2p.i64.ref(1));
    goto inline$__SMACK_check_memory_safety$7$Entry;

  inline$__SMACK_check_memory_safety$7$Entry:
    inline$__SMACK_check_memory_safety$7$p := $p36;
    inline$__SMACK_check_memory_safety$7$size := $p37;
  ...
  $bb5$2:
    ...
    assume {:verifier.code 0} true;
    $i39 := $zext.i8.i32($i38);
    assume {:sourceloc "websocket.c", 39, 4} true;
    assume {:verifier.code 0} true;
    call $i40 := printf.ref.i32(.str.7, $i39);
    assume {:sourceloc "websocket.c", 39, 4} true;
    assume {:verifier.code 0} true;
    goto $bb7;

  $bb7:
    assume {:sourceloc "websocket.c", 38, 35} true;
    assume {:verifier.code 0} true;
    $i41 := $add.i32($i25, 1);
  ...
  $bb1:
    assume $i18 == 1;
    assume {:sourceloc "websocket.c", 34, 36} true;
    assume {:verifier.code 0} true;
    $p19 := $add.ref($add.ref(e, $mul.ref(0, 16)), $mul.ref(4, 1));
    $p20 := $bitcast.ref.ref($p19);
    $p21 := $bitcast.ref.ref($i2p.i64.ref(4));
    goto inline$__SMACK_check_memory_safety$4$Entry;
  ...
  $bb1$1:
    assume {:sourceloc "websocket.c", 34, 36} true;
    assume {:verifier.code 0} true;
    $p22 := $load.ref($M.5, $p19);
    assume {:sourceloc "websocket.c", 34, 3} true;
    assume {:verifier.code 0} true;
    call $i23 := printf.ref.ref(.str.5, $p22);
    assume {:sourceloc "websocket.c", 34, 3} true;
    assume {:verifier.code 0} true;
    goto $bb3;

  $bb3:
    assume {:sourceloc "websocket.c", 45, 2} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
  ...
  $bb4_last:
    assume {:sourceloc "websocket.c", 0, 0} true;
    assume {:verifier.code 0} true;
    assume {:sourceloc "websocket.c", 38, 25} true;
    assume {:verifier.code 0} true;
    $p26 := $add.ref($add.ref(e, $mul.ref(0, 16)), $mul.ref(8, 1));
...
procedure main() returns ($r: i32);
  modifies $M.10, $exn, $M.1, $M.11, $M.12, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    call $initialize();
    assume {:sourceloc "websocket.c", 50, 7} true;
    assume {:verifier.code 0} true;
    call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
    assume {:verifier.code 0} true;
    call $p0 := $alloc($mul.ref(12, 1));
    assume {:sourceloc "websocket.c", 50, 7} true;
    assume {:verifier.code 0} true;
    call $i1 := emscripten_websocket_is_supported();
    assume {:sourceloc "websocket.c", 50, 7} true;
    assume {:verifier.code 0} true;
    $i2 := $ne.i32($i1, 0);
    assume {:sourceloc "websocket.c", 50, 6} true;
    assume {:verifier.code 0} true;
  ...
  $bb2:
    assume !($i2 == 1);
    assume {:sourceloc "websocket.c", 52, 3} true;
    assume {:verifier.code 0} true;
    call $i3 := printf.ref(.str.9);
    assume {:sourceloc "websocket.c", 53, 3} true;
    assume {:verifier.code 0} true;
    call exit(1);
    assume {:sourceloc "websocket.c", 53, 3} true;
    assume {:verifier.code 0} true;
  ...
  $bb1:
    assume $i2 == 1;
    assume true;
    assume {:sourceloc "websocket.c", 57, 2} true;
    assume {:verifier.code 0} true;
    goto $bb3;
  ...
  $bb3$1:
    assume {:sourceloc "websocket.c", 57, 2} true;
    assume {:verifier.code 0} true;
    call $M.10 := $memset.i8($M.10, $p4, 0, 12, false);
    assume {:sourceloc "websocket.c", 57, 2} true;
    assume {:verifier.code 0} true;
    goto $bb4;

  $bb4:
    assume {:sourceloc "websocket.c", 59, 7} true;
    assume {:verifier.code 0} true;
    $p7 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(0, 1));
  ...
  $bb4$1:
    assume {:sourceloc "websocket.c", 59, 11} true;
    assume {:verifier.code 0} true;
    $M.10 := $store.ref($M.10, $p7, .str.10);
    assume {:sourceloc "websocket.c", 61, 34} true;
    assume {:verifier.code 0} true;
    call $i10 := emscripten_websocket_new($p0);
    call {:cexpr "socket"} boogie_si_record_i32($i10);
    assume {:sourceloc "websocket.c", 62, 13} true;
    assume {:verifier.code 0} true;
    $i11 := $sle.i32($i10, 0);
    assume {:sourceloc "websocket.c", 62, 6} true;
    assume {:verifier.code 0} true;
  ...
  $bb6:
    assume !($i11 == 1);
    assume {:sourceloc "websocket.c", 68, 2} true;
    assume {:verifier.code 0} true;
    call $i13 := emscripten_websocket_set_onopen_callback_on_thread($i10, $i2p.i32.ref(42), WebSocketOpen, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 69, 2} true;
    assume {:verifier.code 0} true;
    call $i14 := emscripten_websocket_set_onclose_callback_on_thread($i10, $i2p.i32.ref(43), WebSocketClose, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 70, 2} true;
    assume {:verifier.code 0} true;
    call $i15 := emscripten_websocket_set_onerror_callback_on_thread($i10, $i2p.i32.ref(44), WebSocketError, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 71, 2} true;
    assume {:verifier.code 0} true;
    call $i16 := emscripten_websocket_set_onmessage_callback_on_thread($i10, $i2p.i32.ref(45), WebSocketMessage, $i2p.i32.ref(2));
    call __SMACK_check_memory_leak();
    assume {:sourceloc "websocket.c", 72, 1} true;
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
  ...
  $bb5:
    assume $i11 == 1;
    assume {:sourceloc "websocket.c", 64, 3} true;
    assume {:verifier.code 0} true;
    call $i12 := printf.ref.i32(.str.11, $i10);
    assume {:sourceloc "websocket.c", 65, 3} true;
    assume {:verifier.code 0} true;
    call exit(1);
    assume {:sourceloc "websocket.c", 65, 3} true;
    assume {:verifier.code 0} true;
...
implementation exit(x: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 1} true;
    call {:cexpr "exit:arg:x"} boogie_si_record_i32(x);
    assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 10, 3} true;
    assume {:verifier.code 1} true;
    assert {:valid_memtrack} $allocatedCounter == 0;
...
procedure $initialize();
  modifies $M.1, $M.11, $M.12, $exn, $CurrAddr, $allocatedCounter, $Alloc;
...
procedure {:entrypoint} CorralMain();
  modifies $M.11, $exnv, $allocatedCounter, $CurrAddr, $M.2, $exn, $M.10, $Alloc, $M.1, $M.12;
...
implementation CorralMain()
{
  ...
  var $r_WebSocketOpen: i32;
  var eventType_WebSocketClose: i32;
  var e_WebSocketClose: ref;
  var userData_WebSocketClose: ref;
  var $r_WebSocketClose: i32;
  var eventType_WebSocketError: i32;
  var e_WebSocketError: ref;
  var userData_WebSocketError: ref;
  var $r_WebSocketError: i32;
  var eventType_WebSocketMessage: i32;
  var e_WebSocketMessage: ref;
  var userData_WebSocketMessage: ref;
  var $r_WebSocketMessage: i32;
  var $r_main: i32;
  ...
  L_BAF_15:
    assume __block_call_exit;
    assume MustReach(true);
    call {:AvhEntryPoint} exit(x_exit);
    return;
  ...
  L_BAF_4:
    ...
    call {:ConcretizeConstantName "e_WebSocketMessage"} e_WebSocketMessage := unknown_ref();
    call {:ConcretizeConstantName "userData_WebSocketMessage"} userData_WebSocketMessage := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_WebSocketMessage := WebSocketMessage(eventType_WebSocketMessage, e_WebSocketMessage, userData_WebSocketMessage);
    return;

  L_BAF_3:
    assume __block_call_WebSocketError;
    call {:ConcretizeConstantName "e_WebSocketError"} e_WebSocketError := unknown_ref();
    call {:ConcretizeConstantName "userData_WebSocketError"} userData_WebSocketError := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_WebSocketError := WebSocketError(eventType_WebSocketError, e_WebSocketError, userData_WebSocketError);
    return;

  L_BAF_2:
    assume __block_call_WebSocketClose;
    call {:ConcretizeConstantName "e_WebSocketClose"} e_WebSocketClose := unknown_ref();
    call {:ConcretizeConstantName "userData_WebSocketClose"} userData_WebSocketClose := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_WebSocketClose := WebSocketClose(eventType_WebSocketClose, e_WebSocketClose, userData_WebSocketClose);
    return;

  L_BAF_1:
    assume __block_call_WebSocketOpen;
    call {:ConcretizeConstantName "e_WebSocketOpen"} e_WebSocketOpen := unknown_ref();
    call {:ConcretizeConstantName "userData_WebSocketOpen"} userData_WebSocketOpen := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r_WebSocketOpen := WebSocketOpen(eventType_WebSocketOpen, e_WebSocketOpen, userData_WebSocketOpen);
    return;
...
implementation WebSocketMessage_loop_$bb4(in_e: ref, in_$i25: i32, in_$p26: ref, in_$p27: ref, in_$p28: ref, in_$i29: i32, in_$i30: i1, in_$p31: ref, in_$p32: ref, in_$p33: ref, in_$p34: ref, in_$p35: ref, in_$p36: ref, in_$p37: ref, in_$i38: i8, in_$i39: i32, in_$i40: i32, in_$i41: i32, in_inline$__SMACK_check_memory_safety$5$p: ref, in_inline$__SMACK_check_memory_safety$5$size: ref, in_inline$__SMACK_check_memory_safety$6$p: ref, in_inline$__SMACK_check_memory_safety$6$size: ref, in_inline$__SMACK_check_memory_safety$7$p: ref, in_inline$__SMACK_check_memory_safety$7$size: ref) returns (out_$i25: i32, out_$p26: ref, out_$p27: ref, out_$p28: ref, out_$i29: i32, out_$i30: i1, out_$p31: ref, out_$p32: ref, out_$p33: ref, out_$p34: ref, out_$p35: ref, out_$p36: ref, out_$p37: ref, out_$i38: i8, out_$i39: i32, out_$i40: i32, out_$i41: i32, out_inline$__SMACK_check_memory_safety$5$p: ref, out_inline$__SMACK_check_memory_safety$5$size: ref, out_inline$__SMACK_check_memory_safety$6$p: ref, out_inline$__SMACK_check_memory_safety$6$size: ref, out_inline$__SMACK_check_memory_safety$7$p: ref, out_inline$__SMACK_check_memory_safety$7$size: ref)
{

  entry:
    out_$i25, out_$p26, out_$p27, out_$p28, out_$i29, out_$i30, out_$p31, out_$p32, out_$p33, out_$p34, out_$p35, out_$p36, out_$p37, out_$i38, out_$i39, out_$i40, out_$i41, out_inline$__SMACK_check_memory_safety$5$p, out_inline$__SMACK_check_memory_safety$5$size, out_inline$__SMACK_check_memory_safety$6$p, out_inline$__SMACK_check_memory_safety$6$size, out_inline$__SMACK_check_memory_safety$7$p, out_inline$__SMACK_check_memory_safety$7$size := in_$i25, in_$p26, in_$p27, in_$p28, in_$i29, in_$i30, in_$p31, in_$p32, in_$p33, in_$p34, in_$p35, in_$p36, in_$p37, in_$i38, in_$i39, in_$i40, in_$i41, in_inline$__SMACK_check_memory_safety$5$p, in_inline$__SMACK_check_memory_safety$5$size, in_inline$__SMACK_check_memory_safety$6$p, in_inline$__SMACK_check_memory_safety$6$size, in_inline$__SMACK_check_memory_safety$7$p, in_inline$__SMACK_check_memory_safety$7$size;
    goto $bb4, exit;
  ...
  $bb4:
    ...
    assume {:sourceloc "websocket.c", 38, 25} true;
    assume {:verifier.code 0} true;
    out_$p26 := $add.ref($add.ref(in_e, $mul.ref(0, 16)), $mul.ref(8, 1));
    out_$p27 := $bitcast.ref.ref(out_$p26);
    out_$p28 := $bitcast.ref.ref($i2p.i64.ref(4));
    goto inline$__SMACK_check_memory_safety$5$Entry;

  $bb7:
    assume {:sourceloc "websocket.c", 38, 35} true;
    assume {:verifier.code 0} true;
    out_$i41 := $add.i32(out_$i25, 1);
    call {:cexpr "i"} boogie_si_record_i32(out_$i41);
    assume {:sourceloc "websocket.c", 38, 3} true;
    assume {:verifier.code 0} true;
    out_$i25 := out_$i41;
    goto $bb7_dummy;
  ...
  $bb5$2:
    assume {:sourceloc "websocket.c", 39, 20} true;
    assume {:verifier.code 0} true;
    out_$i38 := $load.i8($M.8, out_$p35);
    assume {:sourceloc "websocket.c", 39, 20} true;
    assume {:verifier.code 0} true;
    out_$i39 := $zext.i8.i32(out_$i38);
    assume {:sourceloc "websocket.c", 39, 4} true;
    assume {:verifier.code 0} true;
    call out_$i40 := printf.ref.i32(.str.7, out_$i39);
    assume {:sourceloc "websocket.c", 39, 4} true;
    assume {:verifier.code 0} true;
    goto $bb7;
  ...
  inline$__SMACK_check_memory_safety$7$anon0:
    assert {:valid_deref} $Alloc[$base(out_inline$__SMACK_check_memory_safety$7$p)];
    assert {:valid_deref} $sle.ref.bool($base(out_inline$__SMACK_check_memory_safety$7$p), out_inline$__SMACK_check_memory_safety$7$p);
    assert {:valid_deref} $sle.ref.bool($add.ref(out_inline$__SMACK_check_memory_safety$7$p, out_inline$__SMACK_check_memory_safety$7$size), $add.ref($base(out_inline$__SMACK_check_memory_safety$7$p), $Size($base(out_inline$__SMACK_check_memory_safety$7$p))));
    goto inline$__SMACK_check_memory_safety$7$Return;

  inline$__SMACK_check_memory_safety$7$Entry:
    out_inline$__SMACK_check_memory_safety$7$p := out_$p36;
    out_inline$__SMACK_check_memory_safety$7$size := out_$p37;
    goto inline$__SMACK_check_memory_safety$7$anon0;

  $bb5$1:
    assume {:sourceloc "websocket.c", 39, 23} true;
    assume {:verifier.code 0} true;
    out_$p34 := $load.ref($M.5, out_$p31);
    assume {:sourceloc "websocket.c", 39, 20} true;
    assume {:verifier.code 0} true;
    out_$p35 := $add.ref(out_$p34, $mul.ref(out_$i25, 1));
    out_$p36 := $bitcast.ref.ref(out_$p35);
    out_$p37 := $bitcast.ref.ref($i2p.i64.ref(1));
    goto inline$__SMACK_check_memory_safety$7$Entry;
  ...
  inline$__SMACK_check_memory_safety$6$anon0:
    assert {:valid_deref} $Alloc[$base(out_inline$__SMACK_check_memory_safety$6$p)];
    assert {:valid_deref} $sle.ref.bool($base(out_inline$__SMACK_check_memory_safety$6$p), out_inline$__SMACK_check_memory_safety$6$p);
    assert {:valid_deref} $sle.ref.bool($add.ref(out_inline$__SMACK_check_memory_safety$6$p, out_inline$__SMACK_check_memory_safety$6$size), $add.ref($base(out_inline$__SMACK_check_memory_safety$6$p), $Size($base(out_inline$__SMACK_check_memory_safety$6$p))));
    goto inline$__SMACK_check_memory_safety$6$Return;

  inline$__SMACK_check_memory_safety$6$Entry:
    out_inline$__SMACK_check_memory_safety$6$p := out_$p32;
    out_inline$__SMACK_check_memory_safety$6$size := out_$p33;
    goto inline$__SMACK_check_memory_safety$6$anon0;
  ...
  $bb5:
    ...
    assume {:sourceloc "websocket.c", 39, 23} true;
    assume {:verifier.code 0} true;
    out_$p31 := $add.ref($add.ref(in_e, $mul.ref(0, 16)), $mul.ref(4, 1));
    out_$p32 := $bitcast.ref.ref(out_$p31);
    out_$p33 := $bitcast.ref.ref($i2p.i64.ref(4));
    goto inline$__SMACK_check_memory_safety$6$Entry;

  $bb4$1:
    assume {:sourceloc "websocket.c", 38, 25} true;
    assume {:verifier.code 0} true;
    out_$i29 := $load.i32($M.6, out_$p26);
    assume {:sourceloc "websocket.c", 38, 20} true;
    assume {:verifier.code 0} true;
    out_$i30 := $ult.i32(out_$i25, out_$i29);
    assume {:sourceloc "websocket.c", 38, 3} true;
    assume {:verifier.code 0} true;
    assume true;
    goto $bb5;
  ...
  inline$__SMACK_check_memory_safety$5$anon0:
    assert {:valid_deref} $Alloc[$base(out_inline$__SMACK_check_memory_safety$5$p)];
    assert {:valid_deref} $sle.ref.bool($base(out_inline$__SMACK_check_memory_safety$5$p), out_inline$__SMACK_check_memory_safety$5$p);
    assert {:valid_deref} $sle.ref.bool($add.ref(out_inline$__SMACK_check_memory_safety$5$p, out_inline$__SMACK_check_memory_safety$5$size), $add.ref($base(out_inline$__SMACK_check_memory_safety$5$p), $Size($base(out_inline$__SMACK_check_memory_safety$5$p))));
    goto inline$__SMACK_check_memory_safety$5$Return;

  inline$__SMACK_check_memory_safety$5$Entry:
    out_inline$__SMACK_check_memory_safety$5$p := out_$p27;
    out_inline$__SMACK_check_memory_safety$5$size := out_$p28;
    goto inline$__SMACK_check_memory_safety$5$anon0;

  $bb7_dummy:
    call {:si_unique_call 1} out_$i25, out_$p26, out_$p27, out_$p28, out_$i29, out_$i30, out_$p31, out_$p32, out_$p33, out_$p34, out_$p35, out_$p36, out_$p37, out_$i38, out_$i39, out_$i40, out_$i41, out_inline$__SMACK_check_memory_safety$5$p, out_inline$__SMACK_check_memory_safety$5$size, out_inline$__SMACK_check_memory_safety$6$p, out_inline$__SMACK_check_memory_safety$6$size, out_inline$__SMACK_check_memory_safety$7$p, out_inline$__SMACK_check_memory_safety$7$size := WebSocketMessage_loop_$bb4(in_e, out_$i25, out_$p26, out_$p27, out_$p28, out_$i29, out_$i30, out_$p31, out_$p32, out_$p33, out_$p34, out_$p35, out_$p36, out_$p37, out_$i38, out_$i39, out_$i40, out_$i41, out_inline$__SMACK_check_memory_safety$5$p, out_inline$__SMACK_check_memory_safety$5$size, out_inline$__SMACK_check_memory_safety$6$p, out_inline$__SMACK_check_memory_safety$6$size, out_inline$__SMACK_check_memory_safety$7$p, out_inline$__SMACK_check_memory_safety$7$size);
    return;
...
procedure WebSocketMessage_loop_$bb4(in_e: ref, in_$i25: i32, in_$p26: ref, in_$p27: ref, in_$p28: ref, in_$i29: i32, in_$i30: i1, in_$p31: ref, in_$p32: ref, in_$p33: ref, in_$p34: ref, in_$p35: ref, in_$p36: ref, in_$p37: ref, in_$i38: i8, in_$i39: i32, in_$i40: i32, in_$i41: i32, in_inline$__SMACK_check_memory_safety$5$p: ref, in_inline$__SMACK_check_memory_safety$5$size: ref, in_inline$__SMACK_check_memory_safety$6$p: ref, in_inline$__SMACK_check_memory_safety$6$size: ref, in_inline$__SMACK_check_memory_safety$7$p: ref, in_inline$__SMACK_check_memory_safety$7$size: ref) returns (out_$i25: i32, out_$p26: ref, out_$p27: ref, out_$p28: ref, out_$i29: i32, out_$i30: i1, out_$p31: ref, out_$p32: ref, out_$p33: ref, out_$p34: ref, out_$p35: ref, out_$p36: ref, out_$p37: ref, out_$i38: i8, out_$i39: i32, out_$i40: i32, out_$i41: i32, out_inline$__SMACK_check_memory_safety$5$p: ref, out_inline$__SMACK_check_memory_safety$5$size: ref, out_inline$__SMACK_check_memory_safety$6$p: ref, out_inline$__SMACK_check_memory_safety$6$size: ref, out_inline$__SMACK_check_memory_safety$7$p: ref, out_inline$__SMACK_check_memory_safety$7$size: ref);
