...
implementation $global_allocations()
{
  ...
  anon0:
    ...
    call {:si_unique_call 5} $galloc(emscripten_websocket_send_binary, 4);
    call {:si_unique_call 6} $galloc(.str.6, 13);
    call {:si_unique_call 7} $galloc(.str.7, 6);
    call {:si_unique_call 8} $galloc(.str.1, 24);
    call {:si_unique_call 9} $galloc(__const.WebSocketOpen.data, 11);
    call {:si_unique_call 10} $galloc(.str.2, 67);
    call {:si_unique_call 11} $galloc(.str.3, 34);
    call {:si_unique_call 12} $galloc(.str.5, 17);
    call {:si_unique_call 13} $galloc(.str, 33);
    call {:si_unique_call 14} $galloc(.str.4, 69);
    call {:si_unique_call 15} $galloc(.str.8, 2);
    call {:si_unique_call 16} $galloc(.str.9, 48);
    call {:si_unique_call 17} $galloc(.str.10, 20);
    call {:si_unique_call 18} $galloc(.str.11, 43);
    call {:si_unique_call 19} $galloc(__SMACK_dummy, 4);
    call {:si_unique_call 20} $galloc(__SMACK_check_overflow, 4);
    call {:si_unique_call 21} $galloc(__SMACK_nondet_unsigned_short_int, 4);
    call {:si_unique_call 22} $galloc(__SMACK_nondet_char, 4);
    ...
    call {:si_unique_call 26} $galloc(.str.2.24, 3);
    call {:si_unique_call 27} $galloc(errno_global, 4);
    call {:si_unique_call 28} $galloc(__SMACK_nondet_signed_long, 4);
    call {:si_unique_call 29} $galloc(__SMACK_nondet_signed_long_int, 4);
    call {:si_unique_call 30} $galloc(__SMACK_nondet_unsigned_long, 4);
    call {:si_unique_call 31} $galloc(__SMACK_nondet_unsigned_long_int, 4);
    call {:si_unique_call 32} $galloc(__SMACK_nondet_long_long, 4);
    call {:si_unique_call 33} $galloc(emscripten_websocket_close, 4);
    call {:si_unique_call 34} $galloc(WebSocketClose, 4);
    call {:si_unique_call 35} $galloc(WebSocketError, 4);
    call {:si_unique_call 36} $galloc(WebSocketMessage, 4);
    call {:si_unique_call 37} $galloc(emscripten_websocket_delete, 4);
    call {:si_unique_call 38} $galloc(main, 4);
    call {:si_unique_call 39} $galloc(emscripten_websocket_is_supported, 4);
    call {:si_unique_call 40} $galloc(llvm.memset.p0i8.i32, 4);
    call {:si_unique_call 41} $galloc(emscripten_websocket_new, 4);
    call {:si_unique_call 42} $galloc(emscripten_websocket_set_onopen_callback_on_thread, 4);
    call {:si_unique_call 43} $galloc(emscripten_websocket_set_onclose_callback_on_thread, 4);
    call {:si_unique_call 44} $galloc(emscripten_websocket_set_onerror_callback_on_thread, 4);
    call {:si_unique_call 45} $galloc(emscripten_websocket_set_onmessage_callback_on_thread, 4);
    call {:si_unique_call 46} $galloc(__VERIFIER_assume, 4);
    call {:si_unique_call 47} $galloc(__SMACK_code, 4);
    call {:si_unique_call 48} $galloc(exit, 4);
    call {:si_unique_call 49} $galloc(__SMACK_nondet_signed_char, 4);
    call {:si_unique_call 50} $galloc(__SMACK_nondet_unsigned_char, 4);
    call {:si_unique_call 51} $galloc(__SMACK_nondet_short, 4);
    call {:si_unique_call 52} $galloc(__SMACK_nondet_signed_short, 4);
    call {:si_unique_call 53} $galloc(__SMACK_nondet_signed_short_int, 4);
    call {:si_unique_call 54} $galloc(__SMACK_nondet_unsigned_short, 4);
    call {:si_unique_call 55} $galloc(__SMACK_nondet_int, 4);
    call {:si_unique_call 56} $galloc(__SMACK_nondet_signed_int, 4);
    call {:si_unique_call 57} $galloc(__SMACK_nondet_unsigned, 4);
    call {:si_unique_call 58} $galloc(__SMACK_nondet_unsigned_int, 4);
    call {:si_unique_call 59} $galloc(__SMACK_nondet_long, 4);
    call {:si_unique_call 60} $galloc(__SMACK_nondet_long_int, 4);
    call {:si_unique_call 61} $galloc(__SMACK_nondet_long_long_int, 4);
    call {:si_unique_call 62} $galloc(__SMACK_nondet_signed_long_long, 4);
    call {:si_unique_call 63} $galloc(__SMACK_nondet_signed_long_long_int, 4);
    call {:si_unique_call 64} $galloc(__SMACK_nondet_unsigned_long_long, 4);
    call {:si_unique_call 65} $galloc(__SMACK_nondet_unsigned_long_long_int, 4);
    call {:si_unique_call 66} $galloc(__SMACK_decls, 4);
    call {:si_unique_call 67} $galloc(__SMACK_top_decl, 4);
    call {:si_unique_call 68} $galloc(__SMACK_check_memory_safety, 4);
    call {:si_unique_call 69} $galloc(__SMACK_check_memory_leak, 4);
    call {:si_unique_call 70} $galloc(__SMACK_init_func_memory_model, 4);
    call {:si_unique_call 71} $galloc(llvm.dbg.value, 4);
    call {:si_unique_call 72} $galloc(__SMACK_static_init, 4);
    return;
}
...
implementation WebSocketOpen(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 73} $p0 := $alloc($mul.ref(11, 1));
    call {:si_unique_call 74} {:cexpr "WebSocketOpen:arg:eventType"} boogie_si_record_i32(eventType);
    assume {:sourceloc "websocket.c", 7, 57} true;
    assume {:verifier.code 0} true;
    $i1 := $p2i.ref.i32(userData);
    assume {:sourceloc "websocket.c", 7, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 75} $i2 := printf.ref.i32.i32(.str, eventType, $i1);
  ...
  $bb0$1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 76} $i7 := emscripten_websocket_send_utf8_text($i6, .str.1);
    assume true;
  ...
  $bb0$3:
    assume {:sourceloc "websocket.c", 11, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 77} $M.2 := $memcpy.i8($M.2, $M.1, $p8, __const.WebSocketOpen.data, 11, false);
  ...
  $bb0$4:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 78} $i18 := emscripten_websocket_send_binary($i16, $p17, 11);
  ...
  $bb0$5:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 79} $i23 := emscripten_websocket_close($i22, 0, $0.ref);
...
implementation WebSocketClose(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 80} {:cexpr "WebSocketClose:arg:eventType"} boogie_si_record_i32(eventType);
    assume {:sourceloc "websocket.c", 20, 94} true;
    assume {:verifier.code 0} true;
  ...
  $bb0$2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 81} $i12 := printf.ref.i32.i32.i32.ref.i32(.str.2, eventType, $i3, $i8, $p10, $i11);
...
implementation WebSocketMessage(eventType: i32, e: ref, userData: ref) returns ($r: i32)
{
  ...
  $bb0$3:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 83} $i13 := printf.ref.i32.i32.ref.i32.i32(.str.4, eventType, $i0, $p4, $i8, $i12);
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 84} $i24 := printf.ref(.str.6);
  ...
  $bb6:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 85} $i42 := printf.ref(.str.8);
  ...
  $bb6$1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 86} $i47 := emscripten_websocket_delete($i46);
    assume {:sourceloc "websocket.c", 43, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 87} exit(0);
    assume {:sourceloc "websocket.c", 43, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb5$2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 88} $i40 := printf.ref.i32(.str.7, $i39);
    assume {:sourceloc "websocket.c", 39, 4} true;
    assume {:verifier.code 0} true;
    goto $bb7;
  ...
  $bb7:
    ...
    assume {:verifier.code 0} true;
    $i41 := $add.i32($i25, 1);
    call {:si_unique_call 89} {:cexpr "i"} boogie_si_record_i32($i41);
    assume {:sourceloc "websocket.c", 38, 3} true;
    assume {:verifier.code 0} true;
    $i25 := $i41;
    goto $bb4;
  ...
  $bb1$1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 90} $i23 := printf.ref.ref(.str.5, $p22);
    assume {:sourceloc "websocket.c", 34, 3} true;
    assume {:verifier.code 0} true;
    goto $bb3;
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 93} $p0 := $alloc($mul.ref(12, 1));
    assume {:sourceloc "websocket.c", 50, 7} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 94} $i1 := emscripten_websocket_is_supported();
    assume {:sourceloc "websocket.c", 50, 7} true;
    assume {:verifier.code 0} true;
    $i2 := $ne.i32($i1, 0);
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} $i3 := printf.ref(.str.9);
    assume {:sourceloc "websocket.c", 53, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 96} exit(1);
    assume {:sourceloc "websocket.c", 53, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
  ...
  $bb3$1:
    assume {:sourceloc "websocket.c", 57, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 97} $M.10 := $memset.i8($M.10, $p4, 0, 12, false);
    assume {:sourceloc "websocket.c", 57, 2} true;
    assume {:verifier.code 0} true;
    goto $bb4;
  ...
  $bb4$1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 98} $i10 := emscripten_websocket_new($p0);
    call {:si_unique_call 99} {:cexpr "socket"} boogie_si_record_i32($i10);
  ...
  $bb6:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 100} $i13 := emscripten_websocket_set_onopen_callback_on_thread($i10, $i2p.i32.ref(42), WebSocketOpen, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 69, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 101} $i14 := emscripten_websocket_set_onclose_callback_on_thread($i10, $i2p.i32.ref(43), WebSocketClose, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 70, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 102} $i15 := emscripten_websocket_set_onerror_callback_on_thread($i10, $i2p.i32.ref(44), WebSocketError, $i2p.i32.ref(2));
    assume {:sourceloc "websocket.c", 71, 2} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 103} $i16 := emscripten_websocket_set_onmessage_callback_on_thread($i10, $i2p.i32.ref(45), WebSocketMessage, $i2p.i32.ref(2));
    call {:si_unique_call 104} __SMACK_check_memory_leak();
  ...
  $bb5:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 105} $i12 := printf.ref.i32(.str.11, $i10);
    assume {:sourceloc "websocket.c", 65, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 106} exit(1);
    assume {:sourceloc "websocket.c", 65, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    return;
...
implementation __SMACK_check_overflow(flag: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 107} {:cexpr "__SMACK_check_overflow:arg:flag"} boogie_si_record_i32(flag);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
    assume true;
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 108} corral_atomic_begin();
    goto inline$$$alloc$0$Entry;

  inline$$$alloc$0$Entry:
    inline$$$alloc$0$n := n;
    call {:si_unique_call 109} inline$$$alloc$0$p := havocNonDetAvh.ref();
  ...
  anon0$1:
    call {:si_unique_call 110} corral_atomic_end();
    return;

  inline$$$alloc$0$anon3_Then:
    assume {:partition} $slt.ref.bool($0.ref, inline$$$alloc$0$n);
    inline$$$alloc$0$p := $CurrAddr;
    call {:si_unique_call 111} $CurrAddr := havocNonDetAvh.ref();
...
implementation $free(p: ref)
{
  ...
  anon0:
    call {:si_unique_call 112} corral_atomic_begin();
  ...
  anon2:
    call {:si_unique_call 113} corral_atomic_end();
    return;
...
implementation exit(x: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 1} true;
    call {:si_unique_call 114} {:cexpr "exit:arg:x"} boogie_si_record_i32(x);
    assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 10, 3} true;
    assume {:verifier.code 1} true;
    assert {:valid_memtrack} $allocatedCounter == 0;
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeCallId 0} {:si_unique_call 119} {:ConcretizeConstantName "$M.11"} $M.11 := unknown_ref();
    assume unknownTrigger_0($M.11);
    call {:ConcretizeCallId 1} {:si_unique_call 120} {:ConcretizeConstantName "$exnv"} $exnv := unknown_int();
    assume unknownTrigger_1($exnv);
    call {:ConcretizeCallId 2} {:si_unique_call 121} {:ConcretizeConstantName "$allocatedCounter"} $allocatedCounter := unknown_int();
    assume unknownTrigger_2($allocatedCounter);
    call {:ConcretizeCallId 3} {:si_unique_call 122} {:ConcretizeConstantName "$CurrAddr"} $CurrAddr := unknown_ref();
  ...
  L_BAF_2:
    ...
    call {:si_unique_call 125} {:AvhEntryPoint} $r_WebSocketMessage := WebSocketMessage(eventType_WebSocketMessage, e_WebSocketMessage, userData_WebSocketMessage);
    return;

  L_BAF_1:
    assume __block_call_WebSocketClose;
    call {:ConcretizeCallId 6} {:si_unique_call 126} {:ConcretizeConstantName "e_WebSocketClose"} e_WebSocketClose := unknown_ref();
    assume unknownTrigger_6(e_WebSocketClose);
    call {:ConcretizeCallId 7} {:si_unique_call 127} {:ConcretizeConstantName "userData_WebSocketClose"} userData_WebSocketClose := unknown_ref();
    assume unknownTrigger_7(userData_WebSocketClose);
    assume MustReach(true);
    call {:si_unique_call 128} {:AvhEntryPoint} $r_WebSocketClose := WebSocketClose(eventType_WebSocketClose, e_WebSocketClose, userData_WebSocketClose);
    return;

  L_BAF_0:
    assume __block_call_WebSocketOpen;
    call {:ConcretizeCallId 8} {:si_unique_call 129} {:ConcretizeConstantName "e_WebSocketOpen"} e_WebSocketOpen := unknown_ref();
    assume unknownTrigger_8(e_WebSocketOpen);
    call {:ConcretizeCallId 9} {:si_unique_call 130} {:ConcretizeConstantName "userData_WebSocketOpen"} userData_WebSocketOpen := unknown_ref();
    assume unknownTrigger_9(userData_WebSocketOpen);
    assume MustReach(true);
    call {:si_unique_call 131} {:AvhEntryPoint} $r_WebSocketOpen := WebSocketOpen(eventType_WebSocketOpen, e_WebSocketOpen, userData_WebSocketOpen);
    return;
}
...
implementation havocNonDetAvh.ref() returns (o: ref)
{
  ...
  L_BAF_20:
    call {:ConcretizeCallId 10} {:si_unique_call 132} {:ConcretizeConstantName "o"} o := unknown_ref();
