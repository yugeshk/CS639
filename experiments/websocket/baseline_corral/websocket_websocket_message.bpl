...
procedure  WebSocketOpen($i0: i32, $p1: ref, $p2: ref)
  returns ($r: i32)
{
  var $p3: ref;
  var $i4: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i26 := emscripten_websocket_close($i25, 0, $0.ref);
...
procedure  WebSocketClose($i0: i32, $p1: ref, $p2: ref)
  returns ($r: i32)
{
  var $p3: ref;
  var $p4: ref;
...
procedure  WebSocketError($i0: i32, $p1: ref, $p2: ref)
  returns ($r: i32)
{
  var $i3: i32;
  var $i4: i32;
...
procedure  {:entrypoint} WebSocketMessage($i0: i32, $p1: ref, $p2: ref)
  returns ($r: i32)
{
  var $i3: i32;
  var $p4: ref;
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  call $i50 := emscripten_websocket_delete($i49);
