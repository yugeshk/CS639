...
$bb0:
  call $initialize();
  assume {:sourceloc "harness.c", 12, 75} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "harness.c", 12, 75} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "harness.c", 12, 43} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "harness.c", 13, 78} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(524);
  assume {:sourceloc "harness.c", 13, 45} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "harness.c", 14, 78} true;
  assume {:verifier.code 0} true;
  call $p4 := malloc(4);
  assume {:sourceloc "harness.c", 14, 45} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "harness.c", 15, 83} true;
  assume {:verifier.code 0} true;
  call $p6 := malloc(16);
  assume {:sourceloc "harness.c", 15, 49} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p6);
  assume {:sourceloc "harness.c", 27, 47} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($u0, 1);
  assume {:sourceloc "harness.c", 27, 32} true;
  assume {:verifier.code 0} true;
  call $p9 := malloc($i8);
  assume {:sourceloc "harness.c", 27, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "harness.c", 27, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p10, $p9);
  assume {:sourceloc "harness.c", 29, 1} true;
  assume {:verifier.code 0} true;
  call $i13 := WebSocketOpen($u0, $p1, $u1);
  assume {:sourceloc "harness.c", 30, 1} true;
  assume {:verifier.code 0} true;
  call $i14 := WebSocketClose($u0, $p3, $u1);
  assume {:sourceloc "harness.c", 31, 1} true;
  assume {:verifier.code 0} true;
  call $i15 := WebSocketError($u0, $p5, $u1);
  assume {:sourceloc "harness.c", 32, 1} true;
  assume {:verifier.code 0} true;
  call $i16 := WebSocketMessage($u0, $p7, $u1);
  assume {:sourceloc "harness.c", 34, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "harness.c", 34, 1} true;
  assume {:verifier.code 0} true;
  call free_($p20);
  assume {:sourceloc "harness.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $p21 := $bitcast.ref.ref($p1);
  assume {:sourceloc "harness.c", 35, 1} true;
  assume {:verifier.code 0} true;
  call free_($p21);
  assume {:sourceloc "harness.c", 36, 6} true;
  assume {:verifier.code 0} true;
  $p22 := $bitcast.ref.ref($p3);
  assume {:sourceloc "harness.c", 36, 1} true;
  assume {:verifier.code 0} true;
  call free_($p22);
  assume {:sourceloc "harness.c", 37, 6} true;
  assume {:verifier.code 0} true;
  $p23 := $bitcast.ref.ref($p5);
  assume {:sourceloc "harness.c", 37, 1} true;
  assume {:verifier.code 0} true;
  call free_($p23);
  assume {:sourceloc "harness.c", 38, 6} true;
  assume {:verifier.code 0} true;
  $p24 := $bitcast.ref.ref($p7);
  assume {:sourceloc "harness.c", 38, 1} true;
  assume {:verifier.code 0} true;
  call free_($p24);
  call __SMACK_check_memory_leak();
  assume {:sourceloc "harness.c", 40, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "websocket.c", 11, 7} true;
  assume {:verifier.code 0} true;
  call $M.3 := $memcpy.i8($M.3, $M.2, $p11, __const.WebSocketOpen.data, 11, false);
