...
procedure mouse_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  modifies $M.0, $M.4, $M.2, $M.3, $M.1, $M.20, $CurrAddr, $Alloc;
...
procedure wheel_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  modifies $M.20, $M.5, $CurrAddr, $Alloc;
...
procedure main() returns ($r: i32);
  modifies $M.37, $M.38, $M.0, $M.1, $M.2, $M.3, $M.4, $M.5, $M.20, $M.39, $CurrAddr, $allocatedCounter, $Alloc;
...
procedure {:entrypoint} CorralMain();
  modifies $M.39, $exnv, $allocatedCounter, $CurrAddr, $M.37, $M.38, $M.20, $M.5, $M.0, $M.4, $M.2, $M.3, $M.1, $Alloc;
