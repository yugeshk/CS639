...
implementation report_result($i0: i32)
{
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 136} $i3 := printf.ref(.str.1);
    assume {:verifier.code 0} true;
    goto $bb3;
  ...
  $bb1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 137} $i2 := printf.ref(.str);
...
implementation instruction()
{
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 139} $i4 := printf.ref(.str.12);
  ...
  $bb5:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 140} $i9 := printf.ref(.str.12);
  ...
  $bb7:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 141} $i14 := printf.ref(.str.12);
  ...
  $bb9:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 142} $i19 := printf.ref(.str.13);
  ...
  $bb11:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 143} $i24 := printf.ref(.str.14);
  ...
  $bb13:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 144} $i29 := printf.ref(.str.15);
...
implementation mouse_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0$14:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 148} $i70 := printf.ref.ref.i32.i32.i32.i32.ref.ref.ref.ref.i32.i32.i32.i32.i32.i32(.str.16, $p3, $i7, $i11, $i15, $i19, $p25, $p31, $p37, $p43, $i48, $i53, $i57, $i61, $i65, $i69);
  ...
  $bb39:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 150} $i138 := printf.ref(.str.22);
...
implementation emscripten_event_type_to_string($i0: i32) returns ($r: ref)
{
  ...
  $bb0$2:
    assume {:sourceloc "test_html5_mouse.c", 26, 15} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 160} $M.20 := $memcpy.i8($M.20, $M.20, $p2, __const.emscripten_event_type_to_string.events, 140, false);
...
implementation wheel_callback($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  ...
  $bb0$16:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 164} $i96 := printf.ref.ref.i32.i32.i32.i32.ref.ref.ref.ref.i32.i32.i32.i32.float.float.float.i32(.str.23, $p3, $i8, $i13, $i18, $i23, $p30, $p37, $p44, $p51, $i57, $i63, $i68, $i73, $f79, $f85, $f91, $i95);
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "test_html5_mouse.c", 115, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 171} $i2 := emscripten_set_canvas_element_size(.str.24, 400, 300);
  ...
  $bb0$1:
    ...
    assume {:sourceloc "test_html5_mouse.c", 116, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 172} $i7 := emscripten_asm_const_int.ref.ref(.str.25, $p6);
  ...
  $bb18$1:
    ...
    assume {:sourceloc "test_html5_mouse.c", 178, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 185} $i36 := emscripten_asm_const_int.ref.ref(.str.33, $p35);
  ...
  $bb16:
    ...
    assume {:sourceloc "test_html5_mouse.c", 130, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 188} $i31 := printf.ref.ref.ref(.str.26, .str.32, $p30);
    assume {:sourceloc "test_html5_mouse.c", 130, 3} true;
    assume {:verifier.code 0} true;
    goto $bb18;
  ...
  $bb13:
    ...
    assume {:sourceloc "test_html5_mouse.c", 127, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 190} $i27 := printf.ref.ref.ref(.str.26, .str.31, $p26);
    assume {:sourceloc "test_html5_mouse.c", 127, 3} true;
    assume {:verifier.code 0} true;
    goto $bb15;
  ...
  $bb10:
    ...
    assume {:sourceloc "test_html5_mouse.c", 125, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 192} $i23 := printf.ref.ref.ref(.str.26, .str.30, $p22);
    assume {:sourceloc "test_html5_mouse.c", 125, 3} true;
    assume {:verifier.code 0} true;
    goto $bb12;
  ...
  $bb7:
    ...
    assume {:sourceloc "test_html5_mouse.c", 123, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 194} $i19 := printf.ref.ref.ref(.str.26, .str.29, $p18);
    assume {:sourceloc "test_html5_mouse.c", 123, 3} true;
    assume {:verifier.code 0} true;
    goto $bb9;
  ...
  $bb4:
    ...
    assume {:sourceloc "test_html5_mouse.c", 121, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 196} $i15 := printf.ref.ref.ref(.str.26, .str.28, $p14);
    assume {:sourceloc "test_html5_mouse.c", 121, 3} true;
    assume {:verifier.code 0} true;
    goto $bb6;
  ...
  $bb1:
    ...
    assume {:sourceloc "test_html5_mouse.c", 119, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 198} $i11 := printf.ref.ref.ref(.str.26, .str.27, $p10);
    assume {:sourceloc "test_html5_mouse.c", 119, 3} true;
    assume {:verifier.code 0} true;
    goto $bb3;
}
...
implementation __SMACK_check_overflow($i0: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 199} {:cexpr "__SMACK_check_overflow:arg:flag"} boogie_si_record_i32($i0);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
    assume true;
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 203} $CurrAddr := havocNonDetAvh.ref();
...
implementation $free(p: ref)
{
  ...
  anon0:
    call {:si_unique_call 204} corral_atomic_begin();
  ...
  anon2:
    call {:si_unique_call 205} corral_atomic_end();
    return;
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeCallId 0} {:si_unique_call 216} {:ConcretizeConstantName "$M.39"} $M.39 := unknown_ref();
    assume unknownTrigger_0($M.39);
    call {:ConcretizeCallId 1} {:si_unique_call 217} {:ConcretizeConstantName "$exnv"} $exnv := unknown_int();
    assume unknownTrigger_1($exnv);
    call {:ConcretizeCallId 2} {:si_unique_call 218} {:ConcretizeConstantName "$allocatedCounter"} $allocatedCounter := unknown_int();
    assume unknownTrigger_2($allocatedCounter);
    call {:ConcretizeCallId 3} {:si_unique_call 219} {:ConcretizeConstantName "$CurrAddr"} $CurrAddr := unknown_ref();
  ...
  L_BAF_2:
    ...
    call {:si_unique_call 220} {:AvhEntryPoint} $r_main := main();
    return;
  ...
  L_BAF_1:
    ...
    assume MustReach(true);
    call {:si_unique_call 223} {:AvhEntryPoint} $r_wheel_callback := wheel_callback($i0_wheel_callback, $p1_wheel_callback, $p2_wheel_callback);
    return;
  ...
  L_BAF_0:
    ...
    assume MustReach(true);
    call {:si_unique_call 226} {:AvhEntryPoint} $r_mouse_callback := mouse_callback($i0_mouse_callback, $p1_mouse_callback, $p2_mouse_callback);
    return;
}
