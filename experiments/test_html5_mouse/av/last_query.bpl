...
procedure wheel_callback_trace_1($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.20, $M.5, $CurrAddr, $Alloc;



procedure emscripten_event_type_to_string_trace_1($i0: i32) returns ($r: ref);
  free requires assertsPassed;
...
implementation {:origRTname "havocNonDetAvh.ref"} havocNonDetAvh.ref_trace_1() returns (o: ref)
{
  ...
  L_BAF_20__unique__1:
    call {:ConcretizeConstantName "InitLocalVar"} o := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(o);
...
implementation {:origRTname "$alloc"} $alloc_trace_1(n: ref) returns (p: ref)
{
  ...
  anon0__unique__1:
    call {:ConcretizeConstantName "InitLocalVar"} inline$$$alloc$0$n := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$$$alloc$0$n);
    call {:ConcretizeConstantName "InitLocalVar"} inline$$$alloc$0$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$$$alloc$0$p);
    call {:ConcretizeConstantName "InitLocalVar"} cmdloc_dummy_var_3 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_3);
    call {:ConcretizeConstantName "InitLocalVar"} p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(p);
    call corral_fix_context_0();
    ...
    inline$$$alloc$0$n := n;
    call corral_fix_context_0();
    call {:si_unique_call 201} inline$$$alloc$0$p := havocNonDetAvh.ref_trace_1();
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
  ...
  inline$$$alloc$0$anon3_Then__unique__2:
    ...
    call corral_fix_context_0();
    call {:si_unique_call 203} cmdloc_dummy_var_3 := havocNonDetAvh.ref_trace_2();
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
...
procedure $memcpy.i8_trace_1(M.dst: [ref]i8, M.src: [ref]i8, dst: ref, src: ref, len: ref, isvolatile: bool) returns (M.ret: [ref]i8);
  free requires assertsPassed;



implementation {:origRTname "$memcpy.i8"} $memcpy.i8_trace_1(M.dst: [ref]i8, M.src: [ref]i8, dst: ref, src: ref, len: ref, isvolatile: bool) returns (M.ret: [ref]i8)
{

  anon0__unique__1:
    call {:ConcretizeConstantName "InitLocalVar"} M.ret := init_locals_nondet_tmp__ref_i8();
    call corral_fix_context_0();
...
implementation {:origRTname "emscripten_event_type_to_string"} emscripten_event_type_to_string_trace_1($i0: i32) returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
  ...
  $bb0__unique__1:
    call {:ConcretizeConstantName "InitLocalVar"} $p1 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p1);
    call {:ConcretizeConstantName "InitLocalVar"} $p2 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p2);
    call {:ConcretizeConstantName "InitLocalVar"} $p3 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p3);
    call {:ConcretizeConstantName "InitLocalVar"} $p4 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p4);
    call {:ConcretizeConstantName "InitLocalVar"} $p5 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p5);
    call {:ConcretizeConstantName "InitLocalVar"} $p6 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p6);
    call {:ConcretizeConstantName "InitLocalVar"} $i7 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i7);
    call {:ConcretizeConstantName "InitLocalVar"} $i8 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i8);
    call {:ConcretizeConstantName "InitLocalVar"} $i9 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i9);
    call {:ConcretizeConstantName "InitLocalVar"} $i10 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i10);
    call {:ConcretizeConstantName "InitLocalVar"} $i11 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i11);
    call {:ConcretizeConstantName "InitLocalVar"} $p12 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p12);
    call {:ConcretizeConstantName "InitLocalVar"} $p13 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p13);
    call {:ConcretizeConstantName "InitLocalVar"} $p14 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p14);
    call {:ConcretizeConstantName "InitLocalVar"} $p15 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p15);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$0$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$0$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$0$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$0$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$1$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$1$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$1$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$1$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$2$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$2$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$2$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$2$size);
    call {:ConcretizeConstantName "InitLocalVar"} cmdloc_dummy_var_0 := init_locals_nondet_tmp__ref_i8();
    call {:ConcretizeConstantName "InitLocalVar"} cmdloc_dummy_var_1 := init_locals_nondet_tmp__ref_i8();
    call {:ConcretizeConstantName "InitLocalVar"} cmdloc_dummy_var_2 := init_locals_nondet_tmp__ref_i8();
    call {:ConcretizeConstantName "InitLocalVar"} $r := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($r);
    call corral_fix_context_0();
    ...
    assume {:verifier.code 0} true;
    call corral_fix_context_0();
    call {:si_unique_call 158} $p1 := $alloc_trace_1($mul.ref(140, 1));
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_386__unique__2;

  AvnSeqInstr_386__unique__2:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_387__unique__3;

  AvnSeqInstr_387__unique__3:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$0$p), inline$__SMACK_check_memory_safety$0$p);
    goto AvnSeqInstr_389__unique__4;

  AvnSeqInstr_389__unique__4:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_390__unique__5;

  AvnSeqInstr_390__unique__5:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_392__unique__6;

  AvnSeqInstr_392__unique__6:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_393__unique__7;

  AvnSeqInstr_393__unique__7:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_395__unique__8;

  AvnSeqInstr_395__unique__8:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_396__unique__9;

  AvnSeqInstr_396__unique__9:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$1$p), inline$__SMACK_check_memory_safety$1$p);
    goto AvnSeqInstr_398__unique__10;

  AvnSeqInstr_398__unique__10:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_399__unique__11;

  AvnSeqInstr_399__unique__11:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_401__unique__12;

  AvnSeqInstr_401__unique__12:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_402__unique__13;

  AvnSeqInstr_402__unique__13:
    call corral_fix_context_0();
    assume {:sourceloc "test_html5_mouse.c", 26, 15} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    ...
    call corral_fix_context_0();
    call {:si_unique_call 160} cmdloc_dummy_var_2 := $memcpy.i8_trace_1(cmdloc_dummy_var_0, cmdloc_dummy_var_1, $p2, __const.emscripten_event_type_to_string.events, 140, false);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
  ...
  $bb6__unique__17:
    ...
    goto AvnSeqInstr_404__unique__18;

  AvnSeqInstr_404__unique__18:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_405__unique__19;

  AvnSeqInstr_405__unique__19:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$2$p), inline$__SMACK_check_memory_safety$2$p);
    goto AvnSeqInstr_407__unique__20;

  AvnSeqInstr_407__unique__20:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_408__unique__21;

  AvnSeqInstr_408__unique__21:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_410__unique__22;

  AvnSeqInstr_410__unique__22:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_411__unique__23;

  AvnSeqInstr_411__unique__23:
    call corral_fix_context_0();
    assume {:sourceloc "test_html5_mouse.c", 33, 10} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
...
implementation {:origRTname "wheel_callback"} wheel_callback_trace_1($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  var $p3: ref;
  var $p5: ref;
  var $p6: ref;
  ...
  $bb0__unique__1:
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p6 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p6);
    call {:ConcretizeConstantName "InitLocalVar"} $p7 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p7);
    call {:ConcretizeConstantName "InitLocalVar"} $i8 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i8);
    call {:ConcretizeConstantName "InitLocalVar"} $p10 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p10);
    call {:ConcretizeConstantName "InitLocalVar"} $p11 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p11);
    call {:ConcretizeConstantName "InitLocalVar"} $p12 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p12);
    call {:ConcretizeConstantName "InitLocalVar"} $i13 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i13);
    call {:ConcretizeConstantName "InitLocalVar"} $p15 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p15);
    call {:ConcretizeConstantName "InitLocalVar"} $p16 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p16);
    call {:ConcretizeConstantName "InitLocalVar"} $p17 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p17);
    call {:ConcretizeConstantName "InitLocalVar"} $i18 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i18);
    call {:ConcretizeConstantName "InitLocalVar"} $p20 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p20);
    call {:ConcretizeConstantName "InitLocalVar"} $p21 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p21);
    call {:ConcretizeConstantName "InitLocalVar"} $p22 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p22);
    call {:ConcretizeConstantName "InitLocalVar"} $i23 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i23);
    call {:ConcretizeConstantName "InitLocalVar"} $p25 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p25);
    call {:ConcretizeConstantName "InitLocalVar"} $p26 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p26);
    call {:ConcretizeConstantName "InitLocalVar"} $p27 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p27);
    call {:ConcretizeConstantName "InitLocalVar"} $i28 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i28);
    call {:ConcretizeConstantName "InitLocalVar"} $i29 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i29);
    call {:ConcretizeConstantName "InitLocalVar"} $p30 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p30);
    call {:ConcretizeConstantName "InitLocalVar"} $p32 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p32);
    call {:ConcretizeConstantName "InitLocalVar"} $p33 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p33);
    call {:ConcretizeConstantName "InitLocalVar"} $p34 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p34);
    call {:ConcretizeConstantName "InitLocalVar"} $i35 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i35);
    call {:ConcretizeConstantName "InitLocalVar"} $i36 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i36);
    call {:ConcretizeConstantName "InitLocalVar"} $p37 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p37);
    call {:ConcretizeConstantName "InitLocalVar"} $p39 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p39);
    call {:ConcretizeConstantName "InitLocalVar"} $p40 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p40);
    call {:ConcretizeConstantName "InitLocalVar"} $p41 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p41);
    call {:ConcretizeConstantName "InitLocalVar"} $i42 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i42);
    call {:ConcretizeConstantName "InitLocalVar"} $i43 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i43);
    call {:ConcretizeConstantName "InitLocalVar"} $p44 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p44);
    call {:ConcretizeConstantName "InitLocalVar"} $p46 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p46);
    call {:ConcretizeConstantName "InitLocalVar"} $p47 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p47);
    call {:ConcretizeConstantName "InitLocalVar"} $p48 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p48);
    call {:ConcretizeConstantName "InitLocalVar"} $i49 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i49);
    call {:ConcretizeConstantName "InitLocalVar"} $i50 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i50);
    call {:ConcretizeConstantName "InitLocalVar"} $p51 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p51);
    call {:ConcretizeConstantName "InitLocalVar"} $p53 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p53);
    call {:ConcretizeConstantName "InitLocalVar"} $p54 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p54);
    call {:ConcretizeConstantName "InitLocalVar"} $p55 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p55);
    call {:ConcretizeConstantName "InitLocalVar"} $i56 := init_locals_nondet_tmp_i16();
    call boogie_si_record_sdvcp_int($i56);
    call {:ConcretizeConstantName "InitLocalVar"} $i57 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i57);
    call {:ConcretizeConstantName "InitLocalVar"} $p59 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p59);
    call {:ConcretizeConstantName "InitLocalVar"} $p60 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p60);
    call {:ConcretizeConstantName "InitLocalVar"} $p61 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p61);
    call {:ConcretizeConstantName "InitLocalVar"} $i62 := init_locals_nondet_tmp_i16();
    call boogie_si_record_sdvcp_int($i62);
    call {:ConcretizeConstantName "InitLocalVar"} $i63 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i63);
    call {:ConcretizeConstantName "InitLocalVar"} $p65 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p65);
    call {:ConcretizeConstantName "InitLocalVar"} $p66 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p66);
    call {:ConcretizeConstantName "InitLocalVar"} $p67 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p67);
    call {:ConcretizeConstantName "InitLocalVar"} $i68 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i68);
    call {:ConcretizeConstantName "InitLocalVar"} $p70 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p70);
    call {:ConcretizeConstantName "InitLocalVar"} $p71 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p71);
    call {:ConcretizeConstantName "InitLocalVar"} $p72 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p72);
    call {:ConcretizeConstantName "InitLocalVar"} $i73 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i73);
    call {:ConcretizeConstantName "InitLocalVar"} $p74 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p74);
    call {:ConcretizeConstantName "InitLocalVar"} $p75 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p75);
    call {:ConcretizeConstantName "InitLocalVar"} $p76 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p76);
    call {:ConcretizeConstantName "InitLocalVar"} $f77 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f77);
    call {:ConcretizeConstantName "InitLocalVar"} $f78 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f78);
    call {:ConcretizeConstantName "InitLocalVar"} $f79 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f79);
    call {:ConcretizeConstantName "InitLocalVar"} $p80 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p80);
    call {:ConcretizeConstantName "InitLocalVar"} $p81 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p81);
    call {:ConcretizeConstantName "InitLocalVar"} $p82 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p82);
    call {:ConcretizeConstantName "InitLocalVar"} $f83 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f83);
    call {:ConcretizeConstantName "InitLocalVar"} $f84 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f84);
    call {:ConcretizeConstantName "InitLocalVar"} $f85 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f85);
    call {:ConcretizeConstantName "InitLocalVar"} $p86 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p86);
    call {:ConcretizeConstantName "InitLocalVar"} $p87 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p87);
    call {:ConcretizeConstantName "InitLocalVar"} $p88 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p88);
    call {:ConcretizeConstantName "InitLocalVar"} $f89 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f89);
    call {:ConcretizeConstantName "InitLocalVar"} $f90 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f90);
    call {:ConcretizeConstantName "InitLocalVar"} $f91 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f91);
    call {:ConcretizeConstantName "InitLocalVar"} $p92 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p92);
    call {:ConcretizeConstantName "InitLocalVar"} $p93 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p93);
    call {:ConcretizeConstantName "InitLocalVar"} $p94 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p94);
    call {:ConcretizeConstantName "InitLocalVar"} $i95 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i95);
    call {:ConcretizeConstantName "InitLocalVar"} $p97 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p97);
    call {:ConcretizeConstantName "InitLocalVar"} $p98 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p98);
    call {:ConcretizeConstantName "InitLocalVar"} $p99 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p99);
    call {:ConcretizeConstantName "InitLocalVar"} $f100 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f100);
    call {:ConcretizeConstantName "InitLocalVar"} $i101 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i101);
    call {:ConcretizeConstantName "InitLocalVar"} $p102 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p102);
    call {:ConcretizeConstantName "InitLocalVar"} $p103 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p103);
    call {:ConcretizeConstantName "InitLocalVar"} $p104 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p104);
    call {:ConcretizeConstantName "InitLocalVar"} $f105 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f105);
    call {:ConcretizeConstantName "InitLocalVar"} $i106 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i106);
    call {:ConcretizeConstantName "InitLocalVar"} $p107 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p107);
    call {:ConcretizeConstantName "InitLocalVar"} $p108 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p108);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$0$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$0$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$0$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$0$size);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$2$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$2$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$3$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$3$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$3$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$3$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$4$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$4$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$4$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$4$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$5$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$5$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$5$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$5$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$6$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$6$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$6$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$6$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$7$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$7$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$7$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$7$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$8$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$8$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$8$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$8$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$9$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$9$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$9$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$9$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$10$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$10$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$10$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$10$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$11$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$11$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$11$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$11$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$12$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$12$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$12$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$12$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$13$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$13$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$13$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$13$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$14$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$14$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$14$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$14$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$15$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$15$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$15$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$15$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$16$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$16$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$16$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$16$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$17$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$17$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$17$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$17$size);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$18$p := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$18$p);
    call {:ConcretizeConstantName "InitLocalVar"} inline$__SMACK_check_memory_safety$18$size := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int(inline$__SMACK_check_memory_safety$18$size);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_10 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_10);
    call {:ConcretizeConstantName "InitLocalVar"} $r := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($r);
    call corral_fix_context_0();
    ...
    assume {:verifier.code 0} true;
    call corral_fix_context_0();
    call {:si_unique_call 163} $p3 := emscripten_event_type_to_string_trace_1($i0);
    goto AvnSeqInstr_413__unique__2;

  AvnSeqInstr_413__unique__2:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_414__unique__3;

  AvnSeqInstr_414__unique__3:
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    assertsPassed := $Alloc[$base(inline$__SMACK_check_memory_safety$0$p)];
    goto AvnSeqInstr_416__unique__4;

  AvnSeqInstr_416__unique__4:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_417__unique__5;

  AvnSeqInstr_417__unique__5:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$0$p), inline$__SMACK_check_memory_safety$0$p);
    goto AvnSeqInstr_419__unique__6;

  AvnSeqInstr_419__unique__6:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_420__unique__7;

  AvnSeqInstr_420__unique__7:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($add.ref(inline$__SMACK_check_memory_safety$0$p, inline$__SMACK_check_memory_safety$0$size), $add.ref($base(inline$__SMACK_check_memory_safety$0$p), $Size($base(inline$__SMACK_check_memory_safety$0$p))));
    goto AvnSeqInstr_422__unique__8;

  AvnSeqInstr_422__unique__8:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_423__unique__9;

  AvnSeqInstr_423__unique__9:
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    assertsPassed := $Alloc[$base(inline$__SMACK_check_memory_safety$1$p)];
    goto AvnSeqInstr_424__unique__10;

  AvnSeqInstr_424__unique__10:
    call corral_fix_context_0();
...
implementation {:origRTname "CorralMain"} CorralMain_trace_1()
{
  ...
  L_BAF_1__unique__2:
    ...
    call corral_fix_context_0();
    call {:si_unique_call 223} {:AvhEntryPoint} vslice_dummy_var_21 := wheel_callback_trace_1($i0_wheel_callback, $p1_wheel_callback, $p2_wheel_callback);
    goto AvnSeqInstr_616__unique__3;

  AvnSeqInstr_616__unique__3:
    call corral_fix_context_0();
    assume !assertsPassed;
    return;
}
...
procedure boogie_si_record_sdvcp_int(x: int);



procedure boogie_si_record_sdvcp_bool(x: bool);



procedure boogie_si_record_sdvcp_ctor_float(x: float);
