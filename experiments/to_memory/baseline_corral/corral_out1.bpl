...
procedure {:entrypoint} _ZZ4mainENK3$_0clEP18emscripten_fetch_t(this: ref, fetch: ref);
  modifies $exn;



implementation {:entrypoint} _ZZ4mainENK3$_0clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  var $i0: i1;
  var $p1: ref;
  var $p2: ref;
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 1} $i5 := printf.ref.i64(.str.5, $i4);
  ...
  $bb35:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 23} $i69 := printf.ref.i32(.str.13, $i68);
  ...
  $bb38:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 25} $i72 := emscripten_fetch_close(fetch);
