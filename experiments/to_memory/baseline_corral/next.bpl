...
implementation _ZZ4mainENK3$_0clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  ...
  $bb2:
    ...
    call {:si_unique_call 0} __SMACK_check_memory_safety($p2, $p3);
  ...
  SeqInstr_3:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 1} vslice_dummy_var_0 := printf.ref.i64(.str.5, $i4);
  ...
  $bb3:
    ...
    assume {:sourceloc "to_memory.cpp", 30, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 3} __assert_fail(.str.4, .str.3, 30, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 30, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb4;
  ...
  $bb6:
    ...
    call {:si_unique_call 4} __SMACK_check_memory_safety($p12, $p13);
  ...
  SeqInstr_9:
    ...
    assume {:sourceloc "to_memory.cpp", 33, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 5} $i15 := _Z6strcmpPKcS0_($p14, .str.1);
    assume {:sourceloc "to_memory.cpp", 33, 5} true;
    assume {:verifier.code 0} true;
    $i16 := $ne.i32($i15, 0);
    assume {:sourceloc "to_memory.cpp", 33, 5} true;
  ...
  $bb7:
    ...
    assume {:sourceloc "to_memory.cpp", 32, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 6} __assert_fail(.str.6, .str.3, 32, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 32, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb8;
  ...
  $bb9:
    ...
    assume {:sourceloc "to_memory.cpp", 33, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 7} __assert_fail(.str.7, .str.3, 33, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 33, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb10;
  ...
  $bb11:
    ...
    call {:si_unique_call 8} __SMACK_check_memory_safety($p18, $p19);
  ...
  $bb14:
    ...
    call {:si_unique_call 9} __SMACK_check_memory_safety($p23, $p24);
  ...
  $bb15:
    ...
    assume {:sourceloc "to_memory.cpp", 34, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 10} __assert_fail(.str.8, .str.3, 34, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 34, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb16;
  ...
  $bb18:
    ...
    call {:si_unique_call 11} __SMACK_check_memory_safety($p29, $p30);
  ...
  $bb19:
    ...
    assume {:sourceloc "to_memory.cpp", 35, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 12} __assert_fail(.str.9, .str.3, 35, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 35, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb20;
  ...
  $bb22:
    ...
    call {:si_unique_call 13} __SMACK_check_memory_safety($p34, $p35);
  ...
  SeqInstr_21:
    ...
    call {:si_unique_call 14} __SMACK_check_memory_safety($p38, $p39);
  ...
  $bb23:
    ...
    assume {:sourceloc "to_memory.cpp", 36, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 15} __assert_fail(.str.10, .str.3, 36, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 36, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb24;
  ...
  $bb26:
    ...
    call {:si_unique_call 16} __SMACK_check_memory_safety($p43, $p44);
  ...
  $bb27:
    ...
    assume {:sourceloc "to_memory.cpp", 37, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 17} __assert_fail(.str.11, .str.3, 37, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 37, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb28;
  ...
  $bb31:
    ...
    assume {:sourceloc "to_memory.cpp", 38, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 18} __assert_fail(.str.12, .str.3, 38, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 38, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb32;
  ...
  $bb33:
    ...
    call {:si_unique_call 19} __SMACK_check_memory_safety($p51, $p52);
  ...
  $bb34:
    ...
    call {:si_unique_call 20} __SMACK_check_memory_safety($p56, $p57);
  ...
  SeqInstr_33:
    ...
    call {:si_unique_call 21} __SMACK_check_memory_safety($p60, $p61);
  ...
  SeqInstr_36:
    ...
    call {:si_unique_call 22} {:cexpr "checksum"} boogie_si_record_i8($i66);
  ...
  $bb35:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 23} vslice_dummy_var_1 := printf.ref.i32(.str.13, $i68);
  ...
  $bb36:
    ...
    assume {:verifier.code 0} true;
    $i67 := $add.i32($i48, 1);
    call {:si_unique_call 24} {:cexpr "i"} boogie_si_record_i32($i67);
    assume {:sourceloc "to_memory.cpp", 41, 5} true;
    assume {:verifier.code 0} true;
    $i47, $i48 := $i66, $i67;
    goto $bb33;
  ...
  $bb38:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 25} vslice_dummy_var_2 := emscripten_fetch_close(fetch);
  ...
  $bb39:
    ...
    assume {:sourceloc "to_memory.cpp", 44, 5} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 26} __assert_fail(.str.14, .str.3, 44, __func__._ZZ4mainENK3$_0clEP18emscripten_fetch_t);
    assume {:sourceloc "to_memory.cpp", 44, 5} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb40;
...
procedure {:entrypoint} _ZZ4mainENK3$_0clEP18emscripten_fetch_t_SeqInstr(this: ref, fetch: ref);
  free requires assertsPassed;
  modifies assertsPassed;



implementation {:entrypoint} _ZZ4mainENK3$_0clEP18emscripten_fetch_t_SeqInstr(this: ref, fetch: ref)
{

  start:
    assertsPassed := true;
    call _ZZ4mainENK3$_0clEP18emscripten_fetch_t(this, fetch);
