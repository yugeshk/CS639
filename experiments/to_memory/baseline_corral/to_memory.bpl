...
$bb8:
  ...
  assume {:verifier.code 0} true;
  // llvm2bpl: to_memory.cpp:61:88: warning: over-approximating floating-point arithmetic fmul;
  ...
  assume {:verifier.code 0} true;
  // llvm2bpl: to_memory.cpp:61:96: warning: over-approximating floating-point arithmetic fdiv;
...
$bb27:
  ...
  call __SMACK_check_memory_safety($p104, $p105);
  assume {:sourceloc "to_memory.cpp", 74, 5} true;
  assume {:verifier.code 0} true;
