...
implementation _ZZ4mainENK3$_1clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  ...
  $bb6$3:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 104} $i19 := printf.ref.i64.i64.i64(.str.15, $i10, $i14, $i18);
  ...
  $bb9$2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 105} $i52 := printf.ref.i64(.str.17, $i51);
    assume {:verifier.code 0} true;
    goto $bb10;
  ...
  $bb8$3:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 113} $i42 := printf.ref.float(.str.16, $f41);
...
implementation _ZZ4mainENK3$_0clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  ...
  $bb2$1:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 116} $i5 := printf.ref.i64(.str.5, $i4);
  ...
  $bb35:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 124} $i69 := printf.ref.i32(.str.13, $i68);
  ...
  $bb38:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 126} $i72 := emscripten_fetch_close(fetch);
...
implementation __SMACK_check_overflow(flag: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 130} {:cexpr "__SMACK_check_overflow:arg:flag"} boogie_si_record_i32(flag);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
    assume true;
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 134} $CurrAddr := havocNonDetAvh.ref();
...
implementation $free(p: ref)
{
  ...
  anon0:
    call {:si_unique_call 135} corral_atomic_begin();
  ...
  anon2:
    call {:si_unique_call 136} corral_atomic_end();
    return;
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeCallId 1} {:si_unique_call 142} {:ConcretizeConstantName "$M.21"} $M.21 := unknown_ref();
    assume unknownTrigger_1($M.21);
    call {:ConcretizeCallId 2} {:si_unique_call 143} {:ConcretizeConstantName "$exnv"} $exnv := unknown_int();
    assume unknownTrigger_2($exnv);
    call {:ConcretizeCallId 3} {:si_unique_call 144} {:ConcretizeConstantName "$allocatedCounter"} $allocatedCounter := unknown_int();
    assume unknownTrigger_3($allocatedCounter);
    call {:ConcretizeCallId 4} {:si_unique_call 145} {:ConcretizeConstantName "$CurrAddr"} $CurrAddr := unknown_ref();
  ...
  L_BAF_0:
    ...
    assume MustReach(true);
    call {:si_unique_call 156} {:AvhEntryPoint} $r_main := main();
    return;
}
