...
procedure _ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t(fetch: ref);
  modifies $exn;



implementation _ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t(fetch: ref)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "to_memory.cpp", 77, 18} true;
    assume {:verifier.code 0} true;
    call _ZZ4mainENK3$_2clEP18emscripten_fetch_t($u0, fetch);
    assume {:sourceloc "to_memory.cpp", 77, 18} true;
    assume {:verifier.code 0} true;
    $exn := false;
    return;
...
procedure _ZZ4mainENK3$_2clEP18emscripten_fetch_t(this: ref, fetch: ref);



implementation _ZZ4mainENK3$_2clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  var $i0: i32;
...
implementation _ZZ4mainENK3$_0clEP18emscripten_fetch_t(this: ref, fetch: ref)
{
  ...
  $bb33:
    call $i47, $i48, $i49, $p50, $p51, $p52, $i53, $i54, $p55, $p56, $p57, $p58, $p59, $p60, $p61, $i62, $i63, $i64, $i65, $i66, $i67, inline$__SMACK_check_memory_safety$9$p, inline$__SMACK_check_memory_safety$9$size, inline$__SMACK_check_memory_safety$10$p, inline$__SMACK_check_memory_safety$10$size, inline$__SMACK_check_memory_safety$11$p, inline$__SMACK_check_memory_safety$11$size := _ZZ4mainENK3$_0clEP18emscripten_fetch_t_loop_$bb33(fetch, $i47, $i48, $i49, $p50, $p51, $p52, $i53, $i54, $p55, $p56, $p57, $p58, $p59, $p60, $p61, $i62, $i63, $i64, $i65, $i66, $i67, inline$__SMACK_check_memory_safety$9$p, inline$__SMACK_check_memory_safety$9$size, inline$__SMACK_check_memory_safety$10$p, inline$__SMACK_check_memory_safety$10$size, inline$__SMACK_check_memory_safety$11$p, inline$__SMACK_check_memory_safety$11$size);
    goto $bb33_last;
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    ...
    goto L_BAF_0, L_BAF_1, L_BAF_2, L_BAF_3, L_BAF_4, L_BAF_5, L_BAF_6, L_BAF_7, L_BAF_8, L_BAF_9, L_BAF_10, L_BAF_11, L_BAF_12, L_BAF_13, L_BAF_14, L_BAF_15, L_BAF_16, L_BAF_17, L_BAF_18, L_BAF_19, L_BAF_20, L_BAF_21;
  ...
  L_BAF_6:
    assume __block_call__ZZ4mainENK3$_2clEP18emscripten_fetch_t;
    call {:ConcretizeConstantName "this__ZZ4mainENK3$_2clEP18emscripten_fetch_t"} this__ZZ4mainENK3$_2clEP18emscripten_fetch_t := unknown_ref();
    call {:ConcretizeConstantName "fetch__ZZ4mainENK3$_2clEP18emscripten_fetch_t"} fetch__ZZ4mainENK3$_2clEP18emscripten_fetch_t := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} _ZZ4mainENK3$_2clEP18emscripten_fetch_t(this__ZZ4mainENK3$_2clEP18emscripten_fetch_t, fetch__ZZ4mainENK3$_2clEP18emscripten_fetch_t);
    return;

  L_BAF_5:
    assume __block_call__ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t;
    call {:ConcretizeConstantName "fetch__ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t"} fetch__ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} _ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t(fetch__ZZ4mainEN3$_28__invokeEP18emscripten_fetch_t);
    return;

  L_BAF_4:
    assume __block_call__ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv;
    call {:ConcretizeConstantName "this__ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv"} this__ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r__ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv := _ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv(this__ZZ4mainENK3$_2cvPFvP18emscripten_fetch_tEEv);
    return;

  L_BAF_3:
    assume __block_call__ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv;
    call {:ConcretizeConstantName "this__ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv"} this__ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r__ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv := _ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv(this__ZZ4mainENK3$_1cvPFvP18emscripten_fetch_tEEv);
    return;

  L_BAF_2:
    assume __block_call__ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv;
    call {:ConcretizeConstantName "this__ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv"} this__ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv := unknown_ref();
    assume MustReach(true);
    call {:AvhEntryPoint} $r__ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv := _ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv(this__ZZ4mainENK3$_0cvPFvP18emscripten_fetch_tEEv);
    return;
...
implementation _ZZ4mainENK3$_0clEP18emscripten_fetch_t_loop_$bb33(in_fetch: ref, in_$i47: i8, in_$i48: i32, in_$i49: i64, in_$p50: ref, in_$p51: ref, in_$p52: ref, in_$i53: i64, in_$i54: i1, in_$p55: ref, in_$p56: ref, in_$p57: ref, in_$p58: ref, in_$p59: ref, in_$p60: ref, in_$p61: ref, in_$i62: i8, in_$i63: i32, in_$i64: i32, in_$i65: i32, in_$i66: i8, in_$i67: i32, in_inline$__SMACK_check_memory_safety$9$p: ref, in_inline$__SMACK_check_memory_safety$9$size: ref, in_inline$__SMACK_check_memory_safety$10$p: ref, in_inline$__SMACK_check_memory_safety$10$size: ref, in_inline$__SMACK_check_memory_safety$11$p: ref, in_inline$__SMACK_check_memory_safety$11$size: ref) returns (out_$i47: i8, out_$i48: i32, out_$i49: i64, out_$p50: ref, out_$p51: ref, out_$p52: ref, out_$i53: i64, out_$i54: i1, out_$p55: ref, out_$p56: ref, out_$p57: ref, out_$p58: ref, out_$p59: ref, out_$p60: ref, out_$p61: ref, out_$i62: i8, out_$i63: i32, out_$i64: i32, out_$i65: i32, out_$i66: i8, out_$i67: i32, out_inline$__SMACK_check_memory_safety$9$p: ref, out_inline$__SMACK_check_memory_safety$9$size: ref, out_inline$__SMACK_check_memory_safety$10$p: ref, out_inline$__SMACK_check_memory_safety$10$size: ref, out_inline$__SMACK_check_memory_safety$11$p: ref, out_inline$__SMACK_check_memory_safety$11$size: ref)
{

  entry:
    out_$i47, out_$i48, out_$i49, out_$p50, out_$p51, out_$p52, out_$i53, out_$i54, out_$p55, out_$p56, out_$p57, out_$p58, out_$p59, out_$p60, out_$p61, out_$i62, out_$i63, out_$i64, out_$i65, out_$i66, out_$i67, out_inline$__SMACK_check_memory_safety$9$p, out_inline$__SMACK_check_memory_safety$9$size, out_inline$__SMACK_check_memory_safety$10$p, out_inline$__SMACK_check_memory_safety$10$size, out_inline$__SMACK_check_memory_safety$11$p, out_inline$__SMACK_check_memory_safety$11$size := in_$i47, in_$i48, in_$i49, in_$p50, in_$p51, in_$p52, in_$i53, in_$i54, in_$p55, in_$p56, in_$p57, in_$p58, in_$p59, in_$p60, in_$p61, in_$i62, in_$i63, in_$i64, in_$i65, in_$i66, in_$i67, in_inline$__SMACK_check_memory_safety$9$p, in_inline$__SMACK_check_memory_safety$9$size, in_inline$__SMACK_check_memory_safety$10$p, in_inline$__SMACK_check_memory_safety$10$size, in_inline$__SMACK_check_memory_safety$11$p, in_inline$__SMACK_check_memory_safety$11$size;
    goto $bb33, exit;
  ...
  $bb33:
    ...
    assume {:sourceloc "to_memory.cpp", 41, 31} true;
    assume {:verifier.code 0} true;
    out_$p50 := $add.ref($add.ref(in_fetch, $mul.ref(0, 208)), $mul.ref(16, 1));
    out_$p51 := $bitcast.ref.ref(out_$p50);
    out_$p52 := $bitcast.ref.ref($i2p.i64.ref(8));
    goto inline$__SMACK_check_memory_safety$9$Entry;

  $bb36:
    assume {:sourceloc "to_memory.cpp", 41, 41} true;
    assume {:verifier.code 0} true;
    out_$i67 := $add.i32(out_$i48, 1);
    call {:cexpr "i"} boogie_si_record_i32(out_$i67);
    assume {:sourceloc "to_memory.cpp", 41, 5} true;
    assume {:verifier.code 0} true;
    out_$i47, out_$i48 := out_$i66, out_$i67;
    goto $bb36_dummy;

  $bb34$2:
    assume {:sourceloc "to_memory.cpp", 42, 19} true;
    assume {:verifier.code 0} true;
    out_$i62 := $load.i8($M.20, out_$p59);
    assume {:sourceloc "to_memory.cpp", 42, 19} true;
    assume {:verifier.code 0} true;
    out_$i63 := $sext.i8.i32(out_$i62);
    assume {:sourceloc "to_memory.cpp", 42, 16} true;
    assume {:verifier.code 0} true;
    out_$i64 := $zext.i8.i32(out_$i47);
    assume {:sourceloc "to_memory.cpp", 42, 16} true;
    assume {:verifier.code 0} true;
    out_$i65 := $xor.i32(out_$i64, out_$i63);
    assume {:sourceloc "to_memory.cpp", 42, 16} true;
    assume {:verifier.code 0} true;
    out_$i66 := $trunc.i32.i8(out_$i65);
    call {:cexpr "checksum"} boogie_si_record_i8(out_$i66);
    assume {:sourceloc "to_memory.cpp", 42, 7} true;
    assume {:verifier.code 0} true;
    goto $bb36;
  ...
  inline$__SMACK_check_memory_safety$11$anon0:
    assert {:valid_deref} $Alloc[$base(out_inline$__SMACK_check_memory_safety$11$p)];
    assert {:valid_deref} $sle.ref.bool($base(out_inline$__SMACK_check_memory_safety$11$p), out_inline$__SMACK_check_memory_safety$11$p);
    assert {:valid_deref} $sle.ref.bool($add.ref(out_inline$__SMACK_check_memory_safety$11$p, out_inline$__SMACK_check_memory_safety$11$size), $add.ref($base(out_inline$__SMACK_check_memory_safety$11$p), $Size($base(out_inline$__SMACK_check_memory_safety$11$p))));
    goto inline$__SMACK_check_memory_safety$11$Return;

  inline$__SMACK_check_memory_safety$11$Entry:
    out_inline$__SMACK_check_memory_safety$11$p := out_$p60;
    out_inline$__SMACK_check_memory_safety$11$size := out_$p61;
    goto inline$__SMACK_check_memory_safety$11$anon0;

  $bb34$1:
    assume {:sourceloc "to_memory.cpp", 42, 26} true;
    assume {:verifier.code 0} true;
    out_$p58 := $load.ref($M.19, out_$p55);
    assume {:sourceloc "to_memory.cpp", 42, 19} true;
    assume {:verifier.code 0} true;
    out_$p59 := $add.ref(out_$p58, $mul.ref(out_$i48, 1));
    out_$p60 := $bitcast.ref.ref(out_$p59);
    out_$p61 := $bitcast.ref.ref($i2p.i64.ref(1));
    goto inline$__SMACK_check_memory_safety$11$Entry;
  ...
  inline$__SMACK_check_memory_safety$10$anon0:
    assert {:valid_deref} $Alloc[$base(out_inline$__SMACK_check_memory_safety$10$p)];
    assert {:valid_deref} $sle.ref.bool($base(out_inline$__SMACK_check_memory_safety$10$p), out_inline$__SMACK_check_memory_safety$10$p);
    assert {:valid_deref} $sle.ref.bool($add.ref(out_inline$__SMACK_check_memory_safety$10$p, out_inline$__SMACK_check_memory_safety$10$size), $add.ref($base(out_inline$__SMACK_check_memory_safety$10$p), $Size($base(out_inline$__SMACK_check_memory_safety$10$p))));
    goto inline$__SMACK_check_memory_safety$10$Return;

  inline$__SMACK_check_memory_safety$10$Entry:
    out_inline$__SMACK_check_memory_safety$10$p := out_$p56;
    out_inline$__SMACK_check_memory_safety$10$size := out_$p57;
    goto inline$__SMACK_check_memory_safety$10$anon0;
  ...
  $bb34:
    ...
    assume {:sourceloc "to_memory.cpp", 42, 26} true;
    assume {:verifier.code 0} true;
    out_$p55 := $add.ref($add.ref(in_fetch, $mul.ref(0, 208)), $mul.ref(12, 1));
    out_$p56 := $bitcast.ref.ref(out_$p55);
    out_$p57 := $bitcast.ref.ref($i2p.i64.ref(4));
    goto inline$__SMACK_check_memory_safety$10$Entry;

  $bb33$1:
    assume {:sourceloc "to_memory.cpp", 41, 31} true;
    assume {:verifier.code 0} true;
    out_$i53 := $load.i64($M.14, out_$p50);
    assume {:sourceloc "to_memory.cpp", 41, 22} true;
    assume {:verifier.code 0} true;
    out_$i54 := $ult.i64(out_$i49, out_$i53);
    assume {:sourceloc "to_memory.cpp", 41, 5} true;
    assume {:verifier.code 0} true;
    assume true;
    goto $bb34;
  ...
  inline$__SMACK_check_memory_safety$9$anon0:
    assert {:valid_deref} $Alloc[$base(out_inline$__SMACK_check_memory_safety$9$p)];
    assert {:valid_deref} $sle.ref.bool($base(out_inline$__SMACK_check_memory_safety$9$p), out_inline$__SMACK_check_memory_safety$9$p);
    assert {:valid_deref} $sle.ref.bool($add.ref(out_inline$__SMACK_check_memory_safety$9$p, out_inline$__SMACK_check_memory_safety$9$size), $add.ref($base(out_inline$__SMACK_check_memory_safety$9$p), $Size($base(out_inline$__SMACK_check_memory_safety$9$p))));
    goto inline$__SMACK_check_memory_safety$9$Return;

  inline$__SMACK_check_memory_safety$9$Entry:
    out_inline$__SMACK_check_memory_safety$9$p := out_$p51;
    out_inline$__SMACK_check_memory_safety$9$size := out_$p52;
    goto inline$__SMACK_check_memory_safety$9$anon0;

  $bb36_dummy:
    call {:si_unique_call 1} out_$i47, out_$i48, out_$i49, out_$p50, out_$p51, out_$p52, out_$i53, out_$i54, out_$p55, out_$p56, out_$p57, out_$p58, out_$p59, out_$p60, out_$p61, out_$i62, out_$i63, out_$i64, out_$i65, out_$i66, out_$i67, out_inline$__SMACK_check_memory_safety$9$p, out_inline$__SMACK_check_memory_safety$9$size, out_inline$__SMACK_check_memory_safety$10$p, out_inline$__SMACK_check_memory_safety$10$size, out_inline$__SMACK_check_memory_safety$11$p, out_inline$__SMACK_check_memory_safety$11$size := _ZZ4mainENK3$_0clEP18emscripten_fetch_t_loop_$bb33(in_fetch, out_$i47, out_$i48, out_$i49, out_$p50, out_$p51, out_$p52, out_$i53, out_$i54, out_$p55, out_$p56, out_$p57, out_$p58, out_$p59, out_$p60, out_$p61, out_$i62, out_$i63, out_$i64, out_$i65, out_$i66, out_$i67, out_inline$__SMACK_check_memory_safety$9$p, out_inline$__SMACK_check_memory_safety$9$size, out_inline$__SMACK_check_memory_safety$10$p, out_inline$__SMACK_check_memory_safety$10$size, out_inline$__SMACK_check_memory_safety$11$p, out_inline$__SMACK_check_memory_safety$11$size);
    return;
...
procedure _ZZ4mainENK3$_0clEP18emscripten_fetch_t_loop_$bb33(in_fetch: ref, in_$i47: i8, in_$i48: i32, in_$i49: i64, in_$p50: ref, in_$p51: ref, in_$p52: ref, in_$i53: i64, in_$i54: i1, in_$p55: ref, in_$p56: ref, in_$p57: ref, in_$p58: ref, in_$p59: ref, in_$p60: ref, in_$p61: ref, in_$i62: i8, in_$i63: i32, in_$i64: i32, in_$i65: i32, in_$i66: i8, in_$i67: i32, in_inline$__SMACK_check_memory_safety$9$p: ref, in_inline$__SMACK_check_memory_safety$9$size: ref, in_inline$__SMACK_check_memory_safety$10$p: ref, in_inline$__SMACK_check_memory_safety$10$size: ref, in_inline$__SMACK_check_memory_safety$11$p: ref, in_inline$__SMACK_check_memory_safety$11$size: ref) returns (out_$i47: i8, out_$i48: i32, out_$i49: i64, out_$p50: ref, out_$p51: ref, out_$p52: ref, out_$i53: i64, out_$i54: i1, out_$p55: ref, out_$p56: ref, out_$p57: ref, out_$p58: ref, out_$p59: ref, out_$p60: ref, out_$p61: ref, out_$i62: i8, out_$i63: i32, out_$i64: i32, out_$i65: i32, out_$i66: i8, out_$i67: i32, out_inline$__SMACK_check_memory_safety$9$p: ref, out_inline$__SMACK_check_memory_safety$9$size: ref, out_inline$__SMACK_check_memory_safety$10$p: ref, out_inline$__SMACK_check_memory_safety$10$size: ref, out_inline$__SMACK_check_memory_safety$11$p: ref, out_inline$__SMACK_check_memory_safety$11$size: ref);
