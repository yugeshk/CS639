...
procedure CorralMain_trace_1();
  free requires assertsPassed;
  free requires {:BlockingConstraint 0} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(0, 1))))]);
  free requires {:BlockingConstraint 1} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1296, 1))))]);
  free requires {:BlockingConstraint 2} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1296, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1296, 1)))));
  free requires {:BlockingConstraint 3} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(0, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(0, 1)))));
  free requires {:BlockingConstraint 4} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1296, 1))), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1296, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1296, 1))))))));
  ...
  free requires {:BlockingConstraint 6} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1300, 1))))]);
  free requires {:BlockingConstraint 7} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1300, 1))), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1300, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1300, 1))))))));
  free requires {:BlockingConstraint 8} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1300, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(1300, 1)))));
  free requires {:BlockingConstraint 9} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $Alloc[$base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(8, 1))))]);
  free requires {:BlockingConstraint 10} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(12, 1)))), $bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(12, 1)))));
  free requires {:BlockingConstraint 11} (forall x_5: ref :: unknownTrigger_4(x_5) ==> $sle.ref.bool($add.ref($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(12, 1))), $bitcast.ref.ref($i2p.i64.ref(4))), $add.ref($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(12, 1)))), $Size($base($bitcast.ref.ref($add.ref($add.ref(x_5, $mul.ref(0, 1432)), $mul.ref(12, 1))))))));
  modifies $M.6, $exnv, $allocatedCounter, $CurrAddr, assertsPassed, $M.4, $M.2, $M.1, $Alloc;



procedure gamepad_callback_trace_1($i0: i32, $p1: ref, $p2: ref) returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.1, $CurrAddr, $Alloc;



implementation {:origRTname "gamepad_callback"} gamepad_callback_trace_1($i0: i32, $p1: ref, $p2: ref) returns ($r: i32)
{
  var $i3: i1;
  var $p4: ref;
  var $p5: ref;
  ...
  $bb0__unique__1:
    call {:ConcretizeConstantName "InitLocalVar"} $i3 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i3);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p8 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p8);
    call {:ConcretizeConstantName "InitLocalVar"} $f9 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f9);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p18 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p18);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i21 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i21);
    call {:ConcretizeConstantName "InitLocalVar"} $p22 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p22);
    call {:ConcretizeConstantName "InitLocalVar"} $p23 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p23);
    call {:ConcretizeConstantName "InitLocalVar"} $p24 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p24);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p29 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p29);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $i34 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i34);
    call {:ConcretizeConstantName "InitLocalVar"} $i35 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i35);
    call {:ConcretizeConstantName "InitLocalVar"} $i36 := init_locals_nondet_tmp_i32();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $p38 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p38);
    call {:ConcretizeConstantName "InitLocalVar"} $p39 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p39);
    call {:ConcretizeConstantName "InitLocalVar"} $i40 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i40);
    call {:ConcretizeConstantName "InitLocalVar"} $i41 := init_locals_nondet_tmp_i1();
    ...
    call {:ConcretizeConstantName "InitLocalVar"} $f46 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f46);
    call {:ConcretizeConstantName "InitLocalVar"} $i48 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i48);
    call {:ConcretizeConstantName "InitLocalVar"} $i49 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i49);
    call {:ConcretizeConstantName "InitLocalVar"} $p50 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p50);
    call {:ConcretizeConstantName "InitLocalVar"} $p51 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p51);
    call {:ConcretizeConstantName "InitLocalVar"} $p52 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p52);
    call {:ConcretizeConstantName "InitLocalVar"} $i53 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i53);
    call {:ConcretizeConstantName "InitLocalVar"} $i54 := init_locals_nondet_tmp_i1();
    call boogie_si_record_sdvcp_int($i54);
    call {:ConcretizeConstantName "InitLocalVar"} $p56 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p56);
    call {:ConcretizeConstantName "InitLocalVar"} $p57 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p57);
    call {:ConcretizeConstantName "InitLocalVar"} $p58 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p58);
    call {:ConcretizeConstantName "InitLocalVar"} $i59 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i59);
    call {:ConcretizeConstantName "InitLocalVar"} $p61 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p61);
    call {:ConcretizeConstantName "InitLocalVar"} $p62 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p62);
    call {:ConcretizeConstantName "InitLocalVar"} $p63 := init_locals_nondet_tmp_ref();
    call boogie_si_record_sdvcp_int($p63);
    call {:ConcretizeConstantName "InitLocalVar"} $f64 := init_locals_nondet_tmp_float();
    call boogie_si_record_sdvcp_ctor_float($f64);
    call {:ConcretizeConstantName "InitLocalVar"} $i66 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int($i66);
    ...
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_0 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_0);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_1 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_1);
    call {:ConcretizeConstantName "InitLocalVar"} vslice_dummy_var_2 := init_locals_nondet_tmp_i32();
    call boogie_si_record_sdvcp_int(vslice_dummy_var_2);
    ...
    call corral_fix_context_0();
    call {:si_unique_call 122} {:cexpr "gamepad_callback:arg:eventType"} boogie_si_record_i32($i0);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume {:sourceloc "test_gamepad.c", 42, 15} true;
  ...
  $bb3__unique__3:
    ...
    goto AvnSeqInstr_2__unique__4;

  AvnSeqInstr_2__unique__4:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_3__unique__5;

  AvnSeqInstr_3__unique__5:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$0$p), inline$__SMACK_check_memory_safety$0$p);
    goto AvnSeqInstr_5__unique__6;

  AvnSeqInstr_5__unique__6:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_6__unique__7;

  AvnSeqInstr_6__unique__7:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_8__unique__8;

  AvnSeqInstr_8__unique__8:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_9__unique__9;

  AvnSeqInstr_9__unique__9:
    call corral_fix_context_0();
    assume {:sourceloc "test_gamepad.c", 42, 87} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    ...
    goto AvnSeqInstr_11__unique__10;

  AvnSeqInstr_11__unique__10:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_12__unique__11;

  AvnSeqInstr_12__unique__11:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$1$p), inline$__SMACK_check_memory_safety$1$p);
    goto AvnSeqInstr_14__unique__12;

  AvnSeqInstr_14__unique__12:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_15__unique__13;

  AvnSeqInstr_15__unique__13:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_17__unique__14;

  AvnSeqInstr_17__unique__14:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_18__unique__15;

  AvnSeqInstr_18__unique__15:
    call corral_fix_context_0();
    assume {:sourceloc "test_gamepad.c", 42, 101} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    ...
    goto AvnSeqInstr_20__unique__16;

  AvnSeqInstr_20__unique__16:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_21__unique__17;

  AvnSeqInstr_21__unique__17:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$2$p), inline$__SMACK_check_memory_safety$2$p);
    goto AvnSeqInstr_23__unique__18;

  AvnSeqInstr_23__unique__18:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_24__unique__19;

  AvnSeqInstr_24__unique__19:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_26__unique__20;

  AvnSeqInstr_26__unique__20:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_27__unique__21;

  AvnSeqInstr_27__unique__21:
    call corral_fix_context_0();
    assume {:sourceloc "test_gamepad.c", 42, 115} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    ...
    goto AvnSeqInstr_29__unique__22;

  AvnSeqInstr_29__unique__22:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_30__unique__23;

  AvnSeqInstr_30__unique__23:
    call corral_fix_context_0();
    assertsPassed := $sle.ref.bool($base(inline$__SMACK_check_memory_safety$3$p), inline$__SMACK_check_memory_safety$3$p);
    goto AvnSeqInstr_32__unique__24;

  AvnSeqInstr_32__unique__24:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_33__unique__25;

  AvnSeqInstr_33__unique__25:
    call corral_fix_context_0();
    ...
    goto AvnSeqInstr_35__unique__26;

  AvnSeqInstr_35__unique__26:
    call corral_fix_context_0();
    assume assertsPassed;
    goto AvnSeqInstr_36__unique__27;

  AvnSeqInstr_36__unique__27:
    call corral_fix_context_0();
    assume {:sourceloc "test_gamepad.c", 43, 8} true;
    call corral_fix_context_0();
    assume {:verifier.code 0} true;
    ...
    goto AvnSeqInstr_37__unique__28;

  AvnSeqInstr_37__unique__28:
    call corral_fix_context_0();
...
implementation {:origRTname "CorralMain"} CorralMain_trace_1()
{
  ...
  CorralMainStart__unique__1:
    ...
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_10);
    ...
    call boogie_si_record_sdvcp_int(vslice_dummy_var_11);
    call corral_fix_context_0();
    call {:ConcretizeCallId 0} {:si_unique_call 177} {:ConcretizeConstantName "$M.6"} cmdloc_dummy_var_7 := unknown_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_7);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    ...
    call corral_fix_context_0();
    call {:ConcretizeCallId 1} {:si_unique_call 178} {:ConcretizeConstantName "$exnv"} cmdloc_dummy_var_8 := unknown_int();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_8);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    $exnv := cmdloc_dummy_var_8;
    call corral_fix_context_0();
    assume unknownTrigger_1($exnv);
    call corral_fix_context_0();
    call {:ConcretizeCallId 2} {:si_unique_call 179} {:ConcretizeConstantName "$allocatedCounter"} cmdloc_dummy_var_9 := unknown_int();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_9);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    $allocatedCounter := cmdloc_dummy_var_9;
    call corral_fix_context_0();
    assume unknownTrigger_2($allocatedCounter);
    call corral_fix_context_0();
    call {:ConcretizeCallId 3} {:si_unique_call 180} {:ConcretizeConstantName "$CurrAddr"} cmdloc_dummy_var_10 := unknown_ref();
    call boogie_si_record_sdvcp_int(cmdloc_dummy_var_10);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    $CurrAddr := cmdloc_dummy_var_10;
    call corral_fix_context_0();
    assume unknownTrigger_3($CurrAddr);
    goto L_BAF_0__unique__2;

  L_BAF_0__unique__2:
    call corral_fix_context_0();
    assume __block_call_gamepad_callback;
    call corral_fix_context_0();
    call {:ConcretizeCallId 4} {:si_unique_call 183} {:ConcretizeConstantName "$p1_gamepad_callback"} $p1_gamepad_callback := unknown_ref();
    call boogie_si_record_sdvcp_int($p1_gamepad_callback);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume unknownTrigger_4($p1_gamepad_callback);
    call corral_fix_context_0();
    call {:ConcretizeCallId 5} {:si_unique_call 184} {:ConcretizeConstantName "$p2_gamepad_callback"} $p2_gamepad_callback := unknown_ref();
    call boogie_si_record_sdvcp_int($p2_gamepad_callback);
    call corral_fix_context_0();
    assume true;
    call corral_fix_context_0();
    assume unknownTrigger_5($p2_gamepad_callback);
    call corral_fix_context_0();
    assume MustReach(true);
    call corral_fix_context_0();
    call {:si_unique_call 185} {:AvhEntryPoint} vslice_dummy_var_11 := gamepad_callback_trace_1($i0_gamepad_callback, $p1_gamepad_callback, $p2_gamepad_callback);
    goto AvnSeqInstr_280__unique__3;

  AvnSeqInstr_280__unique__3:
    call corral_fix_context_0();
    assume !assertsPassed;
    return;
}
