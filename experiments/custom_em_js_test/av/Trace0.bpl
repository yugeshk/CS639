...
implementation $global_allocations()
{
  ...
  anon0:
    ...
    call {:si_unique_call 1} $galloc(__em_js__get_unicode_str, 4);
    call {:si_unique_call 2} $galloc(get_unicode_str, 4);
    call {:si_unique_call 3} $galloc(printf, 4);
    call {:si_unique_call 4} $galloc(free_, 4);
    call {:si_unique_call 5} $galloc(.str, 285);
    call {:si_unique_call 6} $galloc(llvm.used, 4);
    call {:si_unique_call 7} $galloc(.str.1, 22);
    call {:si_unique_call 8} $galloc(.str.24, 28);
    call {:si_unique_call 9} $galloc(.str.25, 26);
    call {:si_unique_call 10} $galloc(env_value_str, 4);
    call {:si_unique_call 11} $galloc(.str.2.6, 3);
    call {:si_unique_call 12} $galloc(.str.26, 49);
    call {:si_unique_call 13} $galloc(.str.1.27, 14);
    call {:si_unique_call 14} $galloc(__SMACK_nondet_unsigned_int, 4);
    call {:si_unique_call 15} $galloc(__SMACK_nondet_long, 4);
    call {:si_unique_call 16} $galloc(errno_global, 4);
    call {:si_unique_call 17} $galloc(__VERIFIER_assume, 4);
    call {:si_unique_call 18} $galloc(__SMACK_code, 4);
    call {:si_unique_call 19} $galloc(__SMACK_dummy, 4);
    call {:si_unique_call 20} $galloc(__SMACK_check_overflow, 4);
    call {:si_unique_call 21} $galloc(__SMACK_nondet_char, 4);
    call {:si_unique_call 22} $galloc(__SMACK_nondet_signed_char, 4);
    call {:si_unique_call 23} $galloc(__SMACK_decls, 4);
    call {:si_unique_call 24} $galloc(__SMACK_top_decl, 4);
    call {:si_unique_call 25} $galloc(__SMACK_check_memory_safety, 4);
    call {:si_unique_call 26} $galloc(__SMACK_check_memory_leak, 4);
    call {:si_unique_call 27} $galloc(__SMACK_init_func_memory_model, 4);
    call {:si_unique_call 28} $galloc(__SMACK_nondet_unsigned, 4);
    call {:si_unique_call 29} $galloc(__SMACK_nondet_unsigned_char, 4);
    call {:si_unique_call 30} $galloc(__SMACK_nondet_short, 4);
    call {:si_unique_call 31} $galloc(__SMACK_nondet_signed_short, 4);
    call {:si_unique_call 32} $galloc(__SMACK_nondet_signed_short_int, 4);
    call {:si_unique_call 33} $galloc(__SMACK_nondet_unsigned_short, 4);
    call {:si_unique_call 34} $galloc(__SMACK_nondet_unsigned_short_int, 4);
    call {:si_unique_call 35} $galloc(__SMACK_nondet_int, 4);
    call {:si_unique_call 36} $galloc(__SMACK_nondet_signed_int, 4);
    call {:si_unique_call 37} $galloc(__SMACK_nondet_long_int, 4);
    call {:si_unique_call 38} $galloc(__SMACK_nondet_signed_long, 4);
    call {:si_unique_call 39} $galloc(__SMACK_nondet_signed_long_int, 4);
    call {:si_unique_call 40} $galloc(__SMACK_nondet_unsigned_long, 4);
    call {:si_unique_call 41} $galloc(__SMACK_nondet_unsigned_long_int, 4);
    call {:si_unique_call 42} $galloc(__SMACK_nondet_long_long, 4);
    call {:si_unique_call 43} $galloc(__SMACK_nondet_long_long_int, 4);
    call {:si_unique_call 44} $galloc(__SMACK_nondet_signed_long_long, 4);
    call {:si_unique_call 45} $galloc(__SMACK_nondet_signed_long_long_int, 4);
    call {:si_unique_call 46} $galloc(__SMACK_nondet_unsigned_long_long, 4);
    call {:si_unique_call 47} $galloc(__SMACK_nondet_unsigned_long_long_int, 4);
    call {:si_unique_call 48} $galloc(llvm.dbg.value, 4);
    call {:si_unique_call 49} $galloc(__SMACK_static_init, 4);
    return;
}
...
procedure main() returns ($r: i32);
  modifies $M.0, $M.1, $M.2, $M.3, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    call {:si_unique_call 50} $initialize();
    call {:si_unique_call 51} {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
    assume {:verifier.code 0} true;
    call {:si_unique_call 52} $p0 := $alloc($mul.ref(4, 1));
    assume {:verifier.code 0} true;
    call {:si_unique_call 53} $p1 := $alloc($mul.ref(4, 1));
    ...
    assume {:verifier.code 0} true;
    call {:ConcretizeCallId 0} {:si_unique_call 54} $p4 := get_unicode_str();
    ...
    $p13 := $load.ref($M.1, $p1);
    assume {:verifier.code 0} true;
    call {:si_unique_call 56} free_($p13);
    call {:si_unique_call 57} __SMACK_check_memory_leak();
    assume {:verifier.code 0} true;
    $r := 0;
    return;
}
...
procedure {:AngelicUnknown} get_unicode_str() returns ($r: ref);
...
implementation free_($p0: ref)
{
  ...
  anon0:
    call {:si_unique_call 58} $free($p0);
    return;
}
...
implementation __SMACK_check_overflow($i0: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 59} {:cexpr "__SMACK_check_overflow:arg:flag"} boogie_si_record_i32($i0);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    ...
    inline$$$alloc$0$n := n;
    call {:si_unique_call 61} inline$$$alloc$0$p := havocNonDetAvh.ref();
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 63} cmdloc_dummy_var_0 := havocNonDetAvh.ref();
...
implementation $free(p: ref)
{
  ...
  anon2:
    call {:si_unique_call 65} corral_atomic_end();
    return;
...
implementation $initialize()
{
  ...
  anon0:
    call {:si_unique_call 67} $global_allocations();
    call {:si_unique_call 68} __SMACK_static_init();
    call {:si_unique_call 69} __SMACK_init_func_memory_model();
    return;
}
...
procedure {:entrypoint} CorralMain();
  modifies $M.2, $M.3, $exnv, $allocatedCounter, $CurrAddr, $M.0, $M.1, $Alloc;
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    ...
    call {:si_unique_call 75} {:AvhEntryPoint} vslice_dummy_var_1 := main();
    return;
}



implementation get_unicode_str() returns ($r: ref)
{
