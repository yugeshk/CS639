...
implementation $global_allocations()
{
  ...
  anon0:
    call $galloc(main, 4);
    call $galloc(__em_js__get_unicode_str, 4);
    call $galloc(get_unicode_str, 4);
    call $galloc(printf, 4);
    call $galloc(free_, 4);
    call $galloc(.str, 285);
    call $galloc(llvm.used, 4);
    call $galloc(.str.1, 22);
    call $galloc(.str.24, 28);
    call $galloc(.str.25, 26);
    call $galloc(env_value_str, 4);
    call $galloc(.str.2.6, 3);
    call $galloc(.str.26, 49);
    call $galloc(.str.1.27, 14);
...
implementation __em_js__get_unicode_str() returns ($r: ref)
{
...
implementation main() returns ($r: i32)
{
  ...
  $bb0$3:
    ...
    $p9 := $load.ref($M.1, $p1);
    assume {:verifier.code 0} true;
    call $i10 := printf.ref.ref(.str.1, $p9);
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeConstantName "$M.2"} $M.2 := unknown_ref();
    call {:ConcretizeConstantName "$M.3"} $M.3 := unknown_ref();
    ...
    goto L_BAF_0, L_BAF_1, L_BAF_2, L_BAF_3, L_BAF_4, L_BAF_5, L_BAF_6, L_BAF_7, L_BAF_8, L_BAF_9, L_BAF_10, L_BAF_11, L_BAF_12, L_BAF_13, L_BAF_14;
  ...
  L_BAF_1:
    assume __block_call___em_js__get_unicode_str;
    assume MustReach(true);
    call {:AvhEntryPoint} $r___em_js__get_unicode_str := __em_js__get_unicode_str();
    return;
