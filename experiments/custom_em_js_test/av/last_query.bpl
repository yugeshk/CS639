...
procedure main() returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.1, $Alloc;
...
procedure CorralMain();
  ...
  free requires {:BlockingConstraint 1} (forall x_7: ref, x_11: ref :: unknownTrigger_7(x_7) && unknownTrigger_0(x_11) ==> $slt.ref.bool($0.ref, $load.ref($store.ref($M.1, x_7, x_11), x_7)));
  modifies assertsPassed, $M.1, $Alloc;
