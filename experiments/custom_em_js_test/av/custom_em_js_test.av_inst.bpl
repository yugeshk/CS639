...
procedure main() returns ($r: i32);
  modifies $M.0, $M.1, $exn, $M.2, $M.3, $M.4, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation main() returns ($r: i32)
{
  ...
  $bb0$3:
    ...
    $p9 := $load.ref($M.1, $p1);
    assume {:verifier.code 0} true;
    call {:si_unique_call 55} $i10 := printf.ref.ref(.str.1, $p9);
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 63} $CurrAddr := havocNonDetAvh.ref();
...
procedure $initialize();
  modifies $M.2, $M.3, $M.4, $exn, $CurrAddr, $allocatedCounter, $Alloc;
...
procedure {:entrypoint} CorralMain();
  modifies $M.2, $M.3, $exnv, $allocatedCounter, $CurrAddr, $exn, $M.0, $M.1, $Alloc, $M.4;



implementation CorralMain()
{
  var $r___em_js__get_unicode_str: ref;
  var $r_main: i32;
  var $p0_free_: ref;
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeCallId 1} {:si_unique_call 70} {:ConcretizeConstantName "$M.2"} $M.2 := unknown_ref();
    assume unknownTrigger_1($M.2);
    call {:ConcretizeCallId 2} {:si_unique_call 71} {:ConcretizeConstantName "$M.3"} $M.3 := unknown_ref();
    assume unknownTrigger_2($M.3);
    call {:ConcretizeCallId 3} {:si_unique_call 72} {:ConcretizeConstantName "$exnv"} $exnv := unknown_int();
    assume unknownTrigger_3($exnv);
    call {:ConcretizeCallId 4} {:si_unique_call 73} {:ConcretizeConstantName "$allocatedCounter"} $allocatedCounter := unknown_int();
    assume unknownTrigger_4($allocatedCounter);
    call {:ConcretizeCallId 5} {:si_unique_call 74} {:ConcretizeConstantName "$CurrAddr"} $CurrAddr := unknown_ref();
  ...
  L_BAF_0:
    ...
    call {:si_unique_call 75} {:AvhEntryPoint} $r_main := main();
    return;
}
