...
procedure __em_js__get_unicode_str() returns ($r: ref);
...
implementation {:entrypoint} main() returns ($r: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 54} __SMACK_check_memory_safety($p2, $p3);
    assume {:verifier.code 0} true;
    $M.0 := $store.i32($M.0, $p0, 0);
    assume {:verifier.code 0} true;
    call {:si_unique_call 55} $p4 := get_unicode_str();
    assume $isExternal($p4);
    $p5 := $bitcast.ref.ref($p1);
    $p6 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 56} __SMACK_check_memory_safety($p5, $p6);
    assume {:verifier.code 0} true;
    $M.1 := $store.ref($M.1, $p1, $p4);
    $p7 := $bitcast.ref.ref($p1);
    $p8 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 57} __SMACK_check_memory_safety($p7, $p8);
    assume {:verifier.code 0} true;
    $p9 := $load.ref($M.1, $p1);
    assume {:verifier.code 0} true;
    call {:si_unique_call 58} $i10 := printf.ref.ref(.str.1, $p9);
    $p11 := $bitcast.ref.ref($p1);
    $p12 := $bitcast.ref.ref($i2p.i64.ref(4));
    call {:si_unique_call 59} __SMACK_check_memory_safety($p11, $p12);
    assume {:verifier.code 0} true;
    $p13 := $load.ref($M.1, $p1);
    assume {:verifier.code 0} true;
    call {:si_unique_call 60} free_($p13);
    call {:si_unique_call 61} __SMACK_check_memory_leak();
    assume {:verifier.code 0} true;
    $r := 0;
    $exn := false;
    return;
...
procedure get_unicode_str() returns ($r: ref);
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 63} corral_atomic_begin();
    call {:si_unique_call 64} p := $$alloc(n);
...
implementation $free(p: ref)
{
  ...
  anon0:
    call {:si_unique_call 66} corral_atomic_begin();
    goto anon3_Then, anon3_Else;
  ...
  anon2:
    call {:si_unique_call 67} corral_atomic_end();
    return;
}
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    ...
    $M.3 := .str.2.6;
    $M.4 := 0;
    call {:si_unique_call 68} {:cexpr "errno_global"} boogie_si_record_i32(0);
    $exn := false;
    return;
}
...
implementation $initialize()
{
  ...
  anon0:
    call {:si_unique_call 69} $global_allocations();
    call {:si_unique_call 70} __SMACK_static_init();
    call {:si_unique_call 71} __SMACK_init_func_memory_model();
    return;
}
