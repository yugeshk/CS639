...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 53670));
...
procedure  $global_allocations()
{
  ...
  call $galloc(__const.get_unicode_str.jsString, 100);
  call $galloc(.str, 22);
  call $galloc(.str.24, 28);
  call $galloc(.str.25, 26);
  call $galloc(env_value_str, 4);
  call $galloc(.str.2.3, 3);
...
const {:count 100} __const.get_unicode_str.jsString: ref;
axiom (__const.get_unicode_str.jsString == $sub.ref(0, 1124));
const .str: ref;
axiom (.str == $sub.ref(0, 2170));
const {:count 28} .str.24: ref;
axiom (.str.24 == $sub.ref(0, 3222));
const {:count 26} .str.25: ref;
axiom (.str.25 == $sub.ref(0, 4272));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 5300));
const {:count 3} .str.2.3: ref;
axiom (.str.2.3 == $sub.ref(0, 6327));
const {:count 49} .str.26: ref;
axiom (.str.26 == $sub.ref(0, 7400));
const {:count 14} .str.1.27: ref;
axiom (.str.1.27 == $sub.ref(0, 8438));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 9466));
const get_unicode_str: ref;
axiom (get_unicode_str == $sub.ref(0, 10494));
procedure  get_unicode_str()
  returns ($r: ref)
{
  var $p0: ref;
  var $p1: ref;
  ...
  var $p9: ref;
$bb0:
  assume {:sourceloc "custom_em_js_test.c", 17, 6} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(100, 1));
  assume true;
  assume {:sourceloc "custom_em_js_test.c", 17, 6} true;
  assume {:verifier.code 0} true;
  ...
  $p4 := $bitcast.ref.ref(__const.get_unicode_str.jsString);
  $p5 := $i2p.i32.ref(100);
  call __SMACK_check_memory_safety($p4, $p5);
  assume {:sourceloc "custom_em_js_test.c", 17, 6} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const.get_unicode_str.jsString, 100, false);
  assume {:sourceloc "custom_em_js_test.c", 18, 27} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 100)), $mul.ref(0, 1));
  assume {:sourceloc "custom_em_js_test.c", 18, 20} true;
  assume {:verifier.code 0} true;
  call $i7 := strlen($p6);
  call {:cexpr "lengthyBytes"} boogie_si_record_i32($i7);
  assume {:sourceloc "custom_em_js_test.c", 19, 48} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32(1, $i7);
  assume {:sourceloc "custom_em_js_test.c", 19, 29} true;
  assume {:verifier.code 0} true;
  call $p9 := malloc($i8);
  assume {:sourceloc "custom_em_js_test.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $r := $p9;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 11522));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.memcpy.p0i8.p0i8.i32: ref;
axiom (llvm.memcpy.p0i8.p0i8.i32 == $sub.ref(0, 12550));
procedure  llvm.memcpy.p0i8.p0i8.i32($p0: ref, $p1: ref, $i2: i32, $i3: i1);
const strlen: ref;
axiom (strlen == $sub.ref(0, 13578));
procedure  strlen($p0: ref)
  returns ($r: i32);
const malloc: ref;
axiom (malloc == $sub.ref(0, 14606));
...
$bb0:
  call $initialize();
  assume {:sourceloc "custom_em_js_test.c", 26, 21} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "custom_em_js_test.c", 26, 21} true;
  assume {:verifier.code 0} true;
  call $p0 := get_unicode_str();
  assume {:sourceloc "custom_em_js_test.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := printf.ref.ref(.str, $p0);
  assume {:sourceloc "custom_em_js_test.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call free_($p0);
  call __SMACK_check_memory_leak();
  assume {:sourceloc "custom_em_js_test.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const printf: ref;
axiom (printf == $sub.ref(0, 16662));
procedure  printf.ref.ref($p0: ref, p.1: ref)
  returns ($r: i32);
const free_: ref;
axiom (free_ == $sub.ref(0, 17690));
procedure  free_($p0: ref)
{
  call $free($p0);
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 18718));
...
axiom (__SMACK_code == $sub.ref(0, 19746));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 20774));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 21802));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 22830));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 23858));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 24886));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 25914));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 26942));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 27970));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 28998));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 30026));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 31054));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 32082));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 33110));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 34138));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 35166));
procedure  __SMACK_nondet_long()
  returns ($r: i32);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 36194));
procedure  __SMACK_nondet_long_int()
  returns ($r: i32);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 37222));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i32);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 38250));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 39278));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i32);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 40306));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i32);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 41334));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 42362));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 43390));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 44418));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 45446));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 46474));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 47502));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 48530));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_check_memory_safety: ref;
axiom (__SMACK_check_memory_safety == $sub.ref(0, 49558));
procedure  __SMACK_check_memory_safety($p0: ref, $p1: ref);
const __SMACK_check_memory_leak: ref;
axiom (__SMACK_check_memory_leak == $sub.ref(0, 50586));
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 51614));
...
axiom (llvm.dbg.value == $sub.ref(0, 52642));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 53670));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i8($M.0, __const.get_unicode_str.jsString, 72);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(1, 1)), 101);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(2, 1)), 108);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(3, 1)), 108);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(4, 1)), 111);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(5, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(6, 1)), 119);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(7, 1)), 105);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(8, 1)), 116);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(9, 1)), 104);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(10, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(11, 1)), 115);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(12, 1)), 111);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(13, 1)), 109);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(14, 1)), 101);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(15, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(16, 1)), 101);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(17, 1)), 120);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(18, 1)), 111);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(19, 1)), 116);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(20, 1)), 105);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(21, 1)), 99);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(22, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(23, 1)), 85);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(24, 1)), 110);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(25, 1)), 105);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(26, 1)), 99);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(27, 1)), 111);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(28, 1)), 100);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(29, 1)), 101);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(30, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(31, 1)), 99);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(32, 1)), 104);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(33, 1)), 97);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(34, 1)), 114);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(35, 1)), 97);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(36, 1)), 99);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(37, 1)), 116);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(38, 1)), 101);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(39, 1)), 114);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(40, 1)), 115);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(41, 1)), 58);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(42, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(43, 1)), 84);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(44, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(45, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(46, 1)), 115);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(47, 1)), 115);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(48, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(49, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(50, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(51, 1)), 111);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(52, 1)), 110);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(53, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(54, 1)), 121);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(55, 1)), 107);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(56, 1)), 115);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(57, 1)), 105);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(58, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(59, 1)), 108);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(60, 1)), 117);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(61, 1)), 109);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(62, 1)), 105);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(63, 1)), 117);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(64, 1)), 107);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(65, 1)), 107);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(66, 1)), 111);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(67, 1)), 58);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(68, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(69, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(70, 1)), 94);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(71, 1)), 120);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(72, 1)), 94);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(73, 1)), 99);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(74, 1)), 44);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(75, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(76, 1)), 111);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(77, 1)), 108);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(78, 1)), 101);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(79, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(80, 1)), 104);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(81, 1)), 121);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(82, 1)), 118);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(83, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(84, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(85, 1)), 46);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(86, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(87, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(88, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(89, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(90, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(91, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(92, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(93, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(94, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(95, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(96, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(97, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(98, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.get_unicode_str.jsString, $mul.ref(0, 100)), $mul.ref(99, 1)), 0);
  $M.2 := .str.2.3;
  $M.3 := 0;
