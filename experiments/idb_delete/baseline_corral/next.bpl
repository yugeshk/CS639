...
procedure main() returns ($r: i32);
  free requires assertsPassed;
  modifies $M.1, $CurrAddr, $allocatedCounter, assertsPassed, $Alloc;
...
implementation main() returns ($r: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 71} __SMACK_check_memory_safety($p5, $p6);
  ...
  SeqInstr_3:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 72} $p7 := emscripten_fetch($p0, .str.1);
    ...
    call {:si_unique_call 73} __SMACK_check_memory_safety($p9, $p10);
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 74} vslice_dummy_var_0 := emscripten_fetch_close($p7);
    assume {:sourceloc "idb_delete.cpp", 24, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 75} emscripten_fetch_attr_init($p0);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 76} $p17 := _Z6strcpyPcPKc($p16, .str);
    ...
    call {:si_unique_call 77} __SMACK_check_memory_safety($p19, $p20);
  ...
  SeqInstr_9:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 78} $p21 := emscripten_fetch($p0, .str.1);
    ...
    call {:si_unique_call 79} __SMACK_check_memory_safety($p23, $p24);
  ...
  $bb3:
    ...
    assume {:sourceloc "idb_delete.cpp", 20, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 80} __assert_fail(.str.2, .str.3, 20, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 20, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb4;
  ...
  $bb6:
    ...
    call {:si_unique_call 81} __SMACK_check_memory_safety($p29, $p30);
  ...
  $bb7:
    ...
    assume {:sourceloc "idb_delete.cpp", 28, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 82} __assert_fail(.str.4, .str.3, 28, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 28, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb8;
  ...
  $bb10:
    ...
    call {:si_unique_call 83} __SMACK_check_memory_safety($p34, $p35);
  ...
  $bb11:
    ...
    assume {:sourceloc "idb_delete.cpp", 29, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 84} __assert_fail(.str.5, .str.3, 29, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 29, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb12;
  ...
  $bb14:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 85} vslice_dummy_var_1 := emscripten_fetch_close($p21);
    assume {:sourceloc "idb_delete.cpp", 34, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 86} emscripten_fetch_attr_init($p0);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 87} $p41 := _Z6strcpyPcPKc($p40, .str.7);
    ...
    call {:si_unique_call 88} __SMACK_check_memory_safety($p43, $p44);
  ...
  SeqInstr_21:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 89} $p45 := emscripten_fetch($p0, .str.1);
    ...
    call {:si_unique_call 90} __SMACK_check_memory_safety($p47, $p48);
  ...
  $bb15:
    ...
    assume {:sourceloc "idb_delete.cpp", 30, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 91} __assert_fail(.str.6, .str.3, 30, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 30, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb16;
  ...
  $bb18:
    ...
    call {:si_unique_call 92} __SMACK_check_memory_safety($p53, $p54);
  ...
  $bb19:
    ...
    assume {:sourceloc "idb_delete.cpp", 38, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 93} __assert_fail(.str.8, .str.3, 38, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 38, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb20;
  ...
  $bb22:
    ...
    call {:si_unique_call 94} __SMACK_check_memory_safety($p58, $p59);
  ...
  $bb23:
    ...
    assume {:sourceloc "idb_delete.cpp", 39, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} __assert_fail(.str.9, .str.3, 39, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 39, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb24;
  ...
  $bb26:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 96} vslice_dummy_var_2 := emscripten_fetch_close($p45);
    assume {:sourceloc "idb_delete.cpp", 44, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 97} emscripten_fetch_attr_init($p0);
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 98} $p65 := _Z6strcpyPcPKc($p64, .str);
    ...
    call {:si_unique_call 99} __SMACK_check_memory_safety($p67, $p68);
  ...
  SeqInstr_33:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 100} $p69 := emscripten_fetch($p0, .str.1);
    ...
    call {:si_unique_call 101} __SMACK_check_memory_safety($p71, $p72);
  ...
  $bb27:
    ...
    assume {:sourceloc "idb_delete.cpp", 40, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 102} __assert_fail(.str.10, .str.3, 40, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 40, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb28;
  ...
  $bb30:
    ...
    call {:si_unique_call 103} __SMACK_check_memory_safety($p77, $p78);
  ...
  $bb31:
    ...
    assume {:sourceloc "idb_delete.cpp", 48, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 104} __assert_fail(.str.11, .str.3, 48, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 48, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb32;
  ...
  $bb34:
    ...
    call {:si_unique_call 105} __SMACK_check_memory_safety($p82, $p83);
  ...
  $bb35:
    ...
    assume {:sourceloc "idb_delete.cpp", 49, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 106} __assert_fail(.str.9, .str.3, 49, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 49, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb36;
  ...
  $bb38:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 107} vslice_dummy_var_3 := emscripten_fetch_close($p69);
    assume {:sourceloc "idb_delete.cpp", 53, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 108} vslice_dummy_var_4 := printf.ref(.str.12);
    call {:si_unique_call 109} __SMACK_check_memory_leak();
  ...
  $bb39:
    ...
    assume {:sourceloc "idb_delete.cpp", 50, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 110} __assert_fail(.str.10, .str.3, 50, __func__.main);
    assume {:sourceloc "idb_delete.cpp", 50, 3} true;
    assume {:verifier.code 0} true;
    assume false;
    goto $bb40;
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  anon0:
    call {:si_unique_call 111} corral_atomic_begin();
    call {:si_unique_call 112} p := $$alloc(n);
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    call {:si_unique_call 114} {:cexpr "errno_global"} boogie_si_record_i32(0);
    return;
}
...
procedure $initialize();
  free requires assertsPassed;
  modifies $CurrAddr, $allocatedCounter, $Alloc;
...
implementation $initialize()
{
  ...
  anon0:
    call {:si_unique_call 115} $global_allocations();
    call {:si_unique_call 116} __SMACK_static_init();
    call {:si_unique_call 117} __SMACK_init_func_memory_model();
    return;
}
...
procedure {:entrypoint} main_SeqInstr() returns ($r: i32);
  free requires assertsPassed;
  modifies assertsPassed, $M.1, $CurrAddr, $allocatedCounter, $Alloc;
