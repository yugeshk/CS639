...
procedure {:entrypoint} main() returns ($r: i32);
  modifies $M.1, $exn, $M.2, $M.3, $CurrAddr, $allocatedCounter, $Alloc;
...
implementation {:entrypoint} main() returns ($r: i32)
{
  ...
  $bb0:
    ...
    assume {:verifier.code 0} true;
    $p1 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1));
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 74} $i14 := emscripten_fetch_close($p7);
    ...
    assume {:verifier.code 0} true;
    $p15 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1));
  ...
  $bb14:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 85} $i38 := emscripten_fetch_close($p21);
    ...
    assume {:verifier.code 0} true;
    $p39 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1));
  ...
  $bb26:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 96} $i62 := emscripten_fetch_close($p45);
    ...
    assume {:verifier.code 0} true;
    $p63 := $add.ref($add.ref($p0, $mul.ref(0, 92)), $mul.ref(0, 1));
  ...
  $bb38:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 107} $i86 := emscripten_fetch_close($p69);
    assume {:sourceloc "idb_delete.cpp", 53, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 108} $i87 := printf.ref(.str.12);
...
procedure $initialize();
  modifies $M.2, $M.3, $exn, $CurrAddr, $allocatedCounter, $Alloc;
