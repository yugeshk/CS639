...
implementation main() returns ($r: i32)
{
  ...
  $bb2:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 73} $i14 := emscripten_fetch_close($p7);
  ...
  $bb14:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 80} $i38 := emscripten_fetch_close($p21);
  ...
  $bb26:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 87} $i62 := emscripten_fetch_close($p45);
  ...
  $bb38:
    ...
    assume {:verifier.code 0} true;
    call {:si_unique_call 94} $i86 := emscripten_fetch_close($p69);
    assume {:sourceloc "idb_delete.cpp", 53, 3} true;
    assume {:verifier.code 0} true;
    call {:si_unique_call 95} $i87 := printf.ref(.str.12);
...
implementation __SMACK_check_overflow(flag: i32)
{
  ...
  $bb0:
    ...
    call {:si_unique_call 97} {:cexpr "__SMACK_check_overflow:arg:flag"} boogie_si_record_i32(flag);
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 247, 29} true;
    assume {:verifier.code 1} true;
    assume true;
...
implementation $alloc(n: ref) returns (p: ref)
{
  ...
  inline$$$alloc$0$anon3_Then:
    ...
    call {:si_unique_call 101} $CurrAddr := havocNonDetAvh.ref();
...
implementation $free(p: ref)
{
  ...
  anon0:
    call {:si_unique_call 102} corral_atomic_begin();
  ...
  anon2:
    call {:si_unique_call 103} corral_atomic_end();
    return;
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeCallId 4} {:si_unique_call 108} {:ConcretizeConstantName "$M.2"} $M.2 := unknown_ref();
    assume unknownTrigger_4($M.2);
    call {:ConcretizeCallId 5} {:si_unique_call 109} {:ConcretizeConstantName "$exnv"} $exnv := unknown_int();
    assume unknownTrigger_5($exnv);
    call {:ConcretizeCallId 6} {:si_unique_call 110} {:ConcretizeConstantName "$allocatedCounter"} $allocatedCounter := unknown_int();
    assume unknownTrigger_6($allocatedCounter);
    call {:ConcretizeCallId 7} {:si_unique_call 111} {:ConcretizeConstantName "$CurrAddr"} $CurrAddr := unknown_ref();
  ...
  L_BAF_0:
    ...
    call {:si_unique_call 112} {:AvhEntryPoint} $r_main := main();
    return;
}
